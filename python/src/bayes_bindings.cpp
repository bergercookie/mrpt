...
CParticleFilter_executeOn(CParticleFilter &self, CParticleFilterCapable &obj,
...
void export_bayes() {
  ...
  // CParticleFilter
  {
    ...
    class_<CParticleFilter::TParticleFilterOptions, bases<CLoadableOptions>>(
  ...
  // CParticleList
  {
    class_<CParticle2DList>("CParticle2DList", init<>())
        ...
        .def("append", &StlListLike<CParticle2DList>::add,
             with_custodian_and_ward<1, 2>()) // to let container keep value
        .def("__getitem__", &StlListLike<CParticle2DList>::get,
             return_value_policy<copy_non_const_reference>())
        .def("__setitem__", &StlListLike<CParticle2DList>::set,
             with_custodian_and_ward<1, 2>()) // to let container keep value
    ...
    class_<CParticle3DList>("CParticle3DList", init<>())
        ...
        .def("append", &StlListLike<CParticle3DList>::add,
             with_custodian_and_ward<1, 2>()) // to let container keep value
        .def("__getitem__", &StlListLike<CParticle3DList>::get,
             return_value_policy<copy_non_const_reference>())
        .def("__setitem__", &StlListLike<CParticle3DList>::set,
             with_custodian_and_ward<1, 2>()) // to let container keep value
