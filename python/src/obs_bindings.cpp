...
// CActionCollection
void CActionCollection_insert1(CActionCollection &self,
                               CActionRobotMovement2D &action) {
  self.insert(action);
}

void CActionCollection_insert2(CActionCollection &self,
                               CActionRobotMovement3D &action) {
  self.insert(action);
}
...
object CObservationOdometry_to_ROS_RawOdometry_msg(CObservationOdometry &self,
                                                   str frame_id) {
  // import msg
  dict locals;
...
void CObservationOdometry_from_ROS_RawOdometry_msg(CObservationOdometry &self,
                                                   object raw_odometry_msg) {
  // set info
  self.sensorLabel =
      extract<std::string>(raw_odometry_msg.attr("header").attr("frame_id"));
  self.timestamp = extract<uint64_t>(
      TTimeStamp_from_ROS_Time(raw_odometry_msg.attr("header").attr("stamp")));
...
// CObservationRange
#ifdef ROS_EXTENSIONS
object CObservationRange_to_ROS_Range_msg(CObservationRange &self,
                                          str frame_id) {
  // import msg
  dict locals;
...
void CObservationRange_from_ROS_Range_msg(CObservationRange &self,
                                          object range_msg) {
  // set info
  self.sensorLabel =
...
#ifdef ROS_EXTENSIONS
object
CObservation2DRangeScan_to_ROS_LaserScan_msg(CObservation2DRangeScan &self,
                                             str frame_id) {
  // import msg
  dict locals;
...
tuple CRawlog_readActionObservationPair(CStream &inStream, size_t rawlogEntry) {
  ...
  bool is_next = CRawlog::readActionObservationPair(inStream, action,
...
void export_obs() {
  ...
  // CAction
  {
    ...
    class_<CAction, boost::noncopyable, bases<CSerializable>>("CAction",
                                                              no_init)
  ...
  // CActionCollection
  {
    class_<CActionCollection>("CActionCollection", init<>())
        .def("clear", &CActionCollection::clear,
             "Erase all actions from the list.")
        .def("insert", &CActionCollection::insert,
             "Add a new object to the list.")
        .def("size", &CActionCollection::size,
             "Returns the actions count in the collection.")
        .def("eraseByIndex", &CActionCollection::eraseByIndex,
  ...
  // CActionRobotMovement2D
  {
    ...
    scope s =
        class_<CActionRobotMovement2D, bases<CAction>>("CActionRobotMovement2D",
                                                       init<>())
            .def_readwrite("rawOdometryIncrementReading",
                           &CActionRobotMovement2D::rawOdometryIncrementReading)
            .def_readwrite("estimationMethod",
                           &CActionRobotMovement2D::estimationMethod)
            .def_readwrite("hasEncodersInfo",
                           &CActionRobotMovement2D::hasEncodersInfo)
            .def_readwrite("encoderLeftTicks",
                           &CActionRobotMovement2D::encoderLeftTicks)
            .def_readwrite("encoderRightTicks",
                           &CActionRobotMovement2D::encoderRightTicks)
            .def_readwrite("hasVelocities",
                           &CActionRobotMovement2D::hasVelocities)
            .def_readwrite("velocityLin", &CActionRobotMovement2D::velocityLin)
            .def_readwrite("velocityAng", &CActionRobotMovement2D::velocityAng)
            .def_readwrite("motionModelConfiguration",
                           &CActionRobotMovement2D::motionModelConfiguration)
            .def("computeFromOdometry",
                 &CActionRobotMovement2D::computeFromOdometry,
                 "Computes the PDF of the pose increment from an odometry "
                 "reading and according to the given motion model (speed and "
                 "encoder ticks information is not modified).")
            .def("computeFromEncoders",
                 &CActionRobotMovement2D::computeFromEncoders,
                 "If \"hasEncodersInfo\"=true, this method updates the pose "
                 "estimation according to the ticks from both encoders and the "
                 "passed parameters, which is passed internally to the method "
                 "\"computeFromOdometry\" with the last used PDF options (or "
                 "the defualt ones if not explicitly called by the user).")
...

    {
      ...
      scope s =
          class_<CActionRobotMovement2D::TMotionModelOptions>(
              ...
              .def_readwrite(
                  "gaussianModel",
                  &CActionRobotMovement2D::TMotionModelOptions::gaussianModel)
              .def_readwrite(
                  "thrunModel",
                  &CActionRobotMovement2D::TMotionModelOptions::thrunModel);

      // TOptions_GaussianModel
      class_<
          CActionRobotMovement2D::TMotionModelOptions::TOptions_GaussianModel>(
          "TOptions_GaussianModel", init<>())
          .def_readwrite("a1", &CActionRobotMovement2D::TMotionModelOptions::
                                   TOptions_GaussianModel::a1)
          .def_readwrite("a2", &CActionRobotMovement2D::TMotionModelOptions::
                                   TOptions_GaussianModel::a2)
          .def_readwrite("a3", &CActionRobotMovement2D::TMotionModelOptions::
                                   TOptions_GaussianModel::a3)
          .def_readwrite("a4", &CActionRobotMovement2D::TMotionModelOptions::
                                   TOptions_GaussianModel::a4)
          .def_readwrite("minStdXY",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_GaussianModel::minStdXY)
          .def_readwrite("minStdPHI",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_GaussianModel::minStdPHI);

      // TOptions_ThrunModel
      class_<CActionRobotMovement2D::TMotionModelOptions::TOptions_ThrunModel>(
          "TOptions_ThrunModel", init<>())
          .def_readwrite("nParticlesCount",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_ThrunModel::nParticlesCount)
          .def_readwrite("alfa1_rot_rot",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_ThrunModel::alfa1_rot_rot)
          .def_readwrite("alfa2_rot_trans",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_ThrunModel::alfa2_rot_trans)
          .def_readwrite("alfa3_trans_trans",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_ThrunModel::alfa3_trans_trans)
          .def_readwrite("alfa4_trans_rot",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_ThrunModel::alfa4_trans_rot)
          .def_readwrite("additional_std_XY",
                         &CActionRobotMovement2D::TMotionModelOptions::
                             TOptions_ThrunModel::additional_std_XY)
          .def_readwrite("additional_std_phi",
                         &CActionRobotMovement2D::TMotionModelOptions::
  ...
  // CObservation
  {
    ...
    class_<CObservation, boost::noncopyable, bases<CSerializable>>(
        ...
        .add_property("timestamp", &CObservation_get_timestamp,
                      &CObservation_set_timestamp)
        .def_readwrite("sensorLabel", &CObservation::sensorLabel)
        .def("getSensorPose", &CObservation_getSensorPose1,
             "A general method to retrieve the sensor pose on the robot.")
        .def("getSensorPose", &CObservation_getSensorPose2,
             "A general method to retrieve the sensor pose on the robot.")
        .def("getSensorPose", &CObservation_getSensorPose3,
             "A general method to retrieve the sensor pose on the robot.")
        .def("setSensorPose", &CObservation_setSensorPose1,
             "A general method to change the sensor pose on the robot.")
        .def("setSensorPose", &CObservation_setSensorPose2,
             "A general method to change the sensor pose on the robot.");
  }
  ...
  // CObservationOdometry
  {
    ...
    scope s = class_<CObservationOdometry, bases<CObservation>>(
                  "CObservationOdometry", init<>())
                  .def_readwrite("odometry", &CObservationOdometry::odometry)
                  .def_readwrite("hasEncodersInfo",
                                 &CObservationOdometry::hasEncodersInfo)
                  .def_readwrite("encoderLeftTicks",
                                 &CObservationOdometry::encoderLeftTicks)
                  .def_readwrite("encoderRightTicks",
                                 &CObservationOdometry::encoderRightTicks)
                  .def_readwrite("hasVelocities",
                                 &CObservationOdometry::hasVelocities)
                  .def_readwrite("velocityLocal",
                                 &CObservationOdometry::velocityLocal)
                      MAKE_CREATE(CObservationOdometry)
#ifdef ROS_EXTENSIONS
                  .def("to_ROS_RawOdometry_msg",
                       &CObservationOdometry_to_ROS_RawOdometry_msg,
                       "Convert to ROS pymrpt_msgs/RawOdometry.")
                  .def("from_ROS_RawOdometry_msg",
  ...
  // CObservationRange
  {
    ...
    scope s =
        class_<CObservationRange, bases<CObservation>>("CObservationRange",
                                                       init<>())
            .def_readwrite("minSensorDistance",
                           &CObservationRange::minSensorDistance)
            .def_readwrite("maxSensorDistance",
                           &CObservationRange::maxSensorDistance)
            .def_readwrite("sensorConeApperture",
    ...
    class_<CObservationRange::TMeasurement>("TMeasurement", init<>())
        ...
        .def_readwrite("sensorPose",
                       &CObservationRange::TMeasurement::sensorPose)
        .def_readwrite("sensedDistance",
    ...
    class_<CObservationRange::TMeasurementList>("TMeasurementList", init<>())
        ...
        .def("append", &StlListLike<CObservationRange::TMeasurementList>::add,
  ...
  // CRawlog
  {
    scope s =
        class_<CRawlog>("CRawlog", init<>())
            ...
            .def("size", &CRawlog::size, "Returns the number of actions / "
                                         "observations object in the sequence.")
            ...
            .def("loadFromRawLogFile", &CRawlog::loadFromRawLogFile,
  ...
  // CSensoryFrame
  {
    ...
    class_<CSensoryFrame>("CSensoryFrame", init<>())
        ...
        .def("insert", &CSensoryFrame::insert,
             "Inserts a new observation to the list.")
        .def("size", &CSensoryFrame::size,
             "Returns the number of observations in the list")
        .def("eraseByIndex", &CSensoryFrame::eraseByIndex,
             "Removes the i'th observation in the list (0=first).")
        .def("getAuxPointsMap", &CSensoryFrame_getAuxPointsMap,
        ...
        .def("buildAuxPointsMap", &CSensoryFrame_buildAuxPointsMap,
             return_internal_reference<>(),
