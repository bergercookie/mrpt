...
// CMetricMap
bool CMetricMap_insertObservation(CMetricMap &self, const CObservation &obs,
                                  const CPose3D &robotPose = CPose3D()) {
  return self.insertObservation(&obs, &robotPose);
}

bool CMetricMap_insertObservationPtr(CMetricMap &self,
...
BOOST_PYTHON_FUNCTION_OVERLOADS(CMetricMap_insertObservation_overloads,
                                CMetricMap_insertObservation, 2, 3)
BOOST_PYTHON_FUNCTION_OVERLOADS(CMetricMap_insertObservationPtr_overloads,
                                CMetricMap_insertObservationPtr, 2, 3)
// end of CMetricMap
...
bool COccupancyGridMap2D_insertObservation(COccupancyGridMap2D &self,
                                           CObservation &obs, CPose3D &pose) {
  return self.insertObservation(&obs, &pose);
}

object COccupancyGridMap2D_to_ROS_OccupancyGrid_msg1(COccupancyGridMap2D &self,
                                                     str frame_id) {
  // import msg
  dict locals;
...
object
COccupancyGridMap2D_to_ROS_OccupancyGrid_msg2(COccupancyGridMap2D &self) {
  return COccupancyGridMap2D_to_ROS_OccupancyGrid_msg1(self, str("map"));
}

void COccupancyGridMap2D_from_ROS_OccupancyGrid_msg(COccupancyGridMap2D &self,
                                                    object occupancy_grid_msg) {
  // set info
...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(COccupancyGridMap2D_fill_overloads, fill,
                                       0, 1)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(COccupancyGridMap2D_setSize_overloads,
                                       setSize, 5, 6)
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(COccupancyGridMap2D_resizeGrid_overloads,
                                       resizeGrid, 4, 6)
...
boost::python::tuple
CSimplePointsMap_getPointAllFieldsFast(CSimplePointsMap &self, uint32_t index) {
...
boost::python::tuple CSimplePointsMap_getPointFast(CSimplePointsMap &self,
                                                   uint32_t index) {
  boost::python::list ret_val;
  float x, y, z;
...
// CSimpleMap
void CSimpleMap_insert(CSimpleMap &self, CPose3DPDF &in_posePDF,
                       CSensoryFrame &in_SF) {
  // create smart pointers
  CPose3DPDF::Ptr in_posePDFPtr =
      std::dynamic_pointer_cast<CPose3DPDF>(in_posePDF.duplicateGetSmartPtr());
...
list CMultiMetricMapPDF_getPath(CMultiMetricMapPDF &self, size_t i) {
  ...
  for (size_t i = 0; i < path.size(); ++i)
    ret_val.append(path[i]);
  return ret_val;
}

CPose3DPDFParticles
CMultiMetricMapPDF_getEstimatedPosePDFAtTime(CMultiMetricMapPDF &self,
                                             size_t timeStep) {
...
void TSetOfMetricMapInitializers_push_back(TSetOfMetricMapInitializers &self,
                                           TMetricMapInitializer::Ptr &o) {
  self.push_back(o);
}
...
CMultiMetricMap_getAs3DObject(CMultiMetricMap &self) {
  mrpt::opengl::CSetOfObjects::Ptr outObj =
      std::make_shared<mrpt::opengl::CSetOfObjects>();
  self.getAs3DObject(outObj);
  return outObj;
...
void CMultiMetricMap_setListOfMaps(CMultiMetricMap &self,
                                   TSetOfMetricMapInitializers &initializers) {
  self.setListOfMaps(initializers);
}

CSimplePointsMap::Ptr
CMultiMetricMap_getAsSimplePointsMap(CMultiMetricMap &self) {
...
void export_maps() {
  ...
  // TMapGenericParams
  {
    ...
    class_<TMapGenericParams, bases<CLoadableOptions, CSerializable>>(
        ...
        .def_readwrite("enableSaveAs3DObject",
                       &TMapGenericParams::enableSaveAs3DObject,
                       "(Default=true) If false, calling "
                       "CMetricMap::getAs3DObject() will have no effects.")
        .def_readwrite("enableObservationLikelihood",
                       &TMapGenericParams::enableObservationLikelihood,
                       "(Default=true) Enable computing observation "
                       "likelihoods with this map.")
        .def_readwrite(
  ...
  // CMetricMap
  {
    ...
    scope s =
        class_<CMetricMap, boost::noncopyable, bases<CSerializable>>(
            "CMetricMap", no_init)
            .def("clear", &CMetricMap::clear,
                 "Erase all the contents of the map.")
            .def("isEmpty", &CMetricMap::isEmpty, "Returns true if the map is "
                                                  "empty/no observation has "
                                                  "been inserted.")
            .def("loadFromProbabilisticPosesAndObservations",
                 &CMetricMap::loadFromProbabilisticPosesAndObservations,
                 "Load the map contents from a CSimpleMap object, erasing all "
                 "previous content of the map.")
            .def("loadFromSimpleMap", &CMetricMap::loadFromSimpleMap,
                 "Load the map contents from a CSimpleMap object, erasing all "
                 "previous content of the map.")
            .def("insertObservation", &CMetricMap_insertObservation,
                 CMetricMap_insertObservation_overloads())
            .def("insertObservationPtr", &CMetricMap_insertObservationPtr,
                 CMetricMap_insertObservationPtr_overloads())
            .def("saveMetricMapRepresentationToFile",
                 &CMetricMap::saveMetricMapRepresentationToFile,
                 "Save map representation to file.")
            .def("getAs3DObject", &CMetricMap_getAs3DObject,
                 "Returns a 3D object representing the map.")
            .def_readwrite("genericMapParams", &CMetricMap::genericMapParams,
  ...
  // COccupancyGridMap2D
  {
    ...
    scope s =
        class_<COccupancyGridMap2D, bases<CMetricMap>>(
            ...
            .def("fill", &COccupancyGridMap2D::fill,
                 COccupancyGridMap2D_fill_overloads()) //, "Fills all the cells
                                                       //with a default value.")
            .def("setSize", &COccupancyGridMap2D::setSize,
                 COccupancyGridMap2D_setSize_overloads()) //, "Change the size
                                                          //of gridmap, erasing
                                                          //all its previous
                                                          //contents.")
            .def("resizeGrid", &COccupancyGridMap2D::resizeGrid,
            ...
            .def(
                "loadFromBitmapFile", &COccupancyGridMap2D::loadFromBitmapFile,
                COccupancyGridMap2D_loadFromBitmapFile_overloads()) //, "Load
                                                                    //the
                                                                    //gridmap
                                                                    //from a
                                                                    //image in a
            ...
            .def("loadFromSimpleMap", &COccupancyGridMap2D::loadFromSimpleMap,
                 "Load the map contents from a CSimpleMap object, erasing all "
                 "previous content of the map.")
            .def_readwrite("insertionOptions",
                           &COccupancyGridMap2D::insertionOptions)
            .def_readwrite("likelihoodOptions",
                           &COccupancyGridMap2D::likelihoodOptions)
            .def("copy", &COccupancyGridMap2D_copy,
                 return_value_policy<manage_new_object>())
                MAKE_CREATE(COccupancyGridMap2D)
#ifdef ROS_EXTENSIONS
            .def("to_ROS_OccupancyGrid_msg",
            ...
            .def("to_ROS_OccupancyGrid_msg",
                 ...
                 "Convert to ROS OccupancyGrid Message")
            .def("from_ROS_OccupancyGrid_msg",
    ...
    class_<COccupancyGridMap2D::TInsertionOptions, bases<CLoadableOptions>>(
        ...
        .def_readwrite("mapAltitude",
                       &COccupancyGridMap2D::TInsertionOptions::mapAltitude)
        .def_readwrite("useMapAltitude",
        ...
        .def_readwrite("maxOccupancyUpdateCertainty",
                       &COccupancyGridMap2D::TInsertionOptions::
                           maxOccupancyUpdateCertainty)
        .def_readwrite("considerInvalidRangesAsFreeSpace",
                       &COccupancyGridMap2D::TInsertionOptions::
                           considerInvalidRangesAsFreeSpace)
        .def_readwrite("decimation",
        ...
        .def_readwrite(
            ...
            &COccupancyGridMap2D::TInsertionOptions::CFD_features_gaussian_size)
        .def_readwrite(
            "CFD_features_median_size",
            &COccupancyGridMap2D::TInsertionOptions::CFD_features_median_size)
        .def_readwrite(
            "wideningBeamsWithDistance",
            &COccupancyGridMap2D::TInsertionOptions::wideningBeamsWithDistance);

    // TLikelihoodOptions
    class_<COccupancyGridMap2D::TLikelihoodOptions, bases<CLoadableOptions>>(
        "TLikelihoodOptions", init<>())
        .def_readwrite(
            "likelihoodMethod",
            &COccupancyGridMap2D::TLikelihoodOptions::likelihoodMethod)
        .def_readwrite("LF_stdHit",
                       &COccupancyGridMap2D::TLikelihoodOptions::LF_stdHit)
        .def_readwrite("LF_zHit",
                       &COccupancyGridMap2D::TLikelihoodOptions::LF_zHit)
        .def_readwrite("LF_zRandom",
                       &COccupancyGridMap2D::TLikelihoodOptions::LF_zRandom)
        .def_readwrite("LF_maxRange",
                       &COccupancyGridMap2D::TLikelihoodOptions::LF_maxRange)
        .def_readwrite("LF_decimation",
        ...
        .def_readwrite(
            ...
            &COccupancyGridMap2D::TLikelihoodOptions::LF_alternateAverageMethod)
        .def_readwrite("MI_exponent",
                       &COccupancyGridMap2D::TLikelihoodOptions::MI_exponent)
        .def_readwrite("MI_skip_rays",
        ...
        .def_readwrite("rayTracing_useDistanceFilter",
        ...
        .def_readwrite(
            ...
            &COccupancyGridMap2D::TLikelihoodOptions::consensus_takeEachRange)
        .def_readwrite("consensus_pow",
                       &COccupancyGridMap2D::TLikelihoodOptions::consensus_pow)
        .def_readwrite("OWA_weights",
                       &COccupancyGridMap2D::TLikelihoodOptions::OWA_weights)
        .def_readwrite(
            "enableLikelihoodCache",
            &COccupancyGridMap2D::TLikelihoodOptions::enableLikelihoodCache);
  }
  ...
  // CPointsMap
  {
    ...
    scope s =
        class_<CPointsMap, boost::noncopyable, bases<CMetricMap>>("CPointsMap",
                                                                  no_init)
            .def("reserve", &CPointsMap::reserve,
                 "Reserves memory for a given number of points: the size of "
                 "the map does not change, it only reserves the memory.")
            .def("resize", &CPointsMap::resize,
                 "Resizes all point buffers so they can hold the given number "
                 "of points: newly created points are set to default values, "
                 "and old contents are not changed.")
            .def("setSize", &CPointsMap::setSize,
                 "Resizes all point buffers so they can hold the given number "
                 "of points, *erasing* all previous contents and leaving all "
                 "points to default values.")
            .def("setPointFast", &CPointsMap::setPointFast,
                 "Changes the coordinates of the given point (0-based index), "
                 "*without* checking for out-of-bounds and *without* calling "
                 "mark_as_modified().")
            .def("insertPointFast", &CPointsMap::insertPointFast,
                 "The virtual method for insertPoint() *without* calling "
                 "mark_as_modified().")
            .def("copyFrom", &CPointsMap::copyFrom,
                 "Virtual assignment operator, copies as much common data "
                 "(XYZ, color,...) as possible from the source map into this "
                 "one.")
            .def("getPointAllFieldsFast", &CPointsMap::getPointAllFieldsFast,
                 "Get all the data fields for one point as a vector: depending "
                 "on the implementation class this can be [X Y Z] or [X Y Z R "
                 "G B], etc...")
            .def("setPointAllFieldsFast", &CPointsMap::setPointAllFieldsFast,
                 "Set all the data fields for one point as a vector: depending "
                 "on the implementation class this can be [X Y Z] or [X Y Z R "
                 "G B], etc...")
            .def("getAs3DObject", &CPointsMap_getAs3DObject,
                 "Returns a 3D object representing the map.");
  }
  ...
  // CSimpleMap
  {
    ...
    class_<CSimpleMap>("CSimpleMap", init<>())
        .def("saveToFile", &CSimpleMap::saveToFile, "Save this object to a "
                                                    ".simplemap binary file "
                                                    "(compressed with gzip)")
        .def("loadFromFile", &CSimpleMap::loadFromFile,
             "Load the contents of this object from a .simplemap binary file "
             "(possibly compressed with gzip).")
  ...
  {
    class_<TMetricMapInitializer::Ptr>("TMetricMapInitializer::Ptr",
                                       init<TMetricMapInitializer *>());

    scope s = class_<TMetricMapInitializer, boost::noncopyable,
                     bases<CLoadableOptions>>("TMetricMapInitializer", no_init)
                  .def("factory", &TMetricMapInitializer::factory,
                       return_value_policy<manage_new_object>())
  ...
  // CMultiMetricMap
  {
    ...
    scope s =
        class_<CMultiMetricMap, bases<CMetricMap>>(
            "CMultiMetricMap", init<optional<TSetOfMetricMapInitializers *>>())
            .def("getAs3DObject", &CMultiMetricMap_getAs3DObject,
                 "Returns a 3D object representing the map.")
            .def("setListOfMaps", &CMultiMetricMap_setListOfMaps,
                 "Sets the list of internal map according to the passed list "
                 "of map initializers (Current maps' content will be "
                 "deleted!).")
            .def("isEmpty", &CMultiMetricMap::isEmpty,
                 "Returns true if all maps returns true to their isEmpty() "
                 "method, which is map-dependent.")
            .def("getAsSimplePointsMap", &CMultiMetricMap_getAsSimplePointsMap,
                 "If the map is a simple point map or it's a multi-metric map "
                 "that contains EXACTLY one simple point map, return it. "
                 "Otherwise, return None.")
            .def_readwrite("maps", &CMultiMetricMap::maps,
    ...
    class_<CMultiMetricMap::TListMaps>("TListMaps", init<>())
        ...
        .def("append", &StlListLike<CMultiMetricMap::TListMaps>::add,
             with_custodian_and_ward<1, 2>()) // to let container keep value
        .def("__getitem__", &StlListLike<CMultiMetricMap::TListMaps>::get,
             return_value_policy<copy_non_const_reference>())
        .def("__setitem__", &StlListLike<CMultiMetricMap::TListMaps>::set,
             with_custodian_and_ward<1, 2>()) // to let container keep value
  ...
  // CMultiMetricMapPDF
  {
    ...
    scope s =
        class_<CMultiMetricMapPDF>("CMultiMetricMapPDF", init<>())
            .def("getLastPose", &CMultiMetricMapPDF_getLastPose,
                 "Return the last robot pose for the i'th particle.")
            .def("getPath", &CMultiMetricMapPDF_getPath,
                 "Return the path (in absolute coordinate poses) for the i'th "
                 "particle.")
            .def("getEstimatedPosePDFAtTime",
            ...
            .def("getCurrentMostLikelyMetricMap",
                 &CMultiMetricMapPDF::getCurrentMostLikelyMetricMap,
                 return_value_policy<reference_existing_object>(),
                 "Returns a pointer to the current most likely map (associated "
                 "to the most likely particle).")
    ...
    class_<CMultiMetricMapPDF::TPredictionParams, bases<CLoadableOptions>>(
        ...
        .def_readwrite("pfOptimalProposal_mapSelection",
                       &CMultiMetricMapPDF::TPredictionParams::
                           pfOptimalProposal_mapSelection)
        .def_readwrite(
            "ICPGlobalAlign_MinQuality",
            &CMultiMetricMapPDF::TPredictionParams::ICPGlobalAlign_MinQuality)
        .def_readwrite("update_gridMapLikelihoodOptions",
                       &CMultiMetricMapPDF::TPredictionParams::
                           update_gridMapLikelihoodOptions)
        .def_readwrite("KLD_params",
                       &CMultiMetricMapPDF::TPredictionParams::KLD_params)
        .def_readwrite("icp_params",
