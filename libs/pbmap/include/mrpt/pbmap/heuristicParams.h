...
struct PBMAP_IMPEXP config_heuristics {
   ...
   * recognition*/
  unsigned min_planes_recognition; // Minimum number of planes to accept a match
                                   // between two neighborhoods of planes
  ...
  float area_half_threshold, area_half_threshold_inv; // Constraint with "half
  ...
  float angle_threshold;  // Binary constraint: the angle between the normals of
                          // two pair of planes
  float height_threshold; // Binary constraint: Height from one plane wrt a
                          // neighbor (in meters)
  float height_threshold_parallel; // Binary constraint: Height from one plane
