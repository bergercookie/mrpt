...
int mrpt::math::solve_poly3(
    double *x, double a, double b,
    double c) noexcept { // solve cubic equation x^3 + a*x^2 + b*x + c
  double a2 = a * a;
  double q = (a2 - 3 * b) / 9;
...
//---------------------------------------------------------------------------
int SolveP4Bi(double *x, double b,
...
//---------------------------------------------------------------------------
int SolveP4De(double *x, double b, double c,
              double d) // solve equation x^4 + b*x^2 + c*x + d
{
  ...
  int res3 = mrpt::math::solve_poly3(x, 2 * b, b * b - 4 * d,
                                     -c * c); // solve resolvent
  ...
  // + b*x^2 + c*x + d
//-----------------------------------------------------------------------------
double N4Step(double x, double a, double b, double c,
...
int mrpt::math::solve_poly4(double *x, double a, double b, double c,
                            double d) noexcept { // solve equation x^4 + a*x^3 +
                                                 // b*x^2 + c*x + d by
                                                 // Dekart-Euler method
  // move to a=0:
...
//-----------------------------------------------------------------------------
int mrpt::math::solve_poly5(double *x, double a, double b, double c, double d,
                            double e) noexcept // solve equation x^5 + a*x^4 +
                                               // b*x^3 + c*x^2 + d*x + e = 0
{
...
// a*x^2 + b*x + c = 0
int mrpt::math::solve_poly2(double a, double b, double c, double &r1,
                            double &r2) noexcept {
  if (std::abs(a) < eps) {
    // b*x+c=0
    if (std::abs(b) < eps)
