...
void CRuntimeCompiledExpression::compile(
    ...
    const std::map<std::string, double> &variables, //!< [in] Map of
                                                    //!variables/constants by
                                                    //!`name` ->  `value`. The
                                                    //!references to the values
                                                    //!in this map **must** be
                                                    //!ensured to be valid
                                                    //!thoughout all the life of
                                                    //!the compiled expression.
    const std::string &expr_name_for_error_reporting //!< A descriptive name of
                                                     //!this formula, to be used
  ...
  if (!parser.compile(expression, PIMPL_GET_REF(exprtk::expression<double>,
                                                m_compiled_formula)))
    THROW_EXCEPTION_FMT(
