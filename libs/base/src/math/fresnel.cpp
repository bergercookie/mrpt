...
static long double xChebyshev_Tn_Series(long double x, const long double a[],
                                        int degree);
...
long double xFresnel_Auxiliary_Sine_Integral(long double x) {
  if (x == 0.0L)
    return 0.5L;
  if (x <= 1.0L)
    return sin_Chebyshev_Expansion_0_1(x);
  if (x <= 3.0L)
    return sin_Chebyshev_Expansion_1_3(x);
  if (x <= 5.0L)
    return sin_Chebyshev_Expansion_3_5(x);
  if (x <= 7.0L)
    return sin_Chebyshev_Expansion_5_7(x);
...
long double xFresnel_Auxiliary_Cosine_Integral(long double x) {
  if (x == 0.0L)
    return 0.5L;
  if (x <= 1.0L)
    return cos_Chebyshev_Expansion_0_1(x);
  if (x <= 3.0L)
    return cos_Chebyshev_Expansion_1_3(x);
  if (x <= 5.0L)
    return cos_Chebyshev_Expansion_3_5(x);
  if (x <= 7.0L)
    return cos_Chebyshev_Expansion_5_7(x);
