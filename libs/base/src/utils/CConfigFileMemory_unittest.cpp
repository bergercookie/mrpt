...
TEST(CConfigFileMemory, setFromString) {
  const std::string sampleCfgTxt = "# example config file from std::string\n"
                                   "[test]\n"
                                   "key_num = 4\n"
                                   "key_str = pepe\n";
...
const std::string expectedStr =
    std::string("this is a long value that can be split into several lines but "
...
TEST(CConfigFileMemory, parseVariables) {
  const std::string sampleCfgTxt2 = "@define MAXSPEED 10\n"
                                    "@define  MAXOMEGA  -30  \n"
                                    "[test]\n"
                                    "var1=5\n"
                                    "var2=${MAXSPEED}\n"
