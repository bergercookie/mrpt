...
bool mrpt::utils::operator==(const TMatchingPairList &a,
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
float TMatchingPairList::overallSquareErrorAndPoints(const CPose2D &q,
                                                     vector<float> &xs,
...
/*---------------------------------------------------------------
                                                squareErrorVector
  ---------------------------------------------------------------*/
void TMatchingPairList::squareErrorVector(const CPose2D &q,
                                          vector<float> &out_sqErrs) const {
