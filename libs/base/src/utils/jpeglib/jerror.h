	...
	JMESSAGE(
		...
		JMESSAGE(JERR_BAD_ALIGN_TYPE, "ALIGN_TYPE is wrong, please fix") JMESSAGE(
			...
			JMESSAGE(JERR_BAD_BUFFER_MODE, "Bogus buffer control mode") JMESSAGE(
				...
				JMESSAGE(JERR_BAD_DCT_COEF, "DCT coefficient out of range") JMESSAGE(
																																																																			...
																																																																			JMESSAGE(
																																																																				...
																																																																				JMESSAGE(
																																																																					...
																																																																					JMESSAGE(
																																																																						JMSG_COPYRIGHT,
																																																																						JCOPYRIGHT)
																																																																						JMESSAGE(JMSG_VERSION, JVERSION) JMESSAGE(
																																																																							JTRC_16BIT_TABLES,
...
#define TRACEMS3(cinfo, lvl, code, p1, p2, p3)                             \
	MAKESTMT(                                                              \
		int* _mp = (cinfo)->err->msg_parm.i; _mp[0] = (p1); _mp[1] = (p2); \
