...
std::string CConfigFileMemory::readString(const std::string &section,
  ...
  if (failIfNotFound && !aux) {
    string tmpStr(format("Value '%s' not found in section '%s' of memory "
                         "configuration string list and failIfNotFound=true.",
...
/*---------------------------------------------------------------
                                          getAllKeys
 ---------------------------------------------------------------*/
void CConfigFileMemory::getAllKeys(const string &section,
