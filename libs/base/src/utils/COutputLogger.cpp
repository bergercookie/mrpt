...
COutputLogger::TMsg::TMsg(
	const mrpt::utils::VerbosityLevel level, const std::string& msg_str,
...
void COutputLogger::logRegisterCallback(
	output_logger_callback_t userFunc, void* userParam)
{
...
void COutputLogger::logDeregisterCallback(
	output_logger_callback_t userFunc, void* userParam)
{
	ASSERT_(userFunc != nullptr);
	TCallbackEntry cbe;
