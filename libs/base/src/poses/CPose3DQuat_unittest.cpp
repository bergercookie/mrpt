...
protected:
  ...
  void test_compose(double x1, double y1, double z1, double yaw1, double pitch1,
    ...
    EXPECT_NEAR(0, (p1_c_p2.getAsVectorVal() - p_q1_c_q2.getAsVectorVal())
                       .array()
                       .abs()
                       .sum(),
                1e-5)
    ...
    EXPECT_NEAR(0, (p1_i_p2.getAsVectorVal() - p_q1_i_q2.getAsVectorVal())
                       .array()
                       .abs()
                       .sum(),
                1e-5)
    ...
    // Test + operator: trg new var
    {
      ...
      EXPECT_NEAR(
          0,
          (A.getAsVectorVal() - q1_c_q2.getAsVectorVal()).array().abs().sum(),
          1e-6);
    }
  ...
  void test_composePoint(double x1, double y1, double z1, double yaw1,
                         double pitch1, double roll1, double x, double y,
                         double z) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    ...
    EXPECT_NEAR(0, (p1_plus_p.getAsVectorVal() - q1_plus_p.getAsVectorVal())
                       .array()
                       .abs()
                       .sum(),
                1e-5)
  ...
  static void func_compose_point(const CArrayDouble<7 + 3> &x,
                                 const double &dummy, CArrayDouble<3> &Y) {
  ...
  void test_composePointJacob(double x1, double y1, double z1, double yaw1,
                              double pitch1, double roll1, double x, double y,
                              double z) {
    ...
    CMatrixFixedNumeric<double, 3, 7> num_df_dpose(UNINITIALIZED_MATRIX);
    {
      ...
      mrpt::math::jacobians::jacob_numeric_estimate(x_mean, func_compose_point,
  ...
  void test_invComposePoint(double x1, double y1, double z1, double yaw1,
                            double pitch1, double roll1, double x, double y,
                            double z) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    const CPose3DQuat q1(p1);
    ...
    EXPECT_NEAR(0, (p_minus_p1.getAsVectorVal() - p_minus_q1.getAsVectorVal())
                       .array()
                       .abs()
                       .sum(),
                1e-5)
    ...
    EXPECT_NEAR(
        0, (p_rec.getAsVectorVal() - p.getAsVectorVal()).array().abs().sum(),
        1e-5)
        << "p_rec: " << p_rec << endl
        << "p: " << p << endl;
  }

  static void func_inv_compose_point(const CArrayDouble<7 + 3> &x,
                                     const double &dummy, CArrayDouble<3> &Y) {
    MRPT_UNUSED_PARAM(dummy);
    CPose3DQuat q(x[0], x[1], x[2], CQuaternionDouble(x[3], x[4], x[5], x[6]));
    q.quat().normalize();
  ...
  void test_invComposePointJacob(double x1, double y1, double z1, double yaw1,
                                 double pitch1, double roll1, double x,
                                 double y, double z) {
    const CPose3DQuat q1(CPose3D(x1, y1, z1, yaw1, pitch1, roll1));
    const CPoint3D p(x, y, z);
  ...
  void test_fromYPRAndBack(double x1, double y1, double z1, double yaw1,
                           double pitch1, double roll1) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    const CPose3DQuat q1(p1);
    const CPose3D p1r = CPose3D(q1);

    EXPECT_NEAR(0, (p1.getHomogeneousMatrixVal() - q1.getHomogeneousMatrixVal())
                       .array()
                       .abs()
                       .sum(),
                1e-5)
  ...
  void test_unaryInverse(double x1, double y1, double z1, double yaw1,
                         double pitch1, double roll1) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    ...
    EXPECT_NEAR(
        0, (p1_inv.getHomogeneousMatrixVal() - q1_inv.getHomogeneousMatrixVal())
               .array()
               .abs()
               .sum(),
        1e-5)
  ...
  void test_copy(double x1, double y1, double z1, double yaw1, double pitch1,
                 double roll1) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    ...
    EXPECT_NEAR(0, (q1.getHomogeneousMatrixVal() - q2.getHomogeneousMatrixVal())
                       .array()
                       .abs()
                       .sum(),
                1e-5)
  ...
  void test_composeAndInvComposePoint(double x1, double y1, double z1,
  ...
  void test_composePoint_vs_CPose3D(double x1, double y1, double z1,
                                    double yaw1, double pitch1, double roll1,
                                    double x, double y, double z) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    const CPose3DQuat q1(p1);
  ...
  void test_invComposePoint_vs_CPose3D(double x1, double y1, double z1,
                                       double yaw1, double pitch1, double roll1,
                                       double x, double y, double z) {
    const CPose3D p1(x1, y1, z1, yaw1, pitch1, roll1);
    const CPose3DQuat q1(p1);
  ...
  static void func_spherical_coords(const CArrayDouble<7 + 3> &x,
                                    const double &dummy, CArrayDouble<3> &Y) {
    MRPT_UNUSED_PARAM(dummy);
    CPose3DQuat q(x[0], x[1], x[2], CQuaternionDouble(x[3], x[4], x[5], x[6]));
    q.quat().normalize();
  ...
  void test_sphericalCoords(double x1, double y1, double z1, double yaw1,
                            double pitch1, double roll1, double x, double y,
                            double z) {
    const CPose3DQuat q1(CPose3D(x1, y1, z1, yaw1, pitch1, roll1));
  ...
  static void func_normalizeJacob(const CArrayDouble<4> &x, const double &dummy,
                                  CArrayDouble<4> &Y) {
    MRPT_UNUSED_PARAM(dummy);
    CQuaternionDouble q;
    for (int i = 0; i < 4; i++)
  ...
  void test_normalizeJacob(double yaw1, double pitch1, double roll1) {
    ...
    CMatrixFixedNumeric<double, 4, 4> num_df_dpose(UNINITIALIZED_MATRIX);
    {
      ...
      x_incrs.assign(1e-5);
      CMatrixDouble numJacobs;
      mrpt::math::jacobians::jacob_numeric_estimate(x_mean, func_normalizeJacob,
                                                    x_incrs, DUMMY, numJacobs);
...
TEST_F(Pose3DQuatTests, Compose) {
  test_compose(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10), DEG2RAD(60), 2.0, -5.0,
               8.0, DEG2RAD(40), DEG2RAD(-5), DEG2RAD(25));

  test_compose(25.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(90), DEG2RAD(0), -10.0,
               4.0, -8.0, DEG2RAD(20), DEG2RAD(9), DEG2RAD(0));
}

TEST_F(Pose3DQuatTests, ComposeWithPoint) {
  test_composePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 10, 11,
                    12);
  test_composePoint(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 10, 11,
                    12);
  test_composePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10), DEG2RAD(0), 10, 11,
                    12);
  test_composePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(10), 10, 11,
                    12);
  test_composePoint(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10), DEG2RAD(60), 10.0,
                    20.0, 30.0);
  test_composePoint(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50), DEG2RAD(-40),
                    -5.0, -15.0, 8.0);
}

TEST_F(Pose3DQuatTests, ComposeWithPointJacob) {
  test_composePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 10,
                         11, 12);
  test_composePointJacob(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 10,
                         11, 12);
  test_composePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10), DEG2RAD(0), 10,
                         11, 12);
  test_composePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(10), 10,
                         11, 12);
  test_composePointJacob(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10), DEG2RAD(60),
                         10.0, 20.0, 30.0);
  test_composePointJacob(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50), DEG2RAD(-40),
                         -5.0, -15.0, 8.0);
}

TEST_F(Pose3DQuatTests, InvComposeWithPoint) {
  test_invComposePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 10,
                       11, 12);
  test_invComposePoint(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 10,
                       11, 12);
  test_invComposePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10), DEG2RAD(0), 10,
                       11, 12);
  test_invComposePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(10), 10,
                       11, 12);
  test_invComposePoint(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10), DEG2RAD(60),
                       10.0, 20.0, 30.0);
  test_invComposePoint(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50), DEG2RAD(-40),
                       -5.0, -15.0, 8.0);
}

TEST_F(Pose3DQuatTests, InvComposeWithPointJacob) {
  test_invComposePointJacob(0, 0, 0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 0, 0,
                            0);
  test_invComposePointJacob(0, 0, 0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 1, 2,
                            3);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0),
                            0, 0, 0);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0),
                            10, 11, 12);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0),
                            10, 11, 12);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10), DEG2RAD(0),
                            10, 11, 12);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(10),
                            10, 11, 12);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10),
                            DEG2RAD(60), 10.0, 20.0, 30.0);
  test_invComposePointJacob(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50),
                            DEG2RAD(-40), -5.0, -15.0, 8.0);
}

TEST_F(Pose3DQuatTests, ComposeInvComposePoint) {
  test_composeAndInvComposePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0),
                                 DEG2RAD(0), 10, 11, 12);
  test_composeAndInvComposePoint(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0),
                                 DEG2RAD(0), 10, 11, 12);
  test_composeAndInvComposePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10),
                                 DEG2RAD(0), 10, 11, 12);
  test_composeAndInvComposePoint(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0),
                                 DEG2RAD(10), 10, 11, 12);
  test_composeAndInvComposePoint(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10),
                                 DEG2RAD(60), 10.0, 20.0, 30.0);
  test_composeAndInvComposePoint(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50),
                                 DEG2RAD(-40), -5.0, -15.0, 8.0);
}

TEST_F(Pose3DQuatTests, ComposePoint_vs_CPose3D) {
  test_composePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0),
                               DEG2RAD(0), 10, 11, 12);
  test_composePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0),
                               DEG2RAD(0), 10, 11, 12);
  test_composePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10),
                               DEG2RAD(0), 10, 11, 12);
  test_composePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0),
                               DEG2RAD(10), 10, 11, 12);
  test_composePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10),
                               DEG2RAD(60), 10.0, 20.0, 30.0);
  test_composePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50),
                               DEG2RAD(-40), -5.0, -15.0, 8.0);
}

TEST_F(Pose3DQuatTests, InvComposePoint_vs_CPose3D) {
  test_invComposePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0),
                                  DEG2RAD(0), 10, 11, 12);
  test_invComposePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0),
                                  DEG2RAD(0), 10, 11, 12);
  test_invComposePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10),
                                  DEG2RAD(0), 10, 11, 12);
  test_invComposePoint_vs_CPose3D(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0),
                                  DEG2RAD(10), 10, 11, 12);
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    test_invComposePoint_vs_CPose3D(v[0], v[1], v[2], v[3], v[4], v[5], v[6],
                                    v[7], v[8]);
  }
}

TEST_F(Pose3DQuatTests, SphericalCoordsJacobian) {
  test_sphericalCoords(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 10,
                       11, 12);
  test_sphericalCoords(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 10,
                       11, 12);
  test_sphericalCoords(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(10), DEG2RAD(0), 10,
                       11, 12);
  test_sphericalCoords(1.0, 2.0, 3.0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(10), 10,
                       11, 12);
  test_sphericalCoords(1.0, 2.0, 3.0, DEG2RAD(-30), DEG2RAD(10), DEG2RAD(60),
                       10.0, 20.0, 30.0);
  test_sphericalCoords(1.0, 2.0, 3.0, DEG2RAD(10), DEG2RAD(-50), DEG2RAD(-40),
                       -5.0, -15.0, 8.0);
}
