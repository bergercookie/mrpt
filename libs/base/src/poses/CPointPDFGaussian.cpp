...
/*---------------------------------------------------------------
 ...
 ---------------------------------------------------------------*/
void CPointPDFGaussian::getCovarianceAndMean(CMatrixDouble33 &C,
                                             CPoint3D &p) const {
  p = mean;
  C = cov;
}
...
/*---------------------------------------------------------------
 ...
 ---------------------------------------------------------------*/
double
CPointPDFGaussian::productIntegralWith(const CPointPDFGaussian &p) const {
  MRPT_START
...
/*---------------------------------------------------------------
 ...
 ---------------------------------------------------------------*/
double
CPointPDFGaussian::productIntegralWith2D(const CPointPDFGaussian &p) const {
  MRPT_START
...
/*---------------------------------------------------------------
                                        bayesianFusion
 ---------------------------------------------------------------*/
void CPointPDFGaussian::bayesianFusion(const CPointPDF &p1_,
                                       const CPointPDF &p2_,
