...
template <class POSE_TYPE> class SE_traits_tests : public ::testing::Test {
protected:
  virtual void SetUp() {}
  ...
  static void func_numeric(const CArrayDouble<2 * SE_TYPE::VECTOR_SIZE> &x,
    ...
    const CPose3D P1DP2inv_(CMatrixDouble44(P1.getHomogeneousMatrixVal() *
                                            Pd.getHomogeneousMatrixVal() *
  ...
  void test_jacobs_P1DP2inv(double x1, double y1, double z1, double yaw1,
                            double pitch1, double roll1, double xd, double yd,
                            double zd, double yawd, double pitchd, double rolld,
    ...
    CMatrixFixedNumeric<double, DIMS, DIMS> num_J1, num_J2;
    {
      ...
      mrpt::math::jacobians::jacob_numeric_estimate(x_mean, func_numeric,
  ...
  void do_all_jacobs_test() {
    test_jacobs_P1DP2inv(0, 0, 0, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 0, 0, 0,
                         DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 0, 0, 0,
                         DEG2RAD(0), DEG2RAD(0), DEG2RAD(0));

    test_jacobs_P1DP2inv(0, 0, 0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 0, 0, 0,
                         DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 0, 0, 0,
                         DEG2RAD(20), DEG2RAD(0), DEG2RAD(0));

    test_jacobs_P1DP2inv(0, 0, 0, DEG2RAD(10), DEG2RAD(0), DEG2RAD(0), 0, 0, 0,
                         DEG2RAD(12), DEG2RAD(0), DEG2RAD(0), 0, 0, 0,
                         DEG2RAD(20), DEG2RAD(0), DEG2RAD(0));

    test_jacobs_P1DP2inv(0, 0, 0, DEG2RAD(10), DEG2RAD(20), DEG2RAD(30), 0, 0,
                         0, DEG2RAD(4), DEG2RAD(3), DEG2RAD(8), 0, 0, 0,
                         DEG2RAD(15), DEG2RAD(25), DEG2RAD(35));

    test_jacobs_P1DP2inv(10, 20, 30, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), -5, -5,
                         -5, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 5, 15, 25,
                         DEG2RAD(0), DEG2RAD(0), DEG2RAD(0));

    test_jacobs_P1DP2inv(10, 20, 30, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), -5.2,
                         -5.3, -4.9, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0), 5, 15,
                         25, DEG2RAD(0), DEG2RAD(0), DEG2RAD(0));

    test_jacobs_P1DP2inv(10, 20, 30, DEG2RAD(10), DEG2RAD(20), DEG2RAD(30), 4.7,
                         4.8, 5.3, DEG2RAD(4), DEG2RAD(3), DEG2RAD(8), 15, 25,
                         35, DEG2RAD(15), DEG2RAD(25), DEG2RAD(35));
  }
};
