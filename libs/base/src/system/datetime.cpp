...
mrpt::system::timestampAdd(const mrpt::system::TTimeStamp tim,
...
/*---------------------------------------------------------------
                                        timeDifference
  ---------------------------------------------------------------*/
double mrpt::system::timeDifference(const mrpt::system::TTimeStamp t1,
                                    const mrpt::system::TTimeStamp t2) {
  MRPT_START
...
string mrpt::system::dateTimeToString(const mrpt::system::TTimeStamp t) {
  ...
  return format("%u/%02u/%02u,%02u:%02u:%02u.%06u", 1900 + ptm->tm_year,
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
double
mrpt::system::extractDayTimeFromTimestamp(const mrpt::system::TTimeStamp t) {
  MRPT_START
...
string mrpt::system::timeLocalToString(const mrpt::system::TTimeStamp t,
                                       unsigned int secondFractionDigits) {
  if (t == INVALID_TIMESTAMP)
    return string("INVALID_TIMESTAMP");
  ...
  return format("%02u:%02u:%02u.%0*u", ptm->tm_hour, ptm->tm_min,
                (unsigned int)ptm->tm_sec, user_secondFractionDigits,
                secFractions);
}
...
string mrpt::system::timeToString(const mrpt::system::TTimeStamp t) {
  ...
  return format("%02u:%02u:%02u.%06u", ptm->tm_hour, ptm->tm_min,
                (unsigned int)ptm->tm_sec, secFractions);
}
...
string mrpt::system::dateToString(const mrpt::system::TTimeStamp t) {
  ...
  return format("%u/%02u/%02u", 1900 + ptm->tm_year, ptm->tm_mon + 1,
                ptm->tm_mday);
}
