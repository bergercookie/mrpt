 ...
 * is passed in error_msg, a description of the error is saved there.
  */
bool BASE_IMPEXP renameFile(const std::string &oldFileName,
 ...
 * not exists, or path is a file).
  ...
  */
bool BASE_IMPEXP deleteFilesInDirectory(const std::string &s,
 ...
 * name
  ...
  */
std::string BASE_IMPEXP extractFileExtension(const std::string &filePath,
 ...
 * optionally get in outErrStr
  */
bool BASE_IMPEXP copyFile(const std::string &sourceFile,
