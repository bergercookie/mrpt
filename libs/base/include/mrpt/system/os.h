 ...
 * ignored in some compilers)
  *  \sa utils::format
  */
int BASE_IMPEXP sprintf(char *buf, size_t bufSize, const char *format,
 ...
 * be ignored in some compilers)
  */
int BASE_IMPEXP vsprintf(char *buf, size_t bufSize, const char *format,
                         va_list args) noexcept;

/** An OS-independent version of vsnprintf (Notice the bufSize param, which may
 * be ignored in some compilers)
  */
int BASE_IMPEXP vsnprintf(char *buf, size_t bufSize, const char *format,
                          va_list args) noexcept;
...
/** An OS-independent version of fprintf
  */
int BASE_IMPEXP fprintf(FILE *fil, const char *format,
                        ...) noexcept MRPT_printf_format_check(2, 3);
...
/** An OS-independent version of strcat.
  ...
  */
char BASE_IMPEXP *strcat(char *dest, size_t destSize,
                         const char *source) noexcept;

/** An OS-independent version of strcpy.
  * \return It will always return the "dest" pointer.
  */
char BASE_IMPEXP *strcpy(char *dest, size_t destSize,
                         const char *source) noexcept;
...
/** An OS-independent version of strncmp.
  * \return It will return 0 when both strings are equal, casi sensitive.
  */
int BASE_IMPEXP _strncmp(const char *str, const char *subStr,
                         size_t count) noexcept;

/** An OS-independent version of strnicmp.
  * \return It will return 0 when both strings are equal, casi insensitive.
  */
int BASE_IMPEXP _strnicmp(const char *str, const char *subStr,
                          size_t count) noexcept;
...
/** An OS and compiler independent version of "memcpy"
  */
void BASE_IMPEXP memcpy(void *dest, size_t destSize, const void *src,
...
void BASE_IMPEXP pause(const std::string &msg = std::string(
 ...
 * which case "cerr" is changed.
  */
void BASE_IMPEXP setConsoleColor(TConsoleColor color,
 ...
 */
int BASE_IMPEXP executeCommand(const std::string &command,
