...
void BASE_IMPEXP compress(void *inData, size_t inDataSize,
                          std::vector<unsigned char> &outData);

/** Compress an array of bytes into another one. */
void BASE_IMPEXP compress(const std::vector<unsigned char> &inData,
                          std::vector<unsigned char> &outData);
 ...
 * enought */
void BASE_IMPEXP decompress(void *inData, size_t inDataSize,
                            std::vector<unsigned char> &outData,
 ...
 * enought
  */
void BASE_IMPEXP decompress(void *inData, size_t inDataSize, void *outData,
 ...
 * enought
  */
void BASE_IMPEXP decompress(mrpt::utils::CStream &inStream, size_t inDataSize,
                            void *outData, size_t outDataBufferSize,
                            size_t &outDataActualSize);
 ...
 * .gz file, it just read the whole file unmodified.
  ...
  */
bool BASE_IMPEXP decompress_gz_file(const std::string &file_path,
                                    vector_byte &buffer);
...
/** Compress a memory buffer into a gzip file (xxxx.gz).
  ...
  */
bool BASE_IMPEXP compress_gz_file(const std::string &file_path,
 ...
 * error is reported.
  ...
  */
bool BASE_IMPEXP compress_gz_data_block(const vector_byte &in_data,
 ...
 * data will be an exact copy of the input.
  ...
  * \sa decompress_gz_file, compress_gz_data_block
  */
bool BASE_IMPEXP decompress_gz_data_block(const vector_byte &in_gz_data,
