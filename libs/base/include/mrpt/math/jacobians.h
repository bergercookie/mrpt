...
inline void jacob_quat_rotation(const QUATERNION &quaternion,
 ...
 * \frac{\partial f}{\partial u} \f$.
  ...
  */
inline void jacobs_6D_pose_comp(const mrpt::poses::CPose3D &x,
 ...
 * \frac{\partial f}{\partial u} \f$.
  ...
  */
inline void jacobs_6D_pose_comp(const mrpt::poses::CPose3DQuat &x,
                                const mrpt::poses::CPose3DQuat &u,
                                CMatrixDouble77 &out_df_dx,
                                CMatrixDouble77 &out_df_du) {
  mrpt::poses::CPose3DQuatPDF::jacobiansPoseComposition(x, u, out_df_dx,
                                                        out_df_du);
}
 ...
 * f}{\partial u} \f$.
  ...
  */
inline void jacobs_2D_pose_comp(const mrpt::poses::CPosePDFGaussian &x,
