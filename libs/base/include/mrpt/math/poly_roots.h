...
namespace mrpt
{
	namespace math
	{
		...
		/** Solves quartic equation `x^4 + a*x^3 + b*x^2 + c*x + d = 0` by Dekart-Euler method. 
		  ...
		  * \note Based on `poly34.h`, by Khashin S.I. http://math.ivanovo.ac.ru/dalgebra/Khashin/index.html - khash2 (at) gmail.com */
		int BASE_IMPEXP solve_poly4(double *x,double a,double b,double c,double d) noexcept;
		...
		/** Solves equation `a*x^2 + b*x + c = 0`.
		  ...
		  * \note Based on `poly34.h`, by Khashin S.I. http://math.ivanovo.ac.ru/dalgebra/Khashin/index.html - khash2 (at) gmail.com */
		int BASE_IMPEXP solve_poly2( double a, double b, double c, double &r1, double &r2) noexcept;
