 ...
 * http://math.ivanovo.ac.ru/dalgebra/Khashin/index.html - khash2 (at) gmail.com
 */
int BASE_IMPEXP solve_poly4(double *x, double a, double b, double c,
                            double d) noexcept;
 ...
 * http://math.ivanovo.ac.ru/dalgebra/Khashin/index.html - khash2 (at) gmail.com
 */
int BASE_IMPEXP solve_poly5(double *x, double a, double b, double c, double d,
                            double e) noexcept;

int BASE_IMPEXP
solve_poly4Bi(double *x, double b,
              double d) noexcept; //!< Solve equation x^4 + b*x^2 + d = 0
int BASE_IMPEXP
solve_poly4De(double *x, double b, double c,
              double d) noexcept; //!< Solve equation x^4 + b*x^2 + c*x + d = 0
 ...
 * http://math.ivanovo.ac.ru/dalgebra/Khashin/index.html - khash2 (at) gmail.com
 */
int BASE_IMPEXP solve_poly2(double a, double b, double c, double &r1,
                            double &r2) noexcept;
