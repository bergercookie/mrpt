 ...
 * "y" values already are in the correct range).
  ...
  */
double BASE_IMPEXP interpolate2points(const double x, const double x0,
...
NUMTYPE spline(const NUMTYPE t, const VECTORLIKE &x, const VECTORLIKE &y,
               bool wrap2pi = false);
...
NUMTYPE leastSquareLinearFit(const NUMTYPE t, const VECTORLIKE &x,
                             const VECTORLIKE &y, bool wrap2pi = false);
...
void leastSquareLinearFit(const VECTORLIKE1 &ts, VECTORLIKE2 &outs,
                          const VECTORLIKE3 &x, const VECTORLIKE3 &y,
                          bool wrap2pi = false);
