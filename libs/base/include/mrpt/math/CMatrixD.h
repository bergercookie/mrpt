 ...
 */
class BASE_IMPEXP_TEMPL CMatrixD : public mrpt::utils::CSerializable,
                                   public CMatrixTemplateNumeric<double> {
  DEFINE_SERIALIZABLE_CUSTOM_LINKAGE(CMatrixD, void BASE_IMPEXP,
...
BASE_IMPEXP::mrpt::utils::CStream &operator>>(mrpt::utils::CStream &in,
                                              CMatrixD::Ptr &pObj);
DEFINE_MRPT_OBJECT_POST_CUSTOM_BASE_LINKAGE2(CMatrixD,
