...
public:
  ...
  inline CSplineInterpolator1D(const VECTOR &initial_x, const VECTOR &initial_y,
                               bool wrap2pi = false)
      : m_wrap2pi(wrap2pi) {
   ...
   */
  template <class VECTOR>
  void setXY(const VECTOR &x, const VECTOR &y,
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE(CSplineInterpolator1D,
