...
class BASE_IMPEXP_TEMPL CMatrix : public mrpt::utils::CSerializable,
                                  public CMatrixFloat {
  DEFINE_SERIALIZABLE_CUSTOM_LINKAGE(CMatrix, void BASE_IMPEXP,
                                     static BASE_IMPEXP, virtual BASE_IMPEXP)
...
public:
  ...
  /** Constructor from a mrpt::poses::CPose6D, which generates a 6x1 matrix \f$
   * [x y z yaw pitch roll]^T \f$  */
  ...
  */
  template <class OTHERMAT> inline CMatrix &operator=(const OTHERMAT &m) {
...
BASE_IMPEXP::mrpt::utils::CStream &operator>>(mrpt::utils::CStream &in,
                                              CMatrix::Ptr &pObj);
DEFINE_MRPT_OBJECT_POST_CUSTOM_BASE_LINKAGE2(CMatrix,
