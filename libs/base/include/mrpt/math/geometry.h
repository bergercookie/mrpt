 ...
 * the pose. An implicit constructor is used if a TPose3D is given.
  ...
  */
void BASE_IMPEXP createFromPoseAndVector(
 ...
 * the pose's coordinates.
  ...
  */
void BASE_IMPEXP createPlaneFromPoseAndNormal(
 ...
 * for y, 2 for z) corresponds to the provided vector.
  ...
  */
void BASE_IMPEXP generateAxisBaseFromDirectionAndAxis(
...
/**
  ...
  */
void BASE_IMPEXP assemblePolygons(
...
/**
  ...
  */
bool BASE_IMPEXP splitInConvexComponents(
...
/** Returns true if the 2D point (px,py) falls INTO the given polygon.
  ...
  */
bool BASE_IMPEXP pointIntoPolygon2D(
 ...
 * point is INTO the polygon or its perimeter.
  */
double BASE_IMPEXP distancePointToPolygon2D(
	const double& px, const double& py, unsigned int polyEdges,
	const double* poly_xs, const double* poly_ys);
