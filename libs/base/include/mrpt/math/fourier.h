 ...
 * Re+Im+Magnitude parts.
  * \sa fft2_real
  */
void BASE_IMPEXP fft_real(CVectorFloat &in_realData, CVectorFloat &out_FFT_Re,
 ...
 * transform (FFT) is used instead of the general algorithm.
  */
void BASE_IMPEXP dft2_real(const CMatrixFloat &in_data, CMatrixFloat &out_real,
 ...
 * transform (FFT) is used instead of the general algorithm.
  ...
  */
void BASE_IMPEXP idft2_real(const CMatrixFloat &in_real,
 ...
 * transform (FFT) is used instead of the general algorithm.
  ...
  */
void BASE_IMPEXP dft2_complex(const CMatrixFloat &in_real,
                              const CMatrixFloat &in_imag,
 ...
 * transform (FFT) is used instead of the general algorithm.
  */
void BASE_IMPEXP idft2_complex(const CMatrixFloat &in_real,
                               const CMatrixFloat &in_imag,
                               CMatrixFloat &out_real, CMatrixFloat &out_imag);

/** Correlation of two matrixes using 2D FFT
  */
void BASE_IMPEXP cross_correlation_FFT(const CMatrixFloat &A,
