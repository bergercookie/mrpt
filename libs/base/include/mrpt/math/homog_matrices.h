...
void homogeneousMatrixInverse(const MATRIXLIKE1 &M,
...
void homogeneousMatrixInverse(const IN_ROTMATRIX &in_R, const IN_XYZ &in_xyz,
                              OUT_ROTMATRIX &out_R, OUT_XYZ &out_xyz) {
  MRPT_START
