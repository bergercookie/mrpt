 ...
 *		- A state vector descritor, which in this case can be any user
*defined CSerializable class
 ...
 */
template <class T> struct CProbabilityParticle {
public:
  mrpt::utils::copy_ptr<T> d; //!< The data associated with this particle. The
                              //!use of copy_ptr<> allows relying on
                              //!compiler-generated copy ctor, etc.
