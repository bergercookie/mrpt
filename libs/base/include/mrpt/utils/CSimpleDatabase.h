...
public:
  ...
  /**  Sets the cell content of the record indicates by its index, and the field
   * indicated in "field".
    * \exception std::exception On field or record not found
    */
...
public:
  ...
  /** Changes the name of a given table
    ...
    */
  void renameTable(const std::string &tableName,
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE(CSimpleDatabase,
                                     mrpt::utils::CSerializable)
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE(CSimpleDatabaseTable,
                                     mrpt::utils::CSerializable)
