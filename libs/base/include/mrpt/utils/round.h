...
template <typename T> inline int round(const T value) {
#if MRPT_HAS_SSE2
...
template <typename T> inline long round_long(const T value) {
 ...
 * -> 0.01, ...
  */
template <class T> T round_10power(T val, int power10) {
