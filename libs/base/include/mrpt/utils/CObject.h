...
class BASE_IMPEXP CObject
{
   ...
   public:
	...
	/** Returns a deep copy (clone) of the object, independently of its class.
	 */
...
/** MRPT 1.X backwards-compatible smart pointer name (to be removed in a
 * future version of MRPT! Use CFoo::Ptr instead) */
 ...
 * the class declaration.
 *
 * This macro is valid for classes within mrpt-base only.
 */
#define DEFINE_MRPT_OBJECT_POST(class_name) \
	DEFINE_MRPT_OBJECT_POST_CUSTOM_LINKAGE(class_name, BASE_IMPEXP)
