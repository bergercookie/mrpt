...
public:
  ...
  /** Sets/change the value of the property (case insensitive), making a copy of
   * the object (or setting it to nullptr if it is the passed value)
    */
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE(CPropertiesValuesList,
