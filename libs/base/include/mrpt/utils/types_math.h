...
#error                                                                         \
    **FATAL ERROR**: MRPT headers must be included before <Eigen/Dense> headers.
#endif
...
typedef dynamic_vector<float> CVectorFloat;   //!< Column vector, like
                                              //!Eigen::MatrixXf, but
                                              //!automatically initialized to
                                              //!zeros since construction
typedef dynamic_vector<double> CVectorDouble; //!< Column vector, like
                                              //!Eigen::MatrixXd, but
                                              //!automatically initialized to
                                              //!zeros since construction
}
