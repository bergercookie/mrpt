 ...
 *  Only work with graylevels (for convenience), so if a color image is passed
 * it'll be passed first to grayscale.
 *
 * \sa CImage
...
public:
   ...
   * this object.
    ...
    * \param method The interpolation method: It can be imNEAREST, imBILINEAR or
   * imBICUBIC.
    */
  CMappedImage(CImage::Ptr img, double x0 = 0, double x1 = -1, double y0 = 0,
