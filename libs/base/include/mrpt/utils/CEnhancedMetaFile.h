...
public:
  static int LINUX_IMG_WIDTH;  //!< In Linux, the size of the bitmap image that
                               //!emulates the EMF (Default:800)
  static int LINUX_IMG_HEIGHT; //!< In Linux, the size of the bitmap image that
                               //!emulates the EMF (Default:600)
   ...
   * multiplied by this scale, to provide a way of obtaining "subpixel" drawing.
    */
   ...
   * in a more appropiate manner.
    * \sa rectangle
    */
  void textOut(int x0, int y0, const std::string &str,
               const mrpt::utils::TColor color) override;
  ...
  /** Select the current font used when drawing text.
    ...
    */
  virtual void selectVectorTextFont(const std::string &fontName, int fontSize,
   ...
   * in a more appropiate manner.
    */
  void drawImage(int x, int y, const utils::CImage &img, float rotation,
