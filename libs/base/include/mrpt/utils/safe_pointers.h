 ...
 * pointed data.
  ...
  */
template <class T> struct safe_ptr_basic {
protected:
  T *ptr;
 ...
 * pointed data.
  ...
  * \ingroup mrpt_base_grp
  */
template <class T> struct safe_ptr : safe_ptr_basic<T> {
public:
 ...
 * raising an exception at runtime if a copy is attempted.
  ...
  * \ingroup mrpt_base_grp
  */
template <class T> struct non_copiable_ptr_basic {
protected:
  T *ptr;
 ...
 * raising an exception at runtime if a copy is attempted.
  ...
  * \ingroup mrpt_base_grp
  */
template <class T> struct non_copiable_ptr : non_copiable_ptr_basic<T> {
public:
 ...
 * type is permited.
  ...
  * \ingroup mrpt_base_grp
  */
template <class T> struct ignored_copy_ptr {
protected:
  T *ptr;
 ...
 * be set to nullptr in the copy.
  ...
  * \ingroup mrpt_base_grp
  */
template <class T> struct copiable_NULL_ptr_basic {
protected:
  T *ptr;
 ...
 * be set to nullptr in the new copy.
  ...
  * \ingroup mrpt_base_grp
  */
template <class T> struct copiable_NULL_ptr : copiable_NULL_ptr_basic<T> {
public:
