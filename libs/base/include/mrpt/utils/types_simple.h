...
namespace mrpt {
/** \addtogroup mrpt_simpletypes Simple mrpt types (in #include
...
typedef std::vector<bool>
    vector_bool; //!<  A type for passing a vector of bools.
typedef std::vector<std::string>
    vector_string; //!<  A type for passing a vector of strings.
/** @} */
...
typedef uint64_t
    TNodeID; //!< The type for node IDs in graphs of different types.
