...
#if defined(_MSC_VER)
#pragma warning(                                                               \
    disable : 4127) // Disable conditional expression is constant (it shows up
                    // in templates where it's correct)
...
//#pragma warning(disable:4308) // Disable warning for Eigen3 libs: negative
//integral converted to unsigned
...
#pragma warning(disable : 4251) // Visual C++ 2003+ warnings on STL classes when
                                // exporting to DLL...
