...
erase_return_next(std::list<T> &cont, typename std::list<T>::iterator &it) {
  return cont.erase(it);
}
//! \overload
template <class K, class V>
inline typename std::map<K, V>::iterator
erase_return_next(std::map<K, V> &cont, typename std::map<K, V>::iterator &it) {
...
erase_return_next(std::set<T> &cont, typename std::set<T>::iterator &it) {
 ...
 */
template <class T> std::string getSTLContainerAsString(const T &t) {
  using namespace std;
  stringstream ss;
 ...
 */
template <class T> void printSTLContainer(const T &t) {
  using namespace std;
 ...
 */
template <class T> void printSTLContainerOfContainers(const T &t) {
  using namespace std;
 ...
 * \param[in] m Template map
 */
template <class T1, class T2> void printMap(const std::map<T1, T2> &m) {
  using namespace std;
