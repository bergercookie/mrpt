...
protected:
  std::queue<T *> m_msgs;       //!< The queue of messages. Memory is freed at
                                //!destructor or by clients gathering messages.
...
public:
  ...
  /** Insert a new message in the queue - The object must be created with "new",
   * and do not delete is after calling this, it must be deleted later.
    */
