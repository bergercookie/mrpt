...
public:
   ...
   * mean, both at once.
    * \sa getMean
    */
  void getCovarianceAndMean(mrpt::math::CMatrixDouble33 &out_cov,
  ...
  void inverseComposition(const CPosePDFGaussian &x,
  ...
  void inverseComposition(const CPosePDFGaussian &x1,
  ...
  void composePoint(const mrpt::math::TPoint2D &l,
                    CPoint2DPDFGaussian &g) const;
 ...
 * covariance */
CPosePDFGaussian BASE_IMPEXP operator+(const CPosePDFGaussian &a,
...
bool BASE_IMPEXP operator==(const CPosePDFGaussian &p1,
