...
public:
   ...
   * the origin pose (0,0,0deg) is returned, for "n=1" the first pose is
   ...
   * returns 0, for "n=1" the first traveled distance, and for "n=posesCount()",
   * the total
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE(CPoses3DSequence,
