...
template <> struct BASE_IMPEXP SE_traits<3> {
   ...
   * is, the normal
    *  SO(3) logarithm is used for the rotation components, but the translation
   * is left unmodified. */
   ...
   * linearized manifold for P1 and P2.
    */
  static void jacobian_dP1DP2inv_depsilon(const CPose3D &P1DP2inv,
                                          matrix_VxV_t *df_de1,
                                          matrix_VxV_t *df_de2);
...
template <> struct BASE_IMPEXP SE_traits<2> {
   ...
   * is, the normal
    *  SO(2) logarithm is used for the rotation components, but the translation
   * is left unmodified.
    */
   ...
   * linearized manifold for P1 and P2.
    */
  static void jacobian_dP1DP2inv_depsilon(const CPose2D &P1DP2inv,
                                          matrix_VxV_t *df_de1,
                                          matrix_VxV_t *df_de2);
