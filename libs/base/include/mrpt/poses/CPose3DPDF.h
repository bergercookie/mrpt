...
public:
   ...
   * Gaussians->Gaussians,etc)
    *  It returns a new object of any of the derived classes of CPose3DPDF. This
   * object must be deleted by the user when not required anymore.
    *  \sa copyFrom
    */
  ...
  *
  */
  static void jacobiansPoseComposition(const CPose3D &x, const CPose3D &u,
