...
public:
   ...
   * pose mean samples will be drawn around. \return A reference to the argument
   */
  ...
  /** Retrieves the 6x6 covariance of the original PDF in \f$ [ x ~ y ~ z ~ yaw
   * ~ pitch ~ roll ] \f$. */
