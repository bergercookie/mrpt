...
public:
   ...
   * SOGs will be dropped to reduce the number of modes in the output.
    */
  virtual void bayesianFusion(const CPosePDF &p1, const CPosePDF &p2,
  ...
  /** This static method computes the pose composition Jacobians, with these
     formulas:
          ...
          \endcode
    */
  static void jacobiansPoseComposition(const CPose2D &x, const CPose2D &u,
  ...
  /** \overload */
  static void jacobiansPoseComposition(const CPosePDFGaussian &x,
