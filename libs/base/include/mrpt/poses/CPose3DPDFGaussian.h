...
public:
   ...
   * mean, both at once.
    * \sa getMean
    */
  void getCovarianceAndMean(mrpt::math::CMatrixDouble66 &out_cov,
 ...
 * +=  */
inline CPose3DPDFGaussian operator+(const CPose3DPDFGaussian &x,
...
bool BASE_IMPEXP operator==(const CPose3DPDFGaussian &p1,
...
/** If set to true (false), a Scaled Unscented Transform is used instead of a
  ...
  * Affects to:
  *		- CPose3DPDFGaussian::CPose3DPDFGaussian( const
