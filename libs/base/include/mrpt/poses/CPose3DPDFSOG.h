...
public:
  ...
  void getMostLikelyMode(CPose3DPDFGaussian &outVal) const; //!< Return the
                                                            //!Gaussian mode
                                                            //!with the highest
                                                            //!likelihood (or an
                                                            //!empty Gaussian if
  ...
  void copyFrom(const CPose3DPDF &o) override; //!< Copy operator, translating
                                               ...
                                               //!between particles and gaussian
                                               //!representations)
  ...
  void drawSingleSample(CPose3D &outPart)
  ...
  void drawManySamples(size_t N,
      ...
      const override; //!< Draws a number of samples from the distribution, and
                      ...
                      //!a (x,y,z,yaw,pitch,roll) datum
  void inverse(CPose3DPDF &o) const
      override; //!< Returns a new PDF such as: NEW_PDF = (0,0,0) - THIS_PDF

  void appendFrom(const CPose3DPDFSOG &o); //!< Append the Gaussian modes from
                                           //!"o" to the current set of modes of
                                           //!"this" density
