...
*/
template <class DUMMY = int> class MultiSwitchArg : public SwitchArg {
protected:
  /**
...
template <class DUMMY> inline int MultiSwitchArg<DUMMY>::getValue() {
  return _value;
}

template <class DUMMY>
inline bool MultiSwitchArg<DUMMY>::processArg(int *i,
