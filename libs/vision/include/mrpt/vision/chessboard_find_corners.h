...
/** Look for the corners of a chessboard in the image using one of two different
  ...
  *    and the papers:
  *		- 1. Scaramuzza, D., Martinelli, A. and Siegwart, R. (2006), A
  *Toolbox for Easily Calibrating Omnidirectional Cameras, Proceedings of the
  *IEEE/RSJ International Conference on Intelligent Robots and Systems  (IROS
  *2006), Beijing, China, October 2006.
  *		- 2. Scaramuzza, D., Martinelli, A. and Siegwart, R., (2006). "A
  *Flexible Technique for Accurate Omnidirectional Camera Calibration and
  *Structure from Motion", Proceedings of IEEE International Conference of
  *Vision Systems  (ICVS'06), New York, January 5-7, 2006.
