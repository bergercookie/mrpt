...
enum TFeatureTrackStatus
{
	...
	/** Unable to track this feature (mismatch is too high for the given
	   tracking
	   window: lack of texture? oclussion?) */
	status_LOST = 10
};
	...
	: public std::vector<TFeatureObservation>
{
	 ...
	 * list
	 * (eg: from N camera pose IDs at return there will be just
	 * N/decimate_ratio)
...
struct VISION_IMPEXP TMatchingOptions : public mrpt::utils::CLoadableOptions
{
	...
	//            double  fx,cx,cy,baseline;          //!< Intrinsic parameters
	//            of
	//            the stereo rig
	...
	: public mrpt::utils::CLoadableOptions
{
	 ...
	 * is
	 * below this value, more features will be found. */
