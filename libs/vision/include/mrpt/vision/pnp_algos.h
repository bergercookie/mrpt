...
public:
  /**
   * @brief \cite hesch Direct Least Squares (DLS) - PnP : Algorithm formulates
   * position as a function of rotation.
   ...
   *
   * @param[in] obj_pts Object points in Camera Co-ordinate system {C} nX3 (only
   * 4 points used) array [p_x, p_y, p_z]
   ...
   * @return success flag
   */
  bool dls(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
   ...
   * @return success flag
   */
  bool epnp(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
            const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
            const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
            Eigen::Ref<Eigen::MatrixXd> pose_mat);

  /**
   * @brief \cite Kneip2014 Unified-PnP (UPnP) : Algorithm to compute pose from
   * unknown camera intrinsic matrix
   *
   * @param[in] obj_pts Object points in Camera Co-ordinate system {C} nX3 (only
   * 4 points used) array [p_x, p_y, p_z]
   * @param[in] img_pts Image points in pixels nX3 (only 4 points used) array
   ...
   * @return success flag
   */
  bool upnp(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
            const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
            const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
            Eigen::Ref<Eigen::MatrixXd> pose_mat);
   ...
   * @return success flag
   */
  bool p3p(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
           const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
           const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
           Eigen::Ref<Eigen::MatrixXd> pose_mat);
   ...
   * @return success flag
   */
  bool rpnp(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
            const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
            const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
            Eigen::Ref<Eigen::MatrixXd> pose_mat);
   ...
   * algorithm
   * @param[in] obj_pts Object points in Camera Co-ordinate system {C} nX3 array
   * [p_x, p_y, p_z]
   ...
   * @return success flag
   */
  bool ppnp(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
            const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
            const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
            Eigen::Ref<Eigen::MatrixXd> pose_mat);
   ...
   * @return success flag
   */
  bool posit(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
             const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
             const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
             Eigen::Ref<Eigen::MatrixXd> pose_mat);

  /**@brief \cite lu Lu-Hager-Mjolsness(LHM)-PnP algorithm : Iterative algorithm
   * to reduce object space error
   ...
   * @return success flag
   */
  bool lhm(const Eigen::Ref<Eigen::MatrixXd> obj_pts,
           const Eigen::Ref<Eigen::MatrixXd> img_pts, int n,
           const Eigen::Ref<Eigen::MatrixXd> cam_intrinsic,
           Eigen::Ref<Eigen::MatrixXd> pose_mat);
};
