...
/** Sparse Levenberg-Marquart solution to bundle adjustment - optimizes all the
  ...
  *		- "num_fix_frames": Number of first frame poses to don't optimize
  *(keep unmodified as they come in)  (default=1: the first pose is the
  *reference and is not modified)
  *		- "num_fix_points": Idem, for the landmarks positions (default=0:
  *optimize all)
  *		- "profiler": If !=0, displays profiling information to the console
  *at return.
  *
