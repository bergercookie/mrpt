...
**
************************************************************************************************/
void CFeatureExtraction::extractFeaturesSURF(const mrpt::utils::CImage &inImg,
                                             CFeatureList &feats,
...
// older openCV versions
  ...
  THROW_EXCEPTION("Method not available: MRPT compiled without OpenCV, or "
                  "against a version of OpenCV without SURF")
