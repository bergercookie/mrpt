...
void mrpt::vision::pnp::epnp::fill_M(CvMat *M, const int row, const double *as,
...
void mrpt::vision::pnp::epnp::copy_R_and_t(const double R_src[3][3],
...
void mrpt::vision::pnp::epnp::gauss_newton(const CvMat *L_6x10,
                                           const CvMat *Rho, double betas[4]) {
