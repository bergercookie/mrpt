...
bool mrpt::vision::pnp::p3p::solve(cv::Mat &R, cv::Mat &tvec,
...
bool mrpt::vision::pnp::p3p::solve(double R[3][3], double t[3], double mu0,
                                   double mv0, double X0, double Y0, double Z0,
                                   double mu1, double mv1, double X1, double Y1,
                                   double Z1, double mu2, double mv2, double X2,
                                   double Y2, double Z2, double mu3, double mv3,
...
int mrpt::vision::pnp::p3p::solve(double R[4][3][3], double t[4][3], double mu0,
                                  double mv0, double X0, double Y0, double Z0,
                                  double mu1, double mv1, double X1, double Y1,
                                  double Z1, double mu2, double mv2, double X2,
                                  double Y2, double Z2) {
...
bool mrpt::vision::pnp::p3p::align(double M_end[3][3], double X0, double Y0,
