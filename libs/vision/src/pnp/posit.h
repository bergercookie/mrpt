...
class posit {
  ...
  Eigen::MatrixXd
      img_vecs_old; //! Used to store img_vecs from previous iteration

public:
  //! Constructor for P-PnP class
  posit(Eigen::MatrixXd obj_pts_, Eigen::MatrixXd img_pts_,
        Eigen::MatrixXd camera_intrinsic_, int n);
