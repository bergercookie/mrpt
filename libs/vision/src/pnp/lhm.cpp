...
lhm::lhm(Eigen::MatrixXd obj_pts_, Eigen::MatrixXd img_pts_,
...
*/
  ...
  Eigen::Vector4d D; // Ae.diagonal(); for some reason this leads to an internal
                     // compiler error in MSVC11... (sigh)
  for (int i = 0; i < 4; i++)
    D[i] = Ae(i, i);
