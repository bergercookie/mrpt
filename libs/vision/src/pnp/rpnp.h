...
public:
  ...
  rpnp(Eigen::MatrixXd obj_pts_, Eigen::MatrixXd img_pts_, Eigen::MatrixXd cam_,
       int n0);
   ...
   * @return Success flag
   */
  bool compute_pose(Eigen::Ref<Eigen::Matrix3d> R_,
   ...
   */
  Eigen::VectorXd getp3p(double l1, double l2, double A5, double C1, double C2,
   ...
   */
  void calcampose(Eigen::MatrixXd &XXc, Eigen::MatrixXd &XXw,
