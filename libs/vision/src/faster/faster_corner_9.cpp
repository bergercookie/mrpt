	...
	uint8_t octave, std::vector<size_t>* out_feats_index_by_row)
{
	...
	for (int y = 3; y < I->height - 3; y++)
	{
		...
		{
			const uint8_t* p =
				(const uint8_t*)I->imageData + I->widthStep * y +
			...
			unsigned int ans_14, ans_6;
			{
				...
				}
				{
					...
					possible &=
						ans_6 | (ans_14_15 & (ans_12 | (ans_0 & ans_1)));
			...
			unsigned int ans_13, ans_5;
			{
				...
				const unsigned int ans_7_8 = ans_7 & ans_8;
				{
					...
					possible &=
						ans_5 | (ans_12_13 & ans_14 & ((ans_15_0) | ans_10));
				...
				}
				{
					...
					const unsigned int ans_9_10 = ans_9 & ans_10;
					possible &=
						ans_13 | (ans_4_5 & ans_6 & ((ans_7_8) | ans_2));
			...
			unsigned int ans_11, ans_3;
			{
				...
				CHECK_BARRIER(lo, hi, jj, ans_3);
				{
					...
					possible &= ans_11 | (ans_2_3 & ans_4 &
										  ((ans_0 & ans_1) | (ans_5 & ans_6)));
	...
	uint8_t octave, std::vector<size_t>* out_feats_index_by_row)
{
	...
	if (mrpt::system::is_aligned<16>(I->imageData) &&
		...
		faster_corner_detect_9<true>(
			I, corners, barrier, octave, out_feats_index_by_row);
	else
		faster_corner_detect_9<false>(
			I, corners, barrier, octave, out_feats_index_by_row);
#else
	fast_corner_detect_plain_9(
		I, corners, barrier, octave, out_feats_index_by_row);
