...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
CLandmark::CLandmark()
    : features(), pose_mean(), normal(), pose_cov_11(), pose_cov_22(),
      pose_cov_33(), pose_cov_12(), pose_cov_13(), pose_cov_23(),
      ID(INVALID_LANDMARK_ID), timestampLastSeen(INVALID_TIMESTAMP),
      seenTimesCount(0) {}
...
void CLandmark::readFromStream(mrpt::utils::CStream &in, int version) {
  ...
  case 3:
    ...
    break;
  case 4: {
    in >> features >> pose_mean >> normal >> pose_cov_11 >> pose_cov_22 >>
        pose_cov_33 >> pose_cov_12 >> pose_cov_13 >> pose_cov_23 >> ID >>
        timestampLastSeen >> seenTimesCount;
  } break;
  default:
