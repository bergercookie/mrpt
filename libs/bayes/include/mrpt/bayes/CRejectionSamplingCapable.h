 ...
 * \ingroup mrpt_bayes_grp
 */
template <class TStateSpace> class CRejectionSamplingCapable {
public:
   ...
   * generated sample (i.e. the maximum number of iterations). This can be used
   * to set a limit to the time complexity of the algorithm for difficult
   ...
   * sampling), although those samples
    ...
    */
  void rejectionSampling(size_t desiredSamples,
