...
public:
   ...
   * variables to be returned.
    ...
    */
  void get(size_t index, mrpt::poses::CPose3DPDF::Ptr &out_posePDF,
   ...
   * the values).
    ...
    */
  void set(size_t index, const mrpt::poses::CPose3DPDF::Ptr &in_posePDF,
   ...
   * the 3D version.
    ...
    * \sa insert, get, remove
    */
  void set(size_t index, const mrpt::poses::CPosePDF::Ptr &in_posePDF,
           const mrpt::obs::CSensoryFrame::Ptr &in_SF);
  ...
  void insert(const mrpt::poses::CPose3DPDF *in_posePDF,
  ...
  /** Add a new pair to the sequence, making a copy of the smart pointer (it's
   * not made unique). */
  void insert(const mrpt::poses::CPose3DPDF::Ptr &in_posePDF,
              const mrpt::obs::CSensoryFrame::Ptr &in_SF);
   ...
   * the 3D version.
    */
  void insert(const mrpt::poses::CPosePDF::Ptr &in_posePDF,
              const mrpt::obs::CSensoryFrame::Ptr &in_SF);
   ...
   * the 3D version.
    */
  void insert(const mrpt::poses::CPosePDF *in_posePDF,
              const mrpt::obs::CSensoryFrame &in_SF);
  ...
  /** \name Iterators API
    * @{ */
  typedef std::pair<mrpt::poses::CPose3DPDF::Ptr, mrpt::obs::CSensoryFrame::Ptr>
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CSimpleMap,
