...
public:
  ...
  size_t doRegister(const std::string &name, MapDefCtorFunctor func1,
                    MapCtorFromDefFunctor func2); //!< Return the index of the
                                                  //!class in the list (not
                                                  //!important, just used as a
                                                  //!trick to initialize static
                                                  //!members)
  mrpt::maps::TMetricMapInitializer *factoryMapDefinition(
      const std::string &className) const; //!< Return nullptr if not found
  mrpt::maps::CMetricMap *
  factoryMapObjectFromDefinition(const mrpt::maps::TMetricMapInitializer &mi)
      const; //!< Return nullptr if not found
...
protected:                                                                     \
  ...
  /** Constructor from a map definition structure: initializes the map and its \
