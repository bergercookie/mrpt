...
struct OBS_IMPEXP TMetricMapInitializer : public mrpt::utils::CLoadableOptions
{
   ...
   protected:
	...
	/** Derived classes set this to CLASS_ID(< class >) where < class > is any
	 * CMetricMap derived class. */
	...
	: public mrpt::utils::CLoadableOptions
{
   ...
   public:
	...
	/** Loads the configuration for the set of internal maps from a textual
	  ...
	  *  The format of the ini file is defined in utils::CConfigFile. The list
	  *of
	  ...
	  *maps are defined in textual form by the same name of the corresponding
	  *C++
