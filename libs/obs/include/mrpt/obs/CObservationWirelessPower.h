...
public:
  ...
  double power; //!< The power or signal strength as sensed by the Wifi receiver
                //!(In percentage: [0-100])
  mrpt::poses::CPose3D sensorPoseOnRobot; //!< The location of the sensing
                                          //!antenna on the robot coordinate
                                          //!framework
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CObservationWirelessPower,
