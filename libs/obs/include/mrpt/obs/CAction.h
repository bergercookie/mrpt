...
class OBS_IMPEXP CAction : public mrpt::utils::CSerializable {
  ...
  /** The associated time-stamp.
    *  This was added at 2-Dec-2007, new serialization versions have been added
   * to derived classes to manage this time-stamp.
    *  Prior versions will be read as having a INVALID_TIMESTAMP value.
   */
  mrpt::system::TTimeStamp timestamp;

}; // End of class def.
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CAction,
