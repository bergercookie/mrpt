...
struct OBS_IMPEXP T3DPointsProjectionParams
{
	 ...
	 * it
	 * is a good idea to left it enabled. */
	bool PROJ3D_USE_LUT;
...
class OBS_IMPEXP CObservation3DRangeScan : public CObservation
{
   ...
   public:
	 ...
	 * in
	 * \a points3D_x, points3D_y, points3D_z */
	 ...
	 * captured
	 * by the camera (in meters) \sa range_is_depth */
	mrpt::math::CMatrix rangeImage;
	/** true: Kinect-like ranges: entries of \a rangeImage are distances along
	 * the
	 * +X axis; false: Ranges in \a rangeImage are actual distances in 3D. */
	bool range_is_depth;
