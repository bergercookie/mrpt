...
public:
  ...
  /** The users can use this vector for any arbitrary number of batteries or any
   ...
   * (it MUST has the same size than voltageOtherBatteries)
    */
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CObservationBatteryState,
