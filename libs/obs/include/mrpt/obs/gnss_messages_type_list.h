...
enum gnss_message_type_t {
  ...
  NV_OEM6_GENERIC_SHORT_FRAME =
      3001 + NV_OEM6_MSG2ENUM, // Generic container (short header)
  ...
  NV_OEM6_BESTPOS =
      42 +
      NV_OEM6_MSG2ENUM, // SPAN: Best available combined GNSS and INS position
  ...
  NV_OEM6_INSPVAS = 508 + NV_OEM6_MSG2ENUM, // Most recent position, velocity
                                            // and attitude at full rate of IMU
                                            // (short header)
  NV_OEM6_INSATTS = 319 + NV_OEM6_MSG2ENUM, // Most recent attitude (roll, pitch
                                            // and azimuth) measurements (short
                                            // header)
  NV_OEM6_INSCOVS = 320 + NV_OEM6_MSG2ENUM, // Position, attitude, and velocity
                                            // matrices with respect to the
                                            // local level frame (short header)
  NV_OEM6_INSVELS = 324 + NV_OEM6_MSG2ENUM, // Most recent North, East, and Up
                                            // velocity vector values (short
                                            // header)
  NV_OEM6_RAWIMUS =
      325 + NV_OEM6_MSG2ENUM // IMU status indicator and the measurements from
                             // the accelerometers and gyros (short header)
