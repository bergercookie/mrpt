...
enum gnss_message_type_t
{
	...
	// pitch and azimuth) measurements
	// (short header)
	NV_OEM6_INSCOVS =
		320 + NV_OEM6_MSG2ENUM,  // Position, attitude, and velocity
	// matrices with respect to the
	// local level frame (short header)
	NV_OEM6_INSVELS =
		324 + NV_OEM6_MSG2ENUM,  // Most recent North, East, and Up
	// velocity vector values (short
	// header)
	NV_OEM6_RAWIMUS =
		325 +
		NV_OEM6_MSG2ENUM  // IMU status indicator and the measurements from
