...
enum TIMUDataIndex {
  IMU_X_ACC =
      0,     //!< x-axis acceleration (local/vehicle frame) (m/sec<sup>2</sup>)
  ...
  IMU_PITCH, //!< orientation pitch absolute value (global/navigation frame)
             //!(rad)
  ...
  IMU_YAW_VEL_GLOBAL, //!< yaw angular velocity (global/navigation frame)
                      //!(rad/sec)
  IMU_PITCH_VEL_GLOBAL, //!< pitch angular velocity (global/navigation frame)
                        //!(rad/sec)
  IMU_ROLL_VEL_GLOBAL,  //!< roll angular velocity (global/navigation frame)
                        //!(rad/sec)
  IMU_X_ACC_GLOBAL,     //!< x-axis acceleration (global/navigation frame)
                        //!(m/sec<sup>2</sup>)
  IMU_Y_ACC_GLOBAL,     //!< y-axis acceleration (global/navigation frame)
                        //!(m/sec<sup>2</sup>)
  IMU_Z_ACC_GLOBAL,     //!< z-axis acceleration (global/navigation frame)
                        //!(m/sec<sup>2</sup>)
...
public:
   ...
   */
  CObservationIMU()
      : sensorPose(), dataIsPresent(mrpt::obs::COUNT_IMU_DATA_FIELDS, false),
  ...
  /** Each entry in this vector is true if the corresponding data index contains
   * valid data (the IMU unit supplies that kind of data).
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CObservationIMU, CObservation,
                                             OBS_IMPEXP)
