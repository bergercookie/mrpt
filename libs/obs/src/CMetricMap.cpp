...
void CMetricMap::loadFromProbabilisticPosesAndObservations(
  ...
  for (size_t i = 0; i < n; i++) {
    ...
    sf->insertObservationsInto(this,      // Insert into THIS map.
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
double CMetricMap::computeObservationsLikelihood(const CSensoryFrame &sf,
...
double CMetricMap::computeObservationLikelihood(const CObservation *obs,
                                                const CPose2D &takenFrom) {
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
bool CMetricMap::canComputeObservationsLikelihood(
...
bool CMetricMap::insertObservation(const CObservation *obs,
...
bool CMetricMap::insertObservationPtr(const CObservation::Ptr &obs,
                                      const CPose3D *robotPose) {
  MRPT_START
  if (!obs) {
