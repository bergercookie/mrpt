...
//  HMTSLAM_IMPEXP, mrpt_xxx_EXPORTS

/*   The macros below for DLL import/export are required for Windows only.
	Mostly all the definitions in this file are copied or at least hmtslamd
...
#define HMTSLAM_IMPEXP MRPT_HMTSLAM_EXPORT
#else /* Using the DLL */
#define HMTSLAM_IMPEXP MRPT_HMTSLAM_IMPORT
#endif
