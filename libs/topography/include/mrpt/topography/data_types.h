...
struct TOPO_IMPEXP TCoords {
  ...
  double decimal_value; //!< Also obtained directly through the double(void)
                        //!operator using a TCoords anywhere were a double is
                        //!expected.
  ...
  inline void setDegMinSec(const int degrees, const int minutes,
...
struct TOPO_IMPEXP TEllipsoid {
  ...
  inline TEllipsoid(const double _sa, const double _sb,
...
struct TOPO_IMPEXP TDatum7Params {
  ...
  inline TDatum7Params(const double _dX, const double _dY, const double _dZ,
...
struct TOPO_IMPEXP TDatum7Params_TOPCON {
  ...
  inline TDatum7Params_TOPCON(const double _dX, const double _dY,
                              const double _dZ, const double _m11,
                              const double _m12, const double _m13,
                              const double _m21, const double _m22,
                              const double _m23, const double _m31,
                              const double _m32, const double _m33,
                              const double _dS)
      : dX(_dX), dY(_dY), dZ(_dZ), m11(_m11), m12(_m12), m13(_m13), m21(_m21),
        m22(_m22), m23(_m23), m31(_m31), m32(_m32), m33(_m33) {
    dS = _dS * 1e-6;
  }
};
...
struct TOPO_IMPEXP TDatum10Params {
  ...
  inline TDatum10Params(const double _dX, const double _dY, const double _dZ,
...
struct TOPO_IMPEXP TDatumHelmert2D {
  ...
  inline TDatumHelmert2D(const double _dX, const double _dY,
...
struct TOPO_IMPEXP TDatumHelmert2D_TOPCON {
  ...
  inline TDatumHelmert2D_TOPCON(const double _a, const double _b,
...
struct TOPO_IMPEXP TDatumHelmert3D {
  ...
  inline TDatumHelmert3D(const double _dX, const double _dY, const double _dZ,
                         const double _Rx, const double _Ry, const double _Rz,
                         const double _dS)
      : dX(_dX), dY(_dY), dZ(_dZ) {
    Rx = mrpt::utils::DEG2RAD(_Rx / 60 / 60);
...
struct TOPO_IMPEXP TDatumHelmert3D_TOPCON {
  ...
  inline TDatumHelmert3D_TOPCON(const double _a, const double _b,
                                const double _c, const double _d,
                                const double _e, const double _f,
                                const double _g)
...
struct TOPO_IMPEXP TDatum1DTransf {
  ...
  inline TDatum1DTransf(const double _dX, const double _dY, const double _DZ,
                        const double _dS)
      : dX(_dX), dY(_dY), DZ(_DZ) {
    dS = _dS * 1e-6;
  }
...
struct TOPO_IMPEXP TDatumTransfInterpolation {
  ...
  inline TDatumTransfInterpolation(const double _dX, const double _dY,
                                   const double _dSx, const double _dSy,
                                   const double _beta)
      : dX(_dX), dY(_dY) {
    dSx = _dSx * 1e-6;
    dSy = _dSy * 1e-6;
