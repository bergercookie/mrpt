...
// ACT_SIZE, size typename kftype = double>
{
   public:
	...
	struct SLAM_IMPEXP TOptions : utils::CLoadableOptions
	{
		 ...
		 * compatibility
		 * between predictions and observations (default: 0.99) */
   ...
   protected:
	 ...
	 * [0,getNumberOfLandmarksInTheMap()-1]), or -1 if it is a new map element
	 * and
	 ...
	 * whose
	 * prediction is expected as output. For non SLAM-like problems, this will
	 * be
	 ...
	 * the
	 * computation or not of the corresponding covariances is what we're trying
	 * to
	 ...
	 * to
	 * be computed. It corresponds to the row in in_z where the observation can
	 * be
	 * found.
