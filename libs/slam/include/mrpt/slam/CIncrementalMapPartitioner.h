...
public:
   ...
   */
  /**\{*/
  unsigned int addMapFrame(const mrpt::obs::CSensoryFrame::Ptr &frame,
                           const mrpt::poses::CPosePDF::Ptr &robotPose2D);
  unsigned int addMapFrame(const mrpt::obs::CSensoryFrame::Ptr &frame,
                           const mrpt::poses::CPose3DPDF::Ptr &robotPose3D);
  unsigned int addMapFrame(const mrpt::obs::CSensoryFrame &frame,
   ...
   *
   */
  mrpt::maps::CSimpleMap *getSequenceOfFrames() { return &m_individualFrames; }
   ...
   */
  void
  getAs3DScene(mrpt::opengl::CSetOfObjects::Ptr &objs,
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CIncrementalMapPartitioner,
