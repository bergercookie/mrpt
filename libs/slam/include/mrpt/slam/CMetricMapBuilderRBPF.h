...
protected:
  ...
  mrpt::poses::CPose3DPDFGaussian
      odoIncrementSinceLastLocalization; //!< Traveled distance since last
                                         //!localization update
  mrpt::poses::CPose3D odoIncrementSinceLastMapUpdate; //!< Traveled distance
...
public:
  ...
  /** This second constructor is created for the situation where a class member
needs to be
of type CMetricMapBuilderRBPF  */
   ...
   *description.
   *  \param action The incremental 2D pose change in the robot pose. This value
   *is deterministic.
   ...
   * internal object is passed, DO NOT delete nor modify the object in any way,
   * if desired, make a copy of ir with "clone()".
    */
