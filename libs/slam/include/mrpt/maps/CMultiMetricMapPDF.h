										   ...
										   CMultiMetricMapPDF>
{
   ...
   public:
	...
	struct SLAM_IMPEXP TPredictionParams : public utils::CLoadableOptions
	{
		 ...
		 * [0,1]
		 * of the alignment such as it will be accepted. Otherwise, raw odometry
		 * is
		 ...
		 * grid
		 * map, then this structure is passed to the map when updating the
		 * particles
