 ...
 * [0,1]), possibly taking into account their relative positions.
  ...
  */
double
mrpt::slam::observationsOverlap(const mrpt::obs::CObservation *o1,
  ...
  if (IS_CLASS(o1, CObservation2DRangeScan) &&
    ...
    map1->determineMatching3D(map2,         // The other map
 ...
 * SF.
  ...
  */
double
mrpt::slam::observationsOverlap(const mrpt::obs::CSensoryFrame &sf1,
