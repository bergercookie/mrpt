...
public:
  ...
  struct OPENGL_IMPEXP TPolyhedronFace {
    ...
    /** Destructor.  */
    ~TPolyhedronFace() {}
    double area(const std::vector<mrpt::math::TPoint3D> &vertices)
        const; //!< Given a set of vertices, computes the area of this face.
    void getCenter(const std::vector<mrpt::math::TPoint3D> &vertices,
                   mrpt::math::TPoint3D &p)
        const; //!< Given a set of vertices, get this face's center.
  };
...
protected:
  ...
  bool mWireframe;
  /**
    * When displaying as wireframe object, this variable stores the width of the
   * edges.
    */
  double mLineWidth;
  /**
...
public:
  ...
  /**
    * Creates a regular cube, also called hexahedron (see
    ...
    <ul><li>Dual to an octahedron.</li><li>Parallelepiped with three orthogonal,
    equally-lengthed vectors.</li><li>Triangular trapezohedron with proper
    height.</li></ul>
  ...
  /**
    * Creates a regular octahedron (see
    ...
    square bipyramid whit transitive edges and vertices. Another ways to create
    an octahedron are:
  ...
  /**
    * Creates a regular icosahedron (see
    ...
    gyroelongated pentagonal bipyramid with transitive edges, and it's the dual
    to a dodecahedron.
  ...
  /**
    * Creates a truncated tetrahedron, consisting of four triangular faces and
    for hexagonal ones (see http://en.wikipedia.org/wiki/Truncated_tetrahedron).
  ...
  /**
    * Creates a cuboctahedron, consisting of six square faces and eight
    triangular ones (see http://en.wikipedia.org/wiki/Cuboctahedron). There are
    several ways to create a cuboctahedron:
    <ul><li>Hexahedron truncated to a certain extent.</li><li>Octahedron
    truncated to a certain extent.</li><li>Cantellated tetrahedron</li><li>Dual
    to a rhombic dodecahedron.</li></ul>
  ...
  /**
    * Creates a truncated hexahedron, with six octogonal faces and eight
    triangular ones (see http://en.wikipedia.org/wiki/Truncated_hexahedron). The
    truncated octahedron is dual to the triakis octahedron.
  ...
  /**
    * Creates a truncated octahedron, with eight hexagons and eight squares (see
    http://en.wikipedia.org/wiki/Truncated_octahedron). It's the dual to the
    tetrakis hexahedron.
  ...
  /**
    ...
    * If the second argument is set to false, the lower cupola is rotated, so
    ...
    http://en.wikipedia.org/wiki/Elongated_square_gyrobicupola). This is not an
    archimedean solid, but a Johnson one, since it hasn't got vertex
    transitivity.
    ...
    */
  static CPolyhedron::Ptr CreateRhombicuboctahedron(double radius,
                                                    bool type = true);
  /**
    ...
    * If the second argument is set to false, the lower rotunda is rotated. In
    ...
    presents symmetry against the XY plane and is not vertex transitive, so it's
    a Johnson's solid.
    ...
    */
  static CPolyhedron::Ptr CreateIcosidodecahedron(double radius,
                                                  bool type = true);
  /**
  ...
  /**
    * Creates a rhombicosidodecahedron, consisting of 30 squares, 12 pentagons
    and 20 triangles (see http://en.wikipedia.org/wiki/Rhombicosidodecahedron).
    This object can be obtained as the cantellation of either a dodecahedron or
    an icosahedron. The dual of the rhombicosidodecahedron is the deltoidal
    hexecontahedron.
  ...
  */
  ...
  /**
    * Creates a triakis octahedron, dual to the truncated hexahedron. This body
    consists of 24 isosceles triangles (see
  ...
  /**
    * Creates a tetrakis hexahedron, dual to the truncated octahedron. This body
    consists of 24 isosceles triangles (see
   ...
   * &),CreateParallelepiped,CreateCustomPrism,CreateRegularPrism,CreateArchimedeanRegularPrism
    */
  static CPolyhedron::Ptr CreateCubicPrism(double x1, double x2, double y1,
   ...
   * CreateCubicPrism(double,double,double,double,double,double),CreateParallelepiped,CreateCustomPrism,CreateRegularPrism,CreateArchimedeanRegularPrism
    */
  static CPolyhedron::Ptr CreateCubicPrism(const mrpt::math::TPoint3D &p1,
                                           const mrpt::math::TPoint3D &p2);
  /**
    * Creates a custom pyramid, using a set of 2D vertices which will lie on the
   * XY plane.
    * \sa CreateDoublePyramid,CreateFrustum,CreateBifrustum,CreateRegularPyramid
    */
  static CPolyhedron::Ptr
  CreatePyramid(const std::vector<mrpt::math::TPoint2D> &baseVertices,
                double height);
  /**
    * Creates a double pyramid, using a set of 2D vertices which will lie on the
   * XY plane. The second height is used with the downwards pointing pyramid, so
   * that it will effectively point downwards if it's positive.
    * \sa CreatePyramid,CreateBifrustum,CreateRegularDoublePyramid
    */
  static CPolyhedron::Ptr
  CreateDoublePyramid(const std::vector<mrpt::math::TPoint2D> &baseVertices,
                      double height1, double height2);
  /**
    * Creates a truncated pyramid, using a set of vertices which will lie on the
   * XY plane.
   ...
   * When using a ratio of 1, it will create a Prism.
    ...
    */
  static CPolyhedron::Ptr
  CreateTruncatedPyramid(const std::vector<mrpt::math::TPoint2D> &baseVertices,
  ...
  /**
    ...
    */
  static CPolyhedron::Ptr
  CreateFrustum(const std::vector<mrpt::math::TPoint2D> &baseVertices,
                double height, double ratio);
  /**
    * Creates a custom prism with vertical edges, given any base which will lie
   * on the XY plane.
    * \sa
   * CreateCubicPrism,CreateCustomAntiprism,CreateRegularPrism,CreateArchimedeanRegularPrism
    */
  static CPolyhedron::Ptr
  CreateCustomPrism(const std::vector<mrpt::math::TPoint2D> &baseVertices,
                    double height);
  /**
   ...
   * CreateCustomPrism,CreateRegularAntiprism,CreateArchimedeanRegularAntiprism
    */
  static CPolyhedron::Ptr
  CreateCustomAntiprism(const std::vector<mrpt::math::TPoint2D> &bottomBase,
                        const std::vector<mrpt::math::TPoint2D> &topBase,
                        double height);
  /**
    * Creates a parallelepiped, given a base point and three vectors represented
   * as points.
    * \sa CreateCubicPrism
    */
  static CPolyhedron::Ptr CreateParallelepiped(const mrpt::math::TPoint3D &base,
                                               const mrpt::math::TPoint3D &v1,
                                               const mrpt::math::TPoint3D &v2,
                                               const mrpt::math::TPoint3D &v3);
  /**
    * Creates a bifrustum, or double truncated pyramid, given a base which will
   * lie on the XY plane.
    * \sa CreateFrustum,CreateDoublePyramid
    */
  static CPolyhedron::Ptr
  CreateBifrustum(const std::vector<mrpt::math::TPoint2D> &baseVertices,
                  double height1, double ratio1, double height2, double ratio2);
  /**
    * Creates a trapezohedron, consisting of 2*N kites, where N is the number of
   * edges in the base. The base radius controls the polyhedron height, whilst
   * the distance between bases affects the height.
    * When the number of edges equals 3, the polyhedron is actually a
   * parallelepiped, and it can even be a cube.
    */
  static CPolyhedron::Ptr CreateTrapezohedron(uint32_t numBaseEdges,
                                              double baseRadius,
   ...
   * isosceles.
    ...
    */
  static CPolyhedron::Ptr CreateRegularAntiprism(uint32_t numBaseEdges,
                                                 double baseRadius,
                                                 double height);
  /**
   ...
   * are either parallel or perpendicular to the XY plane.
    ...
    */
  static CPolyhedron::Ptr CreateRegularPrism(uint32_t numBaseEdges,
  ...
  /**
    ...
    */
  static CPolyhedron::Ptr
  CreateRegularPyramid(uint32_t numBaseEdges, double baseRadius, double height);
  /**
    * Creates a regular double pyramid whose base is a regular polygon.
    * \sa CreateDoublePyramid
    */
  static CPolyhedron::Ptr CreateRegularDoublePyramid(uint32_t numBaseEdges,
                                                     double baseRadius,
                                                     double height1,
                                                     double height2);
  /**
    * Creates a regular prism whose lateral area is comprised of squares, and so
   * each face of its is a regular polygon. Due to vertex transitivity, the
   * resulting object is always archimedean.
    * \sa CreateRegularPrism,CreateCustomPrism
    */
  static CPolyhedron::Ptr CreateArchimedeanRegularPrism(uint32_t numBaseEdges,
                                                        double baseRadius);
  /**
   ...
   * transitivity, the resulting object is always archimedean.
    ...
    */
  static CPolyhedron::Ptr
  CreateArchimedeanRegularAntiprism(uint32_t numBaseEdges, double baseRadius);
  /**
    * Creates a regular truncated pyramid whose base is a regular polygon.
    * \sa CreateTruncatedPyramid
    */
  static CPolyhedron::Ptr CreateRegularTruncatedPyramid(uint32_t numBaseEdges,
                                                        double baseRadius,
                                                        double height,
                                                        double ratio);
  /**
    ...
    */
  static CPolyhedron::Ptr CreateRegularFrustum(uint32_t numBaseEdges,
                                               double baseRadius, double height,
                                               double ratio);
  /**
   ...
   * polygon lying in the XY plane.
    * \sa CreateBifrustum
    */
  static CPolyhedron::Ptr CreateRegularBifrustum(uint32_t numBaseEdges,
                                                 double baseRadius,
                                                 double height1, double ratio1,
                                                 double height2, double ratio2);
  /**
    * Creates a cupola.
    * \throw std::logic_error if the number of edges is odd or less than four.
    */
  static CPolyhedron::Ptr CreateCupola(uint32_t numBaseEdges,
                                       double edgeLength);
  /**
   ...
   * to the algorithm.
    ...
    */
  static CPolyhedron::Ptr CreateCatalanTrapezohedron(uint32_t numBaseEdges,
                                                     double height);
  /**
   ...
   * to the algorithm.
    ...
    */
  static CPolyhedron::Ptr CreateCatalanDoublePyramid(uint32_t numBaseEdges,
                                                     double height);
  /**
    * Creates a series of concatenated solids (most of which are prismatoids)
    whose base is a regular polygon with a given number of edges. Every face of
    the resulting body will be a regular polygon, so it is a Johnson solid; in
    special cases, it may be archimedean or even platonic.
    * The shape of the body is defined by the string argument, which can include
    one or more of the following:
    <center><table>
    <tr><td><b>String</b></td><td><b>Body</b></td><td><b>Restrictions</b></td></tr>
    <tr><td>P+</td><td>Upward pointing pyramid</td><td>Must be the last object,
    vertex number cannot surpass 5</td></tr>
    ...
    <tr><td>GC+</td><td>Upward pointing cupola, rotated</td><td>Must be the last
    object, vertex number must be an even number in the range 4-10.</td></tr>
    ...
    <tr><td>R+</td><td>Upward pointing rotunda</td><td>Must be the last object,
    vertex number must be exactly 10</td></tr>
    ...
    */
  static CPolyhedron::Ptr
  CreateJohnsonSolidWithConstantBase(uint32_t numBaseEdges, double baseRadius,
  ...
  /** Gets the intersection of two polyhedra, either as a set or as a matrix of
   * intersections. Each intersection is represented by a TObject3D.
    * \sa mrpt::math::TObject3D
    */
  template <class T>
  inline static size_t getIntersection(const CPolyhedron::Ptr &p1,
  ...
  /**
    ...
    * \throw std::logic_error Polyhedron truncation results in skew polygons and
   * thus it's impossible to perform.
    */
  ...
  /**
    * Augments a polyhedron to a given height. This operation is roughly dual to
   * the truncation: given a body P, the operation dtdP and aP yield resembling
   * results.
    * \sa getDual,truncate,cantellate
    */
  CPolyhedron::Ptr augment(double height) const;
  /**
    * Augments a polyhedron to a given height. This method only affects to faces
   * with certain number of vertices.
    * \sa augment(double) const
    */
  CPolyhedron::Ptr augment(double height, size_t numVertices) const;
  /**
    * Augments a polyhedron, so that the resulting triangles are equilateral. If
   * the argument is true, triangles are "cut" from the polyhedron, instead of
   * being added.
   ...
   * affects only faces with certain number of faces. If the second argument is
   * true, triangles are "cut" from the polyhedron.
    * \throw std::logic_error a non-regular face has been found.
    * \sa augment(double) const
    */
  CPolyhedron::Ptr augment(size_t numVertices, bool direction = false) const;
  /**
    * Rotates a polyhedron around the Z axis a given amount of radians. In some
    *cases, this operation may be necessary to view the symmetry between related
    *objects.
    *	\sa scale
    */
...
private:
  /**
    ...
    */
  static std::vector<mrpt::math::TPoint2D> generateBase(uint32_t numBaseEdges,
                                                        double baseRadius);
  /**
    * Generates a list of 2D vertices constituting a regular polygon, with an
   * angle shift which makes it suitable for antiprisms.
    */
  static std::vector<mrpt::math::TPoint2D>
  generateShiftedBase(uint32_t numBaseEdges, double baseRadius);
  /**
    * Generates a list of 3D vertices constituting a regular polygon, appending
   * it to an existing vector.
    */
  static void generateBase(uint32_t numBaseEdges, double baseRadius,
                           double height,
   ...
   * conveniently shifted, appending it to an existing vector.
    */
  static void generateShiftedBase(uint32_t numBaseEdges, double baseRadius,
  ...
  /**
    ...
    */
  static bool
  checkConsistence(const std::vector<mrpt::math::TPoint3D> &vertices,
...
public:
  /**
    ...
    */
  inline CPolyhedron()
      : mVertices(), mEdges(), mFaces(), mWireframe(false), mLineWidth(1),
        polygonsUpToDate(false) {}
  /**
    * Basic constructor with a list of vertices and another of faces, checking
   * for correctness.
    */
  inline CPolyhedron(const std::vector<mrpt::math::TPoint3D> &vertices,
                     const std::vector<TPolyhedronFace> &faces,
                     bool doCheck = true)
      : mVertices(vertices), mEdges(), mFaces(faces), mWireframe(false),
        mLineWidth(1), polygonsUpToDate(false) {
    InitFromVertAndFaces(vertices, faces, doCheck);
  }
  inline void
  InitFromVertAndFaces(const std::vector<mrpt::math::TPoint3D> &vertices,
                       const std::vector<TPolyhedronFace> &faces,
                       bool doCheck = true) {
  ...
  CPolyhedron(const std::vector<mrpt::math::TPoint3D> &vertices,
              const std::vector<std::vector<uint32_t>> &faces);

  /** Creates a polyhedron without checking its correctness. */
  static CPolyhedron::Ptr
  CreateNoCheck(const std::vector<mrpt::math::TPoint3D> &vertices,
                const std::vector<TPolyhedronFace> &faces);
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CPolyhedron,
                                             CRenderizableDisplayList,
                                             OPENGL_IMPEXP)

// Implemented after the definition of Smart::Ptrs in the _POST() macro above.
template <class T>
size_t CPolyhedron::getIntersection(const CPolyhedron::Ptr &p1,
                                    const CPolyhedron::Ptr &p2, T &container) {
...
/**
  ...
  */
OPENGL_IMPEXP mrpt::utils::CStream &operator>>(mrpt::utils::CStream &in,
                                               CPolyhedron::TPolyhedronEdge &o);
/**
  * Writes a polyhedron edge to a binary stream.
  */
OPENGL_IMPEXP mrpt::utils::CStream &
