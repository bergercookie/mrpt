...
class OPENGL_IMPEXP CPolyhedron : public CRenderizableDisplayList
{
   ...
   public:
	...
	/**
	  * Creates a rhombicosidodecahedron, consisting of 30 squares, 12 pentagons
	  ...
	  This object can be obtained as the cantellation of either a dodecahedron
	  or
	...
	*/
	 ...
	 * the
	 * XY plane. The second height is used with the downwards pointing pyramid,
	 * so
	 ...
	 * to
	 * the truncation: given a body P, the operation dtdP and aP yield
	 * resembling
	 * results.
	...
	/**
	  ...
	  *some
	  *cases, this operation may be necessary to view the symmetry between
	  *related
	  *objects.
	  *	\sa scale
	  */
