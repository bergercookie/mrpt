...
public:
  ...
  void setLineCoords(float x0, float y0, float z0, float x1, float y1,
                     float z1) {
    m_x0 = x0;
    m_y0 = y0;
    m_z0 = z0;
  ...
  void getLineCoords(float &x0, float &y0, float &z0, float &x1, float &y1,
                     float &z1) const {
    x0 = m_x0;
    y0 = m_y0;
    z0 = m_z0;
  ...
  /** Class factory */
  static CSimpleLine::Ptr Create(float x0, float y0, float z0, float x1,
                                 float y1, float z1, float lineWidth = 1);
  ...
  /** Constructor
    */
  CSimpleLine(float x0 = 0, float y0 = 0, float z0 = 0, float x1 = 0,
              float y1 = 0, float z1 = 0, float lineWidth = 1,
              bool antiAliasing = true);

  /** Private, virtual destructor: only can be deleted from smart pointers */
  virtual ~CSimpleLine() {}
};
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CSimpleLine,
