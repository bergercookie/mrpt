...
public:
  ...
  struct OPENGL_IMPEXP TVertex {
    ...
    uint32_t m_u, m_v;   //!< 2D texture coordinates. Notice that the texture
                         //!coordinates are 2D pixels!!!
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CSetOfTexturedTriangles,
                                             CTexturedObject, OPENGL_IMPEXP)
