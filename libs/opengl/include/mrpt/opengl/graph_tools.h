...
/** Returns an opengl objects representation of an arbitrary graph, as a network
  ...
  *   </tr>
        ...
        *        <td> If set to !=0, draw a small 3D corner frame at each node
  *(see mrpt::opengl::stock_objects::CornerXYZSimple). </td>
        *        <td align="center" > 1 (do show) </td>
  *   </tr>
  *   <tr>
  ...
  *   </tr>
        ...
        *        <td> If show_node_corners!=0, the size (length) of te corner
  *lines. </td>
