...
protected:
  ...
  mutable bool pointsUpToDate; //!<Whether the coordinates of the points needs
                               //!to be recalculated
...
public:
  ...
  /** Class factory  */
  static CMeshFast::Ptr Create(bool enableTransparency, float xMin = -1.0f,
                               float xMax = 1.0f, float yMin = -1.0f,
                               float yMax = 1.0f);
  ...
  /** Constructor
    */
  CMeshFast(bool enableTransparency = false, float xMin = -1.0f,
            float xMax = 1.0f, float yMin = -1.0f, float yMax = 1.0f)
      : m_textureImage(0, 0), m_enableTransparency(enableTransparency),
        m_colorFromZ(false), m_isImage(false), X(0, 0), Y(0, 0), Z(0, 0),
        C(0, 0), C_r(0, 0), C_g(0, 0), C_b(0, 0),
        m_colorMap(mrpt::utils::cmJET), m_modified_Z(true),
        m_modified_Image(false), xMin(xMin), xMax(xMax), yMin(yMin), yMax(yMax),
        pointsUpToDate(false) {
    m_color.A = 255;
    m_color.R = 0;
    m_color.G = 0;
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CMeshFast,
