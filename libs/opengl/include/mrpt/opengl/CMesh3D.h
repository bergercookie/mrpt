...
class OPENGL_IMPEXP CMesh3D : public CRenderizableDisplayList
{
   ...
   protected:
	...
	mrpt::utils::TColormap
		m_colorMap;  // Not used yet. I leave it here in case I
   ...
   public:
	...
	/** Load a 3D mesh. The arguments indicate:
	   ...
	   The
	   xyz coordinates of each vertex must be consecutive in this array.
	  */
	void loadMesh(
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(
	CMesh3D, CRenderizableDisplayList, OPENGL_IMPEXP)
