...
struct OPENGL_IMPEXP TFontParams {
  TFontParams()
      : draw_shadow(false), font(MRPT_GLUT_BITMAP_NONE), vfont_name("sans"),
        vfont_scale(10), vfont_style(), vfont_spacing(1.5), vfont_kerning(0.1) {
  }
  ...
  double vfont_spacing;         //!< (default: 1.5) Refer to
                                //!mrpt::opengl::gl_utils::glDrawText
  double vfont_kerning;         //!< (default: 0.1) Refer to
                                //!mrpt::opengl::gl_utils::glDrawText
                                /** @} */
};
