...
public:
  ...
  /** Returns the i'th object of a given class (or of a descendant class), or
    ...
    */
  template <typename T> typename T::Ptr getByClass(const size_t &ith = 0) const;
  ...
  static CSetOfObjects::Ptr
  posePDF2opengl(const mrpt::poses::CPose3DQuatPDF &o);
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CSetOfObjects, CRenderizable,
                                             OPENGL_IMPEXP)
/** Inserts an object into the list. Allows call chaining.
  * \sa mrpt::opengl::CSetOfObjects::insert
  */
inline CSetOfObjects::Ptr &operator<<(CSetOfObjects::Ptr &s,
...
/** Inserts a set of objects into the list. Allows call chaining.
  ...
  */
template <class T>
inline CSetOfObjects::Ptr &operator<<(CSetOfObjects::Ptr &o,
