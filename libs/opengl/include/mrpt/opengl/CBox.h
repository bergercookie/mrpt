...
/** A solid or wireframe box in 3D, defined by 6 rectangular faces parallel to
  ...
  *	- Solid box with border: setWireframe(false) + enableBoxBorder(true).
  *Solid color is the CRenderizable color, border line can be set with
  *setBoxBorderColor().
  *
...
protected:
  ...
  bool m_draw_border; //!< Draw line borders to solid box with the given
                      //!linewidth (default: true)
...
public:
  ...
  static CBox::Ptr Create(const mrpt::math::TPoint3D &corner1,
                          const mrpt::math::TPoint3D &corner2,
                          bool is_wireframe = false, float lineWidth = 1.0);
  ...
  void setBoxCorners(const mrpt::math::TPoint3D &corner1,
                     const mrpt::math::TPoint3D &corner2);
  void getBoxCorners(mrpt::math::TPoint3D &corner1,
                     mrpt::math::TPoint3D &corner2) const {
  ...
  CBox(const mrpt::math::TPoint3D &corner1, const mrpt::math::TPoint3D &corner2,
       bool is_wireframe = false, float lineWidth = 1.0);
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CBox, CRenderizableDisplayList,
                                             OPENGL_IMPEXP)
}
}
#endif
