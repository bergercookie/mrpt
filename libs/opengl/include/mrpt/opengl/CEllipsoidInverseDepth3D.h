...
public:
  /** The maximum range to be used as a correction when a point of the ellipsoid
   * falls in the negative ranges (default: 1e6) */
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CEllipsoidInverseDepth3D,
