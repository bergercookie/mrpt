...
CBox::CBox()
    : m_corner_min(-1, -1, -1), m_corner_max(1, 1, 1), m_wireframe(false),
      m_lineWidth(1), m_draw_border(false), m_solidborder_color(0, 0, 0) {}

CBox::CBox(const mrpt::math::TPoint3D &corner1,
           const mrpt::math::TPoint3D &corner2, bool is_wireframe,
           float lineWidth)
    : m_wireframe(is_wireframe), m_lineWidth(lineWidth), m_draw_border(false),
...
void CBox::render_dl() const {
  ...
  if (m_wireframe || m_draw_border) {
    ...
    if (m_wireframe)
      ...
      glColor4ub(m_solidborder_color.R, m_solidborder_color.G,
...
void CBox::setBoxCorners(const mrpt::math::TPoint3D &corner1,
...
void CBox::getBoundingBox(mrpt::math::TPoint3D &bb_min,
