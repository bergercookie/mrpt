...
CGridPlaneXZ::Ptr CGridPlaneXZ::Create(float xMin, float xMax, float zMin,
                                       float zMax, float y, float frequency,
...
/** Constructor */
CGridPlaneXZ::CGridPlaneXZ(float xMin, float xMax, float zMin, float zMax,
                           float y, float frequency, float lineWidth,
                           bool antiAliasing)
    : m_xMin(xMin), m_xMax(xMax), m_zMin(zMin), m_zMax(zMax), m_plane_y(y),
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
void CGridPlaneXZ::writeToStream(mrpt::utils::CStream &out,
                                 int *version) const {
...
void CGridPlaneXZ::getBoundingBox(mrpt::math::TPoint3D &bb_min,
