...
/** Class factory  */
CArrow::Ptr CArrow::Create(float x0, float y0, float z0, float x1, float y1,
                           float z1, float headRatio, float smallRadius,
                           float largeRadius, float arrow_roll,
                           float arrow_pitch, float arrow_yaw) {
  return CArrow::Ptr(new CArrow(x0, y0, z0, x1, y1, z1, headRatio, smallRadius,
                                largeRadius, arrow_roll, arrow_pitch,
                                arrow_yaw));
}
/*---------------------------------------------------------------
                                                        render
...
void CArrow::render_dl() const {
  ...
  math::crossProduct3D(mat + 8, // 1st vector
                       mat + 0, // 2nd vector
...
void CArrow::getBoundingBox(mrpt::math::TPoint3D &bb_min,
