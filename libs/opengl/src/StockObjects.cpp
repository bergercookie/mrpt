...
CSetOfObjects::Ptr stock_objects::CornerXYZ(float scale) {
  ...
  CArrow::Ptr obj = CArrow::Create(0, 0, 0, scale, 0, 0, 0.25f * scale,
  ...
  obj = CArrow::Create(0, 0, 0, 0, scale, 0, 0.25f * scale, 0.02f * scale,
                       0.05f * scale);
  obj->setColor(0, 1, 0);

  ret->insert(obj);

  obj = CArrow::Create(0, 0, 0, 0, 0, scale, 0.25f * scale, 0.02f * scale,
                       0.05f * scale);
  obj->setColor(0, 0, 1);
...
CSetOfObjects::Ptr stock_objects::RobotRhodon() {
  ...
  CPolyhedron::Ptr obj1 = opengl::CPolyhedron::CreateCustomPrism(level1, 0.38);
  ...
  CPolyhedron::Ptr obj2 = opengl::CPolyhedron::CreateCustomPrism(level2, 0.35);
...
CSetOfObjects::Ptr stock_objects::RobotGiraff() {
  ...
  CPolyhedron::Ptr obj1 = opengl::CPolyhedron::CreateCustomPrism(level1, 0.23);
  obj1->setLocation(0, 0, height);
  height += 0.23f;
  ...
  CPolyhedron::Ptr obj2 = opengl::CPolyhedron::CreateCustomPrism(level2, 0.45);
  obj2->setLocation(0, 0, height);
  height += 0.45f;
  ...
  CPolyhedron::Ptr obj3 = opengl::CPolyhedron::CreateCustomPrism(level3, 0.55);
  obj3->setLocation(0, 0, height);
  height += 0.55f;
  obj3->setColor(0.6, 0.6, 0.6);
  ret->insert(obj3);
...
CSetOfObjects::Ptr stock_objects::BumblebeeCamera() {
  ...
  CPolyhedron::Ptr rect =
      opengl::CPolyhedron::CreateCubicPrism(-0.02, 0.14, -0.02, 0.02, 0, -0.04);
...
CSetOfObjects::Ptr stock_objects::CornerXYZSimple(float scale,
                                                  float lineWidth) {
  CSetOfObjects::Ptr ret = std::make_shared<CSetOfObjects>();
...
CSetOfObjects::Ptr stock_objects::Hokuyo_URG() {
  ...
  {
    CBox::Ptr base = std::make_shared<CBox>(TPoint3D(-0.025, -0.025, -0.0575),
...
CSetOfObjects::Ptr stock_objects::Hokuyo_UTM() {
  ...
  {
    CBox::Ptr base = std::make_shared<CBox>(TPoint3D(-0.03, -0.03, -0.055),
...
CSetOfObjects::Ptr stock_objects::Househam_Sprayer() {
  ...
  {
    CBox::Ptr cabin = std::make_shared<CBox>(TPoint3D(0.878, 0.723, -0.12),
                                             TPoint3D(-0.258, -0.723, -1.690));
    cabin->setColor(0.7, 0.7, 0.7);
    ret->insert(cabin);
  }
  {
    CBox::Ptr back = std::make_shared<CBox>(TPoint3D(-0.258, 0.723, -0.72),
  ...
  {
    CBox::Ptr boom1 = std::make_shared<CBox>(TPoint3D(-5.938, 0.723, -1.0),
                                             TPoint3D(-6.189, 11.277, -1.620));
    boom1->setColor(0, 1, 0);
    ret->insert(boom1);
  }
  {
    CBox::Ptr boom2 = std::make_shared<CBox>(TPoint3D(-5.938, -0.723, -1.0),
                                             TPoint3D(-6.189, -11.277, -1.620));
