...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
void CPointCloudColoured::writeToStream(mrpt::utils::CStream &out,
                                        int *version) const {
...
/*---------------------------------------------------------------
        Implements the reading from a CStream capability of
                CSerializable objects
  ---------------------------------------------------------------*/
void CPointCloudColoured::readFromStream(mrpt::utils::CStream &in,
                                         int version) {
  switch (version) {
  case 1:
  case 2: {
...
void CPointCloudColoured::push_back(float x, float y, float z, float R, float G,
                                    float B) {
...
void CPointCloudColoured::PLY_import_set_vertex(
  ...
  if (!pt_color)
    ...
    this->setPoint(idx, TPointColour(pt.x, pt.y, pt.z, pt_color->R, pt_color->G,
                                     pt_color->B));
}
