...
CSimpleLine::Ptr CSimpleLine::Create(float x0, float y0, float z0, float x1,
                                     float y1, float z1, float lineWidth) {
  return CSimpleLine::Ptr(new CSimpleLine(x0, y0, z0, x1, y1, z1, lineWidth));
}

CSimpleLine::CSimpleLine(float x0, float y0, float z0, float x1, float y1,
                         float z1, float lineWidth, bool antiAliasing)
    : m_x0(x0), m_y0(y0), m_z0(z0), m_x1(x1), m_y1(y1), m_z1(z1),
      m_lineWidth(lineWidth), m_antiAliasing(antiAliasing) {}
...
void CSimpleLine::getBoundingBox(mrpt::math::TPoint3D &bb_min,
