...
/*---------------------------------------------------------------
                                                        setLineByIndex
  ---------------------------------------------------------------*/
void CSetOfLines::setLineByIndex(size_t index,
...
void CSetOfLines::getBoundingBox(mrpt::math::TPoint3D &bb_min,
...
void CSetOfLines::getLineByIndex(size_t index, double &x0, double &y0,
