...
template <class GRAPH_T> THypothesis<GRAPH_T>::~THypothesis() {}
...
template <class GRAPH_T>
void THypothesis<GRAPH_T>::getAsString(std::string *str,
...
template <class GRAPH_T>
bool THypothesis<GRAPH_T>::hasEnds(mrpt::utils::TNodeID from_in,
...
template <class GRAPH_T> void THypothesis<GRAPH_T>::inverseHypothesis() {
