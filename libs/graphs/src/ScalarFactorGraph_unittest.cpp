...
struct MySimpleUnaryEdge : public ScalarFactorGraph::UnaryFactorVirtualBase {
  MySimpleUnaryEdge(vector<double> &parent, size_t nodeid, double observation,
                    double information)
      : m_parent(parent), m_observation(observation),
...
struct MySimpleBinaryEdge : public ScalarFactorGraph::BinaryFactorVirtualBase {
  MySimpleBinaryEdge(vector<double> &parent, size_t nodeid_i, size_t nodeid_j,
                     double information)
