...
public:
  ...
  bool setDataFormat(const CmtOutputMode outputMode,
  ...
  /*! \brief Return the data size.
          ...
          \param index The index of the item of which the size should be
     returned.
  */
  ...
  */
  ...
  //! Interpolate so resulting packet is (1-f)*pa + pb OR pb if pa and pb are
  //! non-matching types
