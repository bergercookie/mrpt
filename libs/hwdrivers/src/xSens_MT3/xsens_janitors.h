...
/*! \brief Value restoring janitor class
        ...
        This class can be used to make sure that the value that is in the
   variable at the time
        the janitor is created will be in it again when the janitor leaves
   scope.
*/
template <class T> class JanitorRestore {
private:
  T &m_control;
  T m_value;
  bool m_enabled;
...
/*! \brief Memory releasing janitor class
        ...
        This class can be used to make sure that the associated pointer is freed
   when the
        janitor leaves scope.
*/
template <class T> class JanitorFree {
private:
  T *m_control;
  bool m_enabled;
...
/*! \brief Memory releasing janitor class
        ...
        This class can be used to make sure that the associated object is
   deleted when the
        janitor leaves scope.
*/
template <class T> class JanitorDelete {
private:
  T *m_control;
  bool m_enabled;
...
/*! \brief Memory releasing janitor class
   ...
   deleted when the
        janitor leaves scope.
*/
template <class T> class JanitorDeleteArray {
private:
  T *m_control;
  bool m_enabled;
...
/*! \brief Class function calling janitor class
        ...
        This class can be used to make sure that the given class function is
   called when the
        janitor leaves scope.
*/
template <class T, typename R = void> class JanitorClassFunc {
public:
...
public:
  JanitorClassFunc<T, R>(T &control, t_func_JanitorClasssFunc func,
                         bool enabl = true)
...
/*! \brief Function calling janitor class
        ...
        This class can be used to make sure that the given function is called on
   the given
        object when the janitor leaves scope. Take care that the object is not
   of a type that
        is destroyed before the function unrolling begins.
*/
template <class T, typename R = void> class JanitorFunc {
public:
...
/*! \brief Log / printf-like function calling janitor class
        ...
        This class can be used to make sure that the given printf-like function
   is called with the
        supplied parameter when the janitor leaves scope. Take care that the
   object is not of a type that
        is destroyed before the function unrolling begins.
*/
template <class T, class C, typename R = void> class JanitorLogFunc {
public:
...
public:
  JanitorLogFunc<T, C, R>(t_func_JanitorLogFunc func, const char *str,
                          T &control, bool enable = true)
...
/*! \brief Function calling janitor class
   ...
   of a type that
        is destroyed before the function unrolling begins.
*/
template <class T, typename R = void> class JanitorFuncStdCall {
public:
...
public:
  JanitorFuncStdCall<T, R>(t_func_JanitorFuncStdCall func, T &control,
                           bool enabl = true)
...
/*! \brief Value restoring janitor class
   ...
   scope.
*/
template <class T> class JanitorSet {
private:
  T &m_control;
  T m_value;
  bool m_enabled;
