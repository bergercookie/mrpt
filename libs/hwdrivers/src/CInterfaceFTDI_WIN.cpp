...
void CInterfaceFTDI::loadDriver() {
  ...
  if (m_hmodule == nullptr)
    THROW_EXCEPTION("Error: Cannot load Ftd2xx.dll");
  ...
  m_pGetQueueStatus = (PtrToGetQueueStatus)GetProcAddress((HMODULE)m_hmodule,
                                                          "FT_GetQueueStatus");
...
void CInterfaceFTDI::ftdi_listDevices(void *pArg1, void *pArg2,
