...
typedef struct {
  uint32_t reserved; /**< unique ID used internally.  The meaning of values may
                        change without notice.  Don't touch or depend on the
                        contents of this field.  We mean it. */
  freenect_resolution resolution; /**< Resolution this freenect_frame_mode
  ...
  union {
    ...
    freenect_depth_format depth_format;
                    ...
                    describes.  The caller should know which of video_format or
...
typedef void (*freenect_log_cb)(freenect_context *dev, freenect_loglevel level,
                                const char *msg);
...
typedef void (*freenect_video_cb)(freenect_device *dev, void *video,
                                  uint32_t timestamp);
 ...
 */
FREENECTAPI freenect_raw_tilt_state *
 ...
 */
FREENECTAPI const freenect_frame_mode
freenect_find_video_mode(freenect_resolution res, freenect_video_format fmt);
 ...
 */
FREENECTAPI const freenect_frame_mode
freenect_find_depth_mode(freenect_resolution res, freenect_depth_format fmt);
