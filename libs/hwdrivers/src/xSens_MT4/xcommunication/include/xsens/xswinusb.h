...
typedef BOOL __stdcall WinUSB_ReadPipe(
...
typedef BOOL __stdcall WinUSB_WritePipe(
	WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID, PUCHAR Buffer,
	ULONG BufferLength, PULONG LengthTransferred, LPOVERLAPPED Overlapped);
...
typedef BOOL __stdcall WinUSB_ResetPipe(
	WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID);
typedef BOOL __stdcall WinUSB_AbortPipe(
	WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID);
typedef BOOL __stdcall WinUSB_FlushPipe(
	WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID);
