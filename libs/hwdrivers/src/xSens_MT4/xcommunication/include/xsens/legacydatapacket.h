...
public:
  ...
  bool setDataFormat(XsOutputMode outputMode, XsOutputSettings outputSettings,
                     int32_t index = 0);
  ...
  /*! \brief Return the Raw Gyroscope component of a data item.
          \param index The index of the item of which the data should be
     returned.
  ...
  */
  ...
  /*! \brief Return the Orientation component of a data item as an Orientation
     Matrix.
          \param index The index of the item of which the data should be
     returned.
          \returns The Orientation component of a data item as an Orientation
     Matrix.
  */
  ...
  */
  ...
  /*! \brief Return the Status component of a data item.
          \param index The index of the item of which the data should be
     returned.
          \param[out] outIsDetailed pointer to boolean. After call, the boolean
     is true if the status is detailed
  ...
  */
  ...
  /*! \brief Return the synhcronization time recorded by the station.
          \param channelID The synchronization channel number, where the output
     signal is connected.
...
private:
  ...
  mutable uint16_t
      m_lastFoundIndex;   //!< Index of last found deviceId, speeds up searches
  ...
  XsTimeStamp
      m_triggerIn1; //!< Trigger indication on line 1	\todo remove this
  XsTimeStamp
      m_triggerIn2; //!< Trigger indication on line 2	\todo remove this
};
