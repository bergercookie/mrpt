...
public:
  ...
  XsResultValue open(const XsPortInfo &portInfo, uint32_t readBufSize = 0,
  ...
  XsResultValue writeData(XsSize length, const void *data,
                          XsSize *written = nullptr);
  XsResultValue readData(XsSize maxLength, void *data,
                         XsSize *length = nullptr);
  XsResultValue waitForData(XsSize maxLength, void *data,
                            XsSize *length = nullptr);
  // lint +e1411
