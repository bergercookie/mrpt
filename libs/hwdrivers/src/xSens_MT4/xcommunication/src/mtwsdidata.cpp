...
MtwSdiData::MtwSdiData()
    : m_deviceId(0), m_timeSync(0), m_firstFrameNumber(0), m_lastFrameNumber(0),
      m_aidingData(0), m_barometer(0), m_rssi(0) {}

/*! \brief Construct a copy of \a other */
MtwSdiData::MtwSdiData(const MtwSdiData &other)
    : m_deviceId(other.m_deviceId), m_timeSync(other.m_timeSync),
      ...
      m_aidingData(other.m_aidingData), m_barometer(other.m_barometer),
      m_magnetoMeter(other.m_magnetoMeter), m_rssi(other.m_rssi) {}
...
inline bool MtwSdiData::empty() const { return !m_deviceId.toInt(); }
