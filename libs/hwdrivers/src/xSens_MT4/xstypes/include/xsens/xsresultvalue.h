...
enum XsResultValue {
  ...
  ,
  XRV_INITBUSFAIL2 =
      17 //!< 17: An incorrect answer received after WaitForSetBID
  ,
  XRV_INITBUSFAIL3 =
      18 //!< 18: After four bus-scans still undetected Motion Trackers
  ,
  XRV_SETBIDFAIL1 =
      20 //!< 20: No reply to SetBID message during SetBID procedure
  ,
  XRV_SETBIDFAIL2 = 21 //!< 21: Other than SetBIDAck received
  ,
  XRV_MEASUREMENTFAIL1 = 24 //!< 24: Timer overflow - period too short to
                            //!collect all data from Motion Trackers
  ,
  XRV_MEASUREMENTFAIL2 =
      25 //!< 25: Motion Tracker responds with other than SlaveData message
  ,
  XRV_MEASUREMENTFAIL3 = 26 //!< 26: Total bytes of data of Motion Trackers
                            //!including sample counter exceeds 255 bytes
  ,
  ...
  XRV_MEASUREMENTFAIL6 =
      29 //!< 29: No correct response from Motion Tracker during measurement
  ,
  ...
  XRV_MEASUREMENTFAIL8 =
      36 //!< 36: TX PC Buffer overflow, cannot fit full message
  ,
  XRV_DEVICEERROR =
      40 //!< 40: The device generated an error, try updating the firmware
  ,
  XRV_DATAOVERFLOW = 41 //!< 41: The device generates more data than the bus
                        //!communication can handle (baud rate may be too low)
  ,
  XRV_BUFFEROVERFLOW = 42 //!< 42: The sample buffer of the device was full
  ...
  ,
  XRV_NOTIMPLEMENTED =
      257 //!< 257: Operation not implemented in this version (yet)
  ,
  ...
  ,
  XRV_UNEXPECTEDMSG = 263 //!< 263: Unexpected message received (e.g. no
  ...
  XRV_INPUTCANNOTBEOPENED =
      267 //!< 267: The specified i/o device can not be opened
  ,
  XRV_OUTPUTCANNOTBEOPENED =
      268 //!< 268: The specified i/o device can not be opened
  ,
  XRV_ALREADYOPEN =
      269 //!< 269: An I/O device is already opened with this object
  ,
  XRV_ENDOFFILE = 270 //!< 270: End of file is reached
  ,
  XRV_COULDNOTREADSETTINGS = 271 //!< 271: A required settings file could not be
                                 //!opened or is missing some data
  ,
  ...
  ,
  XRV_NULLPTR =
      274 //!< 274: Tried to supply a nullptr value where it is not allowed
  ,
  XRV_INSUFFICIENTDATA =
      275 //!< 275: Insufficient data was supplied to a function
  ,
  ...
  ,
  XRV_DATACORRUPT =
      278 //!< 278: A trusted data stream proves to contain corrupted data
  ...
  XRV_MTLOCATIONINVALID =
      283 //!< 283: One or more sensors are not where they were expected
  ,
  XRV_INSUFFICIENTMTS = 284 //!< 284: Not enough sensors were found
  ,
  XRV_INITFUSIONFAILED =
      285 //!< 285: Failure during initialization of Fusion Engine
  ,
  ...
  XRV_NOFILEORPORTOPEN =
      289 //!< 289: No file or serial port opened for reading/writing
  ,
  XRV_PORTNOTFOUND = 290 //!< 290: A required port could not be found
  ,
  XRV_INITPORTFAILED =
      291 //!< 291: The low-level port handler failed to initialize
  ,
  ...
  ,
  XRV_ALREADYDONE =
      294 //!< 294: The operation is once only and has already been performed

  ,
  XRV_SYNC_SINGLE_SLAVE =
      295 //!< 295: The single connected device is configured as a slave
  ,
  XRV_SYNC_SECOND_MASTER = 296 //!< 296: More than one master was detected
  ,
  XRV_SYNC_NO_SYNC =
      297 //!< 297: A device was detected that was neither master nor slave
  ,
  ...
  ,
  XRV_VERSION_TOO_LOW = 300 //!< 300: The version of the object is too low for
                            //!the requested operation
  ,
  XRV_VERSION_PROBLEM = 301 //!< 301: The object has an unrecognized version, so
                            //!it's not safe to perform the operation

  ,
  XRV_ABORTED = 302 //!< 302: The process was aborted by an external event,
                    //!usually a user action or process termination
  ,
  XRV_UNSUPPORTED =
      303 //!< 303: The requested functionality is not supported by the device

  ,
  XRV_PACKETCOUNTERMISSED = 304 //!< 304: A packet counter value was missed

  ,
  XRV_MEASUREMENTFAILED = 305 //!< 305: An error occured while trying to put the
