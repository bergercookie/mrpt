...
struct XsSyncSetting {
  ...
  explicit XsSyncSetting(XsSyncLine line = XSL_Invalid,
                         ...
                         uint32_t pulseWidth = 1000, int32_t offset = 0,
                         uint16_t skipFirst = 0, uint16_t skipFactor = 0,
                         uint16_t clockPeriod = 0, uint8_t triggerOnce = 0)
      : m_line(line), m_function(function), m_polarity(polarity),
        m_pulseWidth(pulseWidth), m_offset(offset), m_skipFirst(skipFirst),
        m_skipFactor(skipFactor), m_clockPeriod(clockPeriod),
  ...
  inline bool operator==(const XsSyncSetting &other) const {
    return (this == &other) ||
           (m_line == other.m_line && m_function == other.m_function &&
            ...
            m_pulseWidth == other.m_pulseWidth && m_offset == other.m_offset &&
