...
struct XsGpsPvtData {
  uint16_t m_pressure; //!< The pressure measurement in units of 2 Pascal, only
                       //!valid if m_pressureAge is not 255
  uint8_t m_pressureAge; //!< The age of the pressure measurement in packets.
                         //!When it decreases relative to the previous packet,
                         //!it indicates that new data is available.
  ...
  uint32_t m_hacc;  //!< Horizontal accuracy estimate, expected error standard
                    //!deviation in mm
  uint32_t m_vacc;  //!< Vertical accuracy estimate, expected error standard
                    //!deviation in mm
  uint32_t m_sacc;  //!< Speed accuracy estimate, expected error standard
                    //!deviation in cm/s
  uint8_t m_gpsAge; //!< The age of the GPS measurement in packets. When it
                    //!decreases relative to the previous packet, it indicates
