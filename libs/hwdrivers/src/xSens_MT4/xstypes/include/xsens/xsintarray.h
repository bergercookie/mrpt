...
XSTYPES_DLL_API void XsIntArray_construct(
	XsIntArray* thisPtr, XsSize count, int const* src);
#else
}  // extern "C"
#endif
...
struct XsIntArray : public XsArrayImpl<int, g_xsIntArrayDescriptor, XsIntArray>
{
	...
	//! ref
	inline explicit XsIntArray(
		int* ref, XsSize sz, XsDataFlags flags = XSDF_None)
