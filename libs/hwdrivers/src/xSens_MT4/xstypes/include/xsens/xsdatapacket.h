...
#define XSDATAPACKET_INITIALIZER                                               \
  {                                                                            \
    XSMESSAGE_INITIALIZER, XSMESSAGE_INITIALIZER, XSDEVICEID_INITIALIZER,      \
        XDI_None, -1, 0, 0, XSTIMESTAMP_INITIALIZER, XSTIMESTAMP_INITIALIZER   \
  }
#endif
...
XSTYPES_DLL_API void XsDataPacket_setMessage(XsDataPacket *thisPtr,
                                             const XsMessage *msg);
XSTYPES_DLL_API XsMessage *
XsDataPacket_originalMessage(const XsDataPacket *thisPtr, XsMessage *returnVal);
...
XSTYPES_DLL_API XsUShortVector *
XsDataPacket_rawAcceleration(const XsDataPacket *thisPtr,
                             XsUShortVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsRawAcceleration(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void XsDataPacket_setRawAcceleration(XsDataPacket *thisPtr,
                                                     const XsUShortVector *vec);
XSTYPES_DLL_API XsUShortVector *
XsDataPacket_rawGyroscopeData(const XsDataPacket *thisPtr,
                              XsUShortVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsRawGyroscopeData(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setRawGyroscopeData(XsDataPacket *thisPtr,
                                 const XsUShortVector *vec);
XSTYPES_DLL_API XsUShortVector *
XsDataPacket_rawGyroscopeTemperatureData(const XsDataPacket *thisPtr,
                                         XsUShortVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsRawGyroscopeTemperatureData(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setRawGyroscopeTemperatureData(XsDataPacket *thisPtr,
                                            const XsUShortVector *vec);
XSTYPES_DLL_API XsUShortVector *
XsDataPacket_rawMagneticField(const XsDataPacket *thisPtr,
                              XsUShortVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsRawMagneticField(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setRawMagneticField(XsDataPacket *thisPtr,
                                 const XsUShortVector *vec);
XSTYPES_DLL_API uint16_t
XsDataPacket_rawTemperature(const XsDataPacket *thisPtr);
XSTYPES_DLL_API int
XsDataPacket_containsRawTemperature(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API XsVector *
XsDataPacket_calibratedAcceleration(const XsDataPacket *thisPtr,
                                    XsVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsCalibratedAcceleration(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setCalibratedAcceleration(XsDataPacket *thisPtr,
                                       const XsVector *vec);
XSTYPES_DLL_API XsVector *
XsDataPacket_calibratedGyroscopeData(const XsDataPacket *thisPtr,
                                     XsVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsCalibratedGyroscopeData(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setCalibratedGyroscopeData(XsDataPacket *thisPtr,
                                        const XsVector *vec);
XSTYPES_DLL_API XsVector *
XsDataPacket_calibratedMagneticField(const XsDataPacket *thisPtr,
                                     XsVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsCalibratedMagneticField(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setCalibratedMagneticField(XsDataPacket *thisPtr,
                                        const XsVector *vec);
XSTYPES_DLL_API XsCalibratedData *
XsDataPacket_calibratedData(const XsDataPacket *thisPtr,
                            XsCalibratedData *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsCalibratedData(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setCalibratedData(XsDataPacket *thisPtr,
                               const XsCalibratedData *data);
XSTYPES_DLL_API XsQuaternion *
XsDataPacket_orientationQuaternion(const XsDataPacket *thisPtr,
                                   XsQuaternion *returnVal,
                                   XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API void
XsDataPacket_setOrientationQuaternion(XsDataPacket *thisPtr,
                                      const XsQuaternion *data,
                                      XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API XsEuler *
XsDataPacket_orientationEuler(const XsDataPacket *thisPtr, XsEuler *returnVal,
                              XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API void
XsDataPacket_setOrientationEuler(XsDataPacket *thisPtr, const XsEuler *data,
                                 XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API XsMatrix *
XsDataPacket_orientationMatrix(const XsDataPacket *thisPtr, XsMatrix *returnVal,
                               XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API void
XsDataPacket_setOrientationMatrix(XsDataPacket *thisPtr, const XsMatrix *data,
                                  XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API int
XsDataPacket_containsOrientation(const XsDataPacket *thisPtr);
XSTYPES_DLL_API XsDataIdentifier
...
XSTYPES_DLL_API int
XsDataPacket_containsStatusByte(const XsDataPacket *thisPtr);
XSTYPES_DLL_API int
XsDataPacket_containsDetailedStatus(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsPacketCounter8(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsPacketCounter(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsSampleTimeFine(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsSampleTimeCoarse(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsSampleTime64(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void XsDataPacket_setSampleTime64(XsDataPacket *thisPtr,
                                                  uint64_t counter);
XSTYPES_DLL_API XsVector *
XsDataPacket_freeAcceleration(const XsDataPacket *thisPtr, XsVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsFreeAcceleration(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsTemperature(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void XsDataPacket_setTemperature(XsDataPacket *thisPtr,
                                                 double temp);
XSTYPES_DLL_API XsGpsPvtData *
XsDataPacket_gpsPvtData(const XsDataPacket *thisPtr, XsGpsPvtData *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsGpsPvtData(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API int
XsDataPacket_containsPressureAge(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void XsDataPacket_setPressure(XsDataPacket *thisPtr,
                                              const XsPressure *data);
XSTYPES_DLL_API XsAnalogInData *
XsDataPacket_analogIn1Data(const XsDataPacket *thisPtr,
                           XsAnalogInData *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsAnalogIn1Data(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void XsDataPacket_setAnalogIn1Data(XsDataPacket *thisPtr,
                                                   const XsAnalogInData *data);
XSTYPES_DLL_API XsAnalogInData *
XsDataPacket_analogIn2Data(const XsDataPacket *thisPtr,
                           XsAnalogInData *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsAnalogIn2Data(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API XsVector *XsDataPacket_positionLLA(const XsDataPacket *thisPtr,
                                                   XsVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsPositionLLA(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void XsDataPacket_setPositionLLA(XsDataPacket *thisPtr,
                                                 const XsVector *data);
XSTYPES_DLL_API XsVector *
XsDataPacket_latitudeLongitude(const XsDataPacket *thisPtr,
                               XsVector *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsLatitudeLongitude(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API void XsDataPacket_setAltitude(XsDataPacket *thisPtr,
                                              double data);
XSTYPES_DLL_API XsVector *
XsDataPacket_velocity(const XsDataPacket *thisPtr, XsVector *returnVal,
                      XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API int XsDataPacket_containsVelocity(const XsDataPacket *thisPtr);
XSTYPES_DLL_API void
XsDataPacket_setVelocity(XsDataPacket *thisPtr, const XsVector *data,
                         XsDataIdentifier coordinateSystem);
XSTYPES_DLL_API XsDataIdentifier
...
XSTYPES_DLL_API XsRange *XsDataPacket_frameRange(const XsDataPacket *thisPtr,
                                                 XsRange *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsFrameRange(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API XsRawGpsTimeUtc *
XsDataPacket_rawGpsTimeUtc(const XsDataPacket *thisPtr,
                           XsRawGpsTimeUtc *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsRawGpsTimeUtc(const XsDataPacket *thisPtr);
XSTYPES_DLL_API XsRawGpsSvInfo *
XsDataPacket_rawGpsSvInfo(const XsDataPacket *thisPtr,
                          XsRawGpsSvInfo *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsRawGpsSvInfo(const XsDataPacket *thisPtr);
...
XSTYPES_DLL_API XsTriggerIndicationData *
XsDataPacket_triggerIndication(XsDataPacket const *thisPtr,
                               XsDataIdentifier triggerId,
                               XsTriggerIndicationData *returnVal);
XSTYPES_DLL_API int
XsDataPacket_containsTriggerIndication(XsDataPacket const *thisPtr,
                                       XsDataIdentifier triggerId);
...
struct XsDataPacket {
  ...
  */
  explicit XsDataPacket(const XsMessage *msg = 0)
      : m_lastFoundId(XDI_None), m_lastFoundOffset(-1), m_itemCount(0),
        m_originalMessageLength(0), m_toa(0), m_packetId(0) {
  ...
  */
  ...
  /*! \brief Return the offset that was last returned by itemOffsetLoose or
     itemOffsetExact
          \details When the last search didn't find anything, -1 will be
     returned.
  ...
  */
  ...
  inline XsQuaternion
  orientationQuaternion(XsDataIdentifier coordinateSystem) const {
    XsQuaternion returnVal;
    return *XsDataPacket_orientationQuaternion(this, &returnVal,
                                               coordinateSystem);
  }

  /*! \brief returns the orientation as a quaternion with the current coordinate
   * system*/
  ...
  inline void setOrientationQuaternion(const XsQuaternion &data,
                                       XsDataIdentifier coordinateSystem) {
  ...
  inline XsEuler orientationEuler() const {
    XsEuler returnVal;
    return *XsDataPacket_orientationEuler(this, &returnVal,
                                          coordinateSystemOrientation());
  }

  /*! \brief \copybrief XsDataPacket_setOrientationEuler */
  inline void setOrientationEuler(const XsEuler &data,
                                  XsDataIdentifier coordinateSystem) {
  ...
  inline XsMatrix orientationMatrix() const {
    XsMatrix returnVal;
    return *XsDataPacket_orientationMatrix(this, &returnVal,
                                           coordinateSystemOrientation());
  }

  /*! \brief \copybrief XsDataPacket_setOrientationMatrix */
  inline void setOrientationMatrix(const XsMatrix &data,
                                   XsDataIdentifier coordinateSystem) {
  ...
  inline void setAltitude(double data) { XsDataPacket_setAltitude(this, data); }
  ...
  inline void setVelocity(const XsVector &data,
                          XsDataIdentifier coordinateSystem) {
  ...
  /*! \brief Return the time of arrival of the data packet. Only valid for live
   * streams. The behaviour for file streams is undefined and may change in the
   * future. */
  ...
  */
  ...
  void
  setTriggerIndication(XsDataIdentifier triggerId,
                       XsTriggerIndicationData const &triggerIndicationData) {
  ...
  /*! \brief Returns the trigger indication data of a packet
      \details
          If the packet does not contain the requested data, the return val
     struct will be set to all zeroes
...
/*! \privatesection */
  ...
  XsMessage m_legacyMsg; //!< Optional legacy MtData message as received (for
                         //!logging the received data only)
  XsDeviceId m_deviceId; //!< The device Id to which the message belongs
  XsDataIdentifier
      m_lastFoundId;     //!< Last found data identifer, speeds up searches
  int m_lastFoundOffset; //!< Offset of last found data identifier, speeds up
                         //!searches
  ...
  XsTimeStamp m_packetId; //!< 64 bit packet id, based on, depending on
                          //!availability: (1) packet counter (2) sample time
                          //!(3) arrival order
};
