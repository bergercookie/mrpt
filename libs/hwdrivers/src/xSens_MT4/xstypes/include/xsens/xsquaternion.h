...
XsQuaternion_fromRotationMatrix(XsQuaternion *thisPtr,
...
public:
  ...
  //! default
  inline explicit XsQuaternion(XsReal w = XsMath_zero, XsReal x = XsMath_zero,
                               XsReal y = XsMath_zero, XsReal z = XsMath_zero)
  ...
  */
  ...
  //! \brief Normalized the quaternion \sa XsQuaternion_normalized \returns The
  //! cartesian length of the quaternion before normalization
...
inline XsQuaternion operator*(const XsQuaternion &lhs,
                              const XsQuaternion &rhs) {
