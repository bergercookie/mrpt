...
#ifdef _WIN32
//#			pragma message("XSTYPES_DLL_API export in
//xstypesconfig.h")
#define XSTYPES_DLL_API __declspec(dllexport)
#else
//#			pragma message("XSTYPES_DLL_API linux export in
//xstypesconfig.h")
#define XSTYPES_DLL_API __attribute__((visibility("default")))
#endif
#else // ifdef XSTYPES_DLL_EXPORT
#ifdef XSTYPES_STATIC_LIB
//#			pragma message("XSTYPES_DLL_API static in
//xstypesconfig.h")
#define XSTYPES_DLL_API
#else
#ifdef _WIN32
//#				pragma message("XSTYPES_DLL_API import in
//xstypesconfig.h")
#define XSTYPES_DLL_API __declspec(dllimport)
#else
//#				pragma message("XSTYPES_DLL_API import/static for
//linux in xstypesconfig.h")
#define XSTYPES_DLL_API
#endif
#endif
