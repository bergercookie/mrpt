...
struct XsArrayDescriptor
{
   ...
   protected:
	 ...
	 * simple
	 * types. \param e Pointer to item to construct. */
...
{  // MRPT
	...
	*/
	 ...
	 * the
	 * array after this operation are undefined. \param count The desired new
	 * size
	 ...
	 * slightly
	 * from a straight check for size() != 0 in that it also works for
	 * fixed-size
