...
XSTYPES_DLL_API int
XsDeviceId_isXbusMasterMotionTracker(struct XsDeviceId const *thisPtr);
XSTYPES_DLL_API int
XsDeviceId_isWirelessMaster(struct XsDeviceId const *thisPtr);
...
XSTYPES_DLL_API int
XsDeviceId_isAwindaStation(struct XsDeviceId const *thisPtr);
...
XSTYPES_DLL_API int
XsDeviceId_containsBroadcast(struct XsDeviceId const *thisPtr);
...
struct XsDeviceId {
#ifdef __cplusplus
  /*! \brief Constructor that creates an XsDeviceId from the supplied \a
   * deviceId */
  inline XsDeviceId(uint32_t deviceId = 0) : m_deviceId(deviceId) {}
  /*! \brief Constructor that creates an XsDeviceId from the supplied XsDeviceId
   * \a other */
  inline XsDeviceId(const XsDeviceId &other) : m_deviceId(other.m_deviceId) {}
  ...
  inline uint32_t toInt() const { return m_deviceId; }
  ...
  inline bool isValid() const { return 0 != XsDeviceId_isValid(this); }
  ...
  inline bool isMtw() const { return 0 != XsDeviceId_isMtw(this); }
  /*! \brief \copybrief XsDeviceId_isMtix */
  inline bool isMtix() const { return 0 != XsDeviceId_isMtix(this); }
  ...
  inline bool isMtig() const { return 0 != XsDeviceId_isMtig(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4 */
  inline bool isMtMk4() const { return 0 != XsDeviceId_isMtMk4(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_X0 */
  inline bool isMtMk4_X0() const { return 0 != XsDeviceId_isMtMk4_X0(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_10 */
  inline bool isMtMk4_10() const { return 0 != XsDeviceId_isMtMk4_10(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_20 */
  inline bool isMtMk4_20() const { return 0 != XsDeviceId_isMtMk4_20(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_30 */
  inline bool isMtMk4_30() const { return 0 != XsDeviceId_isMtMk4_30(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_X00 */
  inline bool isMtMk4_X00() const { return 0 != XsDeviceId_isMtMk4_X00(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_100 */
  inline bool isMtMk4_100() const { return 0 != XsDeviceId_isMtMk4_100(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_200 */
  inline bool isMtMk4_200() const { return 0 != XsDeviceId_isMtMk4_200(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_300 */
  inline bool isMtMk4_300() const { return 0 != XsDeviceId_isMtMk4_300(this); }
  /*! \brief \copybrief XsDeviceId_isMtMk4_700 */
  inline bool isMtMk4_700() const { return 0 != XsDeviceId_isMtMk4_700(this); }
  /*! \brief \copybrief XsDeviceId_isMtw2 */
  inline bool isMtw2() const { return 0 != XsDeviceId_isMtw2(this); }
  /*! \brief \copybrief XsDeviceId_isMtx2 */
  inline bool isMtx2() const { return 0 != XsDeviceId_isMtx2(this); }
  ...
  inline bool isAwindaOem() const { return 0 != XsDeviceId_isAwindaOem(this); }
  ...
  inline bool isBroadcast() const { return 0 != XsDeviceId_isBroadcast(this); }
  ...
  /*! \brief Returns true if this deviceId is less or equal to the \a other
   * deviceId */
  inline bool operator<=(const XsDeviceId &other) const {
    return m_deviceId <= other.m_deviceId;
  }
  ...
  /*! \brief Returns true if this deviceId is larger or equal to the \a other
   * deviceId */
  inline bool operator>=(const XsDeviceId &other) const {
    return m_deviceId >= other.m_deviceId;
  }

  /*! \brief Creates and returns a XsDeviceId representing the broadcast
   * deviceId */
  static XsDeviceId broadcast() { return XsDeviceId(XsDeviceId_broadcast()); }
