...
XSTYPES_DLL_API void XsInt64Array_construct(
	XsInt64Array* thisPtr, XsSize count, int64_t const* src);
...
#ifdef __cplusplus
struct XsInt64Array
	: public XsArrayImpl<int64_t, g_xsInt64ArrayDescriptor, XsInt64Array>
{
	...
	inline XsInt64Array(XsInt64Array const& other) : ArrayImpl(other) {}
	//! \brief Constructs an XsInt64Array that references the data supplied in
	//! \a
	//! ref
	inline explicit XsInt64Array(
		int64_t* ref, XsSize sz, XsDataFlags flags = XSDF_None)
		: ArrayImpl(ref, sz, flags)
	{
	}

#ifndef XSENS_NOITERATOR
	//! \brief Constructs an XsInt64Array with the array bound by the supplied
