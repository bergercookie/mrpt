...
#define XsSyncSettingList_assign(thisPtr, size, src) \
	XsArray_assign(thisPtr, size, src)
#define XsSyncSettingList_construct(thisPtr, size, src) \
	XsSyncSettingArray_construct(thisPtr, size, src)
...
#define XsSyncSettingList_popFront(thisPtr, count) \
	XsArray_erase(thisPtr, 0, count)
#define XsSyncSettingList_popBack(thisPtr, count) \
	XsArray_erase(thisPtr, (XsSize)-1, count)
#define XsSyncSettingList_swap(a, b) XsArray_swap(a, b)
#define XsSyncSettingList_erase(thisPtr, index, count) \
