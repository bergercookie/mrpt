...
enum XsSyncLine {
  XSL_Inputs,
  XSL_In1 = XSL_Inputs, /*!< \brief Sync In 1 \remark Applies to Awinda Station
                           and Mt */
  ...
  XSL_ExtTimepulseIn, /*!< \brief External time pulse input (e.g. for external
                         GPS unit) \remark Applies to Mk4 with external device*/
  XSL_ReqData, /*!< \brief Serial data sync option, use \a XMID_ReqData message
                  id for this \remark Applies to Mk4*/
  XSL_Outputs,
  XSL_Out1 = XSL_Outputs, /*!< \brief Sync Out 1 \remark Applies to Awinda
                             Station and Mt */
  XSL_Out2,   /*!< \brief Sync Out 2 \remark Applies to Awinda Station */
  XSL_Bi1Out, /*!< \brief Bidirectional Sync 1 Out \remark Applies to Xbus
                 Master */
