...
struct XsPortInfoArray
  ...
  //! \brief Constructs an XsPortInfoArray that references the data supplied in
  //! \a ref
  inline explicit XsPortInfoArray(XsPortInfo *ref, XsSize sz,
                                  XsDataFlags flags = XSDF_None)
      : ArrayImpl(ref, sz, flags) {}

#ifndef XSENS_NOITERATOR
  //! \brief Constructs an XsPortInfoArray with the array bound by the supplied
