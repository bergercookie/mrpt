...
struct XsDeviceIdArray
  ...
  //! \brief Constructs an XsDeviceIdArray that references the data supplied in
  //! \a ref
  inline explicit XsDeviceIdArray(XsDeviceId *ref, XsSize sz,
                                  XsDataFlags flags = XSDF_None)
      : ArrayImpl(ref, sz, flags) {}
#ifndef XSENS_NOITERATOR
  //! \brief Constructs an XsDeviceIdArray with the array bound by the supplied
