...
struct XsUtcTime {
  ...
  uint8_t m_valid;  //!< \brief Validity indicator \details When set to 1, the
                    //!time is valid, when set to 2, the time part is valid, but
                    //!the date may not be valid. when set to 0, the time is
