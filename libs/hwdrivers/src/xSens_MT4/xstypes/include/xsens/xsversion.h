...
struct XsVersion {
  ...
  explicit XsVersion(int maj = 0, int min = 0, int rev = 0, int bld = 0,
                     const XsString &extra = XsString())
      : m_major(maj), m_minor(min), m_revision(rev), m_build(bld),
        m_extra(extra) {}
  ...
  XsVersion(const XsVersion &other)
      : m_major(other.m_major), m_minor(other.m_minor),
        m_revision(other.m_revision), m_build(other.m_build),
