...
public:
  ...
  /*! \brief Initializing constructor
     ...
     description to create a full
          ...
          \param description A description of the error. The constructor
     prefixes this with a textual
                                                  description of the error code
     unless prefix is false.
          \param prefix Whether to prefix the description with a textual
     description of the error code or not (default is yes)
  */
...
private:
  ...
  XsString m_description; //!< The supplied description, prefixed with a
                          //!description of the error code
};
