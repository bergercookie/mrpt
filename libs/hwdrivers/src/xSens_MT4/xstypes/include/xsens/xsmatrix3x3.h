...
XSTYPES_DLL_API void XsMatrix3x3_assign(
	XsMatrix3x3* thisPtr, const XsReal* src, XsSize srcStride);
...
struct XsMatrix3x3
{
   ...
   public:
	...
	XsMatrix3x3(
		XsReal r1c1, XsReal r1c2, XsReal r1c3, XsReal r2c1, XsReal r2c2,
