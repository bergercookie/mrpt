...
/*! \relates XsAtomicInt \brief Increase the value by one unit (prefix
 * notation). */
#define XsAtomicInt_preIncrement(a)                                            \
  ((XsAtomicIntValue)atomicIncrement((a)->m_value))

/*! \relates XsAtomicInt \brief Decrease the value by one unit (prefix
 * notation). */
#define XsAtomicInt_preDecrement(a)                                            \
  ((XsAtomicIntValue)atomicDecrement((a)->m_value))

/*! \relates XsAtomicInt \brief Increase the value by one unit (postfix
 * notation). */
#define XsAtomicInt_postIncrement(a)                                           \
  ((XsAtomicIntValue)atomicIncrement((a)->m_value) - 1)

/*! \relates XsAtomicInt \brief Decrease the value by one unit (postfix
 * notation). */
#define XsAtomicInt_postDecrement(a)                                           \
  ((XsAtomicIntValue)atomicDecrement((a)->m_value) + 1)
...
struct XsAtomicInt {
  ...
  XsAtomicInt(XsAtomicIntValue val = 0) : m_value(val) {}

  /*! \brief Set the value to the given \a val. */
  inline void setValue(XsAtomicIntValue val) { m_value = val; }

  /*! \brief Get the current value. */
  inline XsAtomicIntValue value() const { return (XsAtomicIntValue)m_value; }
