 ...
 *namespace. This file
 *	   includes all the other ones, so user applications must include just
 *this one
...
MRPT_WARNING("Including <mrpt/hwdrivers.h> makes compilation much slower, "
             "consider including only what you need (define "
             "MRPT_NO_WARN_BIG_HDR to disable this warning)")
#endif
