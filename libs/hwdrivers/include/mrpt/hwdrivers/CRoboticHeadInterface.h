 ...
 * etc...)
  ...
  */
class HWDRIVERS_IMPEXP CRoboticHeadInterface
...
public:
  ...
  /** Read the gain for the amplifier of the ear "channel", where channel is 0,
   * 1 or 2.
    */
  ...
  /** This function return the angle where last sound where detected. This angle
   * is related to the robot pose, NOT head pose.
    * \code
  ...
  /** Debug only!!! This function return the last 500 acquired samples for each
   * sound channel.
    *
    */
