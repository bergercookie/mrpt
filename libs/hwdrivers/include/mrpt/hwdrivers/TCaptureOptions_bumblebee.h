...
struct HWDRIVERS_IMPEXP TCaptureOptions_bumblebee {
  ...
  bool color; //!< Indicates if the Bumblebee camera must capture color images
              //!(Default: false -> grayscale)
  bool getRectified; //!< Indicates if the Bumblebee camera must capture
                     //!rectified images (Default: true -> rectified)
