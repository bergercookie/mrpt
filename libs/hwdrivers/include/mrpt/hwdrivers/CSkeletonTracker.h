...
/** A class for grabbing mrpt::obs::CObservationSkeleton from a PrimeSense
  ...
  *	   sensorLabel		= <label>			; Label of the
  *sensor
  *	   grab_decimation	= 1					; [int] Grab
  *skeletons in 1 out of 'grab_decimation' frames.
  *    show_preview		= 1					; [bool] {0,1} Opens a
  *display window to show the recorded skeleton.
  *    pose_x			= 0					; [double] Sensor 3D
  *position relative to the robot (meters)
  *    pose_y			= 0
  *    pose_z			= 0
...
protected:
  ...
  std::vector<double>
      m_joint_theta; //!< Joint angles when no skeleton has been detected
