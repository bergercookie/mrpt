...
//  HWDRIVERS_IMPEXP, mrpt_xxx_EXPORTS

/*   The macros below for DLL import/export are required for Windows only.
    Mostly all the definitions in this file are copied or at least hwdriversd
...
#define HWDRIVERS_IMPEXP MRPT_HWDRIVERS_EXPORT
#else /* Using the DLL */
#define HWDRIVERS_IMPEXP MRPT_HWDRIVERS_IMPORT
#endif
