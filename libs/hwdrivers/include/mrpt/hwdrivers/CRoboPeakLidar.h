...
public:
  ...
  virtual void initialize(); //!< Attempts to connect and turns the laser on.
  ...
  void disconnect(); //!< Closes the comms with the laser. Shouldn't have to be
                     //!directly needed by the user
