...
/** A class for interfacing Intersense Inertial Measuring Units (IMUs).
  ...
  *    pose_x		= 0					; [double] Sensor 3D position relative
  *to
  *the
  *robot
  *(meters)
  ...
  *    pose_roll	= 0
  *
  *	   sensitivity	= 10				; [int] Sensor sensitivity (see API
  *documentation)
  *	   enhancement	= 2					; [int] Enhancement mode (see API
  *documentation)
  *	   prediction	= 0					; [int] Prediction mode (see API
  *documentation)
  *	   useBuffer	= 0					; [bool] {0,1} (unused by now) Whether
  *or
  *not
  *use
  *a
  *buffer for storing old data (see API documentation)
  *
  *  \endcode
