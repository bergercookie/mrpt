...
* can pass to the class's constructor the Lux's ip address and port.
        *   Device will NOT be configured. Configuration has to be done
* seperately.
        *
...
public:
   ...
   * Adress and TCP Port of your device.
          */
  CIbeoLuxETH(std::string _ip = std::string("10.152.36.93"),
...
private:
  ...
  mrpt::poses::CPoint3D convertToCartesian(float vrad, float hrad,
                                           float distance);
  float vwinkel;
