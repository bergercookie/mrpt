...
public:
  ...
  CStereoGrabber_Bumblebee_libdc1394(uint64_t cameraGUID, uint16_t cameraUnit,
                                     double frameRate);

  CStereoGrabber_Bumblebee_libdc1394(
      const CStereoGrabber_Bumblebee_libdc1394 &) = delete;
  CStereoGrabber_Bumblebee_libdc1394 &
  operator=(const CStereoGrabber_Bumblebee_libdc1394 &) = delete;
...
protected:
  mrpt::hwdrivers::CImageGrabber_dc1394
      *m_firewire_capture; //!< The actual capture object used in Linux / Mac.
