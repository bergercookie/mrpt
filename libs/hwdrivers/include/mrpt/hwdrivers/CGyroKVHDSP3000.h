...
*gather data from the scanner.
  *	 The generated observation is a CObservationIMU, but only the yaw
*angular velocity and the absolute yaw position are
...
public:
  ...
  /** Turns on the KVH DSP 3000 device and configure it for getting orientation
   * data. you must have called loadConfig_sensorSpecific before
