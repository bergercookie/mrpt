...
struct HWDRIVERS_IMPEXP TCaptureOptions_DUO3D
{
	...
	/** Loads all the options from a config file.
	  ...
	  *WWW being the image width and HHH the image height, as provided by the
	  *calibration application.
	  *		rectify_map_filename	= ""			// [string]	Rectification
	  *map
...
/** This "software driver" implements the communication protocol for interfacing
  ...
  *(if
  *available)
  *		calibration_from_file	= true			// [bool]	Use YML calibration
  *files
  *provided
  *by calibration application supplied with DUO3D device
  *	  	intrinsic_filename		= ""			// [string]	Intrinsic parameters
  *file.
  *This
  *filename should contain a substring _RWWWxHHH_ with WWW being the image width
  *and HHH the image height, as provided by the calibration application.
  *		extrinsic_filename		= ""			// [string]	Extrinsic parameters
  *file.
  *This
  *filename should contain a substring _RWWWxHHH_ with WWW being the image width
  *and HHH the image height, as provided by the calibration application.
