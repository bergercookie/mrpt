 ...
 * mrpt::kinematics::CVehicleSimulVirtualBase
  ...
  */
class NAV_IMPEXP CRobot2NavInterfaceForSimulator_Holo
...
public:
  ...
  virtual bool
  changeSpeeds(const mrpt::kinematics::CVehicleVelCmd &vel_cmd) override {
    m_simul.sendVelCmd(vel_cmd);
    return true; // ok
  }

  bool stop(bool isEmergencyStop) override {
    m_simul.sendVelRampCmd(0.0 /*vel*/, 0 /*dir*/,
                           isEmergencyStop ? 0.1 : 1.0 /* ramp_time */,
                           0.0 /*rot speed */);
    return true;
  }
  ...
  getAlignCmd(const double relative_heading_radians) override {
    return mrpt::kinematics::CVehicleVelCmd::Ptr(
 ...
 * mrpt::kinematics::CVehicleSimulVirtualBase
  *  \ingroup nav_reactive
  */
class NAV_IMPEXP CRobot2NavInterfaceForSimulator_DiffDriven
    : public CRobot2NavInterface {
private:
