...
class GUI_IMPEXP CDisplayWindow3D : public mrpt::gui::CBaseGUIWindow
{
   ...
   public:
	 ...
	 * window
	 * is not updated with this method, call "forceRepaint" to update the 3D
	 * view.
	 */
	 ...
	 * be
	 * disabled and the camera position will be determined by the opengl
	 * viewports
	 * in the 3D scene */
	void useCameraFromScene(bool useIt = true);
	/** Gets the 3D ray for the direction line of the pixel where the mouse
	 * cursor
	 * is at. \return False if the window is closed. \sa getLastMousePosition */
