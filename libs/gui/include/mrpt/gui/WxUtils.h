...
public:
  ...
  void AssignImage(wxBitmap *img); //!< Assigns this image. This object has the
                                   //!ownship of the image and will delete it
                                   //!when appropriate. Remember to call Refresh
                                   //!to display the image.
  void AssignImage(const mrpt::utils::CImage &img); //!< Assigns this image.
...
public:
  ...
  void
  readConfigIntoVideoSourcePanel(const std::string &sect,
                                 const mrpt::utils::CConfigFileBase *cfg) const;

  void writeConfigFromVideoSourcePanel(const std::string &sect,
