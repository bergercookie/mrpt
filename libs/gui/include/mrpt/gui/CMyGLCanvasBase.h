...
public:
  ...
  /** Set the camera from a CPose3D, which defines the +X,+Y axis as image place
   * RIGHT and UP dirctions, and -Z as towards the pointing direction.
    */
   ...
   * camera using the mouse.
    ...
    *  - cameraAzimuthDeg
    *
    *  A "new_NAME" variable will be passed with the temptative new value after
   * the user action.
    *   The default behavior should be to copy all the new variables to the
   * variables listed above
    *   but in the middle any find of user-defined filter can be implemented.
    */
  virtual void OnUserManuallyMovesCamera(float new_cameraPointingX,
