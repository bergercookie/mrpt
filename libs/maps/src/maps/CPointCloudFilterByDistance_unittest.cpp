...
void run_pc_filter_test(const double map2_x_off, const double map2_tim_off,
                        const size_t expected_m1_count,
                        const size_t expected_m2_count) {
  const double pts1[8][3] = {{1, 0, 0},       {1.03, 0, 0},    {1, 1, 0},
                             {1.01, 1.02, 0}, {0, 1, 0},       {-0.01, 1.01, 0},
                             {-1, 0, 0},      {-1.01, 0.02, 0}};
...
TEST(CPointCloudFilterByDistance, noOutliers) {
  run_pc_filter_test(.0 /*map2_x_off*/, .0 /*map2_tim_off*/,
                     8 /*expected_m1_count*/, 8 /*expected_m2_count*/);
}
TEST(CPointCloudFilterByDistance, withOutliers) {
  run_pc_filter_test(.35 /*map2_x_off*/, .0 /*map2_tim_off*/,
                     8 /*expected_m1_count*/, 6 /*expected_m2_count*/);
}
TEST(CPointCloudFilterByDistance, tooOldMap) {
  run_pc_filter_test(.35 /*map2_x_off*/, 2.0 /*map2_tim_off*/,
                     8 /*expected_m1_count*/, 8 /*expected_m2_count*/);
}
