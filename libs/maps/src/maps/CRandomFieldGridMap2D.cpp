	...
	switch (m_mapType)
	{
		...
		case mrGMRF_SD:
		{
				...
				this->m_insertOptions_common->GMRF_use_occupancy_information)
			{
				...
				// (relations) of
				// each cell with its neighbourds
	...
	double normReading, const mrpt::math::TPoint2D& point)
{
	...
	// "cellIdx".
	vector_int window_idxs(
		W21sqr, -1);  // The real-map indexes for each element
