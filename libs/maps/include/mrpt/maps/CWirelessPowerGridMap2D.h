...
public:
  /** Constructor */
  CWirelessPowerGridMap2D(TMapRepresentation mapType = mrKernelDM,
...
protected:
  ...
  double min_x, max_x, min_y, max_y,
      resolution; //!< See CWirelessPowerGridMap2D::CWirelessPowerGridMap2D
  mrpt::maps::CWirelessPowerGridMap2D::TMapRepresentation
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CWirelessPowerGridMap2D,
