...
public:
  /** Constructor */
  CHeightGridMap2D_MRF(TMapRepresentation mapType = mrGMRF_SD,
                       double x_min = -2, double x_max = 2, double y_min = -2,
                       double y_max = 2, double resolution = 0.5,
                       bool run_first_map_estimation_now =
                           true //!< [in] Whether to call updateMapEstimation().
                                //!If false, make sure of calling that function
                                //!before accessing map contents.
                       );
  ...
  bool run_map_estimation_at_ctor; //!< Runs map estimation at start up
                                   //!(Default:true)
  double min_x, max_x, min_y, max_y,
      resolution; //!< See CHeightGridMap2D_MRF::CHeightGridMap2D_MRF
  mrpt::maps::CHeightGridMap2D_MRF::TMapRepresentation
...
DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CHeightGridMap2D_MRF,
