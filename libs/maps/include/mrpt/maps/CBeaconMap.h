   ...
   public:
	...
	struct MAPS_IMPEXP TInsertionOptions : public utils::CLoadableOptions
	{
	   public:
		 ...
		 * the
		 * beacons to be in the same horizontal plane that the sensors, that is,
		 * 2D
		 ...
		 * time
		 * a beacon is observed, and their weights just updated subsequently -
		 * if
		 * set to "true", fewer samples will be required since the particles
		 * will be
