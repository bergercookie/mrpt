	...
	const std::string& output_dir_fname)
{
	...
	{  // slam evaluation metric
		...
		const std::string desc(
			...
			"metric "
			"computes the \"deformation energy\" that is needed to transfer "
			"the "
			"estimated trajectory into the ground-truth trajectory (computed "
			"as "
			"sum of the difference between estimated trajectory and ground "
			"truth "
			"consecutive poses See \"A comparison of SLAM algorithms based on "
			"a "
