...
template <class GRAPH_T> TUncertaintyPath<GRAPH_T>::TUncertaintyPath() {
  this->clear();
}
...
template <class GRAPH_T> void TUncertaintyPath<GRAPH_T>::clear() {
...
template <class GRAPH_T> bool TUncertaintyPath<GRAPH_T>::isEmpty() const {
  return *this == self_t();
}
...
template <class GRAPH_T>
TUncertaintyPath<GRAPH_T> &TUncertaintyPath<GRAPH_T>::
operator+=(const self_t &other) {
  ...
  this->nodes_traversed.insert(this->nodes_traversed.end(),
...
template <class GRAPH_T>
void TUncertaintyPath<GRAPH_T>::addToPath(const mrpt::utils::TNodeID &node,
...
template <class GRAPH_T> double TUncertaintyPath<GRAPH_T>::getDeterminant() {
  using namespace mrpt;
  using namespace mrpt::math;
  using namespace mrpt::poses;
  using namespace std;
