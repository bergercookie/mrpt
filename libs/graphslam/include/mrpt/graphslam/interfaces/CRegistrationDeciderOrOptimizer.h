...
public:
   ...
   */
  virtual void
  setWindowManagerPtr(mrpt::graphslam::CWindowManager *win_manager);
   ...
   */
  virtual void
  notifyOfWindowEvents(const std::map<std::string, bool> &events_occurred);
  /**\brief Load the necessary for the decider/optimizer configuration
   * parameters.
   */
  virtual void loadParams(const std::string &source_fname);
  /**\brief Print the problem parameters - relevant to the decider/optimizer to
   * the
