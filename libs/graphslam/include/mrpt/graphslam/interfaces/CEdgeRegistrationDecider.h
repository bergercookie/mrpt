...
public:
   ...
   */
  virtual void
  getEdgesStats(std::map<std::string, int> *edge_type_to_num) const {};
...
protected:
  /**\name Registration criteria checks
    ...
    *call
           ...
           */
  /**\{*/
  virtual void checkRegistrationCondition(mrpt::utils::TNodeID from,
                                          mrpt::utils::TNodeID to) {}
  virtual void
  checkRegistrationCondition(const std::set<mrpt::utils::TNodeID> &) {}
  /**\}*/
