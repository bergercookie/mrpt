...
template <class GRAPH_T> CFixedIntervalsNRD<GRAPH_T>::CFixedIntervalsNRD() {
...
bool CFixedIntervalsNRD<GRAPH_T>::checkRegistrationCondition() {
  ...
  if (this->checkRegistrationCondition(last_pose_inserted,
...
template <class GRAPH_T> void CFixedIntervalsNRD<GRAPH_T>::printParams() const {
  MRPT_START;
...
// TParams
//////////////////////////////////////////////////////////////
template <class GRAPH_T> CFixedIntervalsNRD<GRAPH_T>::TParams::TParams() {}
template <class GRAPH_T> CFixedIntervalsNRD<GRAPH_T>::TParams::~TParams() {}
template <class GRAPH_T>
...
void CFixedIntervalsNRD<GRAPH_T>::TParams::getAsString(
  ...
  *params_out +=
      mrpt::format("Max angle for registration    = %.2f deg\n", max_angle_deg);
