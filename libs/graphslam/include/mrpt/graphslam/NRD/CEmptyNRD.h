...
template <class GRAPH_T> CEmptyNRD<GRAPH_T>::CEmptyNRD() {}
template <class GRAPH_T> CEmptyNRD<GRAPH_T>::~CEmptyNRD() {}

template <class GRAPH_T>
bool CEmptyNRD<GRAPH_T>::updateState(mrpt::obs::CActionCollection::Ptr action,
                                     mrpt::obs::CSensoryFrame::Ptr observations,
                                     mrpt::obs::CObservation::Ptr observation) {
  return false;
}

template <class GRAPH_T> void CEmptyNRD<GRAPH_T>::registerNewNode() {}
