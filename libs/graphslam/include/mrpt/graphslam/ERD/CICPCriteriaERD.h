...
protected:
  ...
  //////////////////////////////////////////////////////////////
  void
  checkRegistrationCondition2D(const std::set<mrpt::utils::TNodeID> &nodes_set);
  void
  checkRegistrationCondition3D(const std::set<mrpt::utils::TNodeID> &nodes_set);
  ...
  mrpt::utils::TColor
      m_search_disk_color; //!< see Constructor for initialization
  mrpt::utils::TColor
      m_laser_scans_color; //!< see Constructor for initialization
