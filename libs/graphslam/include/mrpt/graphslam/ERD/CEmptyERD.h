...
template <class GRAPH_T> CEmptyERD<GRAPH_T>::CEmptyERD() {}
template <class GRAPH_T> CEmptyERD<GRAPH_T>::~CEmptyERD() {}

template <class GRAPH_T>
bool CEmptyERD<GRAPH_T>::updateState(mrpt::obs::CActionCollection::Ptr action,
                                     mrpt::obs::CSensoryFrame::Ptr observations,
                                     mrpt::obs::CObservation::Ptr observation) {
  return true;
}
...
template <class GRAPH_T>
void CEmptyERD<GRAPH_T>::registerNewEdge(const mrpt::utils::TNodeID &from,
                                         const mrpt::utils::TNodeID &to,
                                         const constraint_t &rel_edge) {}
}
}
