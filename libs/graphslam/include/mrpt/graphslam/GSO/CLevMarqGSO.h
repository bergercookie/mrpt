...
protected:
   ...
   *
   */
  static void levMarqFeedback(const GRAPH_T &graph, const size_t iter,
                              const size_t max_iter, const double cur_sq_error);
  ...
  initOptDistanceVisualizationInternal(const mrpt::poses::CPose2D &p_unused);
  mrpt::opengl::CRenderizable::Ptr
  initOptDistanceVisualizationInternal(const mrpt::poses::CPose3D &p_unused);
  /**\}*/
