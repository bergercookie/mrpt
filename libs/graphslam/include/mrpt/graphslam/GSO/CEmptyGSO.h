...
template <class GRAPH_T> CEmptyGSO<GRAPH_T>::CEmptyGSO() {}
template <class GRAPH_T> CEmptyGSO<GRAPH_T>::~CEmptyGSO() {}

template <class GRAPH_T>
bool CEmptyGSO<GRAPH_T>::updateState(mrpt::obs::CActionCollection::Ptr action,
                                     mrpt::obs::CSensoryFrame::Ptr observations,
                                     mrpt::obs::CObservation::Ptr observation) {
  return true;
}
...
template <class GRAPH_T>
void CEmptyGSO<GRAPH_T>::registerNewEdge(const mrpt::utils::TNodeID &from,
                                         const mrpt::utils::TNodeID &to,
                                         const constraint_t &rel_edge) {}
}
}
