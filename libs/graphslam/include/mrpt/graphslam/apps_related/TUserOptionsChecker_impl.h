...
void TUserOptionsChecker<GRAPH_t>::populateDeciderOptimizerProperties()
{
	...
	{  // CFixedIntervalsNRD
		...
		dec->description =
			...
			"surpasses "
			"a predefined distance threshold. Uses odometry information for "
			"estimating the robot movement";
		dec->type = "Node";
	...
	{  // CICPCriteriaNRD
		...
		dec->description =
			"Register a new node if the distance from the previous node "
			"surpasses "
			"a predefined distance threshold. Uses 2D/3D RangeScans alignment "
			"for "
			"estimating the robot movement";
		dec->type = "Node";
	...
	{  // CICPCriteriaERD
		...
		dec->description =
			...
			"2 "
			"nodes. Uses the goodness of the ICP Alignment as the criterium "
			"for "
			"adding a new edge";
		dec->type = "Edge";
		dec->rawlog_format = "Both";
	...
	{  // CLoopCloserERD
		...
		dec->description =
			...
			"Pairwise "
			"consistency matrix of each set.";
		dec->type = "Edge";
		dec->rawlog_format = "Both";
		dec->observations_used.push_back(
			"CObservation2DRangeScan - Format #1, #2");
