...
private:
  ...
  void
  updateViewsDynamicObjects(); // Update 3D object positions and refresh views.
  ...
  mrpt::math::TPoint2D m_curCursorPos; //!< Of the cursor on the 3D view (in
                                       //!world coordinates at Z=0)
  TCursorPickState
      m_cursorPickState; //!< The state of the cursor onto the 3D view:
  ...
  mrpt::opengl::CSetOfObjects::Ptr m_gl_placing_nav_target, m_gl_placing_robot,
      m_gl_drawing_obs;
