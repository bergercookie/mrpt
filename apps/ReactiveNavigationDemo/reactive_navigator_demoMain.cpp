...
// Load my custom icons:
	...
	Create(
		parent, wxID_ANY, _("Reactive Navigation Tester - Part of MRPT"),
	...
	btnSetWaypointSeq->SetBitmapDisabled(
	...
	FlexGridSizer4->Add(
		StaticText8, 1, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText7 = new wxStaticText(
		this, ID_STATICTEXT9, _("(with yaw: CTRL+click)"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	FlexGridSizer4->Add(
		StaticText7, 1, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText6 = new wxStaticText(
		this, ID_STATICTEXT8, _("Waypt yaw (deg):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer4->Add(
		StaticText6, 1, wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edWayPtHeading = new wxTextCtrl(
		this, ID_TEXTCTRL6, _("0.0"), wxDefaultPosition, wxDefaultSize, 0,
	...
	Panel1 = new wxPanel(
		SplitterWindow1, ID_PANEL1, wxDefaultPosition, wxSize(400, 143),
		wxTAB_TRAVERSAL, _T("ID_PANEL1"));
	FlexGridSizer2 = new wxFlexGridSizer(1, 2, 0, 0);
	FlexGridSizer2->AddGrowableCol(1);
	FlexGridSizer2->AddGrowableRow(0);
	pnNavSelButtons = new wxPanel(
		Panel1, ID_PANEL6, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL,
		_T("ID_PANEL6"));
	...
	FlexGridSizer3->Add(
		cbEnableLog, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer3->Add(
		-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbNavLog = new wxCheckBox(
		pnNavSelButtons, ID_CHECKBOX2, _("Record .navlog files"),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_CHECKBOX2"));
	cbNavLog->SetValue(false);
	FlexGridSizer3->Add(
		cbNavLog, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer3->Add(
		-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbShowPredictedPTG = new wxCheckBox(
		pnNavSelButtons, ID_CHECKBOX3, _("Show selected PTG prediction"),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_CHECKBOX3"));
	cbShowPredictedPTG->SetValue(true);
	FlexGridSizer3->Add(
		cbShowPredictedPTG, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
		5);
	cbDrawShapePath = new wxCheckBox(
		pnNavSelButtons, ID_CHECKBOX4, _("and draw robot shape"),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_CHECKBOX4"));
	...
	FlexGridSizer3->Add(
		cbDrawShapePath, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	cbWaypointsAllowSkip = new wxCheckBox(
		pnNavSelButtons, ID_CHECKBOX5, _("Allow skip waypoints"),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_CHECKBOX5"));
	...
	FlexGridSizer9->Add(
		rbKinType, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	btnGenerateTemplate = new wxButton(
		pnNavSelButtons, ID_BUTTON13, _("Generate template config file..."),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_BUTTON13"));
	FlexGridSizer9->Add(
		btnGenerateTemplate, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	...
	pnParamsGeneral = new wxPanel(
		Notebook1, ID_PANEL2, wxDefaultPosition, wxSize(474, 170),
	...
	edParamsReactive = new wxTextCtrl(
		...
		_("# "
		  ...
		  "or "
		  "resolution (in meters)\nPTG0_refDistance= 10.0 # Maximum distance "
		  "to "
		  ...
		  "or "
		  "resolution (in meters)\nPTG2_refDistance= 10.0 # Maximum distance "
		  "to "
		  "build PTGs (in meters), i.e. the visibility \"range\" of tentative "
		  "paths\nPTG2_num_paths = 121\nPTG2_v_max_mps = 1.0\nPTG2_w_max_dps = "
		  ...
		  "parameters)\n# Each PTG will use only one of either (a) polygonal "
		  "2D "
		  "shape or, (b) radius of a circular "
	...
	SplitterWindow2 = new wxSplitterWindow(
		Panel5, ID_SPLITTERWINDOW2, wxDefaultPosition, wxDefaultSize, wxSP_3D,
		_T("ID_SPLITTERWINDOW2"));
	SplitterWindow2->SetMinSize(wxSize(10, 10));
	SplitterWindow2->SetMinimumPaneSize(10);
	Panel2 = new wxPanel(
		SplitterWindow2, ID_PANEL7, wxDefaultPosition, wxDefaultSize,
		wxTAB_TRAVERSAL, _T("ID_PANEL7"));
	FlexGridSizer10 = new wxFlexGridSizer(1, 2, 0, 0);
	FlexGridSizer10->AddGrowableCol(1);
	FlexGridSizer10->AddGrowableRow(0);
	StaticText3 = new wxStaticText(
		Panel2, ID_STATICTEXT3, _("Log:"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT3"));
	FlexGridSizer10->Add(
		StaticText3, 1, wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
	edLog = new wxTextCtrl(
		Panel2, ID_TEXTCTRL5, wxEmptyString, wxDefaultPosition, wxSize(612, 85),
	...
	Panel3 = new wxPanel(
		SplitterWindow2, ID_PANEL8, wxDefaultPosition, wxDefaultSize,
	...
	StaticText1 = new wxStaticText(
		Panel3, ID_STATICTEXT1, _("[Local view]"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	FlexGridSizer5->Add(
		StaticText1, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	m_plot3D = new CMyGLCanvas(
		Panel3, ID_XY_GLCANVAS, wxDefaultPosition, wxSize(450, 350),
...
void reactive_navigator_demoframe::OntimRunSimulTrigger(wxTimerEvent& event)
{
	try
	{
		...
		timRunSimul.Start(
			NAV_SIMUL_TIMESTEP_MS, true);  // execute the simulation
		// step by step ("one shot"
		// timer) so in the event
		// of an exception, we
		// don't output an endless
		// stream of errors.
	}
...
bool reactive_navigator_demoframe::reinitSimulator()
{
	...
	switch (rbNavMode->GetSelection())
	{
		case 0:
		{
			mrpt::nav::CReactiveNavigationSystem* react =
				new mrpt::nav::CReactiveNavigationSystem(
	...
	// params for simulator itself:
	{
		...
		cfgGeneral.setContent(
			std::string(edParamsGeneral->GetValue().mb_str()));
...
void reactive_navigator_demoframe::simulateOneStep(double time_step)
{
	...
	if (simul_time - LAST_TIM_LIDAR > 1.0 / m_simul_options.SENSOR_RATE)
	{
		...
		{
			m_latest_obstacles.insertionOptions.minDistBetweenLaserPoints =
				0.005f;
	...
	const TPoint3D cur_pt(
		m_robotSimul->getCurrentGTPose().x, m_robotSimul->getCurrentGTPose().y,
		0.01);
	...
	if (sel_PTG >= 0 && sel_PTG < (int)lfr.infoPerPTG.size())
	{
			...
			IS_CLASS(lfr.infoPerPTG[sel_PTG].HLFR, CLogFileRecord_ND))
		{
			...
			for (size_t i = 0; i < nGaps; i++)
			{
				...
				for (size_t j = 0; j < N_STEPS; j++)
				{
					...
					const double d =
						lfr.infoPerPTG[sel_PTG].TP_Obstacles[sec] - 0.05;
		...
		if (nObs > 1)
		{
			...
			{
				const double d0 =
					lfr.infoPerPTG[sel_PTG].TP_Obstacles[i % nObs];
				const double a0 =
					M_PI * (-1.0 + 2.0 * ((i % nObs) + 0.5) / nObs);
				const double d1 =
					lfr.infoPerPTG[sel_PTG].TP_Obstacles[(i + 1) % nObs];
				const double a1 =
		...
		// Movement direction:
		{
			const double desiredDirection =
				lfr.infoPerPTG[sel_PTG].desiredDirection;
			const double d =
				lfr.infoPerPTG[sel_PTG].desiredSpeed;  /// ROBOT_MAX_SPEED;
			gl_line_direction->setLineCoords(
				0, 0, 0, cos(desiredDirection) * d, sin(desiredDirection) * d,
				0);
		}
	...
	if (cbShowPredictedPTG->IsChecked() && lfr.infoPerPTG.size() > 0 && ptg_nav)
	{
		...
		if (lfr.nSelectedPTG <=
			(int)
				ptg_nav->getPTG_count())  // the == case is for "NOP motion cmd"
		{
			const bool is_NOP_op =
				(lfr.nSelectedPTG == (int)ptg_nav->getPTG_count());
			const int idx_ptg =
				is_NOP_op ? lfr.ptg_index_NOP : lfr.nSelectedPTG;
			...
			if (ptg)
			{
				...
				ptg->updateNavDynamicState(
					is_NOP_op ? lfr.ptg_last_navDynState : lfr.navDynState);
	...
	if (wp_nav)
	{
		...
		if (!wxFrWpInfo)
		{
			wxFrWpInfo = new wxFrame(
				this, -1, wxT("Waypoints info"), wxDefaultPosition,
				wxSize(400, 150),
		...
		switch (m_cursorPickState)
		{
			...
			case cpsPickWaypoints:
			{
				...
				m_gl_placing_nav_target->setLocation(
					m_curCursorPos.x, m_curCursorPos.y, 0.01);
			}
			break;
			case cpsPlaceRobot:
			{
		...
		case cpsDrawClear:
			if (event.ButtonIsDown(wxMOUSE_BTN_LEFT))
			{
					...
					cy < (int)m_gridMap.getSizeY())
				{
					m_gridMap.setCell(
						cx, cy,
						m_cursorPickState == cpsDrawObstacles ? 0.01f : 0.99f);
					updateMap3DView();
					m_plot3D->Refresh();
				}
				skip_normal_process = true;
	...
	mrpt::utils::CConfigFileBase& cfg, const std::string& section) const
{
	...
	cfg.write(
		section, "SENSOR_FOV", 180.0 / M_PI * SENSOR_FOV, WN, WV,
	...
	cfg.write(
		section, "NAVIGATION_RATE", NAVIGATION_RATE, WN, WV,
...
void reactive_navigator_demoframe::OnbtnDrawMapObsClick(wxCommandEvent& event)
{
	...
	m_gl_drawing_obs->setVisibility(
		m_cursorPickState == cpsDrawObstacles ||
	...
	wxCommandEvent& event)
{
	...
	{
		wxMessageBox(
			wxT("Navigator class does not support waypoints sequences!"));
		return;
	}
	...
	btnSetWaypointSeq->Refresh();
	m_gl_placing_nav_target->setVisibility(
		m_cursorPickState == cpsPickWaypoints);
	m_plot3D->Refresh();
}
