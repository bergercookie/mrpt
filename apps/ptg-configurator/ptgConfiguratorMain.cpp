...
// Load my custom icons:
  ...
  Create(parent, wxID_ANY, _("PTG configurator - Part of the MRPT project"),
  ...
  StaticText1 = new wxStaticText(Panel1, ID_STATICTEXT1,
                                 _("Select a PTG class:"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT1"));
  FlexGridSizer7->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  cbPTGClass =
      new wxChoice(Panel1, ID_CHOICE1, wxDefaultPosition, wxDefaultSize, 0, 0,
                   wxCB_SORT, wxDefaultValidator, _T("ID_CHOICE1"));
  FlexGridSizer7->Add(cbPTGClass, 1,
  ...
  FlexGridSizer7->Add(StaticText5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                      ...
                      5);
  btnReloadParams =
      new wxButton(Panel1, ID_BUTTON1, _("Initialize PTG"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  wxFont btnReloadParamsFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL, wxBOLD,
                             false, wxEmptyString, wxFONTENCODING_DEFAULT);
  btnReloadParams->SetFont(btnReloadParamsFont);
  FlexGridSizer7->Add(btnReloadParams, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer4->Add(StaticText2, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edPTGIndex = new wxSpinCtrl(Panel1, ID_SPINCTRL1, _T("0"), wxDefaultPosition,
                              wxDefaultSize, 0, 0, 100, 0, _T("ID_SPINCTRL1"));
  edPTGIndex->SetValue(_T("0"));
  FlexGridSizer4->Add(edPTGIndex, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  cbDrawShapePath = new wxCheckBox(Panel1, ID_CHECKBOX1, _("Draw robot shape"),
                                   wxDefaultPosition, wxDefaultSize, 0,
                                   wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbDrawShapePath->SetValue(true);
  FlexGridSizer4->Add(cbDrawShapePath, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText4 = new wxStaticText(
      Panel1, ID_STATICTEXT4, _("Dist. btw. robot shapes:"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT4"));
  FlexGridSizer4->Add(StaticText4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edMinDistBtwShapes =
      new wxTextCtrl(Panel1, ID_TEXTCTRL5, _("0.5"), wxDefaultPosition,
                     wxSize(50, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
  FlexGridSizer4->Add(edMinDistBtwShapes, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                      5);
  btnLoadPlugin =
      new wxButton(Panel1, ID_BUTTON5, _("Load Plugin"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer4->Add(btnLoadPlugin, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer4->Add(cbHighlightOnePath, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                      5);
  slidPathHighlight =
      new wxSlider(Panel1, ID_SLIDER1, 0, 0, 100, wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER1"));
  FlexGridSizer4->Add(slidPathHighlight, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                      5);
  edIndexHighlightPath =
      new wxSpinCtrl(Panel1, ID_SPINCTRL2, _T("0"), wxDefaultPosition,
                     wxDefaultSize, 0, 0, 100, 0, _T("ID_SPINCTRL2"));
  ...
  cbBuildTPObs = new wxCheckBox(Panel1, ID_CHECKBOX2, _("Obstacle point: x="),
                                wxDefaultPosition, wxDefaultSize, 0,
                                wxDefaultValidator, _T("ID_CHECKBOX2"));
  cbBuildTPObs->SetValue(true);
  FlexGridSizer8->Add(cbBuildTPObs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  edObsX =
      new wxTextCtrl(Panel1, ID_TEXTCTRL3, _("9.0"), wxDefaultPosition,
                     wxSize(50, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
  FlexGridSizer8->Add(edObsX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText3 =
      new wxStaticText(Panel1, ID_STATICTEXT3, _("y="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT3"));
  FlexGridSizer8->Add(StaticText3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edObsY =
      new wxTextCtrl(Panel1, ID_TEXTCTRL4, _("3.0"), wxDefaultPosition,
                     wxSize(50, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
  FlexGridSizer8->Add(edObsY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer8->Add(btnPlaceObs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  btnRebuildTPObs = new wxButton(Panel1, ID_BUTTON2, _("Rebuild TP-Obs now"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 wxDefaultValidator, _T("ID_BUTTON2"));
  FlexGridSizer8->Add(btnRebuildTPObs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText6 = new wxStaticText(Panel1, ID_STATICTEXT6, _("Target: x="),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT6"));
  FlexGridSizer8->Add(StaticText6, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edTargetX =
      new wxTextCtrl(Panel1, ID_TEXTCTRL6, _("5.0"), wxDefaultPosition,
                     wxSize(31, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
  FlexGridSizer8->Add(edTargetX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                        wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText7 =
      new wxStaticText(Panel1, ID_STATICTEXT7, _("y="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT7"));
  FlexGridSizer8->Add(StaticText7, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edTargetY =
      new wxTextCtrl(Panel1, ID_TEXTCTRL7, _("1.0"), wxDefaultPosition,
                     wxSize(35, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL7"));
  FlexGridSizer8->Add(edTargetY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                        wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText17 = new wxStaticText(Panel1, ID_STATICTEXT17, _("RelSpeed="),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT17"));
  FlexGridSizer8->Add(StaticText17, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  edRelSpeedAtTarget =
      new wxTextCtrl(Panel1, ID_TEXTCTRL8, _("0.0"), wxDefaultPosition,
                     wxSize(34, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL8"));
  FlexGridSizer8->Add(edRelSpeedAtTarget, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer8->Add(btnPlaceTarget, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer3->Add(FlexGridSizer8, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer6->Add(edCfg, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      2);
  ...
  FlexGridSizer6->Add(edLog, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  FlexGridSizer3->Add(FlexGridSizer6, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer2->Add(FlexGridSizer3, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel1->SetSizer(FlexGridSizer2);
  FlexGridSizer2->Fit(Panel1);
  FlexGridSizer2->SetSizeHints(Panel1);
  FlexGridSizer1->Add(Panel1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  ...
  m_plot =
      new CMyGLCanvas(this, ID_XY_GLCANVAS, wxDefaultPosition, wxSize(150, 300),
                      wxTAB_TRAVERSAL, _T("ID_XY_GLCANVAS"));
  FlexGridSizer9->Add(m_plot, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  ...
  cbShowTPObs =
      new wxCheckBox(Panel2, ID_CHECKBOX5, _("TP-Obstacles"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX5"));
  cbShowTPObs->SetValue(true);
  FlexGridSizer15->Add(cbShowTPObs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  cbShowClearance = new wxCheckBox(Panel2, ID_CHECKBOX6, _("Clearance diagram"),
                                   wxDefaultPosition, wxDefaultSize, 0,
                                   wxDefaultValidator, _T("ID_CHECKBOX6"));
  cbShowClearance->SetValue(true);
  FlexGridSizer15->Add(cbShowClearance, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                               wxALIGN_CENTER_VERTICAL,
                       5);
  cbClearanceInterp =
      new wxCheckBox(Panel2, ID_CHECKBOX7, _("Interpolate clearance diagram"),
                     wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
                     _T("ID_CHECKBOX7"));
  cbClearanceInterp->SetValue(false);
  FlexGridSizer15->Add(cbClearanceInterp, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer1->Add(FlexGridSizer15, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer10->Add(StaticBoxSizer1, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 2);
  m_plotTPSpace =
      new CMyGLCanvas(Panel2, ID_CUSTOM2, wxDefaultPosition, wxSize(150, 300),
                      wxTAB_TRAVERSAL, _T("ID_CUSTOM2"));
  FlexGridSizer10->Add(m_plotTPSpace, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer11->Add(m_plotVelCmds, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  StaticText8 = new wxStaticText(
      Panel4, ID_STATICTEXT8, _("Motion direction to robot heading angle: for "
                                "selected PTG over time [deg]"),
  ...
  FlexGridSizer12->Add(m_plotHeadAngIndiv, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer12->Add(m_plotHeadAngAll, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer13->Add(m_plotPathX, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer13->Add(m_plotPathY, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer13->Add(StaticText12, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  m_plotPathPhi =
      new mpWindow(Panel5, ID_CUSTOM7, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer13->Add(m_plotPathPhi, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticText16 = new wxStaticText(
      Panel5, ID_STATICTEXT16,
      _("Selected path trajectory: traversed distance [m]"), wxDefaultPosition,
  ...
  FlexGridSizer13->Add(m_plotPathDist, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer14->Add(m_plotPathXp, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer14->Add(m_plotPathYp, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer14->Add(StaticText15, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  m_plotPathW =
      new mpWindow(Panel6, ID_CUSTOM10, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer14->Add(m_plotPathW, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer9->Add(Notebook1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  Connect(
      ...
      (wxObjectEventFunction)&ptgConfiguratorframe::OncbHighlightOnePathClick);
  Connect(ID_SLIDER1,
  ...
  Connect(ID_CHECKBOX5, wxEVT_COMMAND_CHECKBOX_CLICKED,
          (wxObjectEventFunction)&ptgConfiguratorframe::OnrbShowTPSelectSelect);
  Connect(ID_CHECKBOX6, wxEVT_COMMAND_CHECKBOX_CLICKED,
          (wxObjectEventFunction)&ptgConfiguratorframe::OnrbShowTPSelectSelect);
  ...
  m_plot->Connect(
      wxEVT_MOTION,
      (wxObjectEventFunction)&ptgConfiguratorframe::Onplot3DMouseMove, 0, this);
  m_plot->Connect(
      wxEVT_LEFT_DOWN,
  ...
  gl_TPSpace_clearance =
      std::make_shared<mrpt::opengl::CMesh>(true, -5.0f, 5.0f, -5.0f, 5.0f);
  ...
  m_plot->addTextMessage(0.01, 5, "Workspace",
                         mrpt::utils::TColorf(1, 1, 1, 0.75), "sans", 15,
                         mrpt::opengl::NICE, 1);
  m_plotTPSpace->addTextMessage(0.01, 5, "TP-Space",
                                mrpt::utils::TColorf(1, 1, 1, 0.75), "sans", 15,
                                mrpt::opengl::NICE, 2);
  ...
  gl_WS_obs = std::make_shared<mrpt::opengl::CPointCloud>();
  gl_WS_obs->setPointSize(7.0);
  gl_WS_obs->setColor_u8(0, 0, 0);
  gl_view_WS->insert(gl_WS_obs);

  gl_WS_target = std::make_shared<mrpt::opengl::CPointCloud>();
  ...
  gl_WS_target_reprojected = std::make_shared<mrpt::opengl::CPointCloud>();
  ...
  gl_TP_target = std::make_shared<mrpt::opengl::CPointCloud>();
  ...
  {
    gl_axis_WS = std::make_shared<mrpt::opengl::CAxis>(-10.0, -10.0, 0, 10.0,
                                                       10.0, 0.0, 1.0, 2.0);
  ...
  {
    gl_axis_TPS = std::make_shared<mrpt::opengl::CAxis>(-1.0, -1.0, 0, 1.0, 1.0,
                                                        0.0, 0.25, 2.0);
...
#if 0
	// Fixed camera:
	gl_view_TPSpace_cam = std::make_shared<mrpt::opengl::CCamera>();
  ...
  // Populate list of existing PTGs:
  {
    ...
    for (size_t i = 0; i < lstClasses.size(); i++) {
      if (!lstClasses[i]->derivedFrom("CParameterizedTrajectoryGenerator") ||
          !mrpt::system::os::_strcmpi(lstClasses[i]->className,
...
void ptgConfiguratorframe::prepareRobotPathPlot(mpWindow *plot,
                                                mpFXYVector **graph,
...
void ptgConfiguratorframe::OncbPTGClassSelect(wxCommandEvent &event) {
  ...
  if (!classId) {
    THROW_EXCEPTION_FMT("[CreatePTG] No PTG named `%s` is registered!",
                        sSelPTG.c_str());
  }
...
void ptgConfiguratorframe::rebuild3Dview() {
  ...
  if (ptg && ptg->isInitialized()) {
    ...
    {
      mrpt::nav::CParameterizedTrajectoryGenerator::TNavDynamicState navdyn =
          ptg->getCurrentNavDynamicState();
      ...
      if (ok_x && ok_y) {
        if (cbBuildTPObs->IsChecked()) {
          ...
          StatusBar1->SetStatusText(
              wxString::Format(wxT("TP-Obstacle build time: %ss"),
        ...
        cd.renderAs3DObject(*gl_TPSpace_clearance, -1.0, 1.0, -1.0, 1.0, 0.05,
                            false /*interpolate*/);
        cd.renderAs3DObject(*gl_TPSpace_clearance_interp, -1.0, 1.0, -1.0, 1.0,
                            0.05, true /*interpolate*/);
    ...
    try {
      ...
      StaticText12->SetLabel(wxString::Format(
          _("Selected path trajectory: Phi [deg]. PTG alpha=%.03f [deg]"),
  ...
  // Target:
  {
    if (ptg && ptg->isInitialized()) {
      ...
      uint32_t check_step;
      if (ptg->getPathStepForDist(k, norm_d * ptg->getRefDistance(),
                                  check_step)) {
        mrpt::math::TPose2D p;
...
#else
  wxMessageBox(wxT("This feature is only available in GNU/Linux!"),
               wxT("Error"), wxOK, nullptr);
#endif
}
...
void ptgConfiguratorframe::dumpPTGcfgToTextBox() {
  ...
  cfp.write(sSection, "Type", ptg->GetRuntimeClass()->className, WN, WV,
            "PTG C++ class name");
...
void ptgConfiguratorframe::Onplot3DMouseMove(wxMouseEvent &event) {
  ...
  if (inters.getPoint(inters_pt)) {
    ...
    StatusBar1->SetStatusText(wxString::Format(wxT("Cursor: X=%.03f Y=%.04f"),
                                               m_curCursorPos.x,
                                               m_curCursorPos.y),
                              0);
  }
...
void ptgConfiguratorframe::OnrbShowTPSelectSelect(wxCommandEvent &event) {
  ...
  gl_TPSpace_clearance->setVisibility(cbShowClearance->IsChecked() &&
                                      !cbClearanceInterp->IsChecked());
  gl_TPSpace_clearance_interp->setVisibility(cbShowClearance->IsChecked() &&
                                             cbClearanceInterp->IsChecked());
