...
wxBitmap MyArtProvider::CreateBitmap(const wxArtID &id,
  ...
  if (id == wxART_MAKE_ART_ID(MAIN_ICON))
    return wxBitmap(icono_main_xpm);
  if (id == wxART_MAKE_ART_ID(IMG_MRPT_LOGO))
    return wxBitmap(mrpt_logo_xpm);

  if (id == wxART_MAKE_ART_ID(ICON_BATCH))
    return wxBitmap(icon_batch_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_CONFIG))
    return wxBitmap(icon_config_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_HELP))
    return wxBitmap(icon_help_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_EXIT))
    return wxBitmap(icon_exit_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_PLAY))
    return wxBitmap(icon_play_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_RESET))
    return wxBitmap(icon_reset_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_STEP))
    return wxBitmap(icon_step_xpm);
  if (id == wxART_MAKE_ART_ID(ICON_STOP))
    return wxBitmap(icon_stop_xpm);
...
// Load my custom icons:
  ...
  Create(parent, wxID_ANY, _("2D SLAM Demo - Part of the MRPT project"),
  ...
  Panel3 = new wxPanel(this, ID_PANEL3, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL3"));
  Panel3->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer1 = new wxGridSizer(0, 1, 0, 0);
  lbGT = new wxStaticText(Panel3, ID_STATICTEXT1, _("Ground truth"),
                          wxDefaultPosition, wxDefaultSize, 0,
                          _T("ID_STATICTEXT1"));
  wxFont lbGTFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD,
                  false, wxEmptyString, wxFONTENCODING_DEFAULT);
  lbGT->SetFont(lbGTFont);
  GridSizer1->Add(
      lbGT, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  Panel3->SetSizer(GridSizer1);
  GridSizer1->Fit(Panel3);
  GridSizer1->SetSizeHints(Panel3);
  FlexGridSizer4->Add(Panel3, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotGT = new mpWindow(this, ID_CUSTOM1, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer4->Add(plotGT, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      3);
  Panel4 = new wxPanel(this, ID_PANEL4, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL4"));
  Panel4->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer2 = new wxGridSizer(0, 1, 0, 0);
  lbObs = new wxStaticText(Panel4, ID_STATICTEXT2, _("Observation"),
                           wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE,
                           _T("ID_STATICTEXT2"));
  wxFont lbObsFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD,
                   false, wxEmptyString, wxFONTENCODING_DEFAULT);
  lbObs->SetFont(lbObsFont);
  GridSizer2->Add(
      lbObs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  Panel4->SetSizer(GridSizer2);
  GridSizer2->Fit(Panel4);
  GridSizer2->SetSizeHints(Panel4);
  FlexGridSizer4->Add(Panel4, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotObs = new mpWindow(this, ID_CUSTOM2, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer4->Add(plotObs, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      3);
  FlexGridSizer3->Add(FlexGridSizer4, 1,
  ...
  Panel5 = new wxPanel(this, ID_PANEL5, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL5"));
  Panel5->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer3 = new wxGridSizer(0, 1, 0, 0);
  lbMap =
      new wxStaticText(Panel5, ID_STATICTEXT10, _("Map"), wxDefaultPosition,
                       wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT10"));
  wxFont lbMapFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD,
                   false, wxEmptyString, wxFONTENCODING_DEFAULT);
  lbMap->SetFont(lbMapFont);
  GridSizer3->Add(
      lbMap, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  Panel5->SetSizer(GridSizer3);
  GridSizer3->Fit(Panel5);
  GridSizer3->SetSizeHints(Panel5);
  FlexGridSizer5->Add(Panel5, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotMap = new mpWindow(this, ID_CUSTOM3, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer5->Add(plotMap, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      3);
  Panel6 = new wxPanel(this, ID_PANEL6, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL6"));
  Panel6->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer4 = new wxGridSizer(0, 1, 0, 0);
  lmIndCompat = new wxStaticText(
      Panel6, ID_STATICTEXT3, _("Indiv. compat (95% ellips.)"),
      wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
  wxFont lmIndCompatFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  lmIndCompat->SetFont(lmIndCompatFont);
  GridSizer4->Add(lmIndCompat, 1,
  ...
  FlexGridSizer5->Add(Panel6, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotIndivCompat =
      new mpWindow(this, ID_CUSTOM4, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer5->Add(plotIndivCompat, 1,
  ...
  Panel7 = new wxPanel(this, ID_PANEL7, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL7"));
  Panel7->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer5 = new wxGridSizer(0, 1, 0, 0);
  lbDatAssoc = new wxStaticText(Panel7, ID_STATICTEXT4, _("Dat assoc"),
                                wxDefaultPosition, wxDefaultSize,
                                wxALIGN_CENTRE, _T("ID_STATICTEXT4"));
  wxFont lbDatAssocFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                        wxFONTWEIGHT_BOLD, false, wxEmptyString,
                        wxFONTENCODING_DEFAULT);
  lbDatAssoc->SetFont(lbDatAssocFont);
  GridSizer5->Add(lbDatAssoc, 1,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  5);
  Panel7->SetSizer(GridSizer5);
  GridSizer5->Fit(Panel7);
  GridSizer5->SetSizeHints(Panel7);
  FlexGridSizer6->Add(Panel7, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  gridDA = new wxGrid(this, ID_GRID1, wxDefaultPosition, wxDefaultSize, 0,
                      _T("ID_GRID1"));
  ...
  FlexGridSizer6->Add(gridDA, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  ...
  Panel1 = new wxPanel(Notebook1, ID_PANEL1, wxDefaultPosition, wxDefaultSize,
  ...
  Panel8 = new wxPanel(Panel1, ID_PANEL9, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText2Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText2->SetFont(StaticText2Font);
  GridSizer7->Add(StaticText2, 1,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  5);
  Panel8->SetSizer(GridSizer7);
  GridSizer7->Fit(Panel8);
  GridSizer7->SetSizeHints(Panel8);
  FlexGridSizer8->Add(Panel8, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotErrorX =
      new mpWindow(Panel1, ID_CUSTOM7, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer8->Add(plotErrorX, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  Panel9 = new wxPanel(Panel1, ID_PANEL10, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText3Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText3->SetFont(StaticText3Font);
  GridSizer8->Add(StaticText3, 1,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  5);
  Panel9->SetSizer(GridSizer8);
  GridSizer8->Fit(Panel9);
  GridSizer8->SetSizeHints(Panel9);
  FlexGridSizer8->Add(Panel9, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotErrorY =
      new mpWindow(Panel1, ID_CUSTOM8, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer8->Add(plotErrorY, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  Panel10 = new wxPanel(Panel1, ID_PANEL11, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText4Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText4->SetFont(StaticText4Font);
  GridSizer9->Add(StaticText4, 1,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  5);
  Panel10->SetSizer(GridSizer9);
  GridSizer9->Fit(Panel10);
  GridSizer9->SetSizeHints(Panel10);
  FlexGridSizer8->Add(Panel10, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotErrorPhi =
      new mpWindow(Panel1, ID_CUSTOM9, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer8->Add(plotErrorPhi, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  Panel1->SetSizer(FlexGridSizer8);
  FlexGridSizer8->Fit(Panel1);
  FlexGridSizer8->SetSizeHints(Panel1);
  Panel2 = new wxPanel(Notebook1, ID_PANEL2, wxDefaultPosition, wxDefaultSize,
  ...
  Panel13 = new wxPanel(Panel2, ID_PANEL8, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL8"));
  Panel13->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer6 = new wxGridSizer(0, 1, 0, 0);
  lbDaTP = new wxStaticText(Panel13, ID_STATICTEXT9, _("True positives:"),
                            wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE,
                            _T("ID_STATICTEXT9"));
  wxFont lbDaTPFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD,
                    false, wxEmptyString, wxFONTENCODING_DEFAULT);
  lbDaTP->SetFont(lbDaTPFont);
  GridSizer6->Add(lbDaTP, 1,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  5);
  Panel13->SetSizer(GridSizer6);
  GridSizer6->Fit(Panel13);
  GridSizer6->SetSizeHints(Panel13);
  FlexGridSizer9->Add(Panel13, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotDaTP =
      new mpWindow(Panel2, ID_CUSTOM5, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer9->Add(plotDaTP, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  Panel14 = new wxPanel(Panel2, ID_PANEL14, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL14"));
  Panel14->SetBackgroundColour(wxColour(255, 255, 0));
  GridSizer11 = new wxGridSizer(0, 1, 0, 0);
  lbDaTN = new wxStaticText(Panel14, ID_STATICTEXT11, _("True negatives:"),
                            wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE,
                            _T("ID_STATICTEXT11"));
  wxFont lbDaTNFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD,
                    false, wxEmptyString, wxFONTENCODING_DEFAULT);
  lbDaTN->SetFont(lbDaTNFont);
  GridSizer11->Add(lbDaTN, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  Panel14->SetSizer(GridSizer11);
  GridSizer11->Fit(Panel14);
  GridSizer11->SetSizeHints(Panel14);
  FlexGridSizer9->Add(Panel14, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  plotDaTN =
      new mpWindow(Panel2, ID_CUSTOM6, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer9->Add(plotDaTN, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel15 = new wxPanel(Panel2, ID_PANEL15, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText6Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText6->SetFont(StaticText6Font);
  GridSizer12->Add(StaticText6, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  Panel15->SetSizer(GridSizer12);
  GridSizer12->Fit(Panel15);
  GridSizer12->SetSizeHints(Panel15);
  FlexGridSizer9->Add(Panel15, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  plotDaFP =
      new mpWindow(Panel2, ID_CUSTOM11, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer9->Add(plotDaFP, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel16 = new wxPanel(Panel2, ID_PANEL16, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText7Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText7->SetFont(StaticText7Font);
  GridSizer13->Add(StaticText7, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  Panel16->SetSizer(GridSizer13);
  GridSizer13->Fit(Panel16);
  GridSizer13->SetSizeHints(Panel16);
  FlexGridSizer9->Add(Panel16, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  plotDaFN =
      new mpWindow(Panel2, ID_CUSTOM12, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer9->Add(plotDaFN, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel2->SetSizer(FlexGridSizer9);
  FlexGridSizer9->Fit(Panel2);
  FlexGridSizer9->SetSizeHints(Panel2);
  Panel11 = new wxPanel(Notebook1, ID_PANEL12, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL12"));
  FlexGridSizer2 = new wxFlexGridSizer(4, 1, 0, 0);
  FlexGridSizer2->AddGrowableCol(0);
  FlexGridSizer2->AddGrowableRow(1);
  Panel12 = new wxPanel(Panel11, ID_PANEL13, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText1Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText1->SetFont(StaticText1Font);
  GridSizer10->Add(StaticText1, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  Panel12->SetSizer(GridSizer10);
  GridSizer10->Fit(Panel12);
  GridSizer10->SetSizeHints(Panel12);
  FlexGridSizer2->Add(Panel12, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  plotStatTime =
      new mpWindow(Panel11, ID_CUSTOM10, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer2->Add(plotStatTime, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  Panel17 = new wxPanel(Panel11, ID_PANEL17, wxDefaultPosition, wxDefaultSize,
  ...
  StaticText5 = new wxStaticText(
      Panel17, ID_STATICTEXT14, _("JCBB iterations (if used)"),
      wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT14"));
  wxFont StaticText5Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  StaticText5->SetFont(StaticText5Font);
  GridSizer14->Add(StaticText5, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  Panel17->SetSizer(GridSizer14);
  GridSizer14->Fit(Panel17);
  GridSizer14->SetSizeHints(Panel17);
  FlexGridSizer2->Add(Panel17, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  plotDaJCBB =
      new mpWindow(Panel11, ID_CUSTOM13, wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer2->Add(plotDaJCBB, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 3);
  ...
  FlexGridSizer7->Add(Notebook1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer3->Add(FlexGridSizer7, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  Menu1 = new wxMenu();
  MenuItem3 =
      new wxMenuItem(Menu1, ID_MENUITEM1, _("Reset simulation\tCtrl+F2"),
                     wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem3);
  Menu1->AppendSeparator();
  mnuOneStep = new wxMenuItem(Menu1, ID_MENUITEM2, _("Run one step\tF11"),
                              wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(mnuOneStep);
  mnuRun = new wxMenuItem(Menu1, ID_MENUITEM3, _("Run (interactive)...\tF5"),
                          wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(mnuRun);
  mnuStop = new wxMenuItem(Menu1, ID_MENUITEM6, _("Stop\tF2"), wxEmptyString,
                           wxITEM_NORMAL);
  Menu1->Append(mnuStop);
  mnuRunBatch = new wxMenuItem(Menu1, ID_MENUITEM4,
                               _("Run (non-interactive)...\tCtrl-F5"),
                               wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(mnuRunBatch);
  Menu1->AppendSeparator();
  MenuItem7 = new wxMenuItem(Menu1, ID_MENUITEM5, _("Parameters..."),
                             wxEmptyString, wxITEM_NORMAL);
  ...
  Menu3 = new wxMenu();
  MenuItem5 = new wxMenuItem(Menu3, ID_MENUITEM8, _("Save filter state..."),
                             wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem5);
  mnuSaveLastDA = new wxMenuItem(Menu3, ID_MENUITEM11,
                                 _("Save last data association state..."),
                                 wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(mnuSaveLastDA);
  Menu3->AppendSeparator();
  mnuItemSaveRawlog =
      new wxMenuItem(Menu3, ID_MENUITEM_SAVE_RAWLOG, _("Enable save rawlog..."),
                     wxEmptyString, wxITEM_CHECK);
  Menu3->Append(mnuItemSaveRawlog);
  Menu3->AppendSeparator();
  MenuItem4 = new wxMenu();
  MenuItem6 = new wxMenuItem(MenuItem4, ID_MENUITEM9, _("View stats"),
                             wxEmptyString, wxITEM_NORMAL);
  MenuItem4->Append(MenuItem6);
  MenuItem8 = new wxMenuItem(MenuItem4, ID_MENUITEM10, _("Reset stats"),
                             wxEmptyString, wxITEM_NORMAL);
  ...
  ToolBar1 = new wxToolBar(
      ...
      wxTB_FLAT | wxTB_HORIZONTAL | wxTB_TEXT | wxNO_BORDER, _T("ID_TOOLBAR1"));
  ToolBarItem1 = ToolBar1->AddTool(
      ID_TOOLBARITEM1, _("Reset"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_RESET")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL, _("Reset the simulation"),
      _("Reset the simulation"));
  ToolBar1->AddSeparator();
  ToolBarItem2 = ToolBar1->AddTool(
      ID_TOOLBARITEM2, _("One step"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_STEP")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL, _("Run one step"), _("Run one step"));
  ToolBarItem3 = ToolBar1->AddTool(
      ID_BTNRUN, _("Run..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_PLAY")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_CHECK, _("Continuous run with animations..."),
      _("Continuous run with animations..."));
  ToolBarItem4 = ToolBar1->AddTool(
      ID_BTNSTOP, _("Stop"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_STOP")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL, _("Stop continuous run"),
      _("Stop continuous run"));
  ToolBarItem5 = ToolBar1->AddTool(
      ID_TOOLBARITEM4, _("Run (batch)"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_BATCH")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL,
      _("Run the whole simulation without animate"),
      _("Run the whole simulation without animate"));
  ToolBar1->AddSeparator();
  ToolBarItem6 = ToolBar1->AddTool(
      ID_TOOLBARITEM3, _("Config..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_CONFIG")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL, _("Change simulation parameters..."),
      _("Change simulation parameters..."));
  ToolBar1->AddSeparator();
  ToolBarItem7 = ToolBar1->AddTool(
      ID_TOOLBARITEM6, _("About..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_HELP")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL, _("About this program"),
      _("About this program"));
  ToolBarItem8 = ToolBar1->AddTool(
      ID_TOOLBARITEM7, _("Quit"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_EXIT")),
                               wxART_TOOLBAR),
      wxNullBitmap, wxITEM_NORMAL, _("Exit the application"),
  ...
  Connect(ID_MENUITEM_SAVE_RAWLOG, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_TOOLBARITEM1, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnbtnResetClicked);
  Connect(ID_TOOLBARITEM2, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnbtnOneStepClicked);
  Connect(ID_BTNRUN, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnbtnRunClicked);
  Connect(ID_BTNSTOP, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnbtnStopClicked);
  Connect(ID_TOOLBARITEM4, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnbtnRunBatchClicked);
  Connect(ID_TOOLBARITEM3, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnConfigClicked);
  Connect(ID_TOOLBARITEM6, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnAbout);
  Connect(ID_TOOLBARITEM7, wxEVT_COMMAND_TOOL_CLICKED,
          (wxObjectEventFunction)&slamdemoFrame::OnQuit);
...
#define INIT_PLOT_TIME(_PL) INIT_PLOT_LABELS(_PL, "time", "")
  ...
  robot_shape_xs[0] = 0;
  robot_shape_ys[0] = -0.10f;
  robot_shape_xs[1] = 0;
  robot_shape_ys[1] = 0.10f;
  robot_shape_xs[2] = 0.2f;
  robot_shape_ys[2] = 0;
...
void slamdemoFrame::OnbtnOneStepClicked(wxCommandEvent &event) {
  ...
  StatusBar1->SetStatusText(wxString::Format(
      _("Step %u done in %.03fms"), (unsigned)m_historicData.size(), 1e3 * T));
  updateAllGraphs();
}
...
void slamdemoFrame::OnbtnRunBatchClicked(wxCommandEvent &event) {
  ...
  StatusBar1->SetStatusText(
      wxString::Format(_("%u steps done in %.03f secs"), (unsigned)N, T));
}
...
void slamdemoFrame::resetSimulator(const std::string &map_type) {
  ...
  if (map_type == "1") {
    ...
    for (int i = 0; i <= mrpt::utils::round((options.path_square_len) / 2.0);
         i++) {
...
void slamdemoFrame::updateAllGraphs(bool alsoGTMap) {
  ...
  if (alsoGTMap) {
    ...
    lbGT->SetLabel(_U(format("Ground truth (%u landmarks)",
  ...
  m_lyGTvisibleRange->SetCoordinateBase(m_GT_pose.x(), m_GT_pose.y(),
                                        m_GT_pose.phi());
  plotGT->Refresh();
  ...
  lbObs->SetLabel(_U(format("Observation (%u landmarks)",
  ...
  for (size_t i = 0; i < m_lastObservation.sensedData.size(); i++) {
    ...
    if (m_lastObservation.sensedData[i].landmarkID != INVALID_LANDMARK_ID)
      cov->SetName(wxString::Format(
          _("#%u"), (unsigned)m_lastObservation.sensedData[i].landmarkID));
    else
      cov->SetName(_("?"));
    ...
    const CPoint2D lm_xy =
        options.sensorOnTheRobot + CPoint2D(hr * cos(ha), hr * sin(ha));
  ...
  // Map estimated by the SLAM filter ----------------------
  {
    ...
    lbMap->SetLabel(wxString::Format(_("Estimated map (%u landmarks)"),
                                     (unsigned)LMs.size()));

    // mean robot pose:
    m_lyMapRobot->SetCoordinateBase(
        estRobotPose.mean.x(), estRobotPose.mean.y(), estRobotPose.mean.phi());
    ...
    // Robot ellipse:
    {
      ...
      cov->SetCoordinateBase(estRobotPose.mean.x(), estRobotPose.mean.y(),
                             estRobotPose.mean.phi());
      cov->SetCovarianceMatrix(estRobotPose.cov(0, 0), estRobotPose.cov(0, 1),
                               estRobotPose.cov(1, 1));
    ...
    for (size_t i = 0; i < LMs.size(); i++) {
      ...
      if (options.show_map_real_correspondences)
        cov->SetName(wxString::Format(_("#%u->%u"), (unsigned)i,
                                      (unsigned)idx_in_real_map));
      else
      ...
      cov->SetCovarianceMatrix(Pkk(idx + 0, idx + 0), Pkk(idx + 0, idx + 1),
                               Pkk(idx + 1, idx + 1));
  ...
  if (!m_historicData.empty()) {
    ...
    for (size_t i = m_lyERRX_err->GetDataLength(); i < N; i++) {
      ...
      m_lyERRX_err->AppendDataPoint(i, h.GT_robot_pose.x() -
                                           h.estimate_robot_pose.mean.x());
    ...
    for (size_t i = m_lyERRY_err->GetDataLength(); i < N; i++) {
      THistoric &h = m_historicData[i];
      m_lyERRY_err->AppendDataPoint(i, h.GT_robot_pose.y() -
                                           h.estimate_robot_pose.mean.y());
    ...
    for (size_t i = m_lyERRPHI_err->GetDataLength(); i < N; i++) {
      ...
      m_lyERRPHI_err->AppendDataPoint(
          i, RAD2DEG(mrpt::math::wrapToPi(h.GT_robot_pose.phi() -
    ...
    plotErrorX->Fit(-0.05 * N, N * 1.05, m_lyERRX_boundDown->GetMinY() * 1.05,
                    m_lyERRX_boundUp->GetMaxY() * 1.05);
    plotErrorX->Refresh();
    plotErrorY->Fit(-0.05 * N, N * 1.05, m_lyERRY_boundDown->GetMinY() * 1.05,
                    m_lyERRY_boundUp->GetMaxY() * 1.05);
    plotErrorY->Refresh();
    plotErrorPhi->Fit(-0.05 * N, N * 1.05,
                      m_lyERRPHI_boundDown->GetMinY() * 1.05,
    ...
    plotStatTime->Fit(-0.15 * N, N * 1.05, -0.10 * m_lyStatTimes->GetMaxY(),
                      m_lyStatTimes->GetMaxY() * 1.05);
  ...
  // IC graph ------------------------------------------
  {
    ...
    for (size_t i = 0; i < m_lastObservation.sensedData.size(); i++) {
      ...
      if (m_lastObservation.sensedData[i].landmarkID != INVALID_LANDMARK_ID)
        cov->SetName(wxString::Format(
            _("O(%u)"), (unsigned)m_lastObservation.sensedData[i].landmarkID));
      else
    ...
    for (size_t i = 0; i < da.predictions_IDs.size(); i++) {
      ...
      cov->SetQuantiles(2);
      cov->SetCoordinateBase(RAD2DEG(ha), hr);
      if (da.Y_pred_covs.getColCount() ==
          obs_size) { // Independent predictions:
        ASSERT_(da.Y_pred_covs.getRowCount() ==
                obs_size * da.predictions_IDs.size());
        cov->SetCovarianceMatrix(RAD2DEGSQ *
                                     da.Y_pred_covs(obs_size * i + 1, 1),
                                 RAD2DEG(da.Y_pred_covs(obs_size * i + 1, 0)),
                                 da.Y_pred_covs(obs_size * i + 0, 0));
      } else { // Full cov. predictions:
        ASSERT_(da.Y_pred_covs.isSquare() &&
    ...
    for (unsigned int o = 0; o < m_lastObservation.sensedData.size(); o++) {
      ...
      for (unsigned int p = 0; p < da.predictions_IDs.size(); p++) {
        ...
        if (da.results.indiv_compatibility(p, o)) {
          ...
          v->SetName(
              wxString::Format(_("%f"), da.results.indiv_distances(p, o)));
    ...
    plotIndivCompat->Fit(-RAD2DEG(options.sensor_fov) * 0.5 - 10,
                         RAD2DEG(options.sensor_fov) * 0.5 + 10, -0.10,
  ...
  // DA distances ------------------------------------------
  {
    ...
    if (gridDA->GetNumberCols())
      gridDA->DeleteCols(0, gridDA->GetNumberCols());
    ...
    if (gridDA->GetNumberRows())
      gridDA->DeleteRows(0, gridDA->GetNumberRows());
    gridDA->AppendRows(da.predictions_IDs.size());

    for (unsigned int i = 0; i < da.predictions_IDs.size(); i++)
      gridDA->SetRowLabelValue(
          i, wxString::Format(_("P%u"), (unsigned)da.predictions_IDs[i]));
  ...
  if (!m_historicData.empty()) {
    ...
    StaticText6->SetLabel(
        wxString::Format(wxT("False positives: %u"), totalFP));
    ...
    StaticText7->SetLabel(
        wxString::Format(wxT("False negatives: %u"), totalFN));
...
slamdemoFrame::TSimulationOptions::TSimulationOptions()
    : random_seed(-1), map_generator("1"), randomMap_nLMs(70),
      sensorOnTheRobot(0, 0, 0), sensor_max_range(5), sensor_min_range(0.50),
      sensor_fov(DEG2RAD(140)), sensorDistingishesLandmarks(false),
      path_square_len(8), robot_step_length(0.3), odometry_noise_std_xy(0.02),
      odometry_noise_std_phi(DEG2RAD(0.2)), uncert_overestim_odom(1.2),
      uncert_overestim_sensor(1.2), show_map_real_correspondences(false),
      spurious_count_mean(0), spurious_count_std(0) {}
...
void slamdemoFrame::TSimulationOptions::loadFromConfigFile(
  ...
  sensorOnTheRobot.phi(DEG2RAD(f.read_double(c, "sensorOnTheRobot.phi",
                                             RAD2DEG(sensorOnTheRobot.phi()))));
...
void slamdemoFrame::executeOneStep() {
  try {
    ...
    if (!m_historicData.empty()) { // Ok, move:
      ...
      if (fabs(fmod(m_GT_pose.phi(), DEG2RAD(90.0))) < 1e-2) {
        ...
        if ((m_GT_pose.x() > PATH_SQUARE_LEN &&
            ...
            (m_GT_pose.y() <= 0 && dir == -turnSteps)) { // Turn
    ...
    // Simulate observation ------------------------
    {
      ...
      m_GT_map.simulateRangeBearingReadings(
          robotPose, sensorOnRobot, m_lastObservation,
    ...
    const std::set<size_t> old_realIDX_already_mapped =
        m_realIDX_already_mapped;
    ...
    static CTicTac tictac;
    {
      ...
      noisyPoseIncr.x_incr(randomGenerator.drawGaussian1D(
          0, options.odometry_noise_std_xy / options.uncert_overestim_odom));
      noisyPoseIncr.y_incr(randomGenerator.drawGaussian1D(
          0, options.odometry_noise_std_xy / options.uncert_overestim_odom));
      noisyPoseIncr.phi_incr(randomGenerator.drawGaussian1D(
          0, options.odometry_noise_std_phi / options.uncert_overestim_odom));
    ...
    if (!options.sensorDistingishesLandmarks) {
      ASSERT_(m_lastObservation.sensedData.size() ==
              m_lastObservation_GT_indices.size());

      for (unsigned int o = 0; o < m_lastObservation.sensedData.size(); o++) {
        const bool o_has_assoc =
            (da.results.associations.find(o) != da.results.associations.end());
        const size_t o_realmap_idx =
            m_lastObservation_GT_indices[o]; // Note: This can be "-1" for
                                             // spurious readings!
        ...
        if (o_was_mapped) { // ALREADY OBSERVED IN THE PAST

          if (o_has_assoc) {
            if (m_estimatedIDX2realIDX[da.results.associations.find(o)
                                           ->second] == o_realmap_idx) {
              // True positive: If the LM was already known and it's been
              // recognized as such...
              hist.da_true_pos++;
            } else {
              // False positive:
            ...
            // False negative: It was an already known LM but has been wrongly
            // classified as new:
            hist.da_false_neg++;
          }
        } else { // OBSERVED FOR THE FIRST TIME
          ...
          if (o_has_assoc) {
            ...
            ASSERT_(o_has_been_just_inserted);
            // True negative: If the LM is a new one and it's been inserted as
            // such...
            hist.da_true_neg++;
          }
        }
...
void slamdemoFrame::OnConfigClicked(wxCommandEvent &event) {
  ...
  dlg.cbJacobTran->SetValue(
      !m_SLAM.KF_options.use_analytic_transition_jacobian);
  dlg.cbJacobObs->SetValue(
      !m_SLAM.KF_options.use_analytic_observation_jacobian);
  ...
  dlg.edPathStepSize->SetValue(
      wxString::Format(_("%f"), options.robot_step_length));
  dlg.edOdomStdXY->SetValue(
      wxString::Format(_("%f"), options.odometry_noise_std_xy));
  dlg.edStdOdomPhi->SetValue(
      wxString::Format(_("%f"), RAD2DEG(options.odometry_noise_std_phi)));

  dlg.cbSensorDistin->SetValue(options.sensorDistingishesLandmarks);
  dlg.edSeed->SetValue(options.random_seed);

  dlg.edStdRange->SetValue(
      wxString::Format(_("%f"), m_SLAM.options.std_sensor_range));
  dlg.edStdAngle->SetValue(
      wxString::Format(_("%f"), RAD2DEG(m_SLAM.options.std_sensor_yaw)));

  dlg.edSpuriousMean->SetValue(
      wxString::Format(_("%f"), options.spurious_count_mean));
  dlg.edSpuriousStd->SetValue(
      wxString::Format(_("%f"), options.spurious_count_std));
  ...
  dlg.edSenPhi->SetValue(
      wxString::Format(_("%f"), RAD2DEG(options.sensorOnTheRobot.phi())));
  ...
  dlg.edChi2->SetValue(
      wxString::Format(_("%.04f"), m_SLAM.options.data_assoc_IC_chi2_thres));
  ...
  if (dlg.ShowModal() == wxID_OK) {
    // Get all params
    // ---------------------------------------
    if (dlg.rbKFnaiv->GetValue())
      m_SLAM.KF_options.method = kfEKFNaive;
    if (dlg.rbKFdavison->GetValue())
      m_SLAM.KF_options.method = kfEKFAlaDavison;
    if (dlg.rbIKF->GetValue())
      m_SLAM.KF_options.method = kfIKFFull;
    if (dlg.rbIKFdavison->GetValue())
      m_SLAM.KF_options.method = kfIKF;
    m_SLAM.KF_options.IKF_iterations = dlg.edIKFiters->GetValue();

    m_SLAM.KF_options.use_analytic_transition_jacobian =
        !dlg.cbJacobTran->GetValue();
    m_SLAM.KF_options.use_analytic_observation_jacobian =
        !dlg.cbJacobObs->GetValue();
    ...
    options.odometry_noise_std_phi =
        DEG2RAD(atof(dlg.edStdOdomPhi->GetValue().mb_str()));
    ...
    m_SLAM.options.std_sensor_yaw =
        DEG2RAD(atof(dlg.edStdAngle->GetValue().mb_str()));
    ...
    options.sensorOnTheRobot.phi(
        DEG2RAD(atof(dlg.edSenPhi->GetValue().mb_str())));
    ...
    m_SLAM.options.data_assoc_IC_chi2_thres =
        atof(dlg.edChi2->GetValue().mb_str());
    m_SLAM.options.data_assoc_method =
        TDataAssociationMethod(dlg.rbDAMethod->GetSelection());
    m_SLAM.options.data_assoc_metric =
        TDataAssociationMetric(dlg.rbDAMetric->GetSelection());
    m_SLAM.options.data_assoc_IC_metric =
        TDataAssociationMetric(dlg.rbICmetric->GetSelection());
    m_SLAM.options.data_assoc_IC_ml_threshold =
        atof(dlg.edICMLrefDist->GetValue().mb_str());
...
void slamdemoFrame::OnMenuSaveFilterState(wxCommandEvent &event) {
  ...
  {
    wxFileDialog dialog(
        this, _("Save state vector...") /*caption*/, _(".") /* defaultDir */,
  ...
  {
    wxFileDialog dialog(
        this, _("Save covariance matrix...") /*caption*/,
        _(".") /* defaultDir */, _("kf_cov.txt") /* defaultFilename */,
        _("Text files (*.txt)|*.txt|All files (*.*)|*.*") /* wildcard */,
        wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
  ...
  {
    wxFileDialog dialog(this, _("Save as 3D opengl scene...") /*caption*/,
                        _(".") /* defaultDir */,
                        _("slam.3Dscene") /* defaultFilename */,
                        _("MRPT 3D scenes (*.3Dscene)|*.3Dscene|All files "
                          "(*.*)|*.*") /* wildcard */,
                        wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
...
void slamdemoFrame::OnmnuSaveLastDASelected(wxCommandEvent &event) {
  ...
  {
    wxFileDialog dialog(
        this, _("Save prediction landmark IDs...") /*caption*/,
        _(".") /* defaultDir */, _("prediction_IDs.txt") /* defaultFilename */,
        _("Text files (*.txt)|*.txt|All files (*.*)|*.*") /* wildcard */,
        wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
  ...
  {
    wxFileDialog dialog(
        this, _("Save prediction means...") /*caption*/,
        _(".") /* defaultDir */,
  ...
  {
    wxFileDialog dialog(
        this, _("Save prediction covariance...") /*caption*/,
        _(".") /* defaultDir */, _("prediction_cov.txt") /* defaultFilename */,
        _("Text files (*.txt)|*.txt|All files (*.*)|*.*") /* wildcard */,
        wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
...
void slamdemoFrame::OnmnuItemSaveRawlogSelected(wxCommandEvent &event) {
  ...
  if (saveMnuChkd) {
    // Start saving:
    wxFileDialog dialog(
        this, _("Save data set...") /*caption*/, _(".") /* defaultDir */,
    ...
    obs.text = std::string("Rawlog generated by 2d-slam-demo\n"
                           " MRPT version: ") +
