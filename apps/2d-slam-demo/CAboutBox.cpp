...
CAboutBox::CAboutBox(wxWindow *parent, wxWindowID id) {
  ...
  FlexGridSizer1->Add(Button11, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                      5);
...
void CAboutBox::OnInit(wxInitDialogEvent &event) {
...

  {
    ...
    cout << "None" << endl;
#endif
    cout << "Invoke with --help to see command line arguments.\n";
    cout << "This program was inspired by a MATLAB version written by J. Neira "
            "and J. Tardos.\n";
  }
