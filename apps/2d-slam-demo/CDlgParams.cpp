	...
	wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size)
{
	...
	Create(
		parent, wxID_ANY, _("Simulation configuration"), wxDefaultPosition,
	...
	rbKFnaiv = new wxRadioButton(
		this, ID_RADIOBUTTON1, _("Standard EKF"), wxDefaultPosition,
		wxDefaultSize, wxRB_GROUP, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
	FlexGridSizer3->Add(
		rbKFnaiv, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer3->Add(
		-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	rbKFdavison = new wxRadioButton(
		this, ID_RADIOBUTTON2, _("EKF (one scalar at a time)"),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_RADIOBUTTON2"));
	rbKFdavison->SetValue(true);
	FlexGridSizer3->Add(
		rbKFdavison, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer3->Add(
		-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	rbIKF = new wxRadioButton(
		this, ID_RADIOBUTTON3, _("IKF"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_RADIOBUTTON3"));
	FlexGridSizer3->Add(
		rbIKF, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer4 = new wxFlexGridSizer(0, 3, 0, 0);
	StaticText2 = new wxStaticText(
		this, ID_STATICTEXT2, _("IKF iters:"), wxDefaultPosition, wxDefaultSize,
		0, _T("ID_STATICTEXT2"));
	FlexGridSizer4->Add(
		StaticText2, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edIKFiters = new wxSpinCtrl(
		this, ID_SPINCTRL1, _T("3"), wxDefaultPosition, wxSize(39, 23), 0, 1,
		30, 3, _T("ID_SPINCTRL1"));
	...
	rbIKFdavison = new wxRadioButton(
		...
		_T("ID_RADIOBUTTON4"));
	FlexGridSizer3->Add(
		rbIKFdavison, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer3->Add(-1, -1, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	cbJacobTran = new wxCheckBox(
		this, ID_CHECKBOX2, _("Transition model"), wxDefaultPosition,
	...
	FlexGridSizer3->Add(-1, -1, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	cbJacobObs = new wxCheckBox(
		this, ID_CHECKBOX3, _("Observation model"), wxDefaultPosition,
	...
	edPathLen = new wxTextCtrl(
		this, ID_TEXTCTRL3, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL3"));
	FlexGridSizer10->Add(
		edPathLen, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText4 = new wxStaticText(
		this, ID_STATICTEXT4, _("Each step length (m):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer10->Add(
		StaticText4, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edPathStepSize = new wxTextCtrl(
		this, ID_TEXTCTRL4, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0,
	...
	edOdomStdXY = new wxTextCtrl(
		this, ID_TEXTCTRL5, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
	...
	edStdOdomPhi = new wxTextCtrl(
		this, ID_TEXTCTRL6, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
	...
	FlexGridSizer9->Add(
		StaticText17, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edChi2 = new wxTextCtrl(
		panelDA, ID_TEXTCTRL13, wxEmptyString, wxDefaultPosition, wxDefaultSize,
		0, wxDefaultValidator, _T("ID_TEXTCTRL13"));
	FlexGridSizer9->Add(
		edChi2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	...
	FlexGridSizer9->Add(
		StaticText24, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edICMLrefDist = new wxTextCtrl(
		panelDA, ID_TEXTCTRL15, wxEmptyString, wxDefaultPosition, wxDefaultSize,
		0, wxDefaultValidator, _T("ID_TEXTCTRL15"));
	FlexGridSizer9->Add(
		edICMLrefDist, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	wxString __wxRadioBoxChoices_2[2] = {_("Nearest neighbor"), _("JCBB")};
	rbDAMethod = new wxRadioBox(
	...
	FlexGridSizer11->Add(
		...
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer6->Add(
		FlexGridSizer11, 1, wxALL | wxALIGN_RIGHT | wxALIGN_BOTTOM, 0);
	rbMapRandom = new wxRadioButton(
		this, ID_RADIOBUTTON6, _("Random"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_RADIOBUTTON6"));
	rbMapRandom->SetValue(true);
	FlexGridSizer6->Add(
		rbMapRandom, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer7 = new wxFlexGridSizer(0, 5, 0, 0);
	StaticText7 = new wxStaticText(
		this, ID_STATICTEXT7, _("# landmarks:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	FlexGridSizer7->Add(
		StaticText7, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edLMs = new wxSpinCtrl(
		this, ID_SPINCTRL2, _T("60"), wxDefaultPosition, wxSize(52, 23), 0, 1,
		1000, 60, _T("ID_SPINCTRL2"));
	edLMs->SetValue(_T("60"));
	FlexGridSizer7->Add(
		edLMs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText8 = new wxStaticText(
		this, ID_STATICTEXT8, _("Random seed:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer7->Add(
		StaticText8, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edSeed = new wxSpinCtrl(
		this, ID_SPINCTRL3, _T("-1"), wxDefaultPosition, wxSize(61, 23), 0, -1,
		10000000, -1, _T("ID_SPINCTRL3"));
	...
	FlexGridSizer6->Add(
		rbMapFile, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	...
	edStdRange = new wxTextCtrl(
		this, ID_TEXTCTRL7, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL7"));
	FlexGridSizer14->Add(
		edStdRange, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText1 = new wxStaticText(
		this, ID_STATICTEXT1, _("Max. Range (m):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	FlexGridSizer14->Add(
		StaticText1, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edMaxR = new wxTextCtrl(
		this, ID_TEXTCTRL1, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL1"));
	FlexGridSizer14->Add(
		edMaxR, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	...
	edStdAngle = new wxTextCtrl(
		this, ID_TEXTCTRL8, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL8"));
	FlexGridSizer14->Add(
		edStdAngle, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText23 = new wxStaticText(
		this, ID_STATICTEXT23, _("Min. Range (m):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT23"));
	FlexGridSizer14->Add(
		StaticText23, 1, wxALL | wxALIGN_RIGHT | wxALIGN_TOP, 5);
	edMinR = new wxTextCtrl(
		this, ID_TEXTCTRL14, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL14"));
	FlexGridSizer14->Add(edMinR, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	StaticText10 = new wxStaticText(
		this, ID_STATICTEXT10, _("FOV (deg):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT10"));
	FlexGridSizer14->Add(
		StaticText10, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edFOV = new wxTextCtrl(
		this, ID_TEXTCTRL12, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
	...
	StaticText14 = new wxStaticText(
		this, ID_STATICTEXT14, _("x (m):"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT14"));
	FlexGridSizer15->Add(
		StaticText14, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText15 = new wxStaticText(
		this, ID_STATICTEXT15, _("y (m):"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT15"));
	FlexGridSizer15->Add(
		StaticText15, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText16 = new wxStaticText(
		this, ID_STATICTEXT16, _("phi (deg):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT16"));
	FlexGridSizer15->Add(
		StaticText16, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edSenX = new wxTextCtrl(
		this, ID_TEXTCTRL9, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL9"));
	FlexGridSizer15->Add(
		edSenX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	edSenY = new wxTextCtrl(
		this, ID_TEXTCTRL10, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL10"));
	FlexGridSizer15->Add(
		edSenY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	edSenPhi = new wxTextCtrl(
		this, ID_TEXTCTRL11, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
	...
	StaticText26 = new wxStaticText(
		...
		_T("ID_STATICTEXT26"));
	FlexGridSizer20->Add(
		StaticText26, 1, wxALL | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL, 5);
	...
	StaticText27 = new wxStaticText(
		this, ID_STATICTEXT27, _("Mean (#readings):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT27"));
	FlexGridSizer21->Add(
		StaticText27, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText28 = new wxStaticText(
		this, ID_STATICTEXT28, _("Std.Dev. (#readings):"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT28"));
	FlexGridSizer21->Add(
		StaticText28, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edSpuriousMean = new wxTextCtrl(
		this, ID_TEXTCTRL16, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL16"));
	FlexGridSizer21->Add(
		edSpuriousMean, 1, wxALL | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL,
		5);
	edSpuriousStd = new wxTextCtrl(
		this, ID_TEXTCTRL17, _("Text"), wxDefaultPosition, wxDefaultSize, 0,
	...
	StaticText18 = new wxStaticText(
		this, ID_STATICTEXT18, _("Odometry errors:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT18"));
	FlexGridSizer19->Add(
		StaticText18, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edOverOdom = new wxSpinCtrl(
		this, ID_SPINCTRL4, _T("120"), wxDefaultPosition, wxSize(70, -1), 0, 1,
		10000, 120, _T("ID_SPINCTRL4"));
	edOverOdom->SetValue(_T("120"));
	FlexGridSizer19->Add(edOverOdom, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	StaticText19 = new wxStaticText(
		this, ID_STATICTEXT19, _("%"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT19"));
	FlexGridSizer19->Add(
		StaticText19, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	StaticText20 = new wxStaticText(
		this, ID_STATICTEXT20, _("Sensor errors:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT20"));
	FlexGridSizer19->Add(
		StaticText20, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edOverSensor = new wxSpinCtrl(
		this, ID_SPINCTRL5, _T("120"), wxDefaultPosition, wxSize(70, -1), 0, 1,
		10000, 120, _T("ID_SPINCTRL5"));
	edOverSensor->SetValue(_T("120"));
	FlexGridSizer19->Add(
		edOverSensor, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
	StaticText21 = new wxStaticText(
		this, ID_STATICTEXT21, _("%"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT21"));
	FlexGridSizer19->Add(
		StaticText21, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer18->Add(
		FlexGridSizer19, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 0);
