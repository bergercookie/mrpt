...
void CMyGLCanvas::OnPostRender() {
  ...
  mrpt::opengl::CRenderizable::renderTextBitmap(20, 20, s.c_str(), 1, 0, 0,
                                                MRPT_GLUT_BITMAP_HELVETICA_18);

  const mrpt::math::TTwist2D vel_local = the_robot.getCurrentGTVelLocal();
  s = format("V=%.03fm/s  W=%.02fdeg/s", vel_local.vx,
             RAD2DEG(vel_local.omega));
  mrpt::opengl::CRenderizable::renderTextBitmap(20, 45, s.c_str(), 1, 0, 0,
                                                MRPT_GLUT_BITMAP_HELVETICA_18);
}
...
gridmapSimulFrame::gridmapSimulFrame(wxWindow *parent, wxWindowID id) {
  ...
  Panel1 = new wxPanel(SplitterWindow1, ID_PANEL1, wxDefaultPosition,
                       wxSize(983, 291), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
  Panel1->SetMinSize(wxSize(400, 250));
  FlexGridSizer2 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer2->AddGrowableCol(0);
  // FlexGridSizer2->AddGrowableRow();
  Panel2 = new wxPanel(Panel1, ID_PANEL2, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL2"));
  FlexGridSizer3 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer3->AddGrowableCol(0);
  Panel3 = new wxPanel(Panel2, ID_PANEL3, wxDefaultPosition, wxSize(622, 67),
  ...
  StaticText1 = new wxStaticText(Panel3, ID_STATICTEXT1, _("Range count:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT1"));
  FlexGridSizer5->Add(StaticText1, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edCount =
      new wxTextCtrl(Panel3, ID_TEXTCTRL1, _("361"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer5->Add(edCount, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText2 = new wxStaticText(Panel3, ID_STATICTEXT2, _("Span (deg):"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT2"));
  FlexGridSizer5->Add(StaticText2, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edSpan =
      new wxTextCtrl(Panel3, ID_TEXTCTRL2, _("180"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer5->Add(edSpan, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText3 = new wxStaticText(Panel3, ID_STATICTEXT3,
                                 _("Range noise std. (m):"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT3"));
  FlexGridSizer5->Add(StaticText3, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edStdNoise =
      new wxTextCtrl(Panel3, ID_TEXTCTRL3, _("0.01"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
  FlexGridSizer5->Add(edStdNoise, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText8 = new wxStaticText(
      Panel3, ID_STATICTEXT8, _("Bearing noise std. (deg):"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT8"));
  FlexGridSizer5->Add(StaticText8, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edStdNoiseAng =
      new wxTextCtrl(Panel3, ID_TEXTCTRL5, _("0.05"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
  FlexGridSizer5->Add(edStdNoiseAng, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  btnSetLaser =
      new wxButton(Panel3, ID_BUTTON5, _("Apply"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer5->Add(btnSetLaser, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  StaticBoxSizer1->Add(FlexGridSizer5, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12->Add(StaticBoxSizer1, 1, wxALL | wxEXPAND | wxALIGN_TOP |
  ...
  StaticText16 = new wxStaticText(Panel3, ID_STATICTEXT16, _("Decimation:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT16"));
  FlexGridSizer13->Add(StaticText16, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edDecimate = new wxSpinCtrl(Panel3, ID_SPINCTRL1, _T("1"), wxDefaultPosition,
                              wxDefaultSize, 0, 1, 100, 1, _T("ID_SPINCTRL1"));
  edDecimate->SetValue(_T("1"));
  FlexGridSizer13->Add(edDecimate, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer6->Add(FlexGridSizer13, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12->Add(StaticBoxSizer6, 1,
  ...
  StaticText9 = new wxStaticText(Panel3, ID_STATICTEXT9, _MYTT("\u0394x bias:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT9"));
  FlexGridSizer9->Add(StaticText9, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAxb =
      new wxTextCtrl(Panel3, ID_TEXTCTRL6, _("1e-5"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
  FlexGridSizer9->Add(
      edAxb, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText13 = new wxStaticText(Panel3, ID_STATICTEXT13,
                                  _MYTT("\u0394x std:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT13"));
  FlexGridSizer9->Add(StaticText13, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAxs =
      new wxTextCtrl(Panel3, ID_TEXTCTRL7, _("10e-4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL7"));
  FlexGridSizer9->Add(
      edAxs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText10 = new wxStaticText(Panel3, ID_STATICTEXT10,
                                  _MYTT("\u0394y bias:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT10"));
  FlexGridSizer9->Add(StaticText10, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAyb =
      new wxTextCtrl(Panel3, ID_TEXTCTRL8, _("1e-5"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL8"));
  FlexGridSizer9->Add(
      edAyb, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText11 = new wxStaticText(Panel3, ID_STATICTEXT11,
                                  _MYTT("\u0394y std:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT11"));
  FlexGridSizer9->Add(StaticText11, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAys =
      new wxTextCtrl(Panel3, ID_TEXTCTRL9, _("10e-4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL9"));
  FlexGridSizer9->Add(
      edAys, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText12 = new wxStaticText(
      Panel3, ID_STATICTEXT12, _MYTT("\u0394\u03C6 bias:"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT12"));
  FlexGridSizer9->Add(StaticText12, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edApb =
      new wxTextCtrl(Panel3, ID_TEXTCTRL10, _("5e-4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL10"));
  FlexGridSizer9->Add(
      edApb, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText14 = new wxStaticText(Panel3, ID_STATICTEXT14,
                                  _MYTT("\u0394\u03C6 std:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT14"));
  FlexGridSizer9->Add(StaticText14, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAps =
      new wxTextCtrl(Panel3, ID_TEXTCTRL11, _("10e-4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL11"));
  FlexGridSizer9->Add(
      edAps, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticBoxSizer3->Add(FlexGridSizer9, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer7->Add(StaticBoxSizer3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  StaticBoxSizer5 =
  ...
  FlexGridSizer11->Add(StaticText4, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnResimulate =
      new wxButton(Panel3, ID_BUTTON4, _("Re-simulate..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  FlexGridSizer11->Add(btnResimulate, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer5->Add(FlexGridSizer11, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer7->Add(StaticBoxSizer5, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer4->Add(FlexGridSizer7, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, Panel3, _("Controls"));
  FlexGridSizer8 = new wxFlexGridSizer(0, 1, 0, 0);
  cbJoy =
      new wxCheckBox(Panel3, ID_CHECKBOX1, _("Use joystick"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbJoy->SetValue(true);
  FlexGridSizer8->Add(cbJoy, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText6 = new wxStaticText(
      Panel3, ID_STATICTEXT6,
      _("Use arrow keys for inc/decrement speed and turn."), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT6"));
  FlexGridSizer8->Add(StaticText6, 1,
  ...
  FlexGridSizer8->Add(StaticText7, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);

  FlexGridSizer8->Add(new wxStaticText(Panel3, ID_STATICTEXT6,
                                       _("Enter keystrokes in this box:"),
                                       wxDefaultPosition, wxDefaultSize, 0,
                                       _T("ID_STATICTEXT6")),
  ...
  FlexGridSizer8->Add(edInput, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);

  StaticBoxSizer2->Add(FlexGridSizer8, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer4->Add(StaticBoxSizer2, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  btnExit =
      new wxButton(Panel3, ID_BUTTON6, _("Exit"), wxDefaultPosition,
  ...
  FlexGridSizer3->Add(Panel3, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel4 = new wxPanel(Panel2, ID_PANEL4, wxDefaultPosition, wxSize(622, 55),
                       wxTAB_TRAVERSAL, _T("ID_PANEL4"));
  FlexGridSizer6 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer6->AddGrowableCol(0);
  StaticBoxSizer4 =
      new wxStaticBoxSizer(wxHORIZONTAL, Panel4, _("Rawlog generation"));
  Panel5 = new wxPanel(Panel4, ID_PANEL6, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL6"));
  FlexGridSizer10 = new wxFlexGridSizer(0, 5, 0, 0);
  FlexGridSizer10->AddGrowableCol(3);
  btnStart =
      new wxButton(Panel5, ID_BUTTON1, _("START"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  FlexGridSizer10->Add(btnStart, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                        wxALIGN_CENTER_VERTICAL,
                       5);
  btnEnd = new wxButton(Panel5, ID_BUTTON2, _("STOP"), wxDefaultPosition,
                        wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
  btnEnd->Disable();
  FlexGridSizer10->Add(btnEnd, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText5 = new wxStaticText(Panel5, ID_STATICTEXT5, _("Output rawlog:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT5"));
  FlexGridSizer10->Add(StaticText5, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edOutFile = new wxTextCtrl(Panel5, ID_TEXTCTRL4, _("./simul.rawlog"),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_TEXTCTRL4"));
  FlexGridSizer10->Add(edOutFile, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnExplore =
      new wxButton(Panel5, ID_BUTTON3, _("Browse..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
  FlexGridSizer10->Add(btnExplore, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  cbRawlogSFformat = new wxCheckBox(
      Panel5, ID_CHECKBOX_RAWLOG_FORMAT, _("Act/SF format"), wxDefaultPosition,
      wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_RAWLOG_FORMAT"));
  cbRawlogSFformat->SetValue(false);
  FlexGridSizer10->Add(cbRawlogSFformat, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                       5);

  FlexGridSizer10->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText15 = new wxStaticText(Panel5, ID_STATICTEXT15,
                                  _("Output groundtruth:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT15"));
  FlexGridSizer10->Add(StaticText15, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edOutGT = new wxTextCtrl(Panel5, ID_TEXTCTRL12, _("./simul.rawlog.GT.txt"),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_TEXTCTRL12"));
  edOutGT->Disable();
  FlexGridSizer10->Add(edOutGT, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel5->SetSizer(FlexGridSizer10);
  FlexGridSizer10->Fit(Panel5);
  FlexGridSizer10->SetSizeHints(Panel5);
  StaticBoxSizer4->Add(Panel5, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       0);
  FlexGridSizer6->Add(StaticBoxSizer4, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel4->SetSizer(FlexGridSizer6);
  FlexGridSizer6->SetSizeHints(Panel4);
  FlexGridSizer3->Add(Panel4, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel2->SetSizer(FlexGridSizer3);
  FlexGridSizer3->Fit(Panel2);
  FlexGridSizer3->SetSizeHints(Panel2);
  FlexGridSizer2->Add(Panel2, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel1->SetSizer(FlexGridSizer2);
  FlexGridSizer2->SetSizeHints(Panel1);
  panelGL = new wxPanel(SplitterWindow1, ID_PANEL5, wxDefaultPosition,
  ...
  Menu1 = new wxMenu();
  MenuItem1 =
      new wxMenuItem(Menu1, ID_MENUITEM1, _("Set &output rawlog file..."),
  ...
  MenuItemLoadMap =
      new wxMenuItem(Menu1, ID_MENUITEM_LOADMAP, _("Load &gridmap..."),
                     wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItemLoadMap);

  MenuItem2 = new wxMenuItem(Menu1, ID_MENUITEM2, _("&Quit"), wxEmptyString,
                             wxITEM_NORMAL);
  ...
  Menu2 = new wxMenu();
  MenuItem3 = new wxMenuItem(Menu2, ID_MENUITEM3, _("&About..."), wxEmptyString,
                             wxITEM_NORMAL);
  ...
  Connect(ID_MENUITEM1, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&gridmapSimulFrame::OnbtnExploreClick);
  Connect(ID_MENUITEM_LOADMAP, wxEVT_COMMAND_MENU_SELECTED,
  ...
  m_canvas->m_openGLScene->insert(
      std::make_shared<mrpt::opengl::CGridPlaneXY>(-100, 100, -100, 100, 0, 5));

  update_grid_map_3d();
  m_canvas->m_openGLScene->insert(gl_grid);

  // paths:
  gl_path_GT = std::make_shared<mrpt::opengl::CPointCloud>();
  ...
  gl_path_ODO = std::make_shared<mrpt::opengl::CPointCloud>();
  ...
  gl_scan = std::make_shared<mrpt::opengl::CPlanarLaserScan>();
  gl_robot->insert(gl_scan);

  // Redirect all keystrokes in this box to the gl canvas:
  edInput->Connect(wxEVT_CHAR,
                   (wxObjectEventFunction)&CMyGLCanvas::OnCharCustom, nullptr,
                   m_canvas);
...
void gridmapSimulFrame::update_grid_map_3d() {
  if (!gl_grid)
    gl_grid = std::make_shared<CSetOfObjects>();
  gl_grid->clear();
...
void gridmapSimulFrame::OntimRunTrigger(wxTimerEvent &event) {
  ...
  try {
    ...
    the_grid.laserScanSimulator(the_scan, mrpt::poses::CPose2D(p), 0.6f,
                                LASER_N_RANGES, LASER_STD_ERROR, 1,
...
#ifdef DO_SCAN_LIKELIHOOD_DEBUG
    {
      ...
      ssu_params.robotPose.cov << square(0.25), 0.0, 0.0, 0.0, square(0.25),
          0.0, 0.0, 0.0, square(DEG2RAD(5.0));
    ...
    if (!btnStart->IsEnabled()) {
      ...
      if (!outs.fileOpenCorrectly()) {
        if (!outs.open(string(edOutFile->GetValue().mb_str()))) {
          wxCommandEvent dum;
          OnbtnEndClick(dum);
          wxMessageBox(_("Cannot open output rawlog file."), _("Error"), wxOK,
                       this);
        }
        ...
        if (!out_GT.open(string(edOutGT->GetValue().mb_str()))) {
          ...
          wxCommandEvent dum;
          OnbtnEndClick(dum);
          wxMessageBox(_("Cannot open output GT file."), _("Error"), wxOK,
                       this);
        }
        ...
        string grid_file =
            string(edOutFile->GetValue().mb_str()) + string("_grid.gridmap.gz");
        if (!out_grid.open(grid_file)) {
          outs.close();
          out_GT.close();
          wxCommandEvent dum;
          OnbtnEndClick(dum);
          wxMessageBox(_("Cannot open output file for the reference gridmap!."),
                       _("Error"), wxOK, this);
        }
    ...
    if (!robot_path_GT.empty()) {
      gl_path_GT->insertPoint(robot_path_GT.rbegin()->x(),
                              robot_path_GT.rbegin()->y(), 0);
...
void gridmapSimulFrame::OnbtnStartClick(wxCommandEvent &event) {
  ...
  the_robot.setOdometryErrors(true, Ax_err_bias, Ax_err_std, Ay_err_bias,
...
void gridmapSimulFrame::OnbtnResimulateClick(wxCommandEvent &event) {
  ...
  string gt_file;
  {
    wxFileDialog dialog(this, _("Existing GT file..."), _("."), _("GT.txt"),
  ...
  for (size_t i = 1; i < rawlog.size(); i += 2) {
    ...
    the_grid.laserScanSimulator(*the_scan, gt_pose, 0.5f, LASER_N_RANGES,
