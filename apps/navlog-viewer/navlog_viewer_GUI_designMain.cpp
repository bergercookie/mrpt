...
#define ADD_WIN_TEXTMSG_COL(__MSG, __COL)                                      \
  win1->addTextMessage(5.0, 5 + (lineY++) * Ay, __MSG, __COL, "mono", fy,      \
                       mrpt::opengl::NICE, unique_id++);
...
protected:
  virtual wxBitmap CreateBitmap(const wxArtID &id, const wxArtClient &client,
    ...
    // Any wxWidgets icons not implemented here will be provided by the default
    // art provider.
    return wxNullBitmap;
  }
};

navlog_viewer_GUI_designDialog::navlog_viewer_GUI_designDialog(wxWindow *parent,
                                                               wxWindowID id) {
// Load my custom icons:
  ...
  Create(
      ...
      wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
  Move(wxPoint(20, 20));
  FlexGridSizer1 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer1->AddGrowableCol(0);
  FlexGridSizer1->AddGrowableRow(0);
  Panel_AUX = new wxPanel(this, ID_PANEL1, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer10->Add(btnQuit, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText1 = new wxStaticText(Panel_AUX, ID_STATICTEXT1, _("Loaded file:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT1"));
  FlexGridSizer10->Add(StaticText1, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edLogFile = new wxTextCtrl(
      Panel_AUX, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxDefaultSize,
      wxTE_MULTILINE | wxTE_READONLY, wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer10->Add(edLogFile, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  rbPerPTGPlots = new wxRadioBox(Panel_AUX, ID_RADIOBOX1, _("Per PTG plots:"),
                                 wxDefaultPosition, wxDefaultSize, 3,
                                 __wxRadioBoxChoices_1, 1, wxRA_HORIZONTAL,
                                 wxDefaultValidator, _T("ID_RADIOBOX1"));
  FlexGridSizer3->Add(rbPerPTGPlots, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  cbList = new wxCheckListBox(Panel_AUX, ID_CHECKLISTBOX1, wxDefaultPosition,
                              wxSize(250, 71), 0, 0, 0, wxDefaultValidator,
                              _T("ID_CHECKLISTBOX1"));
  FlexGridSizer3->Add(cbList, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      2);
  FlexGridSizer11->Add(FlexGridSizer3, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer2->Add(FlexGridSizer11, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer4 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer4->AddGrowableCol(0);
  Panel1 = new wxPanel(Panel_AUX, ID_PANEL2, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL2"));
  FlexGridSizer7 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer7->AddGrowableCol(0);
  FlexGridSizer6 = new wxFlexGridSizer(0, 2, 0, 0);
  FlexGridSizer6->AddGrowableCol(0);
  slidLog = new wxSlider(Panel1, ID_SLIDER1, 0, 0, 100, wxDefaultPosition,
                         wxDefaultSize, wxSL_LABELS, wxDefaultValidator,
                         _T("ID_SLIDER1"));
  FlexGridSizer6->Add(slidLog, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  btnMoreOps =
      new wxButton(Panel1, ID_BUTTON6, _("More ops..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON6"));
  FlexGridSizer6->Add(btnMoreOps, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer7->Add(FlexGridSizer6, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer5 = new wxFlexGridSizer(0, 6, 0, 0);
  btnPlay =
      new wxButton(Panel1, ID_BUTTON4, _("Play"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  FlexGridSizer5->Add(btnPlay, 1,
                      wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
  btnStop =
      new wxButton(Panel1, ID_BUTTON5, _("Stop"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  btnStop->Disable();
  FlexGridSizer5->Add(btnStop, 1,
                      wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
  StaticText6 = new wxStaticText(Panel1, ID_STATICTEXT9,
                                 _("Animation delay (ms):"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT9"));
  FlexGridSizer5->Add(StaticText6, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAnimDelayMS =
      new wxTextCtrl(Panel1, ID_TEXTCTRL3, _("50"), wxDefaultPosition,
                     wxSize(55, 21), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
  FlexGridSizer5->Add(edAnimDelayMS, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  StaticText5 = new wxStaticText(Panel1, ID_STATICTEXT8,
                                 _("Shape draw min. dist:"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT8"));
  FlexGridSizer5->Add(StaticText5, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edShapeMinDist =
      new wxTextCtrl(Panel1, ID_TEXTCTRL2, _("1.0"), wxDefaultPosition,
                     wxSize(55, 21), 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer5->Add(edShapeMinDist, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer7->Add(FlexGridSizer5, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel1->SetSizer(FlexGridSizer7);
  FlexGridSizer7->Fit(Panel1);
  FlexGridSizer7->SetSizeHints(Panel1);
  FlexGridSizer4->Add(Panel1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  StaticBoxSizer2 =
      new wxStaticBoxSizer(wxHORIZONTAL, Panel_AUX, _("Information:"));
  Panel3 = new wxPanel(Panel_AUX, ID_PANEL3, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL3"));
  FlexGridSizer9 = new wxFlexGridSizer(0, 2, 0, 0);
  StaticText2 = new wxStaticText(Panel3, ID_STATICTEXT2, _("Log entries:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT2"));
  FlexGridSizer9->Add(StaticText2, 1, wxALL | wxALIGN_RIGHT | wxALIGN_TOP, 5);
  txtLogEntries =
      new wxStaticText(Panel3, ID_STATICTEXT3, _("0"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT3"));
  FlexGridSizer9->Add(txtLogEntries, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText3 = new wxStaticText(Panel3, ID_STATICTEXT4, _("Duration:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT4"));
  FlexGridSizer9->Add(StaticText3, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtLogDuration =
      new wxStaticText(Panel3, ID_STATICTEXT5, _("0"), wxDefaultPosition,
                       wxSize(80, -1), 0, _T("ID_STATICTEXT5"));
  FlexGridSizer9->Add(txtLogDuration, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText4 = new wxStaticText(Panel3, ID_STATICTEXT6, _("Selected PTG:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT6"));
  FlexGridSizer9->Add(StaticText4, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtSelectedPTG =
      new wxStaticText(Panel3, ID_STATICTEXT7, _("-"), wxDefaultPosition,
                       wxSize(80, -1), 0, _T("ID_STATICTEXT7"));
  ...
  StaticBoxSizer2->Add(Panel3, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       0);
  FlexGridSizer4->Add(StaticBoxSizer2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer2->Add(FlexGridSizer4, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel_AUX->SetSizer(FlexGridSizer2);
  FlexGridSizer2->Fit(Panel_AUX);
  FlexGridSizer2->SetSizeHints(Panel_AUX);
  FlexGridSizer1->Add(Panel_AUX, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  mnuSeePTGParams =
      new wxMenuItem((&mnuMoreOps), ID_MENUITEM2, _("See PTG params..."),
                     wxEmptyString, wxITEM_NORMAL);
  mnuMoreOps.Append(mnuSeePTGParams);
  mnuMatlabPlots = new wxMenuItem((&mnuMoreOps), ID_MENUITEM1,
                                  _("Export map plot to MATLAB..."),
                                  wxEmptyString, wxITEM_NORMAL);
  mnuMoreOps.Append(mnuMatlabPlots);
  mnuSaveScoreMatrix =
      new wxMenuItem((&mnuMoreOps), ID_MENUITEM3, _("Save score matrices..."),
                     wxEmptyString, wxITEM_NORMAL);
  ...
  Connect(ID_CHECKLISTBOX1, wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
          (wxObjectEventFunction)&navlog_viewer_GUI_designDialog::
  ...
  Connect(
      ...
      (wxObjectEventFunction)&navlog_viewer_GUI_designDialog::OntimPlayTrigger);
...

  {
    ...
    Connect(ID_MENUITEM_SAVE_MATLAB_PATH, wxEVT_COMMAND_MENU_SELECTED,
            (wxObjectEventFunction)&navlog_viewer_GUI_designDialog::
...
void navlog_viewer_GUI_designDialog::OnbtnLoadClick(wxCommandEvent &event) {
  ...
  wxFileDialog dialog(
      ...
      _("") /* defaultFilename */, _("Navigation logs "
  ...
  for (;;) {
    try {
      ...
      if (validClasses.find(string(obj->GetRuntimeClass()->className)) ==
          validClasses.end()) {
        wxMessageBox(_U(format("Unexpected class found: %s",
      ...
      // EOF in the middle of an object... It may be usual if the logger is shut
      // down not cleanly.
...
void navlog_viewer_GUI_designDialog::UpdateInfoFromLoadedLog() {
  ...
  if (N > 0) {
    ...
    // In the past there was a window here to draw cmd_vels: it's now replaced
    // by a more versatile system to log
...
void navlog_viewer_GUI_designDialog::OnslidLogCmdScroll(wxScrollEvent &event) {
  ...
  txtSelectedPTG->SetLabel(
      wxString::Format(_("%i from [0-%u]"), static_cast<int>(log.nSelectedPTG),
  ...
  // --------------------------------
  {
    ...
    if (!win1) {
      win1 = std::make_shared<CDisplayWindow3D>("Sensed obstacles", 500, 400);
      win1->setPos(800, 20);
      ...
      win1->setCameraElevationDeg(90);
      {
        ...
        mrpt::opengl::CGridPlaneXY::Ptr gl_grid =
            std::make_shared<mrpt::opengl::CGridPlaneXY>(-20, 20, -20, 20, 0, 1,
                                                         0.75f);
    ...
    // Update 3D view:
    {
      ...
      mrpt::opengl::CSetOfObjects::Ptr gl_robot_frame;
      {
        ...
        if (!gl_rbframe_r) {
          gl_robot_frame = std::make_shared<mrpt::opengl::CSetOfObjects>();
        ...
        if (cbList->IsChecked(m_cbIdx_GlobalFrame)) {
          ...
          if ((mrpt::math::TPoint2D(log.robotPoseLocalization) -
               mrpt::math::TPoint2D(px, py))
                  .norm() > .3 * cam_zoom)
            win1->setCameraPointingToPoint(log.robotPoseLocalization.x,
      ...
      // Extrapolated poses from delay models:
      {
        ...
        if (!gl_relposes_r) {
          gl_relposes = std::make_shared<mrpt::opengl::CSetOfObjects>();
          gl_relposes->setName("relposes");
          gl_robot_frame->insert(gl_relposes);
        } else {
          gl_relposes = std::dynamic_pointer_cast<mrpt::opengl::CSetOfObjects>(
              gl_relposes_r);
        }
      ...
      }
      {
        ...
        if (!gl_obs_r) {
          ...
          gl_obs =
              std::dynamic_pointer_cast<mrpt::opengl::CPointCloud>(gl_obs_r);
        }
...

      {
        ...
        if (!gl_path_r) {
          ...
          gl_path =
              std::dynamic_pointer_cast<mrpt::opengl::CSetOfLines>(gl_path_r);
        }
        if (sel_ptg_idx < int(m_logdata_ptg_paths.size()) && sel_ptg_idx >= 0) {
          ...
          if (ptg) {
            ...
            ptg->updateNavDynamicState(is_NOP_cmd ? log.ptg_last_navDynState
                                                  : log.navDynState);
            ...
            }
            {
              ...
              if (!gl_shape_r) {
                ...
                gl_shape = std::dynamic_pointer_cast<mrpt::opengl::CSetOfLines>(
                    gl_shape_r);
              }
              gl_shape->clear();
      ...
      }
      {
        ...
        if (!gl_trg_r) {
          ...
          gl_trg =
              std::dynamic_pointer_cast<mrpt::opengl::CPointCloud>(gl_trg_r);
        }
        // Move the map & add a point at (0,0,0) so the name label appears at
        // the target:
        gl_trg->clear();
...

    {
      ...
      if (nObsFiltered) {
        ADD_WIN_TEXTMSG(mrpt::format("Obstacle points=%u (%u filtered out)",
                                     nObs, nObsFiltered));
      } else {
    ...
    ADD_WIN_TEXTMSG(
        mrpt::format("cmd_vel=%s", log.cmd_vel ? log.cmd_vel->asString().c_str()
                                               : "NOP (Continue last PTG)"));

    ADD_WIN_TEXTMSG(mrpt::format(
        "cur_vel      =[%.02f m/s, %0.2f m/s, %.02f dps]", log.cur_vel.vx,
        log.cur_vel.vy, mrpt::utils::RAD2DEG(log.cur_vel.omega)));
    ADD_WIN_TEXTMSG(mrpt::format(
        "cur_vel_local=[%.02f m/s, %0.2f m/s, %.02f dps]", log.cur_vel_local.vx,
        log.cur_vel_local.vy, mrpt::utils::RAD2DEG(log.cur_vel_local.omega)));

    ADD_WIN_TEXTMSG(mrpt::format("robot_pose=%s",
                                 log.robotPoseLocalization.asString().c_str()));
    {
      for (unsigned int i = 0; i < log.WS_targets_relative.size(); i++) {
        ADD_WIN_TEXTMSG(
            mrpt::format("rel_target[%u]=%s", i,
...

    {
      ...
      for (size_t i = 0; i < log.infoPerPTG.size(); i++)
        ss << "PTG#" << i
           << mrpt::format(" TPObs:%ss HoloNav:%ss |",
    ...
    for (unsigned int nPTG = 0; nPTG < log.infoPerPTG.size(); nPTG++) {
      ...
      ADD_WIN_TEXTMSG_COL(
          mrpt::format(
              "PTG#%u: SelDir=%+7.01f deg SelSpeed=%.03f Eval=%5.03f. %s", nPTG,
              mrpt::utils::RAD2DEG(pI.desiredDirection), pI.desiredSpeed,
               ...
               // used for "NOP cmdvel"
  {
    ...
    if (!win) {
      ...
      win = std::make_shared<CDisplayWindow3D>(format("%u|TP-Obstacles", nPTG),
                                               W, H);
      win->setPos(20 + (W + 10) * (nPTG % 3), 280 + (H + 10) * (nPTG / 3));
      win->addTextMessage(
          4, 4, format("[%u]:%s", nPTG, log.infoPerPTG[nPTG].PTG_desc.c_str()),
          TColorf(1.0f, 1.0f, 1.0f), "sans", 8, mrpt::opengl::NICE, 0 /*id*/,
          1.5, 0.1, true /*shadow*/);

      {
        ...
        {
          auto gl_obj =
              std::make_shared<mrpt::opengl::CMesh>(true /*transparency*/);
...

    {
      ...
      win->addTextMessage(
          ...
          "mono", 8, mrpt::opengl::NICE, 0 /*id*/, 1.5, 0.1, true /*shadow*/);
      ...
      // Chosen direction:
      {
        ...
        gl_obj->clear();
        gl_obj->appendLine(0, 0, 0, pI.desiredSpeed * cos(aDir),
      ...
      // Target:
      {
        ...
        if (!pI.TP_Targets.empty()) {
          ...
          win->addTextMessage(
              4, -12, format("TP_Target[0]=(%.02f,%.02f) k=%i ang=%.02f deg",
                             pI.TP_Targets[0].x, pI.TP_Targets[0].y,
                             tp_target_k, mrpt::utils::RAD2DEG(ang)),
              TColorf(1.0f, 1.0f, 1.0f), "mono", 8, mrpt::opengl::NICE,
              1 /*id*/, 1.5, 0.1, false /*shadow*/);
        }
      }
      if (cbList->IsChecked(m_cbIdx_ShowAllDebugFields)) {
        ...
        for (const auto &e : pI.evalFactors) {
          win->addTextMessage(
              ...
              mrpt::utils::TColorf(1, 1, 1), "mono", 9, mrpt::opengl::NICE,
              unique_id++, 1.5, 0.1, true);
        }
      }
...
void navlog_viewer_GUI_designDialog::OnmnuMatlabPlotsSelected(
  ...
  for (size_t i = 0; i < N; i++) {
    ...
    f << format("dec=dec+1; if (dec>=dec_shps); drawRobotShape(rs,[%f %f %f]); "
                "dec=0; end\n",
                robotPose.x, robotPose.y, robotPose.phi);

    if (++decim_point_cnt >= DECIMATE_POINTS) {
      CSimplePointsMap pts;
      pts.changeCoordinatesReference(logptr->WS_Obstacles,
                                     CPose3D(observationBasePose));
...
void navlog_viewer_GUI_designDialog::OnmnuSeePTGParamsSelected(
  ...
  wxMessageBox(_U(sCfgText.c_str()), _("PTG parameters as stored in the log:"),
               wxOK, this);

  WX_END_TRY
}

void navlog_viewer_GUI_designDialog::OncbGlobalFrameClick(
    wxCommandEvent &event) {
  if (cbList->IsChecked(m_cbIdx_ShowCursor))
...
void navlog_viewer_GUI_designDialog::OnmnuSaveScoreMatrixSelected(
  ...
  for (size_t i = 0; i < N; i++) {
    ...
    for (size_t iPTG = 0; iPTG < logptr->infoPerPTG.size(); iPTG++) {
      ...
      if (!dirs_scores || dirs_scores->getRowCount() < 2)
        continue;

      const std::string sFil = mrpt::system::fileNameChangeExtension(
          filName, mrpt::format("step%06u_ptg%02u.txt", (unsigned int)i,
                                (unsigned int)iPTG));
...
void navlog_viewer_GUI_designDialog::OntimMouseXY(wxTimerEvent &event) {
...

  {
    ...
    const mrpt::math::TPlane ground_plane(TPoint3D(0, 0, 0), TPoint3D(1, 0, 0),
                                          TPoint3D(0, 1, 0));
    ...
    if (inters.getPoint(inters_pt)) {
      ADD_WIN_TEXTMSG(mrpt::format("Mouse pos: X=%.04f  Y=%.04f", inters_pt.x,
                                   inters_pt.y));
      win1->repaint();
    }
  }
...
void navlog_viewer_GUI_designDialog::OnmnuMatlabExportPaths(
  ...
  wxFileDialog dialog(
      ...
      _(".") /* defaultDir */, _U((mrpt::system::extractFileName(std::string(
                                       this->edLogFile->GetValue().mb_str())) +
                                   std::string("_log.m"))
  ...
  for (size_t i = 0; i < N; i++) {
...

    {
      ...
      if (it != logptr->timestamps.end()) {
        ...
        tim_start_iteration++; // just in case we don't have valid iteration
                               // timestamp (??)
      }
    }
  ...
  for (const auto &e : global_local_vel) {
    f << (e.first - t_ref) << "," << e.second.pose.x << "," << e.second.pose.y
      << "," << e.second.pose.phi << ", " << e.second.poseOdom.x << ","
      << e.second.poseOdom.y << "," << e.second.poseOdom.phi << " ; ";
  }
  f << "];\n"
       ...
       "idxs_rob_incr_z = find(robot_pose_diff(:, 1) == 0 & robot_pose_diff(:, "
       "2) == 0 & robot_pose_diff(:, 3) == 0);\n"
       "plot(robot_pose(2:end, 1), diff(robot_pose(:, 2 : 4)), '.');\n"
       "hold on;\n"
       "plot(robot_pose(idxs_rob_incr_z, 1), robot_pose_diff(idxs_rob_incr_z, "
       ":), 'k', 'MarkerSize', 11, 'Marker', 'square');\n"
       "xlabel('Time'); legend('x', 'y', 'phi (rad)'); title('Robot pose "
       "*increments*');\n"
       "xlim(xl);\n\n";

  f << "% Selected PTG over time. Columns: [tim_start_iteration, 0-based index "
       "selected PTG]\n"
       "selected_PTG = [";
  ...
  if (!iteration_duration.empty()) {
    ...
    f << "];\n"
         ...
         "xlabel('Time'); legend('Iteration duration', 'Diff consecutive call "
         "time'); title('rnav_iter_call_time_duration');\n\n";
  }
  ...
  if (!vals_timoff_curPoseVelAge.empty()) {
    ...
    f << "];\n"
         "figure(); plot(timoff_curPoseVelAge(:,1),timoff_curPoseVelAge(:,2), "
