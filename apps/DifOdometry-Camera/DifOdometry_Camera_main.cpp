...
int main(int num_arg, char *argv[]) {
  try {
    ...
    if (num_arg < 2)
      ...
      printf(" --save-logfile: Enable saving a file with results of the pose "
             "estimate \n\n");
      system::os::getch();
      return 1;
    ...
    // Initial steps. Load configuration from file or default, initialize scene
    // and initialize camera
    //----------------------------------------------------------------------------------------------
