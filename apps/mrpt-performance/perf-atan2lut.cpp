...
void register_tests_atan2lut() {
  ...
  lstTests.push_back(TestData("CAtan2LUTMultiRes: 22x22m,build",
                              atan2_lut_multires_test_build));
  lstTests.push_back(TestData("CAtan2LUTMultiRes: 22x22m,query",
                              atan2_lut_multires_test_query));
