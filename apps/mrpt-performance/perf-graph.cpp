...
void register_tests_graph()
{
	...
	lstTests.push_back(
		TestData(
			...
			graphs_test_populate<CPose2D, map_traits_map_as_vector>, 1e3,
			1000));

	lstTests.push_back(
		TestData(
			"graph(2d): insertEdgeAtEnd x 1e3",
			graphs_test_populate_at_end<CPose2D, map_traits_stdmap>, 1e3,
			1000));
	lstTests.push_back(
		TestData(
	...
	lstTests.push_back(
		TestData(
			...
			graphs_test_populate<CPose3D, map_traits_map_as_vector>, 1e3,
			1000));

	lstTests.push_back(
		TestData(
			"graph(3d): insertEdgeAtEnd x 1e3",
			graphs_test_populate_at_end<CPose3D, map_traits_stdmap>, 1e3,
			1000));
	lstTests.push_back(
		TestData(
	...
	lstTests.push_back(
		TestData(
			...
			graphs_test_populate<CPose3DPDFGaussianInf,
								 map_traits_map_as_vector>,
			1e3, 1000));
