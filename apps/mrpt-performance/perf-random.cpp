...
template <size_t DIM> double random_test_8(int a1, int a2) {
  CRandomGenerator rg;
...
void register_tests_random() {
  ...
  lstTests.push_back(
      TestData("random: drawGaussianMultivariateMany(fixed 2x2, 1000)",
               random_test_8<2>));
  lstTests.push_back(
      TestData("random: drawGaussianMultivariateMany(fixed 3x3, 1000)",
               random_test_8<3>));
  lstTests.push_back(
      TestData("random: drawGaussianMultivariateMany(fixed 6x6, 1000)",
               random_test_8<6>));
  lstTests.push_back(TestData(
      "random: drawGaussianMultivariateMany(dyn 2x2, 1000)", random_test_9, 2));
  lstTests.push_back(TestData(
      "random: drawGaussianMultivariateMany(dyn 3x3, 1000)", random_test_9, 3));
  lstTests.push_back(TestData(
      "random: drawGaussianMultivariateMany(dyn 6x6, 1000)", random_test_9, 6));
