...
void register_tests_pose_interp() {
  ...
  lstTests.push_back(
      TestData("CPose3DInterpolator: CPose3D insert pose at end",
               &pose_interp_test<CPose3DInterpolator, CPose3D, true, true>));
  lstTests.push_back(
      TestData("CPose3DInterpolator: CPose3D insert pose random",
               &pose_interp_test<CPose3DInterpolator, CPose3D, false, true>));
  lstTests.push_back(
      TestData("CPose3DInterpolator: CPose3D query",
               &pose_interp_test<CPose3DInterpolator, CPose3D, true, false>));

  lstTests.push_back(
      TestData("CPose3DInterpolator: TPose3D insert pose at end",
               &pose_interp_test<CPose3DInterpolator, TPose3D, true, true>));
  lstTests.push_back(
      TestData("CPose3DInterpolator: TPose3D insert pose random",
               &pose_interp_test<CPose3DInterpolator, TPose3D, false, true>));
  lstTests.push_back(
      TestData("CPose3DInterpolator: TPose3D query",
               &pose_interp_test<CPose3DInterpolator, TPose3D, true, false>));

  lstTests.push_back(
      TestData("CPose2DInterpolator: TPose2D insert pose at end",
               &pose_interp_test<CPose2DInterpolator, TPose2D, true, true>));
  lstTests.push_back(
      TestData("CPose2DInterpolator: TPose2D insert pose random",
               &pose_interp_test<CPose2DInterpolator, TPose2D, false, true>));
  lstTests.push_back(
      TestData("CPose2DInterpolator: TPose2D query",
