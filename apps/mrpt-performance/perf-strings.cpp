...
double format_test2(int a, int b) {
  ...
  tictac.Tic();
  for (unsigned int i = 0; i < step; i++) {
    s = mrpt::format("Lorem ipsum dolor sit amet, consectetur adipiscing elit, "
                     "%i sed do eiusmod tempor incididunt ut "
                     "labore et dolore magna aliqua. Ut enim ad minim veniam, "
                     "quis nostrud exercitation ullamco laboris "
                     "nisi ut aliquip ex ea commodo consequat. Duis aute irure "
                     "dolor in %u reprehenderit in voluptate velit "
                     "esse cillum dolore eu %i fugiat nulla pariatur. "
