...
double feature_matching_test_Harris_CC(int w, int h) {
  ...
  //	cout << endl << "L: " << featsHarris_L.size() << " R: " <<
  //featsHarris_R.size() << " M: " << mHarris.size() << endl;
...
double feature_matching_test_SIFT(int w, int h) {
  ...
  //	cout << endl << "L: " << featsSIFT_L.size() << " R: " <<
  //featsSIFT_R.size() << " M: " << mSIFT.size() << endl;
...
void register_tests_feature_matching() {
  lstTests.push_back(TestData("feature_matching [640x480]: Harris + CC",
                              feature_matching_test_Harris_CC, 640, 480));
  lstTests.push_back(TestData("feature_matching [640x480]: Harris + SAD",
...
#endif
  lstTests.push_back(TestData("feature_matching [640x480]: SURF",
                              feature_matching_test_SURF, 640, 480));
  lstTests.push_back(TestData("feature_matching [640x480]: FAST + CC",
                              feature_matching_test_FAST_CC, 640, 480));
  lstTests.push_back(TestData("feature_matching [640x480]: FAST + SAD",
