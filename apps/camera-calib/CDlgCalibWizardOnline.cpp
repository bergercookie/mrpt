...
CDlgCalibWizardOnline::CDlgCalibWizardOnline(wxWindow *parent, wxWindowID id,
                                             const wxPoint &pos,
                                             const wxSize &size) {
  ...
  StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _("Frames to grab:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT5"));
  FlexGridSizer7->Add(StaticText5, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edNumCapture =
      new wxSpinCtrl(this, ID_SPINCTRL3, _T("15"), wxDefaultPosition,
                     wxDefaultSize, 0, 5, 100, 15, _T("ID_SPINCTRL3"));
  edNumCapture->SetValue(_T("15"));
  FlexGridSizer7->Add(edNumCapture, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText6 = new wxStaticText(this, ID_STATICTEXT6, _("Grabbed so far:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT6"));
  FlexGridSizer7->Add(StaticText6, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  lbProgress = new wxStaticText(this, ID_STATICTEXT7, _("0"), wxDefaultPosition,
...
void CDlgCalibWizardOnline::OntimCaptureTrigger(wxTimerEvent &event) {
  ...
  try {
    ...
    img_to_show.textOut(10, 10, format("%u out of %u grabbed",
                                       (unsigned int)m_calibFrames.size(),
                                       nFramesToGrab),
                        TColor::white);
    ...
    if (m_calibFrames.size() >= nFramesToGrab) {
      ...
      if (wxOK == wxMessageBox(_("The desired number of frames have been "
