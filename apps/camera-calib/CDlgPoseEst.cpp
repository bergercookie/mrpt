...
CDlgPoseEst::CDlgPoseEst(wxWindow *parent, wxWindowID id, const wxPoint &pos,
                         const wxSize &size) {
  ...
  Create(parent, id, _("Grab chessboard calibration pattern"),
         wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("id"));
  ...
  StaticBoxSizer1->Add(m_panelCamera, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  FlexGridSizer17->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  edSizeX = new wxSpinCtrl(this, ID_SPINCTRL1, _T("5"), wxDefaultPosition,
  ...
  FlexGridSizer17->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  edSizeY = new wxSpinCtrl(this, ID_SPINCTRL2, _T("8"), wxDefaultPosition,
  ...
  FlexGridSizer18->Add(StaticText3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                       ...
                       5);
  edLengthX =
      new wxTextCtrl(this, ID_TEXTCTRL1, _("40.0"), wxDefaultPosition,
                     wxSize(40, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer18->Add(edLengthX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText4 =
      new wxStaticText(this, ID_STATICTEXT4, _("In Y:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT4"));
  FlexGridSizer18->Add(StaticText4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  edLengthY =
      new wxTextCtrl(this, ID_TEXTCTRL3, _("40.0"), wxDefaultPosition,
  ...
  StaticBoxSizer3->Add(FlexGridSizer6, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer2->Add(StaticBoxSizer3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  StaticBoxSizer2 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Real Time Pose Estimation"));
  FlexGridSizer7 = new wxFlexGridSizer(2, 2, 0, 0);
  FlexGridSizer7->AddGrowableCol(0);
  FlexGridSizer7->AddGrowableRow(0);
  StaticTextAlgo = new wxStaticText(this, ID_STATICTEXTALGO,
                                    _("Choose Algorithm"), wxDefaultPosition,
                                    wxDefaultSize, 0, _T("ID_STATICTEXTALGO"));
  FlexGridSizer7->Add(StaticTextAlgo, 1,
  ...
  pnpSelect =
      new wxChoice(this, ID_ALGOCHOICE, wxDefaultPosition, wxDefaultSize, ch_wx,
                   0, wxDefaultValidator, ch_default);
  FlexGridSizer7->Add(pnpSelect, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  pnpSelect->SetSelection(0);
  m_3Dview_cam =
      new CMyGLCanvas(this, ID_CAMPOSEVIEW, wxDefaultPosition, wxSize(300, 300),
                      wxTAB_TRAVERSAL, _T("ID_CAMPOSEVIEW"));
  FlexGridSizer7->Add(m_3Dview_cam, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer2->Add(txtLog, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  ...
  btnStart =
      new wxButton(this, ID_BUTTON1, _("Start"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  wxFont btnStartFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                      wxFONTWEIGHT_BOLD, false, wxEmptyString,
                      wxFONTENCODING_DEFAULT);
  btnStart->SetFont(btnStartFont);
  FlexGridSizer5->Add(btnStart, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                      5);
  btnStop =
      new wxButton(this, ID_BUTTON2, _("Stop"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
  btnStop->Disable();
  FlexGridSizer5->Add(btnStop, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  btnClose =
      new wxButton(this, ID_BUTTON3, _("Close"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
  FlexGridSizer5->Add(btnClose, 1,
...
void CDlgPoseEst::OnbtnStartClick(wxCommandEvent &event) {
  ...
  if (file.is_open()) {
    ...
    int answer = wxMessageBox(wxT("Do calibration first and save camera "
                                  "parameters as intrinsic_matrix.txt"),
...
void CDlgPoseEst::OntimCaptureTrigger(wxTimerEvent &event) {
  ...
  try {
    ...
    if (!blankTime && m_threadResultsComputed && !m_threadResults.empty()) {
      ...
      // Draw the corners:
      img_to_show.drawChessboardCorners(m_threadResults, m_check_size_x,
                                        m_check_size_y);
    ...
    if (std::abs((int)(this->m_realtimeview->GetClientSize().GetWidth()) -
                 int(img_to_show.getWidth())) > 30) {
      this->m_realtimeview->SetSize(img_to_show.getWidth(),
                                    img_to_show.getHeight());
      ...
      if (!obj->m_threadResultsComputed) {
        try {
          ...
          bool foundCorners = mrpt::vision::findChessboardCorners(
              ...
              obj->m_check_size_x, obj->m_check_size_y, obj->m_normalize_image,
          ...
          if (!foundCorners)
            ...
            if (obj->flag_pose_est == true) {
              const double m_check_len_x =
                  0.1 * atof(string(edLengthX->GetValue().mb_str()).c_str());
              const double m_check_len_y =
                  0.1 * atof(string(edLengthY->GetValue().mb_str()).c_str());
              ...
              for (unsigned int j = 0; j < m_check_size_y; j++)
                for (unsigned int i = 0; i < m_check_size_x; i++)
                  obj_pts.row(j * m_check_size_x + i) << (i)*m_check_len_x,
                      (j)*m_check_len_y, 1;
              ...
              for (unsigned int i = 0; i < m_check_size_x; i++)
                for (unsigned int j = 0; j < m_check_size_y; j++)
                  img_pts.row(i * m_check_size_y + j)
                      << (obj->m_threadResults[i * m_check_size_y + j].x -
                          cam_intrinsic(0, 2)) /
                             cam_intrinsic(0, 0),
                      (obj->m_threadResults[i * m_check_size_y + j].y -
                       cam_intrinsic(1, 2)) /
                          cam_intrinsic(1, 1),
                      1;

              int algo_idx = pnpSelect->GetSelection();
              (pnp_algos.*pose_algos[algo_idx])(obj_pts, img_pts,
                                                m_check_size_x * m_check_size_y,
                                                I3, pose_mat);
...
void CDlgPoseEst::showCamPose() {
  ...
  double q_norm =
      sqrt(1 - pose_mat(3, 0) * pose_mat(3, 0) -
           pose_mat(4, 0) * pose_mat(4, 0) - pose_mat(5, 0) * pose_mat(5, 0));
  mrpt::poses::CPose3DQuat q_pose(
      0.005 * pose_mat(0, 0), 0.005 * pose_mat(1, 0), 0.005 * pose_mat(2, 0),
      mrpt::math::CQuaternionDouble(q_norm, pose_mat(3, 0), pose_mat(4, 0),
                                    pose_mat(5, 0)));
  q_pose.inverse();
