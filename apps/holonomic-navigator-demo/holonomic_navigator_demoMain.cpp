...
holonomic_navigator_demoFrame::holonomic_navigator_demoFrame(wxWindow *parent,
                                                             wxWindowID id)
    : m_gridMap(), m_targetPoint(-5, -7), m_robotPose(0, 0, 0),
...
// Load my custom icons:
  ...
  Create(parent, id, _("Holonomic Navigation Demo - Part of MRPT"),
  ...
  BoxSizer1->Add(btnLoadMap, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 1);
  ...
  FlexGridSizer4->Add(BoxSizer1, 1,
  ...
  BoxSizer2->Add(btnPlaceTarget, 1,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 2);
  ...
  FlexGridSizer4->Add(BoxSizer2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  rbHoloMethod = new wxRadioBox(Panel1, ID_RADIOBOX1, _(" Holonomic method "),
                                wxDefaultPosition, wxDefaultSize, 2,
                                __wxRadioBoxChoices_1, 1, wxRA_HORIZONTAL,
                                wxDefaultValidator, _T("ID_RADIOBOX1"));
  FlexGridSizer7->Add(rbHoloMethod, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  wxFont edHoloParamsFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
                          wxNORMAL, false, wxEmptyString,
                          wxFONTENCODING_DEFAULT);
  edHoloParams->SetFont(edHoloParamsFont);
  FlexGridSizer7->Add(edHoloParams, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 2);
  ...
  FlexGridSizer3->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("[Local view]"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT1"));
  FlexGridSizer3->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  m_plot3D =
      new CMyGLCanvas(this, ID_XY_GLCANVAS, wxDefaultPosition, wxSize(450, 350),
                      wxTAB_TRAVERSAL, _T("ID_XY_GLCANVAS"));
  FlexGridSizer3->Add(m_plot3D, 1, wxALL | wxEXPAND | wxFIXED_MINSIZE |
  ...
  m_plotScan =
      new CMyGLCanvas(this, ID_CUSTOM1, wxDefaultPosition, wxSize(150, 150),
                      wxTAB_TRAVERSAL, _T("ID_CUSTOM1"));
  FlexGridSizer5->Add(m_plotScan, 1,
  ...
  wxFont edInfoLocalViewFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
                             wxNORMAL, false, wxEmptyString,
                             wxFONTENCODING_DEFAULT);
  edInfoLocalView->SetFont(edInfoLocalViewFont);
  FlexGridSizer5->Add(edInfoLocalView, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 2);
  ...
  Connect(
      ...
      (wxObjectEventFunction)&holonomic_navigator_demoFrame::OnbtnLoadMapClick);
  ...
  m_plot3D->Connect(
      wxEVT_MOTION,
      (wxObjectEventFunction)&holonomic_navigator_demoFrame::Onplot3DMouseMove,
      0, this);
  m_plot3D->Connect(
      wxEVT_LEFT_DOWN,
      (wxObjectEventFunction)&holonomic_navigator_demoFrame::Onplot3DMouseClick,
      0, this);
...
void holonomic_navigator_demoFrame::OnbtnPlaceRobotClick(
...
void holonomic_navigator_demoFrame::OnbtnPlaceTargetClick(
    wxCommandEvent &event) {
...
void holonomic_navigator_demoFrame::simulateOneStep(double time_step) {
  ...
  m_gridMap.laserScanSimulator(simulatedScan, mrpt::poses::CPose2D(m_robotPose),
                               0.5, m_simul_options.SENSOR_NUM_RANGES,
  ...
  for (size_t j = 0; j < simulatedScan.scan.size(); j++)
    simulatedScan.setScanRange(j, simulatedScan.getScanRange(j) /
                                      simulatedScan.maxRange);

  gl_scan2D->setScan(simulatedScan); // Draw scaled scan in right-hand view

  // Navigate:
  mrpt::math::TPoint2D relTargetPose = mrpt::math::TPoint2D(
      mrpt::poses::CPoint2D(m_targetPoint) - mrpt::poses::CPose2D(m_robotPose));
  ...
  gl_line_direction->setLineCoords(0, 0, 0, cos(no.desiredDirection) * d,
                                   sin(no.desiredDirection) * d, 0);
}
...
void holonomic_navigator_demoFrame::updateViewsDynamicObjects() {
  ...
  StatusBar1->SetStatusText(
      ...
      0);
  StatusBar1->SetStatusText(
      _U(mrpt::format("Target: (%.03f,%.03f)", m_targetPoint.x, m_targetPoint.y)
             .c_str()),
      1);
...
holonomic_navigator_demoFrame::TOptions::TOptions()
    : ROBOT_MAX_SPEED(4.0), MAX_SENSOR_RADIUS(5.0), SENSOR_NUM_RANGES(181),
...
void holonomic_navigator_demoFrame::TOptions::saveToConfigFile(
  ...
  cfg.write(section, "ROBOT_MAX_SPEED", ROBOT_MAX_SPEED, WN, WV,
