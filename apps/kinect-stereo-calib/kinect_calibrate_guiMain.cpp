...
// Load my custom icons:
	...
	StaticText5 = new wxStaticText(
		Panel3, ID_STATICTEXT5, _("(If no error was found but still \nhave no "
								  "images, try disconnecting "
	...
	StaticText4 = new wxStaticText(
		Panel5, ID_STATICTEXT4, _("You should be seeing the\nlive colored 3D "
								  "point cloud. \n\nBy loading "
...
void kinect_calibrate_guiDialog::OnNotebook1PageChanging(wxNotebookEvent& event)
{
	if (event.GetSelection() == 0)
	{
		...
		else
		{
			if (wxYES ==
				::wxMessageBox(
					_("Your unsaved data will be lost, are you sure you "
