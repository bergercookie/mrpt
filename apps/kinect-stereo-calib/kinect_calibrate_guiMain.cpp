...
wxBitmap MyArtProvider::CreateBitmap(const wxArtID &id,
                                     ...
                                     const wxSize &size) {
  if (id == wxART_MAKE_ART_ID(MAIN_ICON))
    return wxBitmap(kinect_xpm);
...
const wxString imageWildcards = _("Image files "
                                  "(*.png;*.jpg;...)|*.png;*.PNG;*.JPG;*.jpg;*."
                                  "BMP;*.bmp;*.TIF;*.tif|All files (*.*)|*.*");
...
kinect_calibrate_guiDialog::kinect_calibrate_guiDialog(wxWindow *parent,
                                                       wxWindowID id)
...
// Load my custom icons:
  ...
  Notebook1 = new wxNotebook(this, ID_NOTEBOOK1, wxDefaultPosition,
                             wxDefaultSize, wxNB_BOTTOM, _T("ID_NOTEBOOK1"));
  Panel8 = new wxPanel(Notebook1, ID_PANEL8, wxDefaultPosition, wxDefaultSize,
  ...
  StaticText26 = new wxStaticText(
      Panel8, ID_STATICTEXT27, _("What do you want to do\?"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT27"));
  wxFont StaticText26Font(16, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                          wxEmptyString, wxFONTENCODING_DEFAULT);
  StaticText26->SetFont(StaticText26Font);
  FlexGridSizer38->Add(StaticText26, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer38->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer39 = new wxFlexGridSizer(3, 1, 0, 0);
  FlexGridSizer39->AddGrowableCol(0);
  btnOpCalibKinect =
      new wxButton(Panel8, ID_BUTTON15, _("Calibrate a Kinect sensor (live)"),
                   wxDefaultPosition, wxSize(-1, 50), 0, wxDefaultValidator,
                   _T("ID_BUTTON15"));
  FlexGridSizer39->Add(btnOpCalibKinect, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnOpCalibStereoGeneric =
      new wxButton(Panel8, ID_BUTTON16,
                   _("Calibrate a stereo/Kinect camera (from images in disk)"),
                   wxDefaultPosition, wxSize(-1, 50), 0, wxDefaultValidator,
                   _T("ID_BUTTON16"));
  FlexGridSizer39->Add(btnOpCalibStereoGeneric, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnOpTestKinect = new wxButton(
      ...
      wxDefaultPosition, wxSize(-1, 50), 0, wxDefaultValidator,
      _T("ID_BUTTON17"));
  FlexGridSizer39->Add(btnOpTestKinect, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer38->Add(FlexGridSizer39, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer37->Add(FlexGridSizer38, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                               wxALIGN_CENTER_VERTICAL,
                       0);
  Panel8->SetSizer(FlexGridSizer37);
  FlexGridSizer37->Fit(Panel8);
  FlexGridSizer37->SetSizeHints(Panel8);
  Panel9 = new wxPanel(Notebook1, ID_PANEL9, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText27Font(15, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                          wxEmptyString, wxFONTENCODING_DEFAULT);
  StaticText27->SetFont(StaticText27Font);
  FlexGridSizer41->Add(StaticText27, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer41->Add(StaticText28, 1,
  ...
  FlexGridSizer41->Add(m_imgStaticKinect, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer41->Add(StaticText30, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  btnNext1 =
      new wxButton(Panel9, ID_BUTTON3, _("START"), wxPoint(376, 368),
                   wxSize(117, 45), 0, wxDefaultValidator, _T("ID_BUTTON3"));
  btnNext1->SetDefault();
  FlexGridSizer41->Add(btnNext1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                        wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer40->Add(FlexGridSizer41, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                               wxALIGN_CENTER_VERTICAL,
                       5);
  Panel9->SetSizer(FlexGridSizer40);
  FlexGridSizer40->Fit(Panel9);
  FlexGridSizer40->SetSizeHints(Panel9);
  Panel3 = new wxPanel(Notebook1, ID_PANEL3, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer7->Add(StaticText11, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnConnect =
      new wxButton(Panel3, ID_BUTTON5, _("Connect..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer7->Add(btnConnect, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  FlexGridSizer7->Add(StaticText9, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnNext2 =
      new wxButton(Panel3, ID_BUTTON4, _("CONTINUE..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  btnNext2->SetDefault();
  btnNext2->Disable();
  FlexGridSizer7->Add(btnNext2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  FlexGridSizer7->Add(StaticText5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  btnDisconnect =
      new wxButton(Panel3, ID_BUTTON8, _("Disconnect"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON8"));
  btnDisconnect->Disable();
  FlexGridSizer7->Add(btnDisconnect, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer5->Add(FlexGridSizer7, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel3->SetSizer(FlexGridSizer5);
  FlexGridSizer5->Fit(Panel3);
  FlexGridSizer5->SetSizeHints(Panel3);
  Panel4 = new wxPanel(Notebook1, ID_PANEL4, wxDefaultPosition, wxDefaultSize,
  ...
  m_realtimeview_cap = new mrpt::gui::wxMRPTImageControl(
      ...
      wxSize(640, 480).GetWidth(), wxSize(640, 480).GetHeight());
  FlexGridSizer3->Add(m_realtimeview_cap, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                      5);
  Panel7 = new wxPanel(Panel4, ID_PANEL7, wxDefaultPosition, wxDefaultSize,
  ...
  TextCtrl2 = new wxTextCtrl(
      ...
      _("- Place the Kinect sensor such that the checkerboard is completely "
        ...
        "on \"CAPTURE\" to save one pair of images. DON\'T MOVE the Kinect "
        "while the pair of images are being captured. \n- Repeat to take as "
        "many image pairs as you want, trying to make sure that the "
  ...
  BoxSizer1->Add(TextCtrl2, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 5);
  StaticBoxSizer1->Add(BoxSizer1, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer4->Add(StaticBoxSizer1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer3 =
      new wxStaticBoxSizer(wxHORIZONTAL, Panel7, _("Checkerboard parameters "));
  FlexGridSizer6 = new wxFlexGridSizer(1, 1, 0, 0);
  StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, Panel7,
                                         _("Number of inner corners: "));
  FlexGridSizer17 = new wxFlexGridSizer(1, 4, 0, 0);
  StaticText1 =
      new wxStaticText(Panel7, ID_STATICTEXT1, _("In X:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT1"));
  FlexGridSizer17->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  edSizeX = new wxSpinCtrl(Panel7, ID_SPINCTRL1, _T("7"), wxDefaultPosition,
                           wxSize(50, -1), 0, 1, 200, 7, _T("ID_SPINCTRL1"));
  edSizeX->SetValue(_T("7"));
  FlexGridSizer17->Add(edSizeX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText2 =
      new wxStaticText(Panel7, ID_STATICTEXT2, _("In Y:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT2"));
  FlexGridSizer17->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  edSizeY = new wxSpinCtrl(Panel7, ID_SPINCTRL2, _T("9"), wxDefaultPosition,
                           wxSize(50, -1), 0, 1, 200, 9, _T("ID_SPINCTRL2"));
  edSizeY->SetValue(_T("9"));
  FlexGridSizer17->Add(edSizeY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer4->Add(FlexGridSizer17, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer6->Add(StaticBoxSizer4, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer3->Add(FlexGridSizer6, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  FlexGridSizer4->Add(StaticBoxSizer3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  rbChannelSwitch =
      new wxRadioBox(Panel7, ID_RADIOBOX1, _(" Channel switch"),
                     wxDefaultPosition, wxDefaultSize, 2, __wxRadioBoxChoices_1,
                     1, 0, wxDefaultValidator, _T("ID_RADIOBOX1"));
  rbChannelSwitch->SetSelection(0);
  FlexGridSizer8->Add(rbChannelSwitch, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  cbNormalize = new wxCheckBox(Panel7, ID_CHECKBOX1, _("Normalize IR image"),
                               wxDefaultPosition, wxDefaultSize, 0,
                               wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbNormalize->SetValue(true);
  FlexGridSizer8->Add(cbNormalize, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer25 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer25->AddGrowableCol(0);
  FlexGridSizer25->AddGrowableCol(1);
  StaticText21 = new wxStaticText(Panel7, ID_STATICTEXT22, _("Tilt (degrees):"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT22"));
  FlexGridSizer25->Add(StaticText21, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edTilt = new wxSpinCtrl(Panel7, ID_SPINCTRL7, _T("0"), wxDefaultPosition,
                          wxDefaultSize, 0, -30, 30, 0, _T("ID_SPINCTRL7"));
  edTilt->SetValue(_T("0"));
  FlexGridSizer25->Add(edTilt, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       5);
  FlexGridSizer8->Add(FlexGridSizer25, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  btnCapture =
      new wxButton(Panel7, ID_BUTTON6, _("CAPTURE NOW"), wxDefaultPosition,
  ...
  FlexGridSizer8->Add(btnCapture, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  lbNumCaptured = new wxStaticText(
      Panel7, ID_STATICTEXT12, _("Captured image pairs: 0"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT12"));
  FlexGridSizer8->Add(lbNumCaptured, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnNextCalib = new wxButton(Panel7, ID_BUTTON7, _("OK, go to calibrate >>"),
                              wxDefaultPosition, wxDefaultSize, 0,
  ...
  FlexGridSizer8->Add(btnNextCalib, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer2->Add(FlexGridSizer8, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  FlexGridSizer4->Add(StaticBoxSizer2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel7->SetSizer(FlexGridSizer4);
  FlexGridSizer4->Fit(Panel7);
  FlexGridSizer4->SetSizeHints(Panel7);
  FlexGridSizer3->Add(Panel7, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  Panel4->SetSizer(FlexGridSizer3);
  FlexGridSizer3->Fit(Panel4);
  FlexGridSizer3->SetSizeHints(Panel4);
  Panel6 = new wxPanel(Notebook1, ID_PANEL6, wxDefaultPosition, wxDefaultSize,
  ...
  wxFont StaticText22Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                          wxFONTWEIGHT_BOLD, false, wxEmptyString,
                          wxFONTENCODING_DEFAULT);
  StaticText22->SetFont(StaticText22Font);
  FlexGridSizer22->Add(StaticText22, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       2);
  lbImagePairs =
      new wxListBox(Panel6, ID_LISTBOX1, wxDefaultPosition, wxDefaultSize, 0, 0,
                    wxLB_SINGLE, wxDefaultValidator, _T("ID_LISTBOX1"));
  FlexGridSizer22->Add(lbImagePairs, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer26 = new wxFlexGridSizer(3, 2, 0, 0);
  FlexGridSizer26->AddGrowableCol(0);
  FlexGridSizer26->AddGrowableCol(1);
  btnListRemoveSelected =
      new wxButton(Panel6, ID_BUTTON9, _("Remove selected"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON9"));
  wxFont btnListRemoveSelectedFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL,
                                   false, wxEmptyString,
                                   wxFONTENCODING_DEFAULT);
  btnListRemoveSelected->SetFont(btnListRemoveSelectedFont);
  FlexGridSizer26->Add(btnListRemoveSelected, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnListLoad = new wxButton(Panel6, ID_BUTTON10, _("Load image pair..."),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_BUTTON10"));
  wxFont btnListLoadFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                         wxEmptyString, wxFONTENCODING_DEFAULT);
  btnListLoad->SetFont(btnListLoadFont);
  FlexGridSizer26->Add(btnListLoad, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  wxFont btnLoadImageListFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                              wxEmptyString, wxFONTENCODING_DEFAULT);
  btnLoadImageList->SetFont(btnLoadImageListFont);
  FlexGridSizer26->Add(btnLoadImageList, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnListSave = new wxButton(Panel6, ID_BUTTON12, _("Save all images..."),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_BUTTON12"));
  wxFont btnListSaveFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                         wxEmptyString, wxFONTENCODING_DEFAULT);
  btnListSave->SetFont(btnListSaveFont);
  FlexGridSizer26->Add(btnListSave, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer22->Add(FlexGridSizer26, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer10->Add(FlexGridSizer22, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer32 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer32->AddGrowableCol(0);
  FlexGridSizer32->AddGrowableRow(1);
  wxString __wxRadioBoxChoices_2[4] = {_("Original"), _("Detected chessboard"),
  ...
  wxFont rbShowImagesFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                          wxEmptyString, wxFONTENCODING_DEFAULT);
  rbShowImages->SetFont(rbShowImagesFont);
  FlexGridSizer32->Add(rbShowImages, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  StaticText18 = new wxStaticText(Panel6, ID_STATICTEXT19, _("(Left camera)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT19"));
  FlexGridSizer23->Add(StaticText18, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       1);
  ...
  FlexGridSizer23->Add(m_view_left, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer42->Add(FlexGridSizer23, 1,
  ...
  StaticText19 = new wxStaticText(Panel6, ID_STATICTEXT20, _("(Right camera)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT20"));
  FlexGridSizer24->Add(StaticText19, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       1);
  m_view_right = new mrpt::gui::wxMRPTImageControl(
      Panel6, ID_CUSTOM5, wxDefaultPosition.x, wxDefaultPosition.y,
      wxSize(320, 240).GetWidth(), wxSize(320, 240).GetHeight());
  FlexGridSizer24->Add(m_view_right, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer42->Add(FlexGridSizer24, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  FlexGridSizer32->Add(FlexGridSizer42, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer10->Add(FlexGridSizer32, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer9->Add(FlexGridSizer10, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  StaticText24 = new wxStaticText(Panel6, ID_STATICTEXT25,
                                  _("Calibration options"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT25"));
  wxFont StaticText24Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                          wxFONTWEIGHT_BOLD, false, wxEmptyString,
                          wxFONTENCODING_DEFAULT);
  StaticText24->SetFont(StaticText24Font);
  FlexGridSizer30->Add(StaticText24, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer29->Add(FlexGridSizer30, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Notebook2 = new wxNotebook(Panel6, ID_NOTEBOOK3, wxDefaultPosition,
                             wxDefaultSize, 0, _T("ID_NOTEBOOK3"));
  Panel11 = new wxPanel(Notebook2, ID_PANEL11, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL11"));
  FlexGridSizer20 = new wxFlexGridSizer(2, 1, 0, 0);
  StaticBoxSizer7 = new wxStaticBoxSizer(wxHORIZONTAL, Panel11,
                                         _("Number of inner corners: "));
  FlexGridSizer21 = new wxFlexGridSizer(1, 4, 0, 0);
  StaticText12 =
      new wxStaticText(Panel11, ID_STATICTEXT13, _("In X:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT13"));
  FlexGridSizer21->Add(StaticText12, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edCalibCheckX =
      new wxSpinCtrl(Panel11, ID_SPINCTRL3, _T("7"), wxDefaultPosition,
                     wxSize(50, -1), 0, 1, 200, 7, _T("ID_SPINCTRL3"));
  edCalibCheckX->SetValue(_T("7"));
  FlexGridSizer21->Add(edCalibCheckX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText13 =
      new wxStaticText(Panel11, ID_STATICTEXT14, _("In Y:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT14"));
  FlexGridSizer21->Add(StaticText13, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edCalibCheckY =
      new wxSpinCtrl(Panel11, ID_SPINCTRL4, _T("9"), wxDefaultPosition,
                     wxSize(50, -1), 0, 1, 200, 9, _T("ID_SPINCTRL4"));
  edCalibCheckY->SetValue(_T("9"));
  FlexGridSizer21->Add(edCalibCheckY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer7->Add(FlexGridSizer21, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer20->Add(StaticBoxSizer7, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticBoxSizer8 = new wxStaticBoxSizer(wxHORIZONTAL, Panel11,
                                         _(" Size of quads (in mm): "));
  FlexGridSizer33 = new wxFlexGridSizer(1, 4, 0, 0);
  StaticText14 =
      new wxStaticText(Panel11, ID_STATICTEXT15, _("In X:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT15"));
  FlexGridSizer33->Add(StaticText14, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edCalibSizeX =
      new wxTextCtrl(Panel11, ID_TEXTCTRL6, _("40.0"), wxDefaultPosition,
                     wxSize(40, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
  FlexGridSizer33->Add(edCalibSizeX, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText15 =
      new wxStaticText(Panel11, ID_STATICTEXT16, _("In Y:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT16"));
  FlexGridSizer33->Add(StaticText15, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edCalibSizeY =
      new wxTextCtrl(Panel11, ID_TEXTCTRL7, _("40.0"), wxDefaultPosition,
                     wxSize(40, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL7"));
  FlexGridSizer33->Add(edCalibSizeY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer8->Add(FlexGridSizer33, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer20->Add(StaticBoxSizer8, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel11->SetSizer(FlexGridSizer20);
  FlexGridSizer20->Fit(Panel11);
  FlexGridSizer20->SetSizeHints(Panel11);
  Panel12 = new wxPanel(Notebook2, ID_PANEL12, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL12"));
  FlexGridSizer35 = new wxFlexGridSizer(3, 2, 0, 0);
  FlexGridSizer35->AddGrowableCol(0);
  cbOptK1 = new wxCheckBox(Panel12, ID_CHECKBOX4, _("k1 (r^2 dist.)"),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_CHECKBOX4"));
  cbOptK1->SetValue(true);
  FlexGridSizer35->Add(cbOptK1, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 1);
  cbOptK2 = new wxCheckBox(Panel12, ID_CHECKBOX5, _("k2 (r^4 dist.)"),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_CHECKBOX5"));
  cbOptK2->SetValue(true);
  FlexGridSizer35->Add(cbOptK2, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 1);
  cbOptK3 = new wxCheckBox(Panel12, ID_CHECKBOX6, _("k3 (r^6 dist.)"),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_CHECKBOX6"));
  cbOptK3->SetValue(false);
  FlexGridSizer35->Add(cbOptK3, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 1);
  FlexGridSizer35->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  cbOptT1 = new wxCheckBox(Panel12, ID_CHECKBOX7, _("t1 (tang. dist.)"),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_CHECKBOX7"));
  cbOptT1->SetValue(false);
  FlexGridSizer35->Add(cbOptT1, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 1);
  cbOptT2 = new wxCheckBox(Panel12, ID_CHECKBOX8, _("t2 (tang. dist.)"),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_CHECKBOX8"));
  cbOptT2->SetValue(false);
  FlexGridSizer35->Add(cbOptT2, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 1);
  Panel12->SetSizer(FlexGridSizer35);
  FlexGridSizer35->Fit(Panel12);
  FlexGridSizer35->SetSizeHints(Panel12);
  Panel13 = new wxPanel(Notebook2, ID_PANEL13, wxDefaultPosition, wxDefaultSize,
  ...
  StaticText25 = new wxStaticText(Panel13, ID_STATICTEXT26,
                                  _("Max. iterations:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT26"));
  FlexGridSizer36->Add(StaticText25, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edMaxIters =
      new wxSpinCtrl(Panel13, ID_SPINCTRL8, _T("1000"), wxDefaultPosition,
                     wxDefaultSize, 0, 0, 10000, 1000, _T("ID_SPINCTRL8"));
  edMaxIters->SetValue(_T("1000"));
  FlexGridSizer36->Add(edMaxIters, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer34->Add(FlexGridSizer36, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  cbCalibUseRobust = new wxCheckBox(
      Panel13, ID_CHECKBOX3, _("Pseudo-Huber robust kernel"), wxDefaultPosition,
      wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
  cbCalibUseRobust->SetValue(false);
  FlexGridSizer34->Add(cbCalibUseRobust, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer34->Add(cbCalibNormalize, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer29->Add(Notebook2, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer31 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer31->AddGrowableCol(0);
  btnRunCalib = new wxButton(Panel6, ID_BUTTON14, _("Run optimizer..."),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_BUTTON14"));
  wxFont btnRunCalibFont(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_BOLD, false, wxEmptyString,
                         wxFONTENCODING_DEFAULT);
  btnRunCalib->SetFont(btnRunCalibFont);
  FlexGridSizer31->Add(btnRunCalib, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer29->Add(FlexGridSizer31, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer11->Add(FlexGridSizer29, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  StaticText23 = new wxStaticText(Panel6, ID_STATICTEXT24,
                                  _("Calibration results:"), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT24"));
  wxFont StaticText23Font(wxDEFAULT, wxDEFAULT, wxFONTSTYLE_NORMAL,
                          wxFONTWEIGHT_BOLD, false, wxEmptyString,
                          wxFONTENCODING_DEFAULT);
  StaticText23->SetFont(StaticText23Font);
  FlexGridSizer28->Add(StaticText23, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  btnSaveCalib = new wxButton(Panel6, ID_BUTTON13, _("Save calibration..."),
                              wxDefaultPosition, wxDefaultSize, 0,
                              wxDefaultValidator, _T("ID_BUTTON13"));
  FlexGridSizer28->Add(btnSaveCalib, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer27->Add(FlexGridSizer28, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  NotebookCalibResults = new wxNotebook(Panel6, ID_NOTEBOOK2, wxDefaultPosition,
                                        wxDefaultSize, 0, _T("ID_NOTEBOOK2"));
  Panel1 = new wxPanel(NotebookCalibResults, ID_PANEL1, wxDefaultPosition,
  ...
  edLogCalibResult = new wxTextCtrl(
      ...
      _T("ID_TEXTCTRL8"));
  wxFont edLogCalibResultFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
                              wxNORMAL, false, wxEmptyString,
                              wxFONTENCODING_DEFAULT);
  edLogCalibResult->SetFont(edLogCalibResultFont);
  FlexGridSizer19->Add(edLogCalibResult, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel1->SetSizer(FlexGridSizer19);
  FlexGridSizer19->Fit(Panel1);
  FlexGridSizer19->SetSizeHints(Panel1);
  Panel10 = new wxPanel(NotebookCalibResults, ID_PANEL10, wxDefaultPosition,
                        wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL10"));
  FlexGridSizer43 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer43->AddGrowableCol(0);
  FlexGridSizer43->AddGrowableRow(0);
  m_plot3D_cameras =
      new CMyGLCanvas(Panel10, ID_CUSTOM6, wxDefaultPosition, wxDefaultSize,
                      wxTAB_TRAVERSAL, _T("ID_CUSTOM6"));
  FlexGridSizer43->Add(m_plot3D_cameras, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer27->Add(NotebookCalibResults, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer11->Add(FlexGridSizer27, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  Panel5 = new wxPanel(Notebook1, ID_PANEL5, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL5"));
  FlexGridSizer15 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer15->AddGrowableCol(0);
  FlexGridSizer15->AddGrowableRow(0);
  m_plot3D =
      new CMyGLCanvas(Panel5, ID_XY_GLCANVAS, wxDefaultPosition, wxDefaultSize,
                      wxTAB_TRAVERSAL, _T("ID_XY_GLCANVAS"));
  FlexGridSizer15->Add(m_plot3D, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  ...
  FlexGridSizer16->Add(StaticText3, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnConnectLive3D =
      new wxButton(Panel5, ID_BUTTON18, _("Connect..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON18"));
  FlexGridSizer16->Add(btnConnectLive3D, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnDisconnectLive =
      new wxButton(Panel5, ID_BUTTON20, _("Disconnect"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON20"));
  btnDisconnectLive->Disable();
  FlexGridSizer16->Add(btnDisconnectLive, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  btnLoadCalib =
      new wxButton(Panel5, ID_BUTTON19, _("Load calib..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON19"));
  wxFont btnLoadCalibFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                          wxEmptyString, wxFONTENCODING_DEFAULT);
  btnLoadCalib->SetFont(btnLoadCalibFont);
  FlexGridSizer18->Add(btnLoadCalib, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  btnSaveCalibLive =
      new wxButton(Panel5, ID_BUTTON21, _("Save calib..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON21"));
  wxFont btnSaveCalibLiveFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                              wxEmptyString, wxFONTENCODING_DEFAULT);
  btnSaveCalibLive->SetFont(btnSaveCalibLiveFont);
  FlexGridSizer18->Add(btnSaveCalibLive, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                       5);
  btnHelpLiveCalib = new wxBitmapButton(
      Panel5, ID_BITMAPBUTTON1,
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_HELP")),
                               wxART_BUTTON),
  ...
  FlexGridSizer18->Add(btnHelpLiveCalib, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer16->Add(FlexGridSizer18, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  m_grid_live_calib =
      new wxGrid(Panel5, ID_GRID1, wxDefaultPosition, wxDefaultSize,
                 wxVSCROLL | wxHSCROLL, _T("ID_GRID1"));
  m_grid_live_calib->CreateGrid(3, 1);
  wxFont m_grid_live_calibFont(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL,
                               false, wxEmptyString, wxFONTENCODING_DEFAULT);
  ...
  wxFont GridLabelFont_1(8, wxDEFAULT, wxFONTSTYLE_NORMAL, wxNORMAL, false,
                         wxEmptyString, wxFONTENCODING_DEFAULT);
  ...
  FlexGridSizer16->Add(m_grid_live_calib, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  FlexGridSizer1->Add(Notebook1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  Panel2 = new wxPanel(this, ID_PANEL2, wxDefaultPosition, wxDefaultSize,
  ...
  StaticText10 =
      new wxStaticText(Panel2, ID_STATICTEXT10, _("Log:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT10"));
  FlexGridSizer13->Add(StaticText10, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  wxFont edLogTestFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
                       false, wxEmptyString, wxFONTENCODING_DEFAULT);
  edLogTest->SetFont(edLogTestFont);
  FlexGridSizer13->Add(edLogTest, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer2->Add(FlexGridSizer13, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer14 = new wxFlexGridSizer(1, 2, 0, 0);
  bntAbout =
      new wxButton(Panel2, ID_BUTTON1, _("About"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  FlexGridSizer14->Add(bntAbout, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                        wxALIGN_CENTER_VERTICAL,
                       5);
  btnQuit =
      new wxButton(Panel2, ID_BUTTON2, _("Quit"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
  FlexGridSizer14->Add(btnQuit, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer2->Add(FlexGridSizer14, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      0);
  Panel2->SetSizer(FlexGridSizer2);
  FlexGridSizer2->Fit(Panel2);
  FlexGridSizer2->SetSizeHints(Panel2);
  FlexGridSizer1->Add(Panel2, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  ...
  Connect(ID_BUTTON15, wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OnbtnOpCalibKinectClick);
  Connect(ID_BUTTON16, wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
  ...
  Connect(
      ...
      (wxObjectEventFunction)&kinect_calibrate_guiDialog::OnbtnDisconnectClick);
  Connect(ID_RADIOBOX1, wxEVT_COMMAND_RADIOBOX_SELECTED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OnrbChannelSwitchSelect);
  Connect(ID_SPINCTRL7, wxEVT_COMMAND_SPINCTRL_UPDATED,
  ...
  Connect(
      ...
      (wxObjectEventFunction)&kinect_calibrate_guiDialog::OnbtnNextCalibClick);
  Connect(
      ID_LISTBOX1, wxEVT_COMMAND_LISTBOX_SELECTED,
      (wxObjectEventFunction)&kinect_calibrate_guiDialog::OnlbImagePairsSelect);
  ...
  Connect(
      ...
      (wxObjectEventFunction)&kinect_calibrate_guiDialog::OnrbShowImagesSelect);
  Connect(ID_SPINCTRL3, wxEVT_COMMAND_SPINCTRL_UPDATED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OnNeedsToUpdate6DCamPlot);
  Connect(ID_SPINCTRL4, wxEVT_COMMAND_SPINCTRL_UPDATED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OnNeedsToUpdate6DCamPlot);
  Connect(
  ...
  Connect(ID_CHECKBOX2, wxEVT_COMMAND_CHECKBOX_CLICKED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OncbCalibNormalizeClick);
  Connect(
  ...
  Connect(
      ...
      (wxObjectEventFunction)&kinect_calibrate_guiDialog::OnbtnSaveCalibClick);
  Connect(ID_BUTTON18, wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OnbtnConnectLive3DClick);
  Connect(ID_BUTTON20, wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
              OnbtnDisconnectLiveClick);
  Connect(
      ID_BUTTON19, wxEVT_COMMAND_BUTTON_CLICKED,
      (wxObjectEventFunction)&kinect_calibrate_guiDialog::OnbtnLoadCalibClick);
  Connect(ID_BUTTON21, wxEVT_COMMAND_BUTTON_CLICKED,
          (wxObjectEventFunction)&kinect_calibrate_guiDialog::
  ...
  // Ground plane:
  {
    mrpt::opengl::CGridPlaneXY::Ptr obj =
        std::make_shared<mrpt::opengl::CGridPlaneXY>(-10, 10, -10, 10, 0, 1);
...
void kinect_calibrate_guiDialog::OnNotebook1PageChanging(
  ...
  if (event.GetSelection() == 0) {
    if (event.GetOldSelection() == 1 || event.GetOldSelection() == 2) {
      ...
      if (wxYES == ::wxMessageBox(_("Your unsaved data will be lost, are you "
...
void kinect_calibrate_guiDialog::thread_grabbing() {
  ...
  try {
    ...
    // Open:
    kinect.setVideoChannel(p.select_IR_channel ? CKinect::VIDEO_CHANNEL_IR
    ...
    while (!hard_error && !p.quit) {
      ...
      if (last_select_IR_channel != p.select_IR_channel) {
        kinect.setVideoChannel(p.select_IR_channel
...
void kinect_calibrate_guiDialog::OntimMiscTrigger(wxTimerEvent &event) {
  // if the thread was launched and has closed (e.g. for some error), clear the
  // handle:
  ...
  // -----------------------------------------------------------------
  if (m_cap_thread.joinable()) { // we're grabbing:

    CObservation3DRangeScan::Ptr possiblyNewObs =
        std::atomic_load(&m_cap_thread_data.new_obs);
    if (possiblyNewObs && possiblyNewObs->timestamp != INVALID_TIMESTAMP &&
        (!m_last_obs ||
         possiblyNewObs->timestamp !=
             m_last_obs->timestamp)) { // It IS a new observation:
  ...
  case 3: {
    ...
    if (m_grabstate != gsIdle)
      center_messages.push_back(
          string("* DON'T MOVE EITHER THE SENSOR OR THE CHESSBOARD *"));
    ...
    case gsCapturingIR: {
      ...
      lbNumCaptured->SetLabel(
          wxString::Format(_("Captured image pairs: %u"),
...
void kinect_calibrate_guiDialog::OnrbChannelSwitchSelect(
...
void kinect_calibrate_guiDialog::thread_find_corners() {
  ...
  while (!p.quit) {
    try {
      ...
      if (!p.detected_corners_done && last_img_proc != p.image_timestamp &&
        ...
        if (!detect_ok)
          p.detected_corners.clear();

        p.detected_corners_done = true; // will be set to false when the buffer
...
void kinect_calibrate_guiDialog::ProcessNewSelectedImageListBox() {
  try {
    ...
    if (sel == wxNOT_FOUND || sel >= (int)m_calib_images.size()) {
      ...
      if (image_mode != 1) {
        ...
        if (cbCalibNormalize->IsChecked()) {
          if (!il.isColor())
            il.equalizeHistInPlace();
          if (!ir.isColor())
            ir.equalizeHistInPlace();
        }
      }
      ...
      const wxSize szView =
          m_view_left->GetSize(); // In theory, right&left will be always equal.
    ...
    wxMessageBox(
        wxString::Format(_("[Draw selected image] Exception:\n %s"), e.what()));
  }
}
...
void myCalibCallback(const mrpt::vision::TImageStereoCallbackData &d,
                     void *user_data) {
  if ((d.current_iter & 0x0F) != 0)
    return;
  ...
  switch (d.calibRound) {
  case -1:
    s = mrpt::format("Detecting corners: %u images done out of %u",
                     d.nImgsProcessed, d.nImgsToProcess);
    break;
  case 0:
...
void kinect_calibrate_guiDialog::OnbtnRunCalibClick(wxCommandEvent &event) {
  try {
    ...
    wxProgressDialog pd(_("Calibration in progress..."), _("(starting)"),
    ...
    if (!res) {
      ...
      cout << mrpt::format("# Left camera (IR/Depth in Kinect) calibration "
                           ...
                           2.0 * std_detector / std::sqrt(lc_inf[1]), lc.k1(),
                           lc.k2(), lc.p1(), lc.p2(), lc.k3());

      cout << mrpt::format("# Right camera (RGB in Kinect) calibration "
                           "parameters  (and 95%% confidence intervals):\n"
                           "[CAMERA_PARAMS_RIGHT]\n"
                           "resolution = [%u %u]\n"
                           "cx         = %f  // +/- %.03f\n"
                           ...
                           2.0 * std_detector / std::sqrt(rc_inf[1]), rc.k1(),
      ...
      cout << mrpt::format("# Info about calibration parameters:\n"
                           "[CALIB_METAINFO]\n"
    ...
    wxMessageBox(wxString::Format(_("Optimization finished with RMSE=%.03fpx"),
                                  m_calib_result.final_rmse),
                 _("Done"), 0, this);
...
void kinect_calibrate_guiDialog::OnbtnOpCalibKinectClick(
    wxCommandEvent &event) {
...
void kinect_calibrate_guiDialog::OnbtnListLoadClick(wxCommandEvent &event) {
  ...
  wxFileDialog dialog1(this, _("Choose LEFT image"), startPath, _(""),
                       imageWildcards, wxFD_OPEN | wxFD_FILE_MUST_EXIST);
  if (dialog1.ShowModal() == wxID_OK) {
    ...
    wxFileDialog dialog2(this, _("Choose RIGHT image"), startPath, _(""),
                         imageWildcards, wxFD_OPEN | wxFD_FILE_MUST_EXIST);
    if (dialog2.ShowModal() == wxID_OK) {
      ...
      if (!scd.left.img_original.loadFromFile(file_img_l))
        THROW_EXCEPTION_FMT("Error loading image: %s", file_img_l.c_str())
      if (!scd.right.img_original.loadFromFile(file_img_r))
        THROW_EXCEPTION_FMT("Error loading image: %s", file_img_r.c_str())
...
void kinect_calibrate_guiDialog::OnbtnListSaveClick(wxCommandEvent &event) {
  ...
  wxDirDialog dlg(
      this,
      _("Choose destination DIRECTORY (will be created if it does not exist)"),
  ...
  if (dlg.ShowModal() == wxID_OK) {
    ...
    if (mrpt::system::fileExists(sListFile))
      throw std::runtime_error(
          mrpt::format("Error: target listing file already exists (won't "
...

    {
      ...
      for (unsigned int i = 0; i < N; i++) {
        ...
        if (mrpt::system::fileExists(sL))
          throw std::runtime_error(
              mrpt::format("Error: target image filename already exists (won't "
                           "overwrite as precaution): %s",
                           sL.c_str()));
        ...
        if (!scd.left.img_original.saveToFile(sL))
          throw std::runtime_error(
              mrpt::format("Error: can't write image file: %s", sL.c_str()));
        if (!scd.right.img_original.saveToFile(sR))
          throw std::runtime_error(
              mrpt::format("Error: can't write image file: %s", sR.c_str()));
...
void kinect_calibrate_guiDialog::OnbtnLoadImageListClick(
    wxCommandEvent &event) {
  WX_START_TRY

  wxMessageBox(_("Image list files contain one file name per line, in "
                 "order:\nLEFT1\nRIGHT1\nLEFT2\nRIGHT2\n..."),
               _("Information"));
  ...
  wxFileDialog dialog(this, _("Select text file with list of image files"),
                      startPath, _(""),
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    if ((lst.size() & 1) != 0)
      throw std::runtime_error("Error: Number of lines in file must be even.");
    ...
    for (unsigned int i = 0; i < N; i++) {
      ...
      if (!scd.left.img_original.loadFromFile(sL) &&
        ...
        throw std::runtime_error(
            mrpt::format("Error: loading left image '%s' of %u'th pair",
                         sL.c_str(), i)
                .c_str());

      if (!scd.right.img_original.loadFromFile(sR) &&
          !scd.right.img_original.loadFromFile(fil_dir + string("/") + sR))
        throw std::runtime_error(
            mrpt::format("Error: loading right image '%s' of %u'th pair",
                         sR.c_str(), i)
                .c_str());
    }
    UpdateListOfImages();
...
void kinect_calibrate_guiDialog::OncbCalibNormalizeClick(
    wxCommandEvent &event) {
  ProcessNewSelectedImageListBox();
}
...
void kinect_calibrate_guiDialog::OnbtnConnectLive3DClick(
    wxCommandEvent &event) {
...
void kinect_calibrate_guiDialog::OnbtnDisconnectLiveClick(
    wxCommandEvent &event) {
  this->StopLiveGrabThreads();
...
void kinect_calibrate_guiDialog::OnbtnApplyCalibLiveClick(
    wxCommandEvent &event) {}

// Save current live-panel calib to disk:
void kinect_calibrate_guiDialog::OnbtnSaveCalibLiveClick(
    wxCommandEvent &event) {
  WX_START_TRY
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    f << mrpt::format("# Right camera (RGB in Kinect) calibration parameters:\n"
                      "[CAMERA_PARAMS_RIGHT]\n"
                      "resolution = [%u %u]\n"
                      "cx         = %f\n"
                      "cy         = %f\n"
                      "fx         = %f\n"
                      "fy         = %f\n"
                      "dist       = [%e %e %e %e %e]    // The order is: [K1 "
                      "K2 T1 T2 K3]\n\n",
                      rc.ncols, rc.nrows, rc.cx(), rc.cy(), rc.fx(), rc.fy(),
...
void kinect_calibrate_guiDialog::OnbtnLoadCalibClick(wxCommandEvent &event) {
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    const string sYPR = cfg.read_string("CAMERA_PARAMS_LEFT2RIGHT_POSE",
                                        "pose_yaw_pitch_roll", "", true);
...
// Aux. function
void kinect_calibrate_guiDialog::fillGridLine(int r, const char *label_prefix,
                                              const char *label,
                                              const std::string &val) {
  m_grid_live_calib->SetRowLabelValue(
      r, _U((std::string(label_prefix) + std::string(".") + std::string(label))
                .c_str()));
...
double kinect_calibrate_guiDialog::parseGridLine(int r) {
  ...
  if (!s.ToDouble(&R))
    throw std::runtime_error(mrpt::format("Error parsing double string: '%s'",
...
void kinect_calibrate_guiDialog::LiveCalibUpdateFromGrid() {
  ...
  int r = 0;
  for (int lr = 0; lr < 2; lr++) {
    mrpt::utils::TCamera &c = (lr == 0 ? m_calib_result.cam_params.leftCamera
                                       : m_calib_result.cam_params.rightCamera);
  ...
  const mrpt::poses::CPose3D l2r(parseGridLine(r), parseGridLine(r + 1),
                                 parseGridLine(r + 2), // x,y,z
...
void kinect_calibrate_guiDialog::OnbtnHelpLiveCalibClick(
    wxCommandEvent &event) {}
    ...
    if (m_calib_result.image_pair_was_used[i]) {
      {
        ...
        mrpt::poses::CPose3D p =
            -m_calib_result.left_cam_poses[i]; // Inversed poses are estimated.
        cor->setPose(p);
