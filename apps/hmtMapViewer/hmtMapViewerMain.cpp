...
hmtMapViewerFrame::hmtMapViewerFrame(wxWindow *parent, wxWindowID id) {
  ...
  Create(parent, wxID_ANY, _("HMT Maps Viewer - Part of the MRPT project"),
  ...
  Panel5 = new wxPanel(Panel1, ID_PANEL5, wxDefaultPosition, wxDefaultSize,
  ...
  BoxSizer2->Add(StaticText1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 5);
  FlexGridSizer4->Add(BoxSizer2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer5 = new wxFlexGridSizer(0, 2, 0, 0);
  StaticText2 = new wxStaticText(Panel5, ID_STATICTEXT2,
  ...
  FlexGridSizer5->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                      ...
                      5);
  cbHypos = new wxChoice(Panel5, ID_CHOICE1, wxDefaultPosition, wxDefaultSize,
                         0, 0, 0, wxDefaultValidator, _T("ID_CHOICE1"));
  FlexGridSizer5->Add(cbHypos, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer1->Add(Panel5, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  ...
  Panel9 = new wxPanel(SplitterWindow3, ID_PANEL9, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL9"));
  FlexGridSizer9 = new wxFlexGridSizer(0, 0, 0, 0);
  FlexGridSizer9->AddGrowableCol(0);
  FlexGridSizer9->AddGrowableRow(0);
  treeView =
      new wxTreeCtrl(Panel9, ID_TREECTRL1, wxDefaultPosition, wxDefaultSize,
                     wxTR_LINES_AT_ROOT | wxTR_MULTIPLE | wxTR_DEFAULT_STYLE |
                         wxVSCROLL | wxHSCROLL,
                     wxDefaultValidator, _T("ID_TREECTRL1"));
  FlexGridSizer9->Add(treeView, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel9->SetSizer(FlexGridSizer9);
  FlexGridSizer9->Fit(Panel9);
  FlexGridSizer9->SetSizeHints(Panel9);
  Panel8 = new wxPanel(SplitterWindow3, ID_PANEL8, wxPoint(0, 305),
                       wxSize(370, 235), wxTAB_TRAVERSAL, _T("ID_PANEL8"));
  ...
  StaticText3 = new wxStaticText(Panel3, ID_STATICTEXT3, _("Global HMT map"),
  ...
  FlexGridSizer2->Add(StaticText3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  Panel6 = new wxPanel(Panel3, ID_PANEL6, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer2->Add(Panel6, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  ...
  Menu1 = new wxMenu();
  MenuItem3 = new wxMenuItem(Menu1, ID_MENUITEM1, _("Load..."),
                             _("Loads a \"hmtmap\" file"), wxITEM_NORMAL);
  Menu1->Append(MenuItem3);
  Menu1->AppendSeparator();
  menuExportLocalMaps =
      new wxMenuItem(Menu1, ID_MENUITEM4, _("Export local maps..."),
  ...
  Menu3 = new wxMenu();
  MenuItem4 =
      new wxMenuItem(Menu3, ID_MENUITEM2, _("Translation btw. 2 areas..."),
                     wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem4);
  MenuItem5 = new wxMenuItem(Menu3, ID_MENUITEM3,
                             _("Overlap probability btw. 2 areas..."),
                             wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem5);
  MenuItem6 = new wxMenu();
  MenuItem7 = new wxMenuItem(MenuItem6, ID_MENUITEM6, _("Grid matching"),
                             wxEmptyString, wxITEM_NORMAL);
  MenuItem6->Append(MenuItem7);
  MenuItem8 = new wxMenuItem(MenuItem6, ID_MENUITEM7, _("FabMap"),
                             wxEmptyString, wxITEM_NORMAL);
  MenuItem6->Append(MenuItem8);
  Menu3->Append(ID_MENUITEM5, _("Topological transition models..."), MenuItem6,
                wxEmptyString);
  ...
  ToolBar1 = new wxToolBar(this, ID_TOOLBAR1, wxDefaultPosition, wxDefaultSize,
                           wxTB_FLAT | wxTB_VERTICAL | wxTB_TEXT | wxNO_BORDER,
                           _T("ID_TOOLBAR1"));
  ...
  Connect(
      ...
      (wxObjectEventFunction)&hmtMapViewerFrame::OnmenuExportLocalMapsSelected);
  ...
  FlexGridSizer6->Add(m_canvas_HMAP, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  m_canvas_LMH->m_openGLScene->insert(std::make_shared<opengl::CGridPlaneXY>());
  FlexGridSizer7->Add(m_canvas_LMH, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
...
void hmtMapViewerFrame::updateLocalMapView() {
  ...
  if (hmt_map->m_LMHs.find(hypID) == hmt_map->m_LMHs.end()) {
    wxMessageBox(_U(format("No LMH has hypothesis ID %i!", (int)hypID).c_str()),
    ...
    for (int nRound = 0; nRound < 2; nRound++) {
      ...
      for (size_t nSelItem = 0; nSelItem < nSel; nSelItem++) {
        ...
        if (!firstArea) {
          ...
          cout << "Pose " << firstArea->getID() << " - " << area->getID()
               << refPoseThisArea << endl;
        }
        ...
        TPoseID refPoseID;
        area->m_annotations.getElemental(NODE_ANNOTATION_REF_POSEID, refPoseID,
                                         hypID, true);
        ...
        if (nRound == 1) {
          ...
          if (refPoseThisArea.cov(0, 0) != 0 ||
            ...
            ellip->setLocation(ellip->getPoseX(), ellip->getPoseY(),
                               ellip->getPoseZ() + 0.5);
...
void hmtMapViewerFrame::updateGlobalMapView() {
  ...
  if (hmt_map->m_map.getFirstNode()) {
    ...
    hmt_map->m_map.getAs3DScene(*m_canvas_HMAP->m_openGLScene, refID, hypID);
...
void hmtMapViewerFrame::OnMenuOverlapBtw2(wxCommandEvent &event) {
...

  {
    ...
    cout << "Overlap probability: " << area1->getID() << " - " << area2->getID()
         << ": " << prob12 << endl;
    cout << "Overlap probability: " << area2->getID() << " - " << area1->getID()
         << ": " << prob21 << endl;
  }
...
void hmtMapViewerFrame::OnmenuExportLocalMapsSelected(wxCommandEvent &event) {
  ...
  for (it = hmt_map->m_map.begin(); it != hmt_map->m_map.end(); it++) {
    ...
    CRobotPosesGraph::Ptr obj_poseGraph =
        area->m_annotations.getAs<CRobotPosesGraph>(NODE_ANNOTATION_POSES_GRAPH,
                                                    hypID, false);
