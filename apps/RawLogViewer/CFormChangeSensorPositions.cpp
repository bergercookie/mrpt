...
CFormChangeSensorPositions::CFormChangeSensorPositions(wxWindow *parent,
                                                       wxWindowID id) {
  ...
  Create(parent, id, _("Change sensor pose information:"), wxDefaultPosition,
  ...
  rbLoaded = new wxRadioButton(this, ID_RADIOBUTTON1, _("Loaded rawlog"),
                               wxDefaultPosition, wxDefaultSize, 0,
                               wxDefaultValidator, _T("ID_RADIOBUTTON1"));
  FlexGridSizer14->Add(rbLoaded, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer14->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  FlexGridSizer14->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  rbFile = new wxRadioButton(this, ID_RADIOBUTTON2, _("Rawlog in file:"),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_RADIOBUTTON2"));
  FlexGridSizer14->Add(rbFile, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  StaticText27 = new wxStaticText(this, ID_STATICTEXT27, _("Input file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT27"));
  FlexGridSizer14->Add(StaticText27, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtInputFile =
      new wxTextCtrl(this, ID_TEXTCTRL16, wxEmptyString, wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL16"));
  FlexGridSizer14->Add(txtInputFile, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnPickInput =
      new wxButton(this, ID_BUTTON9, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON9"));
  FlexGridSizer14->Add(btnPickInput, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       0);
  FlexGridSizer14->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText28 = new wxStaticText(this, ID_STATICTEXT28, _("Output file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT28"));
  FlexGridSizer14->Add(StaticText28, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtOutputFile =
      new wxTextCtrl(this, ID_TEXTCTRL17, wxEmptyString, wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL17"));
  FlexGridSizer14->Add(txtOutputFile, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnPickOut =
      new wxButton(this, ID_BUTTON11, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON11"));
  FlexGridSizer14->Add(btnPickOut, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       0);
  FlexGridSizer13->Add(FlexGridSizer14, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticLine1 =
      new wxStaticLine(this, ID_STATICLINE1, wxDefaultPosition, wxSize(10, -1),
                       wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
  FlexGridSizer13->Add(StaticLine1, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  wxString __wxRadioBoxChoices_1[2] = {_("Select by index within SF"),
                                       _("Select by label")};
  rbApply =
      new wxRadioBox(this, ID_RADIOBOX1, _("Apply to..."), wxDefaultPosition,
                     wxSize(202, 67), 2, __wxRadioBoxChoices_1, 1,
                     wxRA_HORIZONTAL, wxDefaultValidator, _T("ID_RADIOBOX1"));
  FlexGridSizer3->Add(rbApply, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  FlexGridSizer16->Add(FlexGridSizer3, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer17 = new wxFlexGridSizer(2, 2, 0, 0);
  FlexGridSizer17->AddGrowableCol(1);
  StaticText15 = new wxStaticText(
      this, ID_STATICTEXT15, _("Index within CSensoryFrame"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT15"));
  FlexGridSizer17->Add(StaticText15, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  scIndex = new wxSpinCtrl(this, ID_SPINCTRL1, _T("0"), wxDefaultPosition,
                           wxDefaultSize, 0, 0, 100, 0, _T("ID_SPINCTRL1"));
  scIndex->SetValue(_T("0"));
  FlexGridSizer17->Add(scIndex, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  FlexGridSizer17->Add(StaticText30, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edLabel = new wxComboBox(this, ID_COMBOBOX1, wxEmptyString, wxDefaultPosition,
                           wxDefaultSize, 0, 0, 0, wxDefaultValidator,
                           _T("ID_COMBOBOX1"));
  edLabel->Disable();
  FlexGridSizer17->Add(edLabel, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer16->Add(FlexGridSizer17, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer13->Add(FlexGridSizer16, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticBoxSizer1->Add(FlexGridSizer13, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer1->Add(StaticBoxSizer1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  FlexGridSizer1->Add(StaticText16, 1,
  ...
  FlexGridSizer5->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText1 = new wxStaticText(Panel1, ID_STATICTEXT1, _("3D position:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT1"));
  FlexGridSizer5->Add(StaticText1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer5->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer5->Add(StaticText2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer5->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText3 =
      new wxStaticText(Panel1, ID_STATICTEXT3, _("x:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT3"));
  FlexGridSizer5->Add(StaticText3, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edX =
      new wxTextCtrl(Panel1, ID_TEXTCTRL1, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer5->Add(edX, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText4 =
      new wxStaticText(Panel1, ID_STATICTEXT4, _("(meters)"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT4"));
  FlexGridSizer5->Add(StaticText4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText5 =
      new wxStaticText(Panel1, ID_STATICTEXT5, _("yaw:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT5"));
  FlexGridSizer5->Add(StaticText5, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edYaw =
      new wxTextCtrl(Panel1, ID_TEXTCTRL2, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer5->Add(edYaw, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  StaticText6 =
      new wxStaticText(Panel1, ID_STATICTEXT6, _("(deg)"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT6"));
  FlexGridSizer5->Add(StaticText6, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText7 =
      new wxStaticText(Panel1, ID_STATICTEXT7, _("y:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT7"));
  FlexGridSizer5->Add(StaticText7, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edY =
      new wxTextCtrl(Panel1, ID_TEXTCTRL3, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
  FlexGridSizer5->Add(edY, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText8 =
      new wxStaticText(Panel1, ID_STATICTEXT8, _("(meters)"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT8"));
  FlexGridSizer5->Add(StaticText8, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText9 =
      new wxStaticText(Panel1, ID_STATICTEXT9, _("pitch:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT9"));
  FlexGridSizer5->Add(StaticText9, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edPitch =
      new wxTextCtrl(Panel1, ID_TEXTCTRL4, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
  FlexGridSizer5->Add(edPitch, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  StaticText10 =
      new wxStaticText(Panel1, ID_STATICTEXT10, _("(deg)"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT10"));
  FlexGridSizer5->Add(StaticText10, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText11 =
      new wxStaticText(Panel1, ID_STATICTEXT11, _("z:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT11"));
  FlexGridSizer5->Add(StaticText11, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edZ =
      new wxTextCtrl(Panel1, ID_TEXTCTRL5, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
  FlexGridSizer5->Add(edZ, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText12 = new wxStaticText(Panel1, ID_STATICTEXT12, _("(meters)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT12"));
  FlexGridSizer5->Add(StaticText12, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText13 =
      new wxStaticText(Panel1, ID_STATICTEXT13, _("roll:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT13"));
  FlexGridSizer5->Add(StaticText13, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edRoll =
      new wxTextCtrl(Panel1, ID_TEXTCTRL6, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
  FlexGridSizer5->Add(edRoll, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  StaticText14 =
      new wxStaticText(Panel1, ID_STATICTEXT14, _("(deg)"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT14"));
  FlexGridSizer5->Add(StaticText14, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer4->Add(FlexGridSizer5, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer15 = new wxFlexGridSizer(0, 3, 0, 0);
  cbOnlyXYZ = new wxCheckBox(Panel1, ID_CHECKBOX1, _("Change X,Y,Z only"),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbOnlyXYZ->SetValue(false);
  FlexGridSizer15->Add(cbOnlyXYZ, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer4->Add(FlexGridSizer15, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer6 = new wxFlexGridSizer(0, 3, 0, 0);
  FlexGridSizer6->AddGrowableCol(2);
  FlexGridSizer6->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  btnGetCurPose = new wxButton(Panel1, ID_BUTTON3, _("Get current values..."),
                               wxDefaultPosition, wxDefaultSize, 0,
                               wxDefaultValidator, _T("ID_BUTTON3"));
  FlexGridSizer6->Add(btnGetCurPose, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  btnOK =
      new wxButton(Panel1, ID_BUTTON1, _("Apply changes..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  FlexGridSizer6->Add(btnOK, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  FlexGridSizer4->Add(FlexGridSizer6, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  StaticText17 = new wxStaticText(
      Panel2, ID_STATICTEXT17,
      _("This applies to CObservationImages (\"Monocular cameras\" only)"),
      wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT17"));
  FlexGridSizer7->Add(StaticText17, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  StaticBoxSizer2 = new wxStaticBoxSizer(wxHORIZONTAL, Panel2,
                                         _("Intrinsic parameters (in pixels)"));
  FlexGridSizer10 = new wxFlexGridSizer(0, 4, 0, 0);
  FlexGridSizer10->AddGrowableCol(1);
  FlexGridSizer10->AddGrowableCol(3);
  StaticText18 =
      new wxStaticText(Panel2, ID_STATICTEXT18, _("f_x="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT18"));
  FlexGridSizer10->Add(StaticText18, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edFX =
      new wxTextCtrl(Panel2, ID_TEXTCTRL7, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL7"));
  FlexGridSizer10->Add(edFX, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       5);
  StaticText19 =
      new wxStaticText(Panel2, ID_STATICTEXT19, _("f_y="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT19"));
  FlexGridSizer10->Add(StaticText19, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edFY =
      new wxTextCtrl(Panel2, ID_TEXTCTRL8, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL8"));
  FlexGridSizer10->Add(edFY, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       5);
  StaticText20 =
      new wxStaticText(Panel2, ID_STATICTEXT20, _("c_x="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT20"));
  FlexGridSizer10->Add(StaticText20, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edCX =
      new wxTextCtrl(Panel2, ID_TEXTCTRL9, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL9"));
  FlexGridSizer10->Add(edCX, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       5);
  StaticText21 =
      new wxStaticText(Panel2, ID_STATICTEXT21, _("c_y="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT21"));
  FlexGridSizer10->Add(StaticText21, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edCY =
      new wxTextCtrl(Panel2, ID_TEXTCTRL10, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL10"));
  FlexGridSizer10->Add(edCY, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       5);
  StaticBoxSizer2->Add(FlexGridSizer10, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer9->Add(StaticBoxSizer2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer3 =
      new wxStaticBoxSizer(wxHORIZONTAL, Panel2, _("Distortion parameters"));
  FlexGridSizer11 = new wxFlexGridSizer(0, 4, 0, 0);
  StaticText23 =
      new wxStaticText(Panel2, ID_STATICTEXT23, _("k1="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT23"));
  FlexGridSizer11->Add(StaticText23, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edK1 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL12, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL12"));
  FlexGridSizer11->Add(
      edK1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText24 =
      new wxStaticText(Panel2, ID_STATICTEXT24, _("k2="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT24"));
  FlexGridSizer11->Add(StaticText24, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edK2 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL13, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL13"));
  FlexGridSizer11->Add(
      edK2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText25 =
      new wxStaticText(Panel2, ID_STATICTEXT25, _("p1="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT25"));
  FlexGridSizer11->Add(StaticText25, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edP1 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL14, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL14"));
  FlexGridSizer11->Add(
      edP1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText26 =
      new wxStaticText(Panel2, ID_STATICTEXT26, _("p2="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT26"));
  FlexGridSizer11->Add(StaticText26, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edP2 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL15, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL15"));
  FlexGridSizer11->Add(
      edP2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticBoxSizer3->Add(FlexGridSizer11, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer9->Add(StaticBoxSizer3, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer7->Add(FlexGridSizer9, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12 = new wxFlexGridSizer(0, 2, 0, 0);
  StaticText22 = new wxStaticText(
      Panel2, ID_STATICTEXT22, _("Focal length (in meters) ="),
      wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT22"));
  FlexGridSizer12->Add(StaticText22, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edFocalLen =
      new wxTextCtrl(Panel2, ID_TEXTCTRL11, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL11"));
  FlexGridSizer12->Add(edFocalLen, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer7->Add(FlexGridSizer12, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer8 = new wxFlexGridSizer(0, 3, 0, 0);
  FlexGridSizer8->AddGrowableCol(2);
  FlexGridSizer8->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  btnGetCurCamModel = new wxButton(
      Panel2, ID_BUTTON4, _("Get current values..."), wxDefaultPosition,
      wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  FlexGridSizer8->Add(btnGetCurCamModel, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                      5);
  btnApplyCameraParams =
      new wxButton(Panel2, ID_BUTTON5, _("Apply changes..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer8->Add(btnApplyCameraParams, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer7->Add(FlexGridSizer8, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  FlexGridSizer2->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  btnCancel =
  ...
  Connect(
      ...
      (wxObjectEventFunction)&CFormChangeSensorPositions::OnbtnPickInputClick);
  Connect(
...
void CFormChangeSensorPositions::OnbtnPickInputClick(wxCommandEvent &event) {
  ...
  // Save the path
  WX_START_TRY
  iniFile->write(iniFileSect, "LastDir",
                 std::string(dialog.GetDirectory().mb_str()));
  WX_END_TRY
  ...
  while (((!isInMemory && keepLoading) ||
    ...
    try {
      ...
      if (newObj->GetRuntimeClass() == CLASS_ID(CSensoryFrame)) {
        ...
        // Process & save:
        operation(dynamic_cast<CActionCollection *>(acts.get()), nullptr,
                  changes);
        ...
        THROW_EXCEPTION(format("Unexpected class found in the file: '%s'",
...
//    Set the sensor pose
// ------------------------------------------------------------
void exec_setPoseByIdx(mrpt::obs::CActionCollection *acts,
                       mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF)
    if (SF->size() > idxToProcess) {
      ...
      if (changeOnlyXYZ) {
        ...
        tmpPose.setFromValues(sensorPoseToSet.x, sensorPoseToSet.y,
                              sensorPoseToSet.z, tmpPose.yaw(), tmpPose.pitch(),
                              tmpPose.roll());
...
void exec_setPoseByLabel(mrpt::obs::CActionCollection *acts,
                         mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
...
void CFormChangeSensorPositions::OnbtnOKClick(wxCommandEvent &event) {
  ...
  sensorPoseToSet.yaw =
      DEG2RAD(atof(string(edYaw->GetValue().mb_str()).c_str()));
  sensorPoseToSet.pitch =
      DEG2RAD(atof(string(edPitch->GetValue().mb_str()).c_str()));
  sensorPoseToSet.roll =
      DEG2RAD(atof(string(edRoll->GetValue().mb_str()).c_str()));

  changeOnlyXYZ = cbOnlyXYZ->GetValue();

  if (rbApply->GetSelection() == 0) {
    idxToProcess = scIndex->GetValue();
    executeOperationOnRawlog(exec_setPoseByIdx,
                             "Sensor poses changed (by index): ");
  } else {
    labelToProcess = string(edLabel->GetValue().mb_str());
    executeOperationOnRawlog(exec_setPoseByLabel,
                             "Sensor poses changed (by label): ");
  }
...
// ------------------------------------------------------------
void exec_getCurrentPoseByIdx(mrpt::obs::CActionCollection *acts,
                              mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF)
    if (SF->size() > idxToProcess) {
...
void exec_getCurrentPoseByLabel(mrpt::obs::CActionCollection *acts,
...
void CFormChangeSensorPositions::OnbtnGetCurPoseClick1(wxCommandEvent &event) {
  ...
  if (sensorPoseReadOK) {
    ...
    wxMessageBox(_("Error: No observation with the selected index has been "
                   "found in the rawlog!"));
  }
...
// ------------------------------------------------------------
void exec_getCurrentCamCfgByIdx(mrpt::obs::CActionCollection *acts,
                                mrpt::obs::CSensoryFrame *SF,
                                int &changesCount) {
  if (SF)
    if (SF->size() > idxToProcess) {
      if (SF->getObservationByIndex(idxToProcess)->GetRuntimeClass() ==
        ...
        CObservationImage::Ptr obsIm =
            SF->getObservationByIndexAs<CObservationImage::Ptr>(idxToProcess);
...
void exec_getCurrentCamCfgByLabel(mrpt::obs::CActionCollection *acts,
                                  mrpt::obs::CSensoryFrame *SF,
                                  int &changesCount) {
  if (SF && SF->size()) {
    CObservation::Ptr o = SF->getObservationBySensorLabel(labelToProcess);
...
void CFormChangeSensorPositions::OnbtnGetCurCamModelClick(
  ...
  if (camReadIsOk) {
    ...
    wxMessageBox(_("Error: No CObservationImage found in the rawlog with the "
                   "selected index!"));
  }
...
// ------------------------------------------------------------
void exec_setCurrentCamCfgByIdx(mrpt::obs::CActionCollection *acts,
                                mrpt::obs::CSensoryFrame *SF,
                                int &changesCount) {
  if (SF)
    if (SF->size() > idxToProcess) {
...
void exec_setCurrentCamCfgByLabel(mrpt::obs::CActionCollection *acts,
                                  mrpt::obs::CSensoryFrame *SF,
                                  int &changesCount) {
  if (SF && SF->size()) {
    CObservation::Ptr o = SF->getObservationBySensorLabel(labelToProcess);
...
void CFormChangeSensorPositions::OnbtnApplyCameraParamsClick(
    wxCommandEvent &event) {
  WX_START_TRY
  ...
  if (rbApply->GetSelection() == 0) {
    idxToProcess = scIndex->GetValue();
    executeOperationOnRawlog(exec_setCurrentCamCfgByIdx,
                             "CObservationImage objects changed: ");
  } else {
    labelToProcess = string(edLabel->GetValue().mb_str());
    executeOperationOnRawlog(exec_setCurrentCamCfgByLabel,
                             "CObservationImage objects changed: ");
  }
