...
CScanMatching::CScanMatching(wxWindow *parent, wxWindowID) {
  ...
  Create(parent, wxID_ANY, _("Scan Matching Experimenting Module"),
  ...
  FlexGridSizer13->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  btnHelp = new wxBitmapButton(
      ...
      _T("ID_BITMAPBUTTON1"));
  FlexGridSizer13->Add(btnHelp, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer5->Add(FlexGridSizer13, 1,
  ...
  FlexGridSizer6->Add(StaticText3, 1,
  ...
  FlexGridSizer6->Add(edFirst, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  ...
  FlexGridSizer2->Add(StaticBoxSizer1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer5 = new wxStaticBoxSizer(wxHORIZONTAL, Panel1,
                                         _("Config of the ICP algorithm:"));
  edOptICP = new wxTextCtrl(
      Panel1, ID_TEXTCTRL6,
      _("; Options for CICP::TConfigParams. See the MRPT reference for further "
        "information\n; "
        "----------------------------------------------------------------------"
        "---------------\n[InitialPosition]\nx=0 ; The initial position for "
        "the iterative ICP algorithm\ny=0 ; x/y in meters, phi in "
      ...
      _T("ID_TEXTCTRL6"));
  wxFont edOptICPFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
                      false, _T("Monospace"), wxFONTENCODING_DEFAULT);
  edOptICP->SetFont(edOptICPFont);
  StaticBoxSizer5->Add(edOptICP, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer2->Add(StaticBoxSizer5, 1,
  ...
  StaticText5 = new wxStaticText(Panel1, ID_STATICTEXT5, _("Map type:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT5"));
  FlexGridSizer8->Add(StaticText5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  rbPoint = new wxRadioButton(Panel1, ID_RADIOBUTTON1, _("Point map"),
                              wxDefaultPosition, wxDefaultSize, 0,
                              wxDefaultValidator, _T("ID_RADIOBUTTON1"));
  rbPoint->SetValue(true);
  FlexGridSizer8->Add(rbPoint, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  rbGrid = new wxRadioButton(Panel1, ID_RADIOBUTTON2, _("Occupancy grid map"),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_RADIOBUTTON2"));
  FlexGridSizer8->Add(rbGrid, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  edOptRefPnt = new wxTextCtrl(
      ...
      _("; Configuration for CPointsMap::TInsertionOptions - See MRPT "
        "reference for help\n; "
        "----------------------------------------------------------------------"
        "-----------\n[InsertionOptions]\nminDistBetweenLaserPoints=0.05 ; The "
        "minimum distance between points (in 3D): If two points are too close, "
        "one of them is not inserted into the map.\nalso_interpolate=0 ; If "
        "set to true, far points (<1m) are interpolated with samples at "
        "minDistSqrBetweenLaserPoints intervals (Default is "
        "false).\ndisableDeletion=1 ; If set to false (default) points in the "
        "same plane as the inserted scan and inside the free space, are "
        "erased.\nfuseWithExisting=0 ; If set to true (default), inserted "
        "points are fused with previously existent ones.\nisPlanarMap=1 ; If "
        "set to true, only HORIZONTAL (i.e. XY plane) measurements will be "
        "inserted in the map. Default value is false, thus 3D maps are "
        "generated\nmaxDistForInterpolatePoints=1 ; The maximum distance "
        "between two points to interpolate between them (ONLY when "
        "also_interpolate=true).\n"),
      wxDefaultPosition, wxSize(300, 87),
      wxTE_MULTILINE | wxHSCROLL | wxVSCROLL, wxDefaultValidator,
      _T("ID_TEXTCTRL4"));
  wxFont edOptRefPntFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
                         false, _T("Monospace"), wxFONTENCODING_DEFAULT);
  edOptRefPnt->SetFont(edOptRefPntFont);
  edOptRefGrid = new wxTextCtrl(
      Notebook1, ID_TEXTCTRL9,
      _("; Configuration for COccupancyGridMap2D::TInsertionOptions - See MRPT "
        "reference for help\n; "
        "----------------------------------------------------------------------"
        "-----------\n[Construction]\nresolution=0.05 ; The grid cell size, in "
        "meters.\n\n[InsertionOptions]\nmapAltitude=0 ; The height (z axis) "
        "over the ground at which this grid map is at\nuseMapAltitude=0 ; If "
        "this is set to 1, only observations that match the grid height are "
        "inserted in the map.\nmaxDistanceInsertion=40 ; The maximum distance "
        "from the scan origin for updating cells, in "
        "meters\nmaxOccupancyUpdateCertainty=0.8 ; The \"certainty\" used to "
        "update the cells using the Bayes update formulas. Values are in the "
        "range 0.5 (No update) to 1.0 (last value is taken forgetting all old "
        "readings of that cell).\nconsiderInvalidRangesAsFreeSpace=1 ; Whether "
        "to consider \"lost-ranges\" as free space.\n\n"),
      wxDefaultPosition, wxSize(300, 87),
      wxTE_MULTILINE | wxHSCROLL | wxVSCROLL, wxDefaultValidator,
      _T("ID_TEXTCTRL9"));
  wxFont edOptRefGridFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
  ...
  edOptAlignMap = new wxTextCtrl(
      ...
      wxTE_MULTILINE | wxHSCROLL | wxVSCROLL, wxDefaultValidator,
      _T("ID_TEXTCTRL7"));
  wxFont edOptAlignMapFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
                           wxNORMAL, false, _T("Monospace"),
                           wxFONTENCODING_DEFAULT);
  edOptAlignMap->SetFont(edOptAlignMapFont);
  StaticBoxSizer4->Add(edOptAlignMap, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer2->Add(StaticBoxSizer4, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 2);
  Panel1->SetSizer(FlexGridSizer2);
  FlexGridSizer2->Fit(Panel1);
  FlexGridSizer2->SetSizeHints(Panel1);
  Panel2 = new wxPanel(SplitterWindow1, ID_PANEL2, wxDefaultPosition,
                       wxSize(200, 200), wxTAB_TRAVERSAL, _T("ID_PANEL2"));
  FlexGridSizer4 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer4->AddGrowableCol(0);
  FlexGridSizer4->AddGrowableRow(0);
  SplitterWindow2 =
      new wxSplitterWindow(Panel2, ID_SPLITTERWINDOW2, wxDefaultPosition,
                           wxDefaultSize, wxSP_3D, _T("ID_SPLITTERWINDOW2"));
  SplitterWindow2->SetMinSize(wxSize(10, 10));
  SplitterWindow2->SetMinimumPaneSize(10);
  Panel3 = new wxPanel(SplitterWindow2, ID_PANEL3, wxDefaultPosition,
  ...
  FlexGridSizer9->Add(StaticText6, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 3);
  plotMaps =
      new mpWindow(Panel3, ID_CUSTOM1, wxDefaultPosition, wxSize(341, 359), 0);
  FlexGridSizer9->Add(plotMaps, 1, wxALL | wxEXPAND | wxFIXED_MINSIZE |
                                       wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel5 = new wxPanel(Panel3, ID_PANEL5, wxDefaultPosition, wxDefaultSize,
  ...
  btnRunICP =
      new wxButton(Panel5, ID_BUTTON1, _("Run ICP"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  btnRunICP->SetDefault();
  FlexGridSizer11->Add(btnRunICP, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                       5);
  cbAnimate = new wxCheckBox(Panel5, ID_CHECKBOX1, _("Animate step by step"),
                             wxDefaultPosition, wxDefaultSize, 0,
                             wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbAnimate->SetValue(false);
  FlexGridSizer11->Add(cbAnimate, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                       5);
  btnClose =
      new wxButton(Panel5, ID_BUTTON2, _("CLOSE"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
  FlexGridSizer11->Add(btnClose, 1,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer7->Add(FlexGridSizer11, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer12->AddGrowableCol(1);
  txtStep = new wxStaticText(Panel5, ID_STATICTEXT1, _("Step: 0 / 0"),
                             wxDefaultPosition, wxDefaultSize, 0,
                             _T("ID_STATICTEXT1"));
  FlexGridSizer12->Add(txtStep, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                       5);
  pbSteps = new wxGauge(Panel5, ID_GAUGE1, 100, wxDefaultPosition,
                        wxDefaultSize, 0, wxDefaultValidator, _T("ID_GAUGE1"));
  FlexGridSizer12->Add(pbSteps, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  FlexGridSizer9->Add(Panel5, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel3->SetSizer(FlexGridSizer9);
  FlexGridSizer9->Fit(Panel3);
  FlexGridSizer9->SetSizeHints(Panel3);
  Panel4 = new wxPanel(SplitterWindow2, ID_PANEL4, wxDefaultPosition,
  ...
  wxFont txtLogFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
                    false, _T("Monospace"), wxFONTENCODING_DEFAULT);
  txtLog->SetFont(txtLogFont);
  FlexGridSizer10->Add(txtLog, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       0);
  ...
  FlexGridSizer4->Add(SplitterWindow2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
...
void CScanMatching::OnbtnICPClick(wxCommandEvent &) {
  ...
  if (rawlog.getType(refIndx) != CRawlog::etObservation &&
    ...
    wxMessageBox(
        _("The first index is not a sensory frame or an observation!\n Select "
          "an index that corresponds to observations"),
        _("Error"), wxOK, this);
    return;
  }
  ...
  if (useGridMap) {
    ...
    lyRefGrid->SetBitmap(*newBmp, refMapGrid.getXMin(), refMapGrid.getYMin(),
                         lx, ly);
...

  {
    ...
    while (curStep <= maxSteps) {
      ...
      poseEst = icp.Align(refMap, (CMetricMap *)&newMapPt, initialEst, &runTime,
                          &icpInfo);
      ...
      lyNewRobotPose->SetCoordinateBase(estMean.x(), estMean.y(),
                                        estMean.phi());

      lyEstimateEllipse->SetCoordinateBase(estMean.x(), estMean.y());
      lyEstimateEllipse->SetCovarianceMatrix(estCov(0, 0), estCov(0, 1),
                                             estCov(1, 1));
...
void CScanMatching::OnbtnCloseClick(wxCommandEvent &) { Close(); }

void CScanMatching::OnbtnHelpClick(wxCommandEvent &) {
  wxString s;
  s << _("Scan matching tries to register two maps. Each of them is created by "
         "inserting observations,\n");
  s << _(" typically laser scans, into point or grid maps. You must enter here "
         "the indexes of the observations\n");
  s << _(" to be inserted in each map. You can select just one index, or "
         "several ones separated by spaces.\n");
