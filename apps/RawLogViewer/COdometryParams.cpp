...
COdometryParams::COdometryParams(wxWindow *parent, wxWindowID id,
                                 const wxPoint &, const wxSize &size) {
  //(*Initialize(COdometryParams)
  wxFlexGridSizer *FlexGridSizer3;
  wxFlexGridSizer *FlexGridSizer2;
  wxFlexGridSizer *FlexGridSizer1;

  Create(parent, id, _("Recalculate odometry"), wxDefaultPosition,
  ...
  FlexGridSizer1->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer2 = new wxFlexGridSizer(3, 3, 0, 0);
  FlexGridSizer2->AddGrowableCol(1);
  StaticText2 =
      new wxStaticText(this, ID_STATICTEXT2, _("K_left="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT2"));
  FlexGridSizer2->Add(StaticText2, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edKL =
      new wxTextCtrl(this, ID_TEXTCTRL1, _("7.00e-6"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer2->Add(edKL, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  StaticText3 = new wxStaticText(this, ID_STATICTEXT3, _("meters/tick"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT3"));
  FlexGridSizer2->Add(StaticText3, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  StaticText4 =
      new wxStaticText(this, ID_STATICTEXT4, _("K_right="), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT4"));
  FlexGridSizer2->Add(StaticText4, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edKR =
      new wxTextCtrl(this, ID_TEXTCTRL2, _("7.00e-6"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer2->Add(edKR, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _("meters/tick"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT5"));
  FlexGridSizer2->Add(StaticText5, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  FlexGridSizer2->Add(StaticText6, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edD =
      new wxTextCtrl(this, ID_TEXTCTRL3, _("0.41"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
  FlexGridSizer2->Add(edD, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText7 =
      new wxStaticText(this, ID_STATICTEXT7, _("meters"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT7"));
  FlexGridSizer2->Add(StaticText7, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
