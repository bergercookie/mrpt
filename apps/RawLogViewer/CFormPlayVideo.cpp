...
CFormPlayVideo::CFormPlayVideo(wxWindow *parent, wxWindowID id) {
  ...
  Create(parent, wxID_ANY, _("Play images in a Rawlog as a video"),
  ...
  FlexGridSizer6->Add(-1, -1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  FlexGridSizer6->Add(-1, -1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  FlexGridSizer6->Add(-1, -1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
  ...
  FlexGridSizer6->Add(edFile, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  btnPickInput =
      new wxButton(this, ID_BUTTON4, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  FlexGridSizer6->Add(btnPickInput, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      0);
  BoxSizer5->Add(FlexGridSizer6, 1,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  BoxSizer4->Add(BoxSizer5, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 0);
  StaticBoxSizer1->Add(BoxSizer4, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer1->Add(StaticBoxSizer1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer9 = new wxFlexGridSizer(3, 3, 0, 0);
  cbOrderByYaw = new wxCheckBox(
      this, ID_CHECKBOX1, _("Order images by Yaw (<0:left,=0:middle,>0:right)"),
      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
      _T("ID_CHECKBOX1"));
  cbOrderByYaw->SetValue(false);
  FlexGridSizer9->Add(cbOrderByYaw, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  cbOrderByY = new wxCheckBox(this, ID_CHECKBOX2,
                              _("Order by \'y\' (<0: left, >0:right)"),
                              wxDefaultPosition, wxDefaultSize, 0,
                              wxDefaultValidator, _T("ID_CHECKBOX2"));
  cbOrderByY->SetValue(false);
  FlexGridSizer9->Add(cbOrderByY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      5);
  cbReduceLarge = new wxCheckBox(
      this, ID_CHECKBOX3, _("Reduce large images (w>640px)"), wxDefaultPosition,
      wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
  cbReduceLarge->SetValue(true);
  FlexGridSizer9->Add(cbReduceLarge, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer9->Add(cbDrawStereoRules, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer9->Add(StaticText3, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edHorzRuleSpace =
      new wxSpinCtrl(this, ID_SPINCTRL2, _T("50"), wxDefaultPosition,
                     wxDefaultSize, 0, 3, 1000, 50, _T("ID_SPINCTRL2"));
  edHorzRuleSpace->SetValue(_T("50"));
  FlexGridSizer9->Add(edHorzRuleSpace, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                              wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText2 = new wxStaticText(
      this, ID_STATICTEXT6, _("Directory for delayed-load (external) images:"),
      wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
  FlexGridSizer9->Add(StaticText2, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  cbImageDirs = new wxComboBox(
      this, ID_COMBOBOX1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0,
      wxCB_READONLY | wxCB_DROPDOWN, wxDefaultValidator, _T("ID_COMBOBOX1"));
  FlexGridSizer9->Add(cbImageDirs, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  btnPlay =
      new wxButton(this, ID_BUTTON2, _("Play"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
  FlexGridSizer8->Add(btnPlay, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  btnStop =
      new wxButton(this, ID_BUTTON3, _("Stop"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
  btnStop->Disable();
  FlexGridSizer8->Add(btnStop, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer8->Add(-1, -1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  StaticText6 = new wxStaticText(this, ID_STATICTEXT7,
                                 _("Additional delay (ms):"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT7"));
  FlexGridSizer8->Add(StaticText6, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edDelay =
      new wxTextCtrl(this, ID_TEXTCTRL2, _("10"), wxDefaultPosition,
                     wxSize(61, 21), 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer8->Add(edDelay, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer8->Add(-1, -1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  btnClose =
      new wxButton(this, ID_BUTTON5, _("CLOSE"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer8->Add(btnClose, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  progressBar =
      new wxSlider(this, ID_SLIDER1, 0, 0, 100, wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER1"));
  FlexGridSizer5->Add(progressBar, 1,
  ...
  StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("Rawlog index:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT1"));
  FlexGridSizer7->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edIndex = new wxSpinCtrl(this, ID_SPINCTRL1, _T("0"), wxDefaultPosition,
                           wxDefaultSize, 0, 0, 100, 0, _T("ID_SPINCTRL1"));
  edIndex->SetValue(_T("0"));
  FlexGridSizer7->Add(edIndex, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  btnJump =
      new wxButton(this, ID_BUTTON1, _("Jump"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  FlexGridSizer7->Add(btnJump, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  lbProgress =
      new wxStaticText(this, ID_STATICTEXT3, _("(Progress)"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT3"));
  FlexGridSizer7->Add(lbProgress, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  lbCam1 =
      new wxStaticText(this, ID_STATICTEXT5, _("Cam1\?\?"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT5"));
  FlexGridSizer10->Add(lbCam1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer10->Add(btnSaveCam1, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  lbCam2 =
      new wxStaticText(this, ID_STATICTEXT4, _("Cam2\?\?"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT4"));
  FlexGridSizer11->Add(lbCam2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer11->Add(btnSaveCam2, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer3->Add(FlexGridSizer11, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer12->AddGrowableCol(0);
  lbCam3 =
      new wxStaticText(this, ID_STATICTEXT2, _("Cam3\?\?"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT2"));
  FlexGridSizer12->Add(lbCam3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer12->Add(btnSaveCam3, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer3->Add(FlexGridSizer12, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  pnLeft = new wxPanel(this, ID_PANEL3, wxDefaultPosition, wxSize(320, 240),
                       wxSUNKEN_BORDER | wxTAB_TRAVERSAL, _T("ID_PANEL3"));
  pnLeft->SetMinSize(wxSize(-1, 240));
  FlexGridSizer3->Add(pnLeft, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  pnRight = new wxPanel(this, ID_PANEL4, wxDefaultPosition, wxSize(320, 240),
                        wxSUNKEN_BORDER | wxTAB_TRAVERSAL, _T("ID_PANEL4"));
  pnRight->SetMinSize(wxSize(-1, 240));
  FlexGridSizer3->Add(pnRight, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  pnRight2 = new wxPanel(this, ID_PANEL2, wxDefaultPosition, wxSize(320, 240),
                         wxSUNKEN_BORDER | wxTAB_TRAVERSAL, _T("ID_PANEL2"));
  pnRight2->SetMinSize(wxSize(-1, 240));
  FlexGridSizer3->Add(pnRight2, 1,
  ...
  Connect(ID_COMBOBOX1, wxEVT_COMMAND_COMBOBOX_SELECTED,
...
void CFormPlayVideo::OnbtnPickClick(wxCommandEvent &event) {
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    try {
      ...
      wxMessageBox(wxString(e.what(), wxConvUTF8), wxT("Exception"), wxOK,
                   this);
    }
...
void CFormPlayVideo::OnbtnPlayClick(wxCommandEvent &event) {
  ...
  try {
    ...
    progressBar->SetRange(0, fil ? (int)fil->getTotalBytesCount()
                                 : (int)rawlog.size());
    ...
    wxMessageBox(_U(e.what()), _("Error with a delayed load image"), wxOK,
                 this);
...
bool CFormPlayVideo::showSensoryFrame(void *SF, size_t &nImgs) {
  ...
  // Monocular images:
  {
         ...
         img_idx_sf++) // Up to 3 images maximum:
    {
      ...
      // save:
      displayedImgs[thePanel == pnLeft ? 0 : (thePanel == pnRight ? 1 : 2)] =
          obsImg;
  ...
  // Stereo images:
  {
    ...
    if (obsImg2) {
      ...
      // Left:
      {
        ...
        lbCam1->SetLabel(
            _U(format("%s - left", obsImg2->sensorLabel.c_str()).c_str()));
      ...
      if (obsImg2->hasImageRight) {
        ...
        lbCam2->SetLabel(
            _U(format("%s - right", obsImg2->sensorLabel.c_str()).c_str()));
      ...
      if (obsImg2->hasImageDisparity) {
        ...
        lbCam2->SetLabel(
            _U(format("%s - disparity", obsImg2->sensorLabel.c_str()).c_str()));
  ...
  // 3D range images:
  {
    ...
    if (obs3D && obs3D->hasIntensityImage) {
      ...
      // Intensity channel
      {
        ...
        lbCam1->SetLabel(
            _U(format("%s - Intensity", obs3D->sensorLabel.c_str()).c_str()));
...
void CFormPlayVideo::saveCamImage(int n) {
  ...
  if (IS_CLASS(displayedImgs[n], CObservationImage)) {
    ...
    wxString defaultFilename =
        _U(format("%s_%i.jpg", o->sensorLabel.c_str(), m_idxInRawlog).c_str());
    wxFileDialog dialog(this, caption, defaultDir, defaultFilename, wildcard,
    ...
    case 0:
      defaultFilename =
          _U(format("%s_left_%i.jpg", o->sensorLabel.c_str(), m_idxInRawlog)
                 .c_str());
      break;
    case 1:
      defaultFilename =
          _U(format("%s_right_%i.jpg", o->sensorLabel.c_str(), m_idxInRawlog)
                 .c_str());
      break;
    case 2:
      defaultFilename =
          _U(format("%s_disp_%i.jpg", o->sensorLabel.c_str(), m_idxInRawlog)
                 .c_str());
      break;
    }
    ...
    CImage &im =
        (n == 2 ? o->imageDisparity : (n == 1 ? o->imageRight : o->imageLeft));
    im.saveToFile(fil);
  }
