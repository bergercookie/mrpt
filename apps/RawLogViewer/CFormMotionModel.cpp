...
CFormMotionModel::CFormMotionModel(wxWindow *parent, wxWindowID id) {
  ...
  Create(parent, wxID_ANY, _("Modify motion model parameters"),
  ...
  btnOk = new wxButton(this, ID_BUTTON1, _("CLOSE"), wxPoint(338, 9),
                       wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  btnOk->SetToolTip(_("Closes & cancel the dialog"));
  FlexGridSizer4->Add(btnOk, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL,
                      5);
  HyperlinkCtrl1 = new wxHyperlinkCtrl(
      this, ID_HYPERLINKCTRL1,
      _("http://www.mrpt.org/tutorials/programming/odometry-and-motion-models/"
        "probabilistic_motion_models/"),
      _("http://www.mrpt.org/tutorials/programming/odometry-and-motion-models/"
        "probabilistic_motion_models/"),
      wxDefaultPosition, wxDefaultSize,
  ...
  PageControl1 = new wxNotebook(this, ID_NOTEBOOK1, wxDefaultPosition,
                                wxDefaultSize, 0, _T("ID_NOTEBOOK1"));
  Panel2 = new wxPanel(PageControl1, ID_PANEL2, wxDefaultPosition,
  ...
  edG_A1 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL1, _("0.01"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer11->Add(edG_A1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText2 = new wxStaticText(Panel2, ID_STATICTEXT2, _("(meter/meter)"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT2"));
  FlexGridSizer11->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  edG_A2 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL2, _("0.001"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer11->Add(edG_A2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText5 = new wxStaticText(Panel2, ID_STATICTEXT5, _("(meter/deg)"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT5"));
  FlexGridSizer11->Add(StaticText5, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  edG_A3 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL3, _("1.0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
  FlexGridSizer11->Add(edG_A3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText7 = new wxStaticText(Panel2, ID_STATICTEXT7, _("(deg/meter)"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT7"));
  FlexGridSizer11->Add(StaticText7, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  edG_A4 =
      new wxTextCtrl(Panel2, ID_TEXTCTRL15, _("0.05"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL15"));
  FlexGridSizer11->Add(edG_A4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText27 = new wxStaticText(Panel2, ID_STATICTEXT27, _("(deg/deg)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT27"));
  FlexGridSizer11->Add(StaticText27, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  edMinStdXY =
      new wxTextCtrl(Panel2, ID_TEXTCTRL4, _("0.010"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
  FlexGridSizer11->Add(edMinStdXY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText9 =
      new wxStaticText(Panel2, ID_STATICTEXT9, _("(meters)"), wxDefaultPosition,
  ...
  edMinStdPHI =
      new wxTextCtrl(Panel2, ID_TEXTCTRL5, _("0.2"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
  FlexGridSizer11->Add(edMinStdPHI, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText11 = new wxStaticText(Panel2, ID_STATICTEXT11, _("(degrees)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT11"));
  FlexGridSizer11->Add(StaticText11, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  btnResetGauss = new wxButton(Panel2, ID_BUTTON10, _("Reset default values"),
                               wxDefaultPosition, wxDefaultSize, 0,
                               wxDefaultValidator, _T("ID_BUTTON10"));
  FlexGridSizer11->Add(btnResetGauss, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                       5);
  btnGaussOK =
      new wxButton(Panel2, ID_BUTTON2, _("Apply"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
  btnGaussOK->SetDefault();
  btnGaussOK->SetFocus();
  wxFont btnGaussOKFont(10, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                        wxFONTWEIGHT_BOLD, false, wxEmptyString,
                        wxFONTENCODING_DEFAULT);
  btnGaussOK->SetFont(btnGaussOKFont);
  FlexGridSizer11->Add(btnGaussOK, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       0);
  btnSimulate =
      new wxButton(Panel2, ID_BUTTON8, _("Draw samples"), wxDefaultPosition,
  ...
  Panel3 = new wxPanel(PageControl1, ID_PANEL3, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL3"));
  FlexGridSizer5 = new wxFlexGridSizer(8, 3, 0, 0);
  StaticText12 = new wxStaticText(Panel3, ID_STATICTEXT12, _("alpha1_rot_rot="),
                                  wxDefaultPosition, wxDefaultSize,
                                  wxALIGN_RIGHT, _T("ID_STATICTEXT12"));
  FlexGridSizer5->Add(StaticText12, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edA1 =
      new wxTextCtrl(Panel3, ID_TEXTCTRL6, _("0.05"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
  FlexGridSizer5->Add(
      edA1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText13 = new wxStaticText(Panel3, ID_STATICTEXT13, _("(degs/deg)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT13"));
  FlexGridSizer5->Add(StaticText13, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText14 = new wxStaticText(
      Panel3, ID_STATICTEXT14, _("alpha2_rot_trans="), wxDefaultPosition,
      wxDefaultSize, wxALIGN_RIGHT, _T("ID_STATICTEXT14"));
  FlexGridSizer5->Add(StaticText14, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edA2 =
      new wxTextCtrl(Panel3, ID_TEXTCTRL7, _("4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL7"));
  FlexGridSizer5->Add(
      edA2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText15 = new wxStaticText(Panel3, ID_STATICTEXT15, _("(degs/meter)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT15"));
  FlexGridSizer5->Add(StaticText15, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText16 = new wxStaticText(
      Panel3, ID_STATICTEXT16, _("alpha3_trans_trans="), wxDefaultPosition,
      wxDefaultSize, wxALIGN_RIGHT, _T("ID_STATICTEXT16"));
  FlexGridSizer5->Add(StaticText16, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edA3 =
      new wxTextCtrl(Panel3, ID_TEXTCTRL8, _("0.01"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL8"));
  FlexGridSizer5->Add(
      edA3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText17 = new wxStaticText(Panel3, ID_STATICTEXT17, _("(meters/meter)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT17"));
  FlexGridSizer5->Add(StaticText17, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText18 = new wxStaticText(
      Panel3, ID_STATICTEXT18, _("alpha4_trans_rot="), wxDefaultPosition,
      wxDefaultSize, wxALIGN_RIGHT, _T("ID_STATICTEXT18"));
  FlexGridSizer5->Add(StaticText18, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edA4 =
      new wxTextCtrl(Panel3, ID_TEXTCTRL9, _("0.0001"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL9"));
  FlexGridSizer5->Add(
      edA4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText19 = new wxStaticText(Panel3, ID_STATICTEXT19, _("(meters/deg)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT19"));
  FlexGridSizer5->Add(StaticText19, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText20 = new wxStaticText(
      Panel3, ID_STATICTEXT20, _("Number of particles to generate="),
      wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT, _T("ID_STATICTEXT20"));
  FlexGridSizer5->Add(StaticText20, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edNumParts =
      new wxTextCtrl(Panel3, ID_TEXTCTRL10, _("300"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL10"));
  FlexGridSizer5->Add(edNumParts, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText21 = new wxStaticText(Panel3, ID_STATICTEXT21, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT21"));
  FlexGridSizer5->Add(StaticText21, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText29 = new wxStaticText(
      Panel3, ID_STATICTEXT29, _("Additional std. dev. of x/y (min_std_XY)="),
      wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT29"));
  FlexGridSizer5->Add(StaticText29, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAddXY =
      new wxTextCtrl(Panel3, ID_TEXTCTRL17, _("0.001"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL17"));
  FlexGridSizer5->Add(edAddXY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText30 = new wxStaticText(Panel3, ID_STATICTEXT30, _("(meters)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT30"));
  FlexGridSizer5->Add(StaticText30, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText31 = new wxStaticText(
      Panel3, ID_STATICTEXT31, _("Additional std.dev. of phi (min_std_PHI)="),
      wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT31"));
  FlexGridSizer5->Add(StaticText31, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edAddPhi =
      new wxTextCtrl(Panel3, ID_TEXTCTRL18, _("0.050"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL18"));
  FlexGridSizer5->Add(edAddPhi, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText32 = new wxStaticText(Panel3, ID_STATICTEXT32, _("(degrees)"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT32"));
  FlexGridSizer5->Add(StaticText32, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  btnResetThrun = new wxButton(Panel3, ID_BUTTON11, _("Reset default values"),
                               wxDefaultPosition, wxDefaultSize, 0,
                               wxDefaultValidator, _T("ID_BUTTON11"));
  FlexGridSizer5->Add(btnResetThrun, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  btnThrunOk =
      new wxButton(Panel3, ID_BUTTON3, _("Apply"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
  btnThrunOk->SetDefault();
  btnThrunOk->SetFocus();
  wxFont btnThrunOkFont(10, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                        wxFONTWEIGHT_BOLD, false, wxEmptyString,
                        wxFONTENCODING_DEFAULT);
  btnThrunOk->SetFont(btnThrunOkFont);
  FlexGridSizer5->Add(btnThrunOk, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      0);
  btnSimulateThrun =
      new wxButton(Panel3, ID_BUTTON9, _("Draw samples"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON9"));
  FlexGridSizer5->Add(btnSimulateThrun, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                               wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer6->Add(rbLoaded, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer6->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  btnGetFromCurrent =
      new wxButton(this, ID_BUTTON6, _("<-- Get model"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON6"));
  FlexGridSizer6->Add(btnGetFromCurrent, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                      5);
  boxRanges = new wxStaticBoxSizer(wxHORIZONTAL, this, _(" Apply to range: "));
  FlexGridSizer9 = new wxFlexGridSizer(0, 2, 0, 0);
  cbAll =
      new wxCheckBox(this, ID_CHECKBOX1, _("All"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbAll->SetValue(true);
  FlexGridSizer9->Add(cbAll, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer9->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText34 =
      new wxStaticText(this, ID_STATICTEXT34, _("Range:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT34"));
  FlexGridSizer9->Add(StaticText34, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer10 = new wxFlexGridSizer(0, 3, 0, 0);
  edRangeFrom =
      new wxTextCtrl(this, ID_TEXTCTRL19, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL19"));
  edRangeFrom->Disable();
  FlexGridSizer10->Add(edRangeFrom, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  StaticText33 =
      new wxStaticText(this, ID_STATICTEXT33, _("-"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT33"));
  FlexGridSizer10->Add(StaticText33, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                       5);
  edRangeTo =
      new wxTextCtrl(this, ID_TEXTCTRL20, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL20"));
  edRangeTo->Disable();
  FlexGridSizer10->Add(edRangeTo, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                       5);
  ...
  FlexGridSizer6->Add(rbFile, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText22 = new wxStaticText(this, ID_STATICTEXT22, _("Input file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT22"));
  FlexGridSizer6->Add(StaticText22, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtInputFile =
      new wxTextCtrl(this, ID_TEXTCTRL11, wxEmptyString, wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL11"));
  FlexGridSizer6->Add(txtInputFile, 1, wxALL | wxEXPAND, 5);
  btnPickInput =
      new wxButton(this, ID_BUTTON4, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  FlexGridSizer6->Add(btnPickInput, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);
  btnGetFromFile =
      new wxButton(this, ID_BUTTON7, _("<-- Get model"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON7"));
  FlexGridSizer6->Add(btnGetFromFile, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer6->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText23 = new wxStaticText(this, ID_STATICTEXT23, _("Output file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT23"));
  FlexGridSizer6->Add(StaticText23, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtOutputFile =
      new wxTextCtrl(this, ID_TEXTCTRL12, wxEmptyString, wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL12"));
  FlexGridSizer6->Add(txtOutputFile, 1, wxALL | wxEXPAND, 5);
  btnPickOut =
      new wxButton(this, ID_BUTTON5, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer6->Add(btnPickOut, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  Panel1 = new wxPanel(this, ID_PANEL1, wxDefaultPosition, wxDefaultSize,
                       wxDOUBLE_BORDER | wxTAB_TRAVERSAL, _T("ID_PANEL1"));
  FlexGridSizer8 = new wxFlexGridSizer(2, 3, 0, 0);
  StaticText25 = new wxStaticText(Panel1, ID_STATICTEXT25,
                                  _("(Ax,Ay,Aphi_deg)="), wxDefaultPosition,
                                  wxDefaultSize, 0, _T("ID_STATICTEXT25"));
  FlexGridSizer8->Add(StaticText25, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      1);
  ...
  FlexGridSizer8->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                      ...
                      5);
  txtAx =
      new wxTextCtrl(Panel1, ID_TEXTCTRL13, _("0.3"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL13"));
  txtAx->SetToolTip(_("Odometry X increment (meter)"));
  FlexGridSizer8->Add(
      txtAx, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  txtAy =
      new wxTextCtrl(Panel1, ID_TEXTCTRL14, _("0.1"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL14"));
  txtAy->SetToolTip(_("Odometry Y increment (meter)"));
  FlexGridSizer8->Add(
      txtAy, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  txtAphi =
      new wxTextCtrl(Panel1, ID_TEXTCTRL16, _("10"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL16"));
  txtAphi->SetToolTip(_("Odometry angular increment (degrees)"));
  FlexGridSizer8->Add(txtAphi, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  StaticText24 = new wxStaticText(
      this, ID_STATICTEXT24, _("Random samples (X-Y view):"), wxDefaultPosition,
  ...
  StaticText28 = new wxStaticText(
      this, ID_STATICTEXT28, _("Random samples (PHI view):"), wxDefaultPosition,
...
void CFormMotionModel::loadFromGaussian() {
  ...
  options.gaussianModel.minStdPHI =
      DEG2RAD(atof(edMinStdPHI->GetValue().mb_str()));
}
...
void CFormMotionModel::loadFromThrun() {
  ...
  options.thrunModel.additional_std_phi =
      DEG2RAD(atof(edAddPhi->GetValue().mb_str()));
}
      ...
      if (rawlog.getType(i) == CRawlog::etActionCollection) {
        ...
        if (firstActionMov) {
          if (firstActionMov->estimationMethod ==
            ...
            // Use the kinematics motion model to estimate a pose change
            // gaussian approximation:
            firstActionMov->computeFromOdometry(
                firstActionMov->rawOdometryIncrementReading, options);
          } else {
            // Take the mean value
            firstActionMov->computeFromOdometry(
...
void CFormMotionModel::applyToRawlogFile() {
  ...
  while (keepLoading) {
    if (countLoop++ % 100 == 0) {
      auxStr.sprintf(wxT("Processing... (%u objects processed)"),
                     rawlog.size());
    ...
    try {
      ...
      if (newObj->GetRuntimeClass() == CLASS_ID(CRawlog)) {
        newObj.reset();
        THROW_EXCEPTION("File is a 'CRawlog' object. Please save it as a "
        ...
        THROW_EXCEPTION_FMT("Unexpected class found in the file: '%s'",
...
void CFormMotionModel::OnbtnGetFromCurrentClick(wxCommandEvent &event) {
  ...
  for (size_t i = 0;
       !acts && i < rawlog.size() && i < MAX_READ_FOR_MODEL_SEARCH; i++) {
    if (rawlog.getType(i) == CRawlog::etActionCollection) {
  ...
  if (!acts) {
    wxMessageBox(_("I couldn't find any 2D robot action!!"), _("Error"), wxOK,
                 this);
  } else {
    ...
    if (CActionRobotMovement2D::mmGaussian == options.modelSelection)
      wxMessageBox(_("Current model is Gaussian. Modify it as desired and "
                     "press 'Apply'"),
                   _("Done"), wxOK, this);
    else
      wxMessageBox(
          _("Current model is Thrun's. Modify it as desired and press 'Apply'"),
          _("Done"), wxOK, this);
  }
...
void CFormMotionModel::drawRandomSamples() {
  ...
  CPose2D odo(atof(txtAx->GetValue().mb_str()),
...
void CFormMotionModel::OnbtnGetFromFileClick(wxCommandEvent &event) {
  ...
  while (keepLoading) {
    ...
    if (newObj->GetRuntimeClass() == CLASS_ID(CActionCollection)) {
      acts = std::dynamic_pointer_cast<CActionCollection>(newObj)
