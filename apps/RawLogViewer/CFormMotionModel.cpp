...
CFormMotionModel::CFormMotionModel(wxWindow* parent, wxWindowID id)
{
	...
	Create(
		parent, wxID_ANY, _("Modify motion model parameters"),
	...
	HyperlinkCtrl1 = new wxHyperlinkCtrl(
		this, ID_HYPERLINKCTRL1, _("http://www.mrpt.org/tutorials/programming/"
	...
	PageControl1 = new wxNotebook(
		...
		_T("ID_NOTEBOOK1"));
	Panel2 = new wxPanel(
		PageControl1, ID_PANEL2, wxDefaultPosition, wxDefaultSize,
	...
	FlexGridSizer11->Add(
		edG_A1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText2 = new wxStaticText(
		Panel2, ID_STATICTEXT2, _("(meter/meter)"), wxDefaultPosition,
	...
	FlexGridSizer11->Add(
		edG_A2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText5 = new wxStaticText(
		Panel2, ID_STATICTEXT5, _("(meter/deg)"), wxDefaultPosition,
	...
	FlexGridSizer11->Add(
		edG_A3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText7 = new wxStaticText(
		Panel2, ID_STATICTEXT7, _("(deg/meter)"), wxDefaultPosition,
	...
	FlexGridSizer11->Add(
		edG_A4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText27 = new wxStaticText(
		Panel2, ID_STATICTEXT27, _("(deg/deg)"), wxDefaultPosition,
	...
	StaticText9 = new wxStaticText(
		Panel2, ID_STATICTEXT9, _("(meters)"), wxDefaultPosition, wxDefaultSize,
		0, _T("ID_STATICTEXT9"));
	FlexGridSizer11->Add(
		StaticText9, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	...
	StaticText11 = new wxStaticText(
		Panel2, ID_STATICTEXT11, _("(degrees)"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT11"));
	FlexGridSizer11->Add(
		StaticText11, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	btnResetGauss = new wxButton(
		Panel2, ID_BUTTON10, _("Reset default values"), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON10"));
	FlexGridSizer11->Add(
		btnResetGauss, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	btnGaussOK = new wxButton(
		Panel2, ID_BUTTON2, _("Apply"), wxDefaultPosition, wxDefaultSize, 0,
	...
	Panel3 = new wxPanel(
		PageControl1, ID_PANEL3, wxDefaultPosition, wxDefaultSize,
		wxTAB_TRAVERSAL, _T("ID_PANEL3"));
	FlexGridSizer5 = new wxFlexGridSizer(8, 3, 0, 0);
	StaticText12 = new wxStaticText(
		Panel3, ID_STATICTEXT12, _("alpha1_rot_rot="), wxDefaultPosition,
		wxDefaultSize, wxALIGN_RIGHT, _T("ID_STATICTEXT12"));
	FlexGridSizer5->Add(
		StaticText12, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edA1 = new wxTextCtrl(
		Panel3, ID_TEXTCTRL6, _("0.05"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL6"));
	FlexGridSizer5->Add(
		edA1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText13 = new wxStaticText(
		Panel3, ID_STATICTEXT13, _("(degs/deg)"), wxDefaultPosition,
	...
	edA2 = new wxTextCtrl(
		Panel3, ID_TEXTCTRL7, _("4"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL7"));
	FlexGridSizer5->Add(
		edA2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText15 = new wxStaticText(
		Panel3, ID_STATICTEXT15, _("(degs/meter)"), wxDefaultPosition,
	...
	FlexGridSizer5->Add(
		edA3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText17 = new wxStaticText(
		Panel3, ID_STATICTEXT17, _("(meters/meter)"), wxDefaultPosition,
	...
	edA4 = new wxTextCtrl(
		Panel3, ID_TEXTCTRL9, _("0.0001"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL9"));
	FlexGridSizer5->Add(
		edA4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText19 = new wxStaticText(
		Panel3, ID_STATICTEXT19, _("(meters/deg)"), wxDefaultPosition,
	...
	edNumParts = new wxTextCtrl(
		Panel3, ID_TEXTCTRL10, _("300"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL10"));
	FlexGridSizer5->Add(
		edNumParts, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText21 = new wxStaticText(
		Panel3, ID_STATICTEXT21, wxEmptyString, wxDefaultPosition,
	...
	FlexGridSizer5->Add(
		StaticText29, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edAddXY = new wxTextCtrl(
		Panel3, ID_TEXTCTRL17, _("0.001"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL17"));
	FlexGridSizer5->Add(
		edAddXY, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText30 = new wxStaticText(
		Panel3, ID_STATICTEXT30, _("(meters)"), wxDefaultPosition,
	...
	FlexGridSizer5->Add(
		StaticText31, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	edAddPhi = new wxTextCtrl(
		Panel3, ID_TEXTCTRL18, _("0.050"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL18"));
	FlexGridSizer5->Add(
		edAddPhi, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText32 = new wxStaticText(
		Panel3, ID_STATICTEXT32, _("(degrees)"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT32"));
	FlexGridSizer5->Add(
		StaticText32, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	btnResetThrun = new wxButton(
		Panel3, ID_BUTTON11, _("Reset default values"), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON11"));
	FlexGridSizer5->Add(
		btnResetThrun, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	btnThrunOk = new wxButton(
		Panel3, ID_BUTTON3, _("Apply"), wxDefaultPosition, wxDefaultSize, 0,
	...
	FlexGridSizer5->Add(
		btnThrunOk, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
	btnSimulateThrun = new wxButton(
		Panel3, ID_BUTTON9, _("Draw samples"), wxDefaultPosition, wxDefaultSize,
	...
	FlexGridSizer6->Add(
		...
		5);
	btnGetFromCurrent = new wxButton(
		this, ID_BUTTON6, _("<-- Get model"), wxDefaultPosition, wxDefaultSize,
		0, wxDefaultValidator, _T("ID_BUTTON6"));
	FlexGridSizer6->Add(
		btnGetFromCurrent, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	boxRanges =
		new wxStaticBoxSizer(wxHORIZONTAL, this, _(" Apply to range: "));
	FlexGridSizer9 = new wxFlexGridSizer(0, 2, 0, 0);
	cbAll = new wxCheckBox(
		this, ID_CHECKBOX1, _("All"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX1"));
	cbAll->SetValue(true);
	FlexGridSizer9->Add(
		cbAll, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer9->Add(
		-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	StaticText34 = new wxStaticText(
		this, ID_STATICTEXT34, _("Range:"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT34"));
	FlexGridSizer9->Add(
		StaticText34, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer10 = new wxFlexGridSizer(0, 3, 0, 0);
	edRangeFrom = new wxTextCtrl(
		this, ID_TEXTCTRL19, _("0"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL19"));
	edRangeFrom->Disable();
	FlexGridSizer10->Add(
		edRangeFrom, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	StaticText33 = new wxStaticText(
		this, ID_STATICTEXT33, _("-"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT33"));
	FlexGridSizer10->Add(
		StaticText33, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edRangeTo = new wxTextCtrl(
		this, ID_TEXTCTRL20, _("0"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL20"));
	edRangeTo->Disable();
	FlexGridSizer10->Add(
		edRangeTo, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer6->Add(
		btnPickInput, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 0);
	btnGetFromFile = new wxButton(
		this, ID_BUTTON7, _("<-- Get model"), wxDefaultPosition, wxDefaultSize,
	...
	StaticText23 = new wxStaticText(
		this, ID_STATICTEXT23, _("Output file:"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT23"));
	FlexGridSizer6->Add(
		StaticText23, 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer8->Add(
		-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	txtAx = new wxTextCtrl(
		Panel1, ID_TEXTCTRL13, _("0.3"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL13"));
	txtAx->SetToolTip(_("Odometry X increment (meter)"));
	FlexGridSizer8->Add(
		txtAx, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	txtAy = new wxTextCtrl(
		Panel1, ID_TEXTCTRL14, _("0.1"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL14"));
	txtAy->SetToolTip(_("Odometry Y increment (meter)"));
	FlexGridSizer8->Add(
		txtAy, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	txtAphi = new wxTextCtrl(
		Panel1, ID_TEXTCTRL16, _("10"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL16"));
	txtAphi->SetToolTip(_("Odometry angular increment (degrees)"));
	FlexGridSizer8->Add(
		txtAphi, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
...
void CFormMotionModel::OnbtnGetFromCurrentClick(wxCommandEvent& event)
{
	...
	{
		wxMessageBox(
			_("I couldn't find any 2D robot action!!"), _("Error"), wxOK, this);
	}
	else
	{
		...
		if (CActionRobotMovement2D::mmGaussian == options.modelSelection)
			wxMessageBox(
				_("Current model is Gaussian. Modify it as desired and press "
				  "'Apply'"),
				_("Done"), wxOK, this);
		else
			wxMessageBox(
				_("Current model is Thrun's. Modify it as desired and press "
				  "'Apply'"),
				_("Done"), wxOK, this);
	}
...
void CFormMotionModel::OnbtnPickInputClick(wxCommandEvent& event)
{
	...
	WX_START_TRY
	iniFile->write(
		iniFileSect, "LastDir", std::string(dialog.GetDirectory().mb_str()));
	WX_END_TRY
