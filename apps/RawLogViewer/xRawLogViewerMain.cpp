...
// Constructors
wxStaticBitmapPopup::wxStaticBitmapPopup(wxWindow *parent, wxWindowID id,
                                         const wxBitmap &img,
                                         const wxPoint &pos, const wxSize &size,
                                         int flag, const wxString &name)
    : wxStaticBitmap(parent, id, img, pos, size, flag, name) {
  wxMenuItem *mnu1 =
      new wxMenuItem((&mnuImages), ID_MENUITEM_IMG_SAVE,
                     _("Save image to file..."), wxEmptyString, wxITEM_NORMAL);
  wxMenuItem *mnu2 =
      new wxMenuItem((&mnuImages), ID_MENUITEM_IMG_LOAD,
                     _("Replace image by another one from file..."),
...
xRawLogViewerFrame::xRawLogViewerFrame(wxWindow *parent, wxWindowID id)
  ...
  Create(parent, id, _("RawlogViewer - Part of the MRPT project"),
  ...
  btnToolbarOpen = new wxCustomButton(
      ...
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_FOLDER")),
                               wxART_TOOLBAR),
  ...
  FlexGridSizer15->Add(btnToolbarOpen, 1,
  ...
  FlexGridSizer15->Add(Button1, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  StaticLine2 =
      new wxStaticLine(this, ID_STATICLINE2, wxDefaultPosition, wxSize(3, 70),
                       wxLI_VERTICAL, _T("ID_STATICLINE2"));
  FlexGridSizer15->Add(StaticLine2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button2 = new wxCustomButton(
      this, ID_BUTTON4, _("Edit..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_COPY")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button2, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button3 = new wxCustomButton(
      this, ID_BUTTON5, _("\"Raw-map\"..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_RAWMAP")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button3, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button4 = new wxCustomButton(
      this, ID_BUTTON6, _("Motion model"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_MOTION")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button4, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button5 = new wxCustomButton(
      this, ID_BUTTON7, _("ICP..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_ICP")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button5, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  StaticLine3 =
      new wxStaticLine(this, ID_STATICLINE3, wxDefaultPosition, wxSize(3, 70),
                       wxLI_VERTICAL, _T("ID_STATICLINE3"));
  FlexGridSizer15->Add(StaticLine3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       1);
  ...
  FlexGridSizer15->Add(Button6, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button7 = new wxCustomButton(
      this, ID_BUTTON9, _("Video..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_TIP")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button7, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  StaticLine4 =
      new wxStaticLine(this, ID_STATICLINE4, wxDefaultPosition, wxSize(3, 70),
                       wxLI_VERTICAL, _T("ID_STATICLINE4"));
  FlexGridSizer15->Add(StaticLine4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button8 = new wxCustomButton(
      this, ID_BUTTON10, _("About"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_ABOUT")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button8, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  Button9 = new wxCustomButton(
      this, ID_BUTTON11, _("Quit"),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("ICON_QUIT")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxSize(-1, 60), wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer15->Add(Button9, 1,
                       wxALL | wxFIXED_MINSIZE | wxALIGN_CENTER_HORIZONTAL |
                           wxALIGN_CENTER_VERTICAL,
                       1);
  StaticLine1 =
      new wxStaticLine(this, ID_STATICLINE1, wxDefaultPosition, wxSize(3, 70),
                       wxLI_VERTICAL, _T("ID_STATICLINE1"));
  FlexGridSizer15->Add(StaticLine1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       1);
  FlexGridSizer16 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer16->AddGrowableCol(0);
  StaticText4 = new wxStaticText(this, ID_STATICTEXT4, _("Image dirs:"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT4"));
  FlexGridSizer16->Add(StaticText4, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  toolbarcomboImages = new wxComboBox(
      this, ID_COMBO_IMG_DIRS, wxEmptyString, wxDefaultPosition, wxDefaultSize,
      0, 0, 0, wxDefaultValidator, _T("ID_COMBO_IMG_DIRS"));
  ...
  FlexGridSizer16->Add(toolbarcomboImages, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer15->Add(FlexGridSizer16, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer1->Add(FlexGridSizer15, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  Panel1 = new wxPanel(SplitterWindow1, ID_PANEL1, wxDefaultPosition,
                       wxSize(337, -1), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
  FlexGridSizer2 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer2->AddGrowableCol(0);
  FlexGridSizer2->AddGrowableRow(0);
  tree_view = new CRawlogTreeView(Panel1, ID_CUSTOM5, wxDefaultPosition,
                                  wxDefaultSize, wxVSCROLL, _T("ID_CUSTOM5"));
  FlexGridSizer2->Add(tree_view, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel1->SetSizer(FlexGridSizer2);
  FlexGridSizer2->SetSizeHints(Panel1);
  Panel2 = new wxPanel(SplitterWindow1, ID_PANEL2, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL2"));
  BoxSizer1 = new wxBoxSizer(wxHORIZONTAL);
  SplitterWindow3 =
      new wxSplitterWindow(Panel2, ID_SPLITTERWINDOW3, wxDefaultPosition,
                           wxDefaultSize, wxSP_3D, _T("ID_SPLITTERWINDOW3"));
  SplitterWindow3->SetMinSize(wxSize(150, 150));
  SplitterWindow3->SetMinimumPaneSize(150);
  Panel3 = new wxPanel(SplitterWindow3, ID_PANEL3, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL3"));
  BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
  memo = new wxTextCtrl(
      Panel3, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxSize(327, 140),
      wxTE_MULTILINE | wxTE_READONLY | wxTE_WORDWRAP | wxNO_BORDER | wxVSCROLL,
      wxDefaultValidator, _T("ID_TEXTCTRL1"));
  wxFont memoFont(10, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
                  false, _T("Courier 10 Pitch"), wxFONTENCODING_DEFAULT);
  ...
  Panel5 = new wxPanel(SplitterWindow3, ID_PANEL5, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL5"));
  BoxSizer3 = new wxBoxSizer(wxHORIZONTAL);
  Notebook1 = new wxNotebook(Panel5, ID_NOTEBOOK1, wxDefaultPosition,
                             wxDefaultSize, wxNB_BOTTOM, _T("ID_NOTEBOOK1"));
  pn_CSensorialFrame =
      new wxPanel(Notebook1, ID_PANEL6, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL6"));
  FlexGridSizer6 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer6->AddGrowableCol(0);
  FlexGridSizer6->AddGrowableRow(1);
  Panel9 = new wxPanel(pn_CSensorialFrame, ID_PANEL18, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL18"));
  btnEditComments =
      new wxButton(Panel9, ID_BUTTON1, _("Edit comments..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  FlexGridSizer6->Add(Panel9, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Notebook3 =
      new wxNotebook(pn_CSensorialFrame, ID_NOTEBOOK3, wxDefaultPosition,
                     wxSize(-1, 150), 0, _T("ID_NOTEBOOK3"));
  Notebook3->SetMinSize(wxSize(-1, 150));
  SplitterWindow2 =
      new wxSplitterWindow(Notebook3, ID_SPLITTERWINDOW2, wxDefaultPosition,
                           wxDefaultSize, wxSP_3D, _T("ID_SPLITTERWINDOW2"));
  SplitterWindow2->SetMinSize(wxSize(100, 100));
  SplitterWindow2->SetMinimumPaneSize(100);
  memStats = new wxTextCtrl(SplitterWindow2, ID_TEXTCTRL2, wxEmptyString,
                            wxDefaultPosition, wxDefaultSize,
                            wxTE_MULTILINE | wxTE_READONLY | wxVSCROLL,
                            wxDefaultValidator, _T("ID_TEXTCTRL2"));
  memStats->SetMinSize(wxSize(-1, 150));
  wxFont memStatsFont(10, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
  ...
  Panel11 = new wxPanel(SplitterWindow2, ID_PANEL25, wxDefaultPosition,
                        wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL25"));
  BoxSizer6 = new wxBoxSizer(wxHORIZONTAL);
  plotRawlogSensorTimes =
      new mpWindow(Panel11, ID_CUSTOM6, wxDefaultPosition, wxSize(315, 47), 0);
  BoxSizer6->Add(plotRawlogSensorTimes, 1,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  wxFont txtExceptionFont(10, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
                          wxNORMAL, false, _T("Monospace"),
  ...
  FlexGridSizer6->Add(Notebook3, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  pn_Action = new wxPanel(Notebook1, ID_PANEL7, wxDefaultPosition,
                          wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL7"));
  BoxSizer8 = new wxBoxSizer(wxHORIZONTAL);
  plotAct2D_XY =
      new mpWindow(pn_Action, ID_CUSTOM2, wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer8->Add(plotAct2D_XY, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 1);
  plotAct2D_PHI =
      new mpWindow(pn_Action, ID_CUSTOM3, wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer8->Add(plotAct2D_PHI, 1,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  pn_Action->SetSizer(BoxSizer8);
  BoxSizer8->Fit(pn_Action);
  BoxSizer8->SetSizeHints(pn_Action);
  pn_CObservation2DRangeScan =
      new wxPanel(Notebook1, ID_PANEL8, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL8"));
  BoxSizer5 = new wxBoxSizer(wxVERTICAL);
  plotScan2D = new mpWindow(pn_CObservation2DRangeScan, ID_CUSTOM1,
                            wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer5->Add(plotScan2D, 10, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 0);
  Panel4 = new wxPanel(pn_CObservation2DRangeScan, ID_PANEL4, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL4"));
  ...
  pn_CObservationImage =
      new wxPanel(Notebook1, ID_PANEL9, wxDefaultPosition, wxDefaultSize,
  ...
  StaticText2 = new wxStaticText(
      ...
      _("Right click on the images to see the popup menu:"), wxDefaultPosition,
      wxDefaultSize, 0, _T("ID_STATICTEXT2"));
  FlexGridSizer3->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  pn_CObservationStereoImage =
      new wxPanel(Notebook1, ID_PANEL10, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer4->Add(StaticText1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  Notebook2 =
      new wxNotebook(pn_CObservationStereoImage, ID_NOTEBOOK2,
                     wxDefaultPosition, wxDefaultSize, 0, _T("ID_NOTEBOOK2"));
  Panel6 = new wxPanel(Notebook2, ID_PANEL13, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer5->Add(bmpObsStereoLeft, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel6->SetSizer(FlexGridSizer5);
  FlexGridSizer5->Fit(Panel6);
  FlexGridSizer5->SetSizeHints(Panel6);
  Panel7 = new wxPanel(Notebook2, ID_PANEL14, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer7->Add(bmpObsStereoRight, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP,
                      0);
  Panel7->SetSizer(FlexGridSizer7);
  FlexGridSizer7->Fit(Panel7);
  FlexGridSizer7->SetSizeHints(Panel7);
  Panel10 = new wxPanel(Notebook2, ID_PANEL24, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer13->Add(bmpObsStereoDisp, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP,
                       0);
  ...
  FlexGridSizer4->Add(Notebook2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  pn_CObservationBeaconRanges =
      new wxPanel(Notebook1, ID_PANEL11, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL11"));
  pn_CObservationGasSensors =
      new wxPanel(Notebook1, ID_PANEL12, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL12"));
  pn_CObservationGPS =
      new wxPanel(Notebook1, ID_PANEL15, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL15"));
  pn_CObservationBearingRange =
      new wxPanel(Notebook1, ID_PANEL16, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL16"));
  BoxSizer4 = new wxBoxSizer(wxVERTICAL);
  plotRangeBearing = new mpWindow(pn_CObservationBearingRange, ID_CUSTOM4,
                                  wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer4->Add(plotRangeBearing, 10,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  Panel8 =
      new wxPanel(pn_CObservationBearingRange, ID_PANEL17, wxDefaultPosition,
  ...
  pn_CObservation3DRangeScan =
      new wxPanel(Notebook1, ID_PANEL19, wxDefaultPosition, wxDefaultSize,
                  wxTAB_TRAVERSAL, _T("ID_PANEL19"));
  FlexGridSizer8 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer8->AddGrowableCol(0);
  FlexGridSizer8->AddGrowableRow(0);
  nb_3DObsChannels =
      new wxNotebook(pn_CObservation3DRangeScan, ID_NOTEBOOK4,
                     wxDefaultPosition, wxDefaultSize, 0, _T("ID_NOTEBOOK4"));
  pn3Dobs_3D = new wxPanel(nb_3DObsChannels, ID_PANEL20, wxDefaultPosition,
                           wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL20"));
  FlexGridSizer9 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer9->AddGrowableCol(0);
  FlexGridSizer9->AddGrowableRow(0);
  m_gl3DRangeScan =
      new CMyGLCanvas(pn3Dobs_3D, ID_XY_GLCANVAS, wxDefaultPosition,
                      wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_XY_GLCANVAS"));
  FlexGridSizer9->Add(m_gl3DRangeScan, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer12->AddGrowableCol(0);
  FlexGridSizer12->AddGrowableRow(1);
  StaticText3 = new wxStaticText(pn3Dobs_3D, ID_STATICTEXT3, _("Min.conf."),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT3"));
  FlexGridSizer12->Add(StaticText3, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM,
                       5);
  ...
  FlexGridSizer12->Add(slid3DcamConf, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
  FlexGridSizer9->Add(FlexGridSizer12, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  pn3Dobs_3D->SetSizer(FlexGridSizer9);
  FlexGridSizer9->Fit(pn3Dobs_3D);
  FlexGridSizer9->SetSizeHints(pn3Dobs_3D);
  pn3Dobs_Depth = new wxPanel(nb_3DObsChannels, ID_PANEL21, wxDefaultPosition,
                              wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL21"));
  ...
  FlexGridSizer10->Add(bmp3Dobs_depth, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP,
                       5);
  pn3Dobs_Depth->SetSizer(FlexGridSizer10);
  FlexGridSizer10->Fit(pn3Dobs_Depth);
  FlexGridSizer10->SetSizeHints(pn3Dobs_Depth);
  pn3Dobs_Int = new wxPanel(nb_3DObsChannels, ID_PANEL22, wxDefaultPosition,
                            wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL22"));
  FlexGridSizer11 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer11->AddGrowableCol(0);
  FlexGridSizer11->AddGrowableRow(0);
  bmp3Dobs_int = new wxStaticBitmapPopup(
      pn3Dobs_Int, ID_STATICBITMAP5, wxNullBitmap, wxPoint(0, 0), wxDefaultSize,
      wxFULL_REPAINT_ON_RESIZE, _T("ID_STATICBITMAP5"));
  ...
  pn3Dobs_Conf = new wxPanel(nb_3DObsChannels, ID_PANEL23, wxDefaultPosition,
                             wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL23"));
  ...
  FlexGridSizer8->Add(nb_3DObsChannels, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  ...
  Notebook1->AddPage(pn_CObservationBeaconRanges, _("Obs: Beacon Ranges"),
                     false);
  Notebook1->AddPage(pn_CObservationGasSensors, _("Obs: e-Noses"), false);
  Notebook1->AddPage(pn_CObservationGPS, _("Obs: GPS"), false);
  Notebook1->AddPage(pn_CObservationBearingRange, _("Obs: RangeBearing"),
                     false);
  Notebook1->AddPage(pn_CObservation3DRangeScan, _("Obs: 3D range scan"),
                     false);
  BoxSizer3->Add(Notebook1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 0);
  ...
  MenuItem4 =
      new wxMenuItem(Menu1, ID_MENUITEM2, _("Save as..."),
  ...
  MenuItem13 = new wxMenuItem(MenuItem6, ID_MENUITEM11, _("New Menu"),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem9 =
      new wxMenuItem(MenuItem8, ID_MENUITEM7, _("Load a part only..."),
                     _("Load a section of a long rawlog"), wxITEM_NORMAL);
  MenuItem8->Append(MenuItem9);
  MenuItem10 =
      new wxMenuItem(MenuItem8, ID_MENUITEM8, _("Count entries..."),
  ...
  MenuItem59 = new wxMenuItem(MenuItem8, ID_MENUITEM62,
                              _("Conver to externally stored images..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem8->Append(MenuItem59);
  MenuItem61 = new wxMenuItem(MenuItem8, ID_MENUITEM64,
                              _("Convert to observations-only rawlog..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem8->Append(MenuItem61);
  MenuItem8->AppendSeparator();
  MenuItem15 = new wxMenuItem(MenuItem8, ID_MENUITEM13,
                              _("Append visual landmarks from stereo imgs..."),
                              _("Precompute 3D landmarks from stereo images "
                                "and save in another rawlog"),
                              wxITEM_NORMAL);
  ...
  MenuItem58 = new wxMenuItem(MenuItem8, ID_MENUITEM61, _("Compact rawlog..."),
                              _("Group consecutive actions & observations"),
                              wxITEM_NORMAL);
  MenuItem8->Append(MenuItem58);
  Menu1->Append(ID_MENUITEM6, _("Operations on files"), MenuItem8,
                wxEmptyString);
  Menu1->AppendSeparator();
  MenuItem5 = new wxMenu();
  MenuItem7 = new wxMenuItem(MenuItem5, ID_MENUITEM5, _("a CARMEN log..."),
                             _("Import a CARMEN \"log\" file"), wxITEM_NORMAL);
  MenuItem5->Append(MenuItem7);
  MenuItem44 = new wxMenuItem(MenuItem5, ID_MENUITEM47,
                              _("a sequence of image files..."), wxEmptyString,
                              wxITEM_NORMAL);
  MenuItem5->Append(MenuItem44);
  MenuItem53 = new wxMenuItem(MenuItem5, ID_MENUITEM56, _("a MOOS alog..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem5->Append(MenuItem53);
  MenuItem60 = new wxMenuItem(MenuItem5, ID_MENUITEM63, _("a RTL log..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem5->Append(MenuItem60);
  MenuItem83 =
      new wxMenuItem(MenuItem5, ID_MENUITEM87, _("a Bremen DLR log..."),
                     wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem52 =
      new wxMenuItem(MenuItem51, ID_MENUITEM55, _("As a MOOS alog file..."),
                     wxEmptyString, wxITEM_NORMAL);
  ...
  Menu3 = new wxMenu();
  MenuItem16 =
      new wxMenuItem(Menu3, ID_MENUITEM14, _("Edit rawlog..."),
  ...
  MenuItem48 =
      new wxMenuItem(Menu3, ID_MENUITEM51, _("Insert a field for comments"),
                     wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem48);
  MenuItem66 = new wxMenuItem(Menu3, ID_MENUITEM69, _("Rename a sensor..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem54 = new wxMenuItem(Menu3, ID_MENUITEM57, _("Compact rawlog..."),
                              _("Group consecutive actions & observations"),
                              wxITEM_NORMAL);
  Menu3->Append(MenuItem54);
  MenuItem72 =
      new wxMenuItem(Menu3, ID_MENUITEM75, _("Convert into SF format..."),
                     _("Convert a rawlog of observations-only into the "
                       "actions-sensory frames format"),
                     wxITEM_NORMAL);
  ...
  MenuItem65 = new wxMenuItem(Menu3, ID_MENUITEM68,
                              _("Shift timestamp by sensorLabel..."),
                              _("Displaces in time all the observations of a "
                                "given label by some amount"),
                              wxITEM_NORMAL);
  Menu3->Append(MenuItem65);
  MenuItem79 =
      new wxMenuItem(Menu3, ID_MENUITEM82, _("Regenerate timestamps in SF"),
                     wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem24 = new wxMenuItem(Menu14, ID_MENUITEM22,
                              _("Recalculate actions with ICP..."),
                              _("Compute ICP-based odometry"), wxITEM_NORMAL);
  Menu14->Append(MenuItem24);
  MenuItem50 = new wxMenuItem(Menu14, ID_MENUITEM53,
                              _("Modify uncertainty of ICP-based actions..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem38 = new wxMenuItem(Menu14, ID_MENUITEM41,
                              _("Force encoders info to \'false\'"),
                              _("Can be used to force ignoring corrupted "
                                "encoders data in old datasets"),
                              wxITEM_NORMAL);
  Menu14->Append(MenuItem38);
  MenuItem80 = new wxMenuItem(Menu14, ID_MENUITEM84,
                              _("Regenerate invalid odometry timestamps..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem41 = new wxMenuItem(Menu20, ID_MENUITEM44,
                              _("Show an animation with the scans..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem70 = new wxMenuItem(
      Menu20, ID_MENUITEM73, _("Mark as invalid ranges larger than maximum..."),
      wxEmptyString, wxITEM_NORMAL);
  Menu20->Append(MenuItem70);
  MenuItem71 = new wxMenuItem(Menu20, ID_MENUITEM74,
                              _("Change max. range for a given laser scan..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu20->Append(MenuItem71);
  MenuItem74 = new wxMenuItem(Menu20, ID_MENUITEM77,
                              _("Batch exclusion zone filtering..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu20->Append(MenuItem74);
  MenuItem76 = new wxMenuItem(Menu20, ID_MENUITEM79,
                              _("Batch exclusion angles filtering..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu20->Append(MenuItem76);
  Menu6->Append(ID_MENUITEM18, _("&Laser scans"), Menu20, wxEmptyString);
  MenuItem81 = new wxMenu();
  MenuItem82 =
      new wxMenuItem(MenuItem81, ID_MENUITEM86, _("Recover camera params..."),
                     _("Executes a Levenberg-Marquart optimization to recover "
                       "the camera calibration matrix"),
                     wxITEM_NORMAL);
  MenuItem81->Append(MenuItem82);
  mnuItemEnable3DCamAutoGenPoints = new wxMenuItem(
      MenuItem81, ID_MENUITEM90, _("Enable on-the-fly generate 3D point cloud"),
      wxEmptyString, wxITEM_CHECK);
  MenuItem81->Append(mnuItemEnable3DCamAutoGenPoints);
  Menu6->Append(ID_MENUITEM85, _("&3D depth cameras"), MenuItem81,
                wxEmptyString);
  Menu23 = new wxMenu();
  ...
  MenuItem30 = new wxMenuItem(Menu23, ID_MENUITEM28,
                              _("Generate 3D actions from visual odometry..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu23->Append(MenuItem30);
  MenuItem68 =
      new wxMenuItem(Menu23, ID_MENUITEM71,
                     _("Convert pairs of mono into stereo...\tCreate stereo "
                       "images observations from pairs of monocular images"),
                     wxEmptyString, wxITEM_NORMAL);
  Menu23->Append(MenuItem68);
  MenuItem69 =
      new wxMenuItem(Menu23, ID_MENUITEM72, _("Batch rectify images..."),
                     wxEmptyString, wxITEM_NORMAL);
  Menu23->Append(MenuItem69);
  MenuItem75 = new wxMenuItem(Menu23, ID_MENUITEM78,
                              _("Rename externally stored image files..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu23->Append(MenuItem75);
  mnuCreateAVI =
      new wxMenuItem(Menu23, ID_MENUITEM83, _("Create AVI video file..."),
                     wxEmptyString, wxITEM_NORMAL);
  Menu23->Append(mnuCreateAVI);
  Menu6->Append(ID_MENUITEM21, _("&Images (Mono && Stereo)"), Menu23,
                wxEmptyString);
  Menu38 = new wxMenu();
  MenuItem32 =
      new wxMenuItem(Menu38, ID_MENUITEM30,
  ...
  MenuItem62 = new wxMenuItem(Menu39, ID_MENUITEM65,
                              _("&Measure distance between GPS\'s..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu39->Append(MenuItem62);
  MenuItem63 = new wxMenuItem(Menu39, ID_MENUITEM66,
                              _("Regenerate &timestamp from sat time"),
                              wxEmptyString, wxITEM_NORMAL);
  Menu39->Append(MenuItem63);
  MenuItem49 = new wxMenuItem(Menu39, ID_MENUITEM52, _("&Draw 3D path..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu39->Append(MenuItem49);
  MenuItem77 =
      new wxMenuItem(Menu39, ID_MENUITEM80, _("Delete entries with NaN"),
                     wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem14 =
      new wxMenuItem(Menu40, ID_MENUITEM38, _("Remove specific measurements"),
                     wxEmptyString, wxITEM_NORMAL);
  Menu40->Append(MenuItem14);
  Menu6->Append(ID_MENUITEM37, _("Range-only (&beacon detector) sensors"),
                Menu40, wxEmptyString);
  MenuItem20 = new wxMenu();
  MenuItem23 = new wxMenuItem(MenuItem20, ID_MENUITEM40,
                              _("Generate text file with measurements..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem20->Append(MenuItem23);
  MenuItem78 = new wxMenuItem(MenuItem20, ID_MENUITEM81,
                              _("Remove specific landmark by ID..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem20->Append(MenuItem78);
  Menu6->Append(ID_MENUITEM39, _("Range-bearing (landmark detector) sensors"),
                MenuItem20, wxEmptyString);
  MenuItem42 = new wxMenu();
  MenuItem43 = new wxMenuItem(MenuItem42, ID_MENUITEM46,
                              _("Generate a text file with measurements..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem42->Append(MenuItem43);
  Menu6->Append(ID_MENUITEM45, _("1D range finders (Ultrasonic,IR)"),
                MenuItem42, wxEmptyString);
  MenuItem39 = new wxMenu();
  MenuItem40 = new wxMenuItem(MenuItem39, ID_MENUITEM43,
                              _("Generate text file with measurementes..."),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem39->Append(MenuItem40);
  Menu6->Append(ID_MENUITEM42, _("Inertial Measurement Units"), MenuItem39,
                wxEmptyString);
  MenuItem84 = new wxMenu();
  MenuItem85 = new wxMenuItem(MenuItem84, ID_MENUITEM89,
                              _("Generate &text file with all observations..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  Menu2 = new wxMenu();
  MenuItem29 = new wxMenuItem(Menu2, ID_MENUITEM27, _("Show &tips..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem37 = new wxMenuItem((&mnuTree), MNU_1, _("Delete element"),
                              _("Erases the selected element"), wxITEM_NORMAL);
  mnuTree.Append(MenuItem37);
  MenuItem45 = new wxMenu();
  MenuItem46 = new wxMenuItem(MenuItem45, ID_MENUITEM49,
                              _("2D increment (from odometry)"), wxEmptyString,
                              wxITEM_NORMAL);
  MenuItem45->Append(MenuItem46);
  MenuItem47 = new wxMenuItem(MenuItem45, ID_MENUITEM50,
                              _("2D increment (from scan-matching)"),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  Connect(ID_BUTTON11, wxEVT_COMMAND_BUTTON_CLICKED,
  ...
  Connect(ID_SLIDER1, wxEVT_SCROLL_THUMBTRACK,
          (wxObjectEventFunction)&xRawLogViewerFrame::
              Onslid3DcamConfCmdScrollChanged);
  Connect(ID_SLIDER1, wxEVT_SCROLL_CHANGED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
              Onslid3DcamConfCmdScrollChanged);
  Connect(ID_NOTEBOOK1, wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGING,
  ...
  Connect(ID_MENUITEM2, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnSaveFile);
  Connect(ID_MENUITEM76, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM62, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
              OnMenuConvertExternallyStored);
  Connect(
      ID_MENUITEM64, wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuConvertObservationOnly);
  Connect(ID_MENUITEM13, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
              OnFileGenVisualLMFromStereoImages);
  Connect(ID_MENUITEM60, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuLossLessDecFILE);
  Connect(ID_MENUITEM61, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM14, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnEditRawlog);
  Connect(ID_MENUITEM51, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuInsertComment);
  Connect(ID_MENUITEM69, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuRenameSensor);
  Connect(ID_MENUITEM91, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM70, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM59, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuLossLessDecimate);
  Connect(ID_MENUITEM57, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuCompactRawlog);
  Connect(ID_MENUITEM75, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuConvertSF);
  Connect(ID_MENUITEM67, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuResortByTimestamp);
  Connect(
      ID_MENUITEM68, wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuShiftTimestampsByLabel);
  Connect(ID_MENUITEM82, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
  ...
  Connect(ID_MENUITEM53, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
  ...
  Connect(ID_MENUITEM31, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnGenGPSTxt);
  Connect(ID_MENUITEM34, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnSummaryGPS);
  Connect(ID_MENUITEM65, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuDistanceBtwGPSs);
  Connect(ID_MENUITEM66, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
              OnMenuRegenerateGPSTimestamps);
  Connect(ID_MENUITEM52, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuDrawGPSPath);
  Connect(ID_MENUITEM80, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuGPSDeleteNaN);
  Connect(ID_MENUITEM33, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM40, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::
              OnGenerateTextFileRangeBearing);
  Connect(ID_MENUITEM81, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM43, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnGenerateIMUTextFile);
  Connect(ID_MENUITEM89, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnGenWifiTxt);
  Connect(ID_MENUITEM26, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnRawMapOdo);
  Connect(ID_MENUITEM32, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnGenOdoLaser);
  Connect(ID_MENUITEM27, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnMenuShowTips);
  Connect(idMenuAbout, wxEVT_COMMAND_MENU_SELECTED,
          (wxObjectEventFunction)&xRawLogViewerFrame::OnAbout);
  Connect(MNU_1, wxEVT_COMMAND_MENU_SELECTED,
  ...
  Connect(ID_MENUITEM50, wxEVT_COMMAND_MENU_SELECTED,
  ...
  // --------------------------------------------
  Connect(ID_COMBO_IMG_DIRS, wxEVT_COMMAND_COMBOBOX_SELECTED,
...
bool xRawLogViewerFrame::AskForOpenRawlog(std::string &fil) {
  ...
  wxString wildcard =
      wxT("RawLog files (*.rawlog,*.rawlog.gz)|*.rawlog;*.rawlog.gz|All files "
          "(*.*)|*.*");
...
void xRawLogViewerFrame::OnSaveFile(wxCommandEvent &event) {
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    wxProgressDialog progDia(wxT("Saving rawlog to file"), wxT("Saving..."),
                             n,    // range
                             this, // parent
...
//------------------------------------------------------------------------
void xRawLogViewerFrame::loadRawlogFile(const string &str, int first,
                                        int last) {
  WX_START_TRY
  ...
  for (size_t i = 0; i < m_fileHistory.GetCount(); i++)
    iniFile->write("RecentFiles", format("file_%03u", static_cast<unsigned>(i)),
...
#ifdef __WXMSW__
  SendMessage((HWND)toolbarcomboImages->GetHandle(), CB_SETDROPPEDWIDTH,
  ...
  wxString auxStr;
  wxProgressDialog progDia(wxT("Progress of rawlog load"), wxT("Loading..."),
  ...
  while (keepLoading) {
    if (countLoop++ % 10 == 0) {
      ...
      if (ratio - last_ratio >= 0.006) {
        ...
        auxStr.sprintf(wxT("Loading... %u objects / Memory usage: %.03fMb"),
                       static_cast<unsigned int>(rawlog.size()), memUsg_Mb);
        if (!progDia.Update(progPos < (progDialogMax - 1) ? progPos
                                                          : (progDialogMax - 1),
                            auxStr))
          keepLoading = false;
        progDia.Fit();
        ...
        if (memUsg_Mb > 2600 && !alreadyWarnedTooLargeFile) {
          ...
          string msg;
          msg += "It seems that the file you are loading will consume a large "
                 "amount of memory if loaded in memory completely.\n";
          msg += "This is just a warning to make you watch whether your system "
                 "runs out of memory while still loading.\n";
          msg += "Do you want to continue loading this file?";
          if (wxNO == wxMessageBox(_U(msg.c_str()), _("Warning"),
    ...
    try {
      ...
      /* FOR BACKWARD COMPATIBILITY: CPose2D was used previously instead of an
      ...
      wxString s = _("OUT OF MEMORY: The last part of the rawlog has been "
                     "freed to allow the program to continue.\n");
#if MRPT_WORD_SIZE == 32
      s << _("  This is a 32bit machine, so the maximum memory available is "
  ...
  if (!rawlog.size()) {
    wxMessageBox(_("If the file is not really empty, perhaps the format is "
                   "invalid or a more recent\nversion of RawLogViewer is "
                   "required to load the file.\n Please check the tab \"End of "
                   "load message\" for further details."),
...
void xRawLogViewerFrame::rebuildTreeView() {
  ...
  wxProgressDialog progDia(wxT("Constructing the tree view"),
  ...
  memStats->AppendText(_U(
      format("Time to load file:                  %.03fms\n", 1000 * timeToLoad)
          .c_str()));
  memStats->AppendText(_U(format("Records loaded:                     %u\n",
                                 (unsigned)rawlog.size())
                              .c_str()));
  memStats->AppendText(
      _U(format("Traveled distance (from odometry):  %.02f meters\n",
                totalDistance)
             .c_str()));
  ...
  if (tree_view->getFirstTimestamp() != INVALID_TIMESTAMP) {
    ...
    memStats->AppendText(
        _U(format("Dataset first time-stamp (UTC):     %s\n",
  ...
  memStats->AppendText(_U(
      format(
          "Dataset length:                     %s (hh:mm:ss),  %.03f secs.\n",
  ...
  if (experimentLenght == 0)
    experimentLenght = 1;

  for (TListOfObjectsOccurs::const_iterator it = listOfObjects.begin();
       it != listOfObjects.end(); ++it) {
    const char *className = it->first->className;
    size_t count = it->second;
    memStats->AppendText(
        _U(format(" %8u %25s : %5.03f Hz\n", (unsigned)count, className,
  ...
  for (std::map<std::string, TInfoPerSensorLabel>::iterator it =
           listOfSensorLabels.begin();
    ...
    memStats->AppendText(_U(format(" %8u %25s : %5.03f Hz for %.04f s, with "
                                   "%.03f s max delay btw readings.\n",
  ...
  // Show plot of times:
  {
    plotRawlogSensorTimes->DelAllLayers(true /*delete objs*/,
                                        false /*dont refresh view*/);
    ...
    for (std::map<std::string, TInfoPerSensorLabel>::iterator
             it = listOfSensorLabels.begin();
      ...
      plotRawlogSensorTimes->AddLayer(lyRawlogInfo,
                                      false /*dont refresh view*/);
    }

    const double At = std::max(1.0, max_t - min_t);

    plotRawlogSensorTimes->Fit(min_t - At * 0.15, max_t + At * 0.15, -1.0,
                               id + 1.0);
...
public:
  ...
  virtual wxString GetTip() {
    ...
    switch (idx % N_TIPS) {
    case 0:
      return _("To have a first overview of a dataset with odometry and laser "
               "scans, select 'Tools' -> 'maps & paths generation module' -> "
               "'Map from odometry'.\n If the dataset is very large, select a "
               "portion of it, or use the 'decimation' slide.");
    case 1:
      return _("When observations are selected in the tree-view at the left, "
               "extended information will be shown for that observation: "
               "timestamp, a visualization of the laser scan/image, etc.");
    case 2:
      return _(
          "Portions of a rawlog can be stripped out in Edit ->Edit Rawlog");
    case 3:
      return _("When a rawlog is loaded, the panel at the bottom displays a "
               "summary of the log, including approximate overall distance "
               "traveled by the vehicle, overall time, and the frequency of "
               "each sensor.");
    case 4:
      return _("There is an ICP experimenting module that can be opened from "
               "the toolbar button 'ICP'");
    }
    return wxString();
  }
};
...
void xRawLogViewerFrame::OnRawMapOdo(wxCommandEvent &event) {
  if (rawlog.size() < 1) {
    wxMessageBox(_("Please load a rawlog first!"), _("Rawlog is empty"), wxOK,
                 this);
    return;
  }
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    for (i = 0; i < n; i++) {
      ...
      case CRawlog::etObservation: {
        ...
        if (o->GetRuntimeClass() != CLASS_ID(CObservationBeaconRanges))
          break;
        CObservationBeaconRanges::Ptr obs =
...
#define SIZE_lstImgFormats 5
  ...
  int ret = wxGetSingleChoiceIndex(_("Choose the format of the output images:"),
                                   _("Images format"), SIZE_lstImgFormats,
                                   lstImgFormats, this);
...
void xRawLogViewerFrame::OnGenOdoLaser(wxCommandEvent &event) {
  ...
  if (!genTimes)
    ::wxMessageBox(_("It seems that there are no valid timestamps in the "
                     "rawlog. The time files will not be generated."));
  ...
  wxProgressDialog progDia(wxT("Exporting as text files"), wxT("Saving..."),
                           n,    // range
                           this, // parent
                           wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH |
                               wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
  ...
  for (i = 0; i < n; i++) {
    ...
    case CRawlog::etActionCollection: {
      ...
      if (genTimes) {
        ...
        if (action->timestamp != INVALID_TIMESTAMP)
          // t = mrpt::system::timeDifference(rawlog_first_timestamp,
          // action->timestamp);
      ...
      for (unsigned int k = 0; k < sf->size(); k++) {
        if (sf->getObservationByIndex(k)->GetRuntimeClass() ==
          ...
          CObservation2DRangeScan::Ptr obs =
              sf->getObservationByIndexAs<CObservation2DRangeScan::Ptr>(k);
          ...
          if ((it = lstFiles.find(obs->sensorLabel)) == lstFiles.end()) {
            ...
            files->first = os::fopen(
                prefix_laser + obs->sensorLabel + string(".txt"), "wt");
            ASSERT_(files->first);
            files->second.first = os::fopen(
                prefix_laser + obs->sensorLabel + string("_times.txt"), "wt");
            ASSERT_(files->second.first);
            files->second.second = os::fopen(
                prefix_laser + obs->sensorLabel + string("_poses.txt"), "wt");
    ...
    case CRawlog::etObservation: {
      ...
      if (IS_CLASS(o, CObservation2DRangeScan)) {
        ...
        // Get files from list, or create them the first time:
        std::pair<FILE *, std::pair<FILE *, FILE *>> *files = nullptr;
        std::map<string, std::pair<FILE *, std::pair<FILE *, FILE *>>>::iterator
            it;
        if ((it = lstFiles.find(obs->sensorLabel)) == lstFiles.end()) {
          files = &lstFiles[obs->sensorLabel];
          // Open files:
          files->first =
              os::fopen(prefix_laser + obs->sensorLabel + string(".txt"), "wt");
          ASSERT_(files->first);
          files->second.first = os::fopen(
              prefix_laser + obs->sensorLabel + string("_times.txt"), "wt");
          ASSERT_(files->second.first);
  ...
  wxMessageBox(wxString::Format(_("%u odometry & %u laser entries saved."),
                                nOdo, nLaser),
               _("Done"), wxOK, this);
...
void xRawLogViewerFrame::OnLoadAPartOnly(wxCommandEvent &event) {
  ...
  wxString strFirst =
      wxGetTextFromUser(_("Enter the first entry index to load:"),
                        _("Load a part of rawlog:"), _("0"));
  wxString strLast =
      wxGetTextFromUser(_("Enter the last entry index to load (-1:Last):"),
...
void xRawLogViewerFrame::OnFileCountEntries(wxCommandEvent &event) {
  ...
  // Set error msg:
  char auxStr2[100];
  os::sprintf(auxStr2, sizeof(auxStr2),
              "There are %i entries in the rawlog file", entryIndex);
...
void xRawLogViewerFrame::OnFileSaveImages(wxCommandEvent &event) {
  ...
  wxString auxStr;
  wxProgressDialog progDia(wxT("Progress"), wxT("Parsing file..."),
                           filSize, // range
                           this,    // parent
                           wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH |
                               wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
        ...
        for (unsigned k = 0; k < SF->size(); k++) {
          if (SF->getObservationByIndex(k)->GetRuntimeClass() ==
            ...
            CObservationStereoImages::Ptr obsSt =
                SF->getObservationByIndexAs<CObservationStereoImages::Ptr>(k);
            obsSt->imageLeft.saveToFile(format("%s/img_stereo_%u_left_%05u.%s",
                                               outDir.c_str(), k, imgSaved,
                                               imgFileExtension.c_str()));
            if (obsSt->hasImageRight)
              obsSt->imageRight.saveToFile(
                  format("%s/img_stereo_%u_right_%05u.%s", outDir.c_str(), k,
                         imgSaved, imgFileExtension.c_str()));
            if (obsSt->hasImageDisparity)
              obsSt->imageDisparity.saveToFile(
                  format("%s/img_stereo_%u_disp_%05u.%s", outDir.c_str(), k,
                         imgSaved, imgFileExtension.c_str()));
            imgSaved++;
          }
          if (SF->getObservationByIndex(k)->GetRuntimeClass() ==
            ...
            CObservationImage::Ptr obsIm =
                SF->getObservationByIndexAs<CObservationImage::Ptr>(k);

            obsIm->image.saveToFile(format("%s/img_monocular_%u_%05u.%s",
                                           outDir.c_str(), k, imgSaved,
                                           imgFileExtension.c_str()));
            imgSaved++;
          }
  ...
  // Set error msg:
  wxMessageBox(_U(format("Images saved: %i", imgSaved).c_str()), _("Done"),
               wxOK, this);
...
void wxStaticBitmapPopup::OnPopupSaveImage(wxCommandEvent &event) {
  try {
    if (!theMainWindow || !theMainWindow->curSelectedObservation)
      return;
    ...
    cout << "[xRawLogViewerFrame::OnPopupSaveImage] Current observation class: "
    ...
    if (IS_CLASS(curSelectedObservation, CObservationImage)) {
      ...
      case 1:
        if (obs->hasRangeImage) {
          ...
          if (max_rang > 0)
            normalized_range *= 255. / max_rang;
          auxImg.setFromMatrix(normalized_range,
    ...
    if (imgToSave) {
      wxFileDialog dialog(this, _("Save image as...") /*caption*/,
                          _U(iniFile->read_string(iniFileSect, "LastDir", ".")
                                 .c_str()) /* defaultDir */,
                          _("image.png") /* defaultFilename */,
                          _("Image files "
                            "(*.bmp;*.gif;*.jpg;*.jpeg;*.png;*.tif)|*.bmp;*."
                            "gif;*.jpg;*.jpeg;*.png;*.tif") /* wildcard */,
                          wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
      if (dialog.ShowModal() != wxID_OK)
        return;
    ...
    cerr << "[xRawLogViewerFrame::OnPopupSaveImage] Ignoring untyped exception!"
         << endl;
  }
}
  ...
  try {
    ...
    if (imgToLoad) {
      wxFileDialog dialog(
          ...
          _("image.png") /* defaultFilename */,
          _("Image files "
            "(*.bmp;*.gif;*.jpg;*.jpeg;*.png;*.tif)|*.bmp;*.gif;*.jpg;*.jpeg;*."
            "png;*.tif|All files (*.*)|*.*") /* wildcard */,
          wxFD_OPEN | wxFD_FILE_MUST_EXIST);
      if (dialog.ShowModal() != wxID_OK)
        return;
...
void xRawLogViewerFrame::OnDecimateRecords(wxCommandEvent &event) {
  ...
  wxString strDecimation = wxGetTextFromUser(
      _("The number of observations will be decimated (only 1 out of M will be "
        "kept). Enter the decimation ratio M:"),
      _("Decimation"), _("1"));
  long DECIMATE_RATIO;
...
void xRawLogViewerFrame::OnCountBadScans(wxCommandEvent &event) {
  ...
  wxString auxStr;
  wxProgressDialog progDia(wxT("Progress"), wxT("Parsing rawlog..."),
                           nEntries, // range
                           this,     // parent
                           wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH |
                               wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
  ...
  wxMessageBox(_U(format("Found %u range scans with no valid range values.",
                         invalidScans)
                      .c_str()),
               _("Done"), wxOK, this);
...
void xRawLogViewerFrame::OnFilterSpureousGas(wxCommandEvent &event) {
  ...
  wxString strMaxChange =
      wxGetTextFromUser(_("Maximum change between readings (volts):"),
        ...
        for (size_t k = 0; k < SF->size(); k++) {
          if (SF->getObservationByIndex(k)->GetRuntimeClass() ==
            ...
            CObservationGasSensors::Ptr obs =
                SF->getObservationByIndexAs<CObservationGasSensors::Ptr>(k);
            ...
            if (obs_1 && obs_2) {
              ...
              for (size_t j = 0; j < obs->m_readings.size(); j++) {
                ASSERT_(obs->m_readings[j].readingsVoltage.size() ==
                ...
                for (size_t k = 0;
                  ...
                  if (fabs(obs_1->m_readings[j].readingsVoltage[k] -
                           obs->m_readings[j].readingsVoltage[k]) > maxChange &&
                      fabs(obs_1->m_readings[j].readingsVoltage[k] -
        ...
        if (IS_CLASS(o, CObservationGasSensors)) {
          ...
          if (obs_1 && obs_2) {
            ...
            for (size_t j = 0; j < obs->m_readings.size(); j++) {
              ...
              for (size_t k = 0; k < obs->m_readings[j].readingsVoltage.size();
                   k++) {
                nReadings++;
                // Compute difference for "t-1":
                if (fabs(obs_1->m_readings[j].readingsVoltage[k] -
  ...
  wxMessageBox(_U(format("%u out of %u readings have been filtered out!", nFilt,
                         nReadings)
                      .c_str()),
               _("Done"), wxOK, this);
...
void xRawLogViewerFrame::OnRemoveSpecificRangeMeas(wxCommandEvent &event) {
  ...
  wxString strStart =
      wxGetTextFromUser(_("First index of the rawlog to remove from:"),
      ...
      if (obs) {
        ...
        if (obs_1 && obs_2) {
          ...
          for (q = 0; q < obs->sensedData.size(); q++) {
            ...
            if (!filter)
              filter = (obs->sensedData[q].sensedDistance ==
...
void xRawLogViewerFrame::OnForceEncodersFalse(wxCommandEvent &event) {
  ...
  bool clearEncoders =
      wxYES == wxMessageBox(_("Set 'hasEncodersInfo' fields to false?"),
                            _("Select operations"), wxYES_NO, this);
  bool clearVelocities =
      wxYES == wxMessageBox(_("Set 'hasVelocities' fields to false?"),
                            _("Select operations"), wxYES_NO, this);
  ...
  wxMessageBox(_U(format("%u entries have been modified", nChanges).c_str()),
               _("Done"), wxOK, this);

  WX_END_TRY
}

void doFilterErrScans(CObservation::Ptr &obs, size_t &invalidSegments,
                      size_t &invalidRanges, bool &touched) {
  if (obs->GetRuntimeClass()->derivedFrom(CLASS_ID(CObservation2DRangeScan))) {
    ...
    //    element[k] is the element[k] -/+ a value in [0.10-2.0], and viceversa
    //    with [k-1]
    ...
    // Look for segments of 'K' consecutive ringing ranges, and mark them as not
    // valid!!
    int ringingStart = -1;
    for (k = 1; k < (obsScan->scan.size() - 1); k++) {
      if (ringing[k]) {
...
void xRawLogViewerFrame::OnFilterErroneousScans(wxCommandEvent &event) {
  ...
  wxMessageBox(_("This process will look for spurious ranges, e.g. caused by "
                 "\ndirect sunlight in an indoor laser scanner."),
  ...
  wxMessageBox(
      _U(format("Number of bad segments detected & marked as invalid: %u \n(%u "
...
void xRawLogViewerFrame::OnRecalculateActionsICP(wxCommandEvent &event) {
  ...
  wxMessageBox(
      _("Please, modify as desired all the ICP algorithm options\nand the type "
        "of reference map from the following dialog, then close it to start "
        "recomputing the actions from scan matching."));
  ...
  if (!useGridMap) {
    CConfigFileMemory refCfg(CStringList(
    ...
    try {
      ...
      if (rawlog.getType(countLoop) == CRawlog::etActionCollection) {
        ...
        if (SF_new && SF_ref && act_between) {
          ...
          SF_new->insertObservationsInto((CMetricMap *)&newMapPt,
                                         &newMapRobotPose);

          poseEst = icp.Align(refMap, (CMetricMap *)&newMapPt, initialEst,
                              &runTime, &icpInfo);
...
void xRawLogViewerFrame::OnMenuItem47Selected(wxCommandEvent &event) {
  ...
  if (curSelectedObject) {
    if (curSelectedObject->GetRuntimeClass() == CLASS_ID(CActionCollection)) {
      ...
      float odo_x = atof(
          string(wxGetTextFromUser(_("Estimated displacement, X (meters):"),
                                   _("Enter new action parameter:"), _("0"))
                     .mb_str())
              .c_str());
      float odo_y = atof(
          string(wxGetTextFromUser(_("Estimated displacement, Y (meters):"),
                                   _("Enter new action parameter:"), _("0"))
                     .mb_str())
              .c_str());
      float odo_phi = DEG2RAD(atof(
          string(wxGetTextFromUser(_("Estimated displacement, PHI (degrees):"),
                                   _("Enter new action parameter:"), _("0"))
                     .mb_str())
              .c_str()));
...

    {
      ...
      for (size_t i = 0; i < rawlog.size(); i++) {
        if (rawlog.getType(i) == CRawlog::etActionCollection) {
          ...
          CActionRobotMovement2D::Ptr act = acts->getMovementEstimationByType(
              CActionRobotMovement2D::emOdometry);
          if (act) {
            if (!act->hasEncodersInfo) {
              wxMessageBox(
                  _U(format("An odometry measurement was found at entry %i "
                            "which does not\ncontain encoders info: Cannot "
                            "recompute odometry without this information!",
                            (unsigned)i)
                         .c_str()));
              return;
            }
        ...
        if (rawlog.getAsGeneric(i)->GetRuntimeClass() ==
          ...
          if (!odo->hasEncodersInfo) {
            wxMessageBox(
                _U(format("An odometry measurement was found at entry %i which "
                          "does not\ncontain encoders info: Cannot recompute "
          ...
          if (!auxLastAbsOdo_valid) {
            ...
            odo->odometry =
                auxLastAbsOdo + auxOdoIncr.rawOdometryIncrementReading;
            auxLastAbsOdo = odo->odometry;
          }
          M++;
        }
...
void xRawLogViewerFrame::OnRangeFinder1DGenTextFile(wxCommandEvent &event) {
  ...
  if (dialog.ShowModal() == wxID_OK) {
    ...
    for (i = 0; i < n; i++) {
      if (rawlog.getType(i) == CRawlog::etSensoryFrame) {
        ...
        for (size_t k = 0; k < sf->size(); k++) {
          if (sf->getObservationByIndex(k)->GetRuntimeClass() ==
            ...
            CObservationRange::Ptr obs =
                sf->getObservationByIndexAs<CObservationRange::Ptr>(k);

            vector<float> rowOfRangesByID(100, 0);
            for (CObservationRange::iterator it = obs->begin();
                 it != obs->end(); ++it) {
        ...
        if (IS_CLASS(o, CObservationRange)) {
          ...
          vector<float> rowOfRangesByID(100, 0);
          for (it = obs->sensedData.begin(); it != obs->sensedData.end();
               it++) {
            ASSERT_(it->sensorID < rowOfRangesByID.size());
            rowOfRangesByID[it->sensorID] = it->sensedDistance;
          }
    ...
    wxMessageBox(_U(format("%u entries saved!", M).c_str()), _("Done"), wxOK,
                 this);
  }
...
void xRawLogViewerFrame::OnMenuModifyICPActionsUncertainty(
  ...
  float std_xy = atof(
      string(wxGetTextFromUser(_("Standard deviation of x and y (meters):"),
                               _("ICP-based odometry uncertainty:"), _("0.01"))
                 .mb_str())
          .c_str());
  float std_phi = DEG2RAD(atof(
      string(wxGetTextFromUser(_("Standard deviation of phi (degrees):"),
        ...
        for (unsigned int j = 0; j < acts->size(); j++) {
          ...
          if (act->GetRuntimeClass()->derivedFrom(
            ...
            if (actMov->estimationMethod ==
                CActionRobotMovement2D::emScan2DMatching) {
              ASSERT_(actMov->poseChange->GetRuntimeClass() ==
...
vector_string
xRawLogViewerFrame::AskForObservationByLabelMultiple(const std::string &title) {
  vector_string labels;

  if (listOfSensorLabels.empty()) {
    wxMessageBox(_("No sensors were found with proper sensor labels. Labels "
  ...
  wxGetSelectedChoices(sels, _U(title.c_str()), _("Sensor Labels"), lstLabels,
                       this);
#else
  wxGetMultipleChoices(sels, _U(title.c_str()), _("Sensor Labels"), lstLabels,
                       this);
#endif
...
// Asks for a sensor label:
std::string
xRawLogViewerFrame::AskForObservationByLabel(const std::string &title) {
  if (listOfSensorLabels.empty()) {
    wxMessageBox(_("No sensors were found with proper sensor labels. Labels "
                   "are required for this operation."));
    return string();
  ...
  wxString ret =
      wxGetSingleChoice(_U(title.c_str()), _("Sensor Labels"), lstLabels, this);
  if (ret.IsEmpty())
    return string();
...
void xRawLogViewerFrame::OnMenuRenameSensor(wxCommandEvent &event) {
  ...
  wxString new_label =
      wxGetTextFromUser(_("Enter the new sensor label"), _("New label:"),
  ...
  wxMessageBox(wxString::Format(_("%u changes"), nChanges), _("Done"), wxOK,
               this);
...
void xRawLogViewerFrame::OnMenuChangePosesBatch(wxCommandEvent &event) {
  ...
  if (dialog.ShowModal()) {
    ...
    typedef mrpt::aligned_containers<std::string, mrpt::poses::CPose3D>::map_t
        TSensor2PoseMap;
    ...
    for (vector_string::iterator it = sections.begin(); it != sections.end();
      ...
      CPose3D the_pose(cfg.read_double(*it, "pose_x", 0, true),
    ...
    if (desiredSensorPoses.empty()) {
      wxMessageBox(_("No valid 'sensorLabel' entry was found in the text"),
                   _("Error"), wxOK, this);
      return;
    }

    // now apply the changes:
    wxProgressDialog progDia(wxT("Modifying rawlog"), wxT("Processing..."),
                             rawlog.size(), // range
                             this,          // parent
                             wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH |
                                 wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
    ...
    int countLoop = 0;
    bool keepDoing = true;
    for (CRawlog::iterator it = rawlog.begin(); it != rawlog.end() && keepDoing;
         it++, countLoop++) {
      ...
      while (true) {
        ...
        if (obs) {
          ...
          std::map<std::string, mrpt::obs::CObservationImage>::iterator c =
              desiredCamParams.find(obs->sensorLabel);
          if (c != desiredCamParams.end()) {
            if (!IS_CLASS(obs, CObservationImage))
              THROW_EXCEPTION_FMT(
                  "Camera parameters found for non-image observation class: %s",
      ...
      if (countLoop++ % 100 == 0) {
        if (!progDia.Update(
                countLoop,
                wxString::Format(wxT("Processing... (%i objects processed)"),
                                 countLoop)))
          keepDoing = false;
        wxTheApp->Yield(); // Let the app. process messages
      }
    ...
    wxMessageBox(
        wxString::Format(_("%i entries modified for %i sensor labels."),
                         (int)changes, (int)desiredSensorPoses.size()),
        _("Done"), wxOK, this);
...
void xRawLogViewerFrame::OnMenuChangeMaxRangeLaser(wxCommandEvent &event) {
  ...
  wxString strMaxR =
      wxGetTextFromUser(_("Enter the new maximum range (in meters):"),
                        _("Maximum range:"), _("81.0"));
  double maxR;
  ...
  wxMessageBox(_U(format("Number of changes: %i", (int)N).c_str()), _("Done"),
               wxOK, this);
...
void xRawLogViewerFrame::OnMenuBatchLaserExclusionZones(wxCommandEvent &event) {
  ...
  if (dialog.ShowModal()) {
    ...
    // make a list  "sensor_label -> list of exclusion polygons" by parsing the
    // ini-file:
    ...
    for (vector_string::iterator it = sections.begin(); it != sections.end();
      ...
      for (;;) {
        vector<double> x, y;
        cfg.read_vector(*it, format("exclusionZone%u_x", N), vector<double>(0),
                        x);
        cfg.read_vector(*it, format("exclusionZone%u_y", N++),
                        vector<double>(0), y);
    ...
    if (lstExclusions.empty()) {
      wxMessageBox(_("No valid exclusion zones found in the text"), _("Error"),
                   wxOK, this);
      return;
    }
    ...
    wxMessageBox(wxString::Format(_("%i entries modified for %i sensor labels "
                                    "and %u exclusion areas."),
                                  (int)changes, (int)lstExclusions.size(),
                                  nExclZones),
                 _("Done"), wxOK, this);
...
void xRawLogViewerFrame::OnComboImageDirsChange(wxCommandEvent &event) {
  ...
  if (mrpt::system::fileExists(dirc)) {
    ...
    // wxMessageBox( _("The current directory for external images has been set
    ...
    for (vector_string::iterator it = sections.begin(); it != sections.end();
      ...
      for (;;) {
        const double ini = DEG2RAD(
            cfg.read_double(*it, format("exclusionAngles%u_ini", N), -1000));
        const double end = DEG2RAD(
            cfg.read_double(*it, format("exclusionAngles%u_end", N++), -1000));
...
void xRawLogViewerFrame::OnMenuRangeBearFilterIDs(wxCommandEvent &event) {
  ...
  wxString strID = wxGetTextFromUser(_("Enter the landmark ID to remove:"),
                                     _("Landmark ID"), _("0"));
  long ID;
  strID.ToLong(&ID);
...
void xRawLogViewerFrame::OnmnuCreateAVISelected(wxCommandEvent &event) {
  ...
  for (int countLoop = 0; countLoop < nEntries; countLoop++) {
    ...
    try {
        ...
        if (obsImg) {
          ...
          if (obsStereoImg) {
            ...
            if (obsStereoImg->hasImageRight)
              imgsForVideo.insert(
                  TImageToSaveData(&obsStereoImg->imageRight, "RIGHT"));
            if (obsStereoImg->hasImageDisparity)
              imgsForVideo.insert(
                  TImageToSaveData(&obsStereoImg->imageDisparity, "DISP"));
          } else {
      ...
      // If we have images in "imgsForVideo", save them to their video (AVI)
      // files,
  ...
  wxMessageBox(_U(format("Saved %u images.", nFrames).c_str()), _("Done"), wxOK,
               this);
      ...
      if (rawlog.getType(countLoop) == CRawlog::etActionCollection) {
        ...
        if (sf->size() > 0) {
          ...
          if (thisObsTime != INVALID_TIMESTAMP) {
            if (lastOdo && lastObsTime != INVALID_TIMESTAMP) { // Do average:
    ...
    try {
      if (rawlog.getType(countLoop) == CRawlog::etObservation) {
        ...
        if (IS_CLASS(obs, CObservation3DRangeScan)) {
          ...
          if (firstObs) {
            const double avrErr =
                CObservation3DRangeScan::recoverCameraCalibrationParameters(
                    *o, optimal_params);

            if (wxNO ==
                wxMessageBox(
                    _U(format("Calibration with first observation:\nAverage "
                              "reprojection error=%.04fpx.\n Accept and apply "
                              "to ALL 3D observations?",
                              avrErr)
                           .c_str()),
...
void xRawLogViewerFrame::OnMenuRenameSingleObs(wxCommandEvent &event) {
  ...
  const wxString new_label =
      wxGetTextFromUser(_("Enter the new sensor label for selected object"),
                        _("New label:"), _U(obj->sensorLabel.c_str()), this);
  if (new_label.IsEmpty())
    return;
