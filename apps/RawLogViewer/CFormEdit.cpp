...
CFormEdit::CFormEdit(wxWindow *parent, wxWindowID id) {
  ...
  Create(parent, id, _("Edit the rawlog"), wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer7->Add(rbLoaded, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer7->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  FlexGridSizer7->Add(rbFile, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText22 = new wxStaticText(this, ID_STATICTEXT22, _("Input file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT22"));
  FlexGridSizer7->Add(StaticText22, 1,
  ...
  FlexGridSizer7->Add(txtInputFile, 1,
  ...
  FlexGridSizer7->Add(btnPickInput, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      0);
  FlexGridSizer7->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
  ...
  StaticText23 = new wxStaticText(this, ID_STATICTEXT23, _("Output file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT23"));
  FlexGridSizer7->Add(StaticText23, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  txtOutputFile =
      new wxTextCtrl(this, ID_TEXTCTRL12, wxEmptyString, wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL12"));
  FlexGridSizer7->Add(txtOutputFile, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  btnPickOut =
      new wxButton(this, ID_BUTTON11, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON11"));
  FlexGridSizer7->Add(btnPickOut, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      0);
  BoxSizer5->Add(FlexGridSizer7, 1,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  BoxSizer4->Add(BoxSizer5, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                 0);
  StaticBoxSizer6->Add(BoxSizer4, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12->Add(StaticBoxSizer6, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer1 = new wxStaticBoxSizer(wxHORIZONTAL, this,
                                         _("Apply changes to this range:"));
  FlexGridSizer2 = new wxFlexGridSizer(2, 3, 0, 0);
  FlexGridSizer2->AddGrowableCol(1);
  FlexGridSizer2->AddGrowableRow(0);
  FlexGridSizer2->AddGrowableRow(1);
  StaticText1 =
      new wxStaticText(this, ID_STATICTEXT1, _("First:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT1"));
  FlexGridSizer2->Add(StaticText1, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  slFrom = new wxSlider(this, ID_SLIDER1, 0, 0, 100, wxDefaultPosition,
                        wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER1"));
  FlexGridSizer2->Add(slFrom, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  spinFirst = new wxSpinCtrl(this, ID_SPINCTRL1, _T("0"), wxDefaultPosition,
                             wxDefaultSize, 0, 0, 100, 0, _T("ID_SPINCTRL1"));
  spinFirst->SetValue(_T("0"));
  FlexGridSizer2->Add(spinFirst, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  StaticText3 =
      new wxStaticText(this, ID_STATICTEXT3, _("Last:"), wxDefaultPosition,
                       wxDefaultSize, 0, _T("ID_STATICTEXT3"));
  FlexGridSizer2->Add(StaticText3, 1,
                      wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  slTo = new wxSlider(this, ID_SLIDER2, 0, 0, 100, wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER2"));
  FlexGridSizer2->Add(slTo, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  spinLast = new wxSpinCtrl(this, ID_SPINCTRL2, _T("0"), wxDefaultPosition,
                            wxDefaultSize, 0, 0, 100, 0, _T("ID_SPINCTRL2"));
  spinLast->SetValue(_T("0"));
  FlexGridSizer2->Add(spinLast, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                      5);
  StaticBoxSizer1->Add(FlexGridSizer2, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer12->Add(StaticBoxSizer1, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  BoxSizer1->Add(FlexGridSizer12, 1,
                 wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer1->Add(BoxSizer1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
  btnKeep = new wxButton(this, ID_BUTTON1, _("Keep the selected range only..."),
                         wxDefaultPosition, wxDefaultSize, 0,
                         wxDefaultValidator, _T("ID_BUTTON1"));
  BoxSizer2->Add(btnKeep, 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  btnDelete = new wxButton(this, ID_BUTTON2, _("Remove the selected range..."),
                           wxDefaultPosition, wxDefaultSize, 0,
                           wxDefaultValidator, _T("ID_BUTTON2"));
  BoxSizer2->Add(btnDelete, 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  ...
  StaticBoxSizer3 = new wxStaticBoxSizer(
      wxHORIZONTAL, this,
      _("Remove observations by index in sensorial frame:"));
  FlexGridSizer3 = new wxFlexGridSizer(1, 6, 0, 0);
  cbO0 =
      new wxCheckBox(this, ID_CHECKBOX1, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbO0->SetValue(false);
  FlexGridSizer3->Add(
      cbO0, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbO1 =
      new wxCheckBox(this, ID_CHECKBOX2, _("1"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
  cbO1->SetValue(false);
  FlexGridSizer3->Add(
      cbO1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbO2 =
      new wxCheckBox(this, ID_CHECKBOX3, _("2"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
  cbO2->SetValue(false);
  FlexGridSizer3->Add(
      cbO2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbO3 =
      new wxCheckBox(this, ID_CHECKBOX4, _("3"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX4"));
  cbO3->SetValue(false);
  FlexGridSizer3->Add(
      cbO3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbO4 =
      new wxCheckBox(this, ID_CHECKBOX5, _("4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX5"));
  cbO4->SetValue(false);
  FlexGridSizer3->Add(
      cbO4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  btnDelObsIndx =
      new wxButton(this, ID_BUTTON4, _("Do it"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON4"));
  FlexGridSizer3->Add(btnDelObsIndx, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                            wxALIGN_CENTER_VERTICAL,
                      5);
  StaticBoxSizer3->Add(FlexGridSizer3, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer8->Add(StaticBoxSizer3, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  cbA0 =
      new wxCheckBox(this, ID_CHECKBOX6, _("0"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX6"));
  cbA0->SetValue(false);
  FlexGridSizer4->Add(
      cbA0, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbA1 =
      new wxCheckBox(this, ID_CHECKBOX7, _("1"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX7"));
  cbA1->SetValue(false);
  FlexGridSizer4->Add(
      cbA1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbA2 =
      new wxCheckBox(this, ID_CHECKBOX8, _("2"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX8"));
  cbA2->SetValue(false);
  FlexGridSizer4->Add(
      cbA2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbA3 =
      new wxCheckBox(this, ID_CHECKBOX9, _("3"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX9"));
  cbA3->SetValue(false);
  FlexGridSizer4->Add(
      cbA3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbA4 =
      new wxCheckBox(this, ID_CHECKBOX10, _("4"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX10"));
  cbA4->SetValue(false);
  FlexGridSizer4->Add(
      cbA4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  btnRemActsIndx =
      new wxButton(this, ID_BUTTON5, _("Do it"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer4->Add(btnRemActsIndx, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                      5);
  StaticBoxSizer4->Add(FlexGridSizer4, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer8->Add(StaticBoxSizer4, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  StaticBoxSizer5 = new wxStaticBoxSizer(wxHORIZONTAL, this,
                                         _("Remove observations by CLASS:"));
  FlexGridSizer6 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer6->AddGrowableCol(0);
  FlexGridSizer5 = new wxFlexGridSizer(1, 1, 0, 0);
  FlexGridSizer5->AddGrowableCol(0);
  FlexGridSizer5->AddGrowableRow(0);
  cbObsClass = new wxCheckListBox(this, ID_CHECKLISTBOX2, wxDefaultPosition,
                                  wxSize(-1, 200), 0, 0, 0, wxDefaultValidator,
                                  _T("ID_CHECKLISTBOX2"));
  cbObsClass->SetMaxSize(wxSize(-1, 200));
  FlexGridSizer5->Add(cbObsClass, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer6->Add(FlexGridSizer5, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer10 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer10->AddGrowableCol(0);
  FlexGridSizer10->AddGrowableCol(1);
  btnRemoveObsClass =
      new wxButton(this, ID_BUTTON7, _("Remove selected..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON7"));
  FlexGridSizer10->Add(btnRemoveObsClass, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                 wxALIGN_CENTER_VERTICAL,
                       5);
  btnRemoveAllButByClass = new wxButton(
      this, ID_BUTTON8, _("Remove all but selected..."), wxDefaultPosition,
      wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON8"));
  FlexGridSizer10->Add(
      btnRemoveAllButByClass, 1,
      wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer6->Add(FlexGridSizer10, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticBoxSizer5->Add(FlexGridSizer6, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer9->Add(StaticBoxSizer5, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticBoxSizer7 = new wxStaticBoxSizer(wxHORIZONTAL, this,
                                         _("Remove observations by LABEL:"));
  ...
  cbObsLabel = new wxCheckListBox(this, ID_CHECKLISTBOX1, wxDefaultPosition,
                                  wxSize(-1, 200), 0, 0, 0, wxDefaultValidator,
                                  _T("ID_CHECKLISTBOX1"));
  cbObsLabel->SetMaxSize(wxSize(-1, 200));
  FlexGridSizer13->Add(cbObsLabel, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer11->Add(FlexGridSizer13, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer14 = new wxFlexGridSizer(1, 2, 0, 0);
  FlexGridSizer14->AddGrowableCol(0);
  FlexGridSizer14->AddGrowableCol(1);
  btnRemByLabel =
      new wxButton(this, ID_BUTTON10, _("Remove matches..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON10"));
  FlexGridSizer14->Add(btnRemByLabel, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                             wxALIGN_CENTER_VERTICAL,
                       5);
  btnRemByLabelNon = new wxButton(this, ID_BUTTON12, _("Remove non-matches..."),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  wxDefaultValidator, _T("ID_BUTTON12"));
  FlexGridSizer14->Add(btnRemByLabelNon, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                                wxALIGN_CENTER_VERTICAL,
                       5);
  FlexGridSizer11->Add(FlexGridSizer14, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  StaticBoxSizer7->Add(FlexGridSizer11, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer9->Add(StaticBoxSizer7, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  ...
  StaticBoxSizer2 =
      new wxStaticBoxSizer(wxHORIZONTAL, this, _("Miscellaneous"));
  FlexGridSizer15 = new wxFlexGridSizer(2, 3, 0, 0);
  btnLeaveHorizScans =
      new wxButton(this, ID_BUTTON13, _("Leave horizontal laser scans only..."),
                   wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
                   _T("ID_BUTTON13"));
  FlexGridSizer15->Add(btnLeaveHorizScans, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("Max. pitch (deg):"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT2"));
  FlexGridSizer15->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  edMaxPitch =
      new wxTextCtrl(this, ID_TEXTCTRL2, _("1.5"), wxDefaultPosition,
                     wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
  FlexGridSizer15->Add(edMaxPitch, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  btnImgSwap = new wxButton(this, ID_BUTTON3,
                            _("Swap Red-Blue channels of all images..."),
                            wxDefaultPosition, wxDefaultSize, 0,
                            wxDefaultValidator, _T("ID_BUTTON3"));
  FlexGridSizer15->Add(btnImgSwap, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                       5);
  StaticBoxSizer2->Add(FlexGridSizer15, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  FlexGridSizer16->Add(StaticBoxSizer2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                               wxALIGN_CENTER_VERTICAL,
                       5);
  btnClose =
      new wxButton(this, ID_BUTTON6, _("Close"), wxDefaultPosition,
  ...
  Connect(ID_SLIDER1, wxEVT_SCROLL_CHANGED,
          (wxObjectEventFunction)&CFormEdit::OnslFirstCmdScrollChanged);
  Connect(ID_SLIDER2, wxEVT_SCROLL_THUMBTRACK,
          (wxObjectEventFunction)&CFormEdit::OnslToCmdScrollChanged);
  Connect(ID_SLIDER2, wxEVT_SCROLL_CHANGED,
          (wxObjectEventFunction)&CFormEdit::OnslToCmdScrollChanged);
  ...
  Connect(wxID_ANY, wxEVT_INIT_DIALOG,
          (wxObjectEventFunction)&CFormEdit::OnInit);
  //*)
}
...
void filter_delObsByIndex(mrpt::obs::CActionCollection *acts,
...
void filter_delObsByClass(mrpt::obs::CActionCollection *acts,
                          mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
    for (CSensoryFrame::iterator it = SF->begin(); it != SF->end();) {
      CObservation::Ptr obs = *it;
      if (string::npos !=
          find_in_vector(string(obs->GetRuntimeClass()->className),
...
void filter_remObsByClass(mrpt::obs::CActionCollection *acts,
                          mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
    for (CSensoryFrame::iterator it = SF->begin(); it != SF->end();) {
      CObservation::Ptr obs = *it;
...
void CFormEdit::OnbtnRemoveObsClassClick(wxCommandEvent &event) {
  ...
  if (classNameOfObsToRemove.empty())
    THROW_EXCEPTION("You must select one class name!");
...
void filter_delActsByIndex(mrpt::obs::CActionCollection *acts,
                           mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (acts) {
    int j = 0;
...
// Swap colors:
void filter_swapColors(mrpt::obs::CActionCollection *acts,
                       mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
 ...
 * user selection in the GUI).
  */
void CFormEdit::executeOperationOnRawlog(TRawlogFilter operation,
                                         const char *endMsg) {
  WX_START_TRY
...
void filter_delObsByLabel(mrpt::obs::CActionCollection *acts,
                          mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
    for (CSensoryFrame::iterator it = SF->begin(); it != SF->end();) {
      CObservation::Ptr obs = *it;
      if (string::npos !=
          find_in_vector(obs->sensorLabel, labelOfObsToRemove)) {
        // A match: Delete it:
        it = SF->erase(it);
        changesCount++;
      } else
...
void filter_NotDelObsByLabel(mrpt::obs::CActionCollection *acts,
                             mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
    for (CSensoryFrame::iterator it = SF->begin(); it != SF->end();) {
      CObservation::Ptr obs = *it;
...
void CFormEdit::OnRemoveByLabel(wxCommandEvent &event) {
  ...
  if (labelOfObsToRemove.empty())
    THROW_EXCEPTION("You must select at least one label!");
...
void leave_horizontalScans(mrpt::obs::CActionCollection *acts,
                           mrpt::obs::CSensoryFrame *SF, int &changesCount) {
  if (SF) {
    for (CSensoryFrame::iterator it = SF->begin(); it != SF->end();) {
      CObservation::Ptr obs = *it;
...
void CFormEdit::OnbtnLeaveHorizScansClick(wxCommandEvent &event) {
  ...
  minPitchToDeleteLaserScan =
      atof(string(edMaxPitch->GetValue().mb_str()).c_str());
  executeOperationOnRawlog(leave_horizontalScans,
                           "Laser scans that passed the filter: ");
