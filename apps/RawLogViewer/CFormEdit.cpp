...
CFormEdit::CFormEdit(wxWindow* parent, wxWindowID id)
{
	...
	Create(
		parent, id, _("Edit the rawlog"), wxDefaultPosition, wxDefaultSize,
	...
	StaticText1 = new wxStaticText(
		this, ID_STATICTEXT1, _("First:"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT1"));
	FlexGridSizer2->Add(
	...
	FlexGridSizer2->Add(
		spinFirst, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	StaticText3 = new wxStaticText(
		this, ID_STATICTEXT3, _("Last:"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT3"));
	FlexGridSizer2->Add(
	...
	btnKeep = new wxButton(
		...
		_T("ID_BUTTON1"));
	BoxSizer2->Add(
		btnKeep, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	btnDelete = new wxButton(
		this, ID_BUTTON2, _("Remove the selected range..."), wxDefaultPosition,
	...
	cbO0 = new wxCheckBox(
		this, ID_CHECKBOX1, _("0"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX1"));
	cbO0->SetValue(false);
	FlexGridSizer3->Add(
		cbO0, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbO1 = new wxCheckBox(
		this, ID_CHECKBOX2, _("1"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX2"));
	cbO1->SetValue(false);
	FlexGridSizer3->Add(
		cbO1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbO2 = new wxCheckBox(
		this, ID_CHECKBOX3, _("2"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX3"));
	cbO2->SetValue(false);
	FlexGridSizer3->Add(
		cbO2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbO3 = new wxCheckBox(
		this, ID_CHECKBOX4, _("3"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX4"));
	cbO3->SetValue(false);
	FlexGridSizer3->Add(
		cbO3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbO4 = new wxCheckBox(
		this, ID_CHECKBOX5, _("4"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX5"));
	cbO4->SetValue(false);
	FlexGridSizer3->Add(
		cbO4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	btnDelObsIndx = new wxButton(
		this, ID_BUTTON4, _("Do it"), wxDefaultPosition, wxDefaultSize, 0,
	...
	cbA0 = new wxCheckBox(
		this, ID_CHECKBOX6, _("0"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX6"));
	cbA0->SetValue(false);
	FlexGridSizer4->Add(
		cbA0, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbA1 = new wxCheckBox(
		this, ID_CHECKBOX7, _("1"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX7"));
	cbA1->SetValue(false);
	FlexGridSizer4->Add(
		cbA1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbA2 = new wxCheckBox(
		this, ID_CHECKBOX8, _("2"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX8"));
	cbA2->SetValue(false);
	FlexGridSizer4->Add(
		cbA2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbA3 = new wxCheckBox(
		this, ID_CHECKBOX9, _("3"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX9"));
	cbA3->SetValue(false);
	FlexGridSizer4->Add(
		cbA3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	cbA4 = new wxCheckBox(
		this, ID_CHECKBOX10, _("4"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_CHECKBOX10"));
	cbA4->SetValue(false);
	FlexGridSizer4->Add(
		cbA4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
		5);
	btnRemActsIndx = new wxButton(
		this, ID_BUTTON5, _("Do it"), wxDefaultPosition, wxDefaultSize, 0,
	...
	StaticBoxSizer5 = new wxStaticBoxSizer(
		wxHORIZONTAL, this, _("Remove observations by CLASS:"));
	...
	btnRemoveObsClass = new wxButton(
		this, ID_BUTTON7, _("Remove selected..."), wxDefaultPosition,
	...
	btnRemByLabel = new wxButton(
		this, ID_BUTTON10, _("Remove matches..."), wxDefaultPosition,
		wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON10"));
	FlexGridSizer14->Add(
		btnRemByLabel, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	btnRemByLabelNon = new wxButton(
		this, ID_BUTTON12, _("Remove non-matches..."), wxDefaultPosition,
	...
	btnLeaveHorizScans = new wxButton(
	...
	FlexGridSizer15->Add(
		StaticText2, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	edMaxPitch = new wxTextCtrl(
		this, ID_TEXTCTRL2, _("1.5"), wxDefaultPosition, wxDefaultSize, 0,
		wxDefaultValidator, _T("ID_TEXTCTRL2"));
	FlexGridSizer15->Add(
		edMaxPitch, 1,
		wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
	btnImgSwap = new wxButton(
		this, ID_BUTTON3, _("Swap Red-Blue channels of all images..."),
		wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
		_T("ID_BUTTON3"));
	FlexGridSizer15->Add(
		btnImgSwap, 1,
	...
	btnClose = new wxButton(
		this, ID_BUTTON6, _("Close"), wxDefaultPosition, wxDefaultSize, 0,
...
void CFormEdit::OnbtnKeepClick(wxCommandEvent& event)
{
	...
	if (last < n - 1) rawlog.remove(last + 1, n - 1);

	if (first > 0) rawlog.remove(0, first - 1);
...
void CFormEdit::OnbtnLeaveHorizScansClick(wxCommandEvent& event)
{
	...
	executeOperationOnRawlog(
		leave_horizontalScans, "Laser scans that passed the filter: ");
