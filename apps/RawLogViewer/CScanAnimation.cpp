...
CScanAnimation::CScanAnimation(wxWindow *parent, wxWindowID id,
  ...
  Create(parent, wxID_ANY, _("Animate laser scans"), wxDefaultPosition,
  ...
  FlexGridSizer8->Add(rbFile, 1, wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL,
                      5);
  StaticText22 = new wxStaticText(this, ID_STATICTEXT22, _("Input file:"),
                                  wxDefaultPosition, wxDefaultSize, 0,
                                  _T("ID_STATICTEXT22"));
  FlexGridSizer8->Add(StaticText22, 1,
  ...
  FlexGridSizer8->Add(edFile, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  btnPickInput =
      new wxButton(this, ID_BUTTON5, _("Select..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
  FlexGridSizer8->Add(btnPickInput, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                      0);
  BoxSizer5->Add(FlexGridSizer8, 1,
  ...
  btnPlay->SetDefault();
  FlexGridSizer4->Add(btnPlay, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  btnStop =
  ...
  btnStop->Disable();
  FlexGridSizer4->Add(btnStop, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  ...
  FlexGridSizer4->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  edDelay = new wxSpinCtrl(this, ID_SPINCTRL2, _T("5"), wxDefaultPosition,
                           wxDefaultSize, 0, 0, 1000, 5, _T("ID_SPINCTRL2"));
  edDelay->SetValue(_T("5"));
  FlexGridSizer4->Add(edDelay, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  cbAllowMix = new wxCheckBox(
      this, ID_CHECKBOX1, _("Enable mixing of diff. lasers"), wxDefaultPosition,
      wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
  cbAllowMix->SetValue(true);
  FlexGridSizer4->Add(cbAllowMix, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                         wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer4->Add(-1, -1, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  btnClose =
      new wxButton(this, ID_BUTTON3, _("Close"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
  FlexGridSizer4->Add(btnClose, 1,
  ...
  m_plot3D =
      new CMyGLCanvas(this, ID_XY_GLCANVAS, wxDefaultPosition, wxDefaultSize,
                      wxTAB_TRAVERSAL, _T("ID_XY_GLCANVAS"));
  FlexGridSizer2->Add(m_plot3D, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  ...
  slPos = new wxSlider(this, ID_SLIDER1, 0, 0, 100, wxDefaultPosition,
                       wxDefaultSize, 0, wxDefaultValidator, _T("ID_SLIDER1"));
  FlexGridSizer6->Add(slPos, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  ...
  FlexGridSizer7->Add(edIndex, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                      ...
                      5);
  btnJump =
      new wxButton(this, ID_BUTTON4, _("Jump"), wxDefaultPosition,
  ...
  FlexGridSizer7->Add(lbNumScans, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  FlexGridSizer7->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                     wxALIGN_CENTER_VERTICAL,
                      5);
  lbNumPoints = new wxStaticText(this, ID_STATICTEXT3, _("Number of points: 0"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 _T("ID_STATICTEXT3"));
  FlexGridSizer7->Add(lbNumPoints, 1,
                      wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  // Initialize 3D view:
  m_plot3D->m_openGLScene->insert(std::make_shared<mrpt::opengl::CGridPlaneXY>(
      -50, 50, -50, 50, 0 /* z */, 5 /* freq */));
  m_plot3D->m_openGLScene->insert(mrpt::opengl::stock_objects::CornerXYZSimple(
