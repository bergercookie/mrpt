...
CFormBatchSensorPose::CFormBatchSensorPose(wxWindow *parent, wxWindowID id) {
  ...
  Create(parent, id, _("Batch change sensor poses"), wxDefaultPosition,
         wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER | wxCLOSE_BOX,
         _T("id"));
  ...
  StaticText1 = new wxStaticText(
      this, ID_STATICTEXT1, _("Configuration of sensors:"), wxDefaultPosition,
  ...
  edText = new wxTextCtrl(
      this, ID_TEXTCTRL1,
      _("//  Any file in the format used by rawlog-grabber can be used "
      ...
      wxTE_MULTILINE | wxHSCROLL | wxVSCROLL | wxALWAYS_SHOW_SB,
      wxDefaultValidator, _T("ID_TEXTCTRL1"));
  edText->SetMinSize(wxSize(500, 300));
  wxFont edTextFont(9, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxNORMAL,
                    false, _T("FreeMono"), wxFONTENCODING_DEFAULT);
  edText->SetFont(edTextFont);
  FlexGridSizer2->Add(edText, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      5);
  ...
  FlexGridSizer3->Add(btnOpen, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  FlexGridSizer3->Add(-1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                      ...
                      5);
  btnApply =
      new wxButton(this, ID_BUTTON1, _("Apply"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  btnApply->SetDefault();
  FlexGridSizer3->Add(btnApply, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                       wxALIGN_CENTER_VERTICAL,
                      5);
  btnCancel =
...
void CFormBatchSensorPose::OnbtnOpenClick(wxCommandEvent &event) {
  ...
  wxFileDialog dialog(this,
                      ...
                      _("rawlog-grabber config files (*.ini)|*.ini|All files "
                        "(*.*)|*.*") /* wildcard */,
