...
CDlgLog::CDlgLog(wxWindow *parent, wxWindowID id, const wxPoint &pos,
                 const wxSize &size) {
  ...
  Create(parent, id, _("Log messages"), wxDefaultPosition, wxDefaultSize,
  ...
  Connect(wxID_ANY, wxEVT_CLOSE_WINDOW,
          (wxObjectEventFunction)&CDlgLog::OnClose);
  //*)

  m_redirector.reset(new CMyRedirector(edLog, false, 0, true,
                                       /* thread_safe */ true,
