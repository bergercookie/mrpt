...
private:
  ...
  std::unique_ptr<mrpt::hmtslam::CHMTSLAM> m_hmtslam; //!< The main HMT-SLAM
                                                      //!object, keeps the HMT
                                                      //!map and does HMT SLAM.
  ...
  enum THREAD_OPCODE { OP_QUIT_THREAD = 0, OP_START_SLAM, OP_PAUSE_SLAM };
...
public:
  mrpt::utils::CSerializable::Ptr m_ptr;
  size_t m_itemIndex;

  CItemData(mrpt::utils::CSerializable::Ptr ptr, size_t itemIndex)
