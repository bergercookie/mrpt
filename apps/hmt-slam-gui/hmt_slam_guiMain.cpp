...
// Load my custom icons:
	...
	edRestParams = new wxTextCtrl(
		...
		_("//====================================================\n//          "
		  ...
		  "====================================================\n[HMT-SLAM]"
		  "\n\n//"
		  " The directory where the log files will be saved (left in blank if "
		  "no "
		  "log is required)\nLOG_OUTPUT_DIR\t= "
		  ...
		  "amModifiedRANSAC "
		  "method only\n\nsave_feat_coors\t\t\t= 0\t\t// Dump correspondences "
		  "to "
		  ...
		  "algorithm=3\n\nsampleSize\t= "
		  "5\t\t// Number of particles (for fixed number "
		  "algorithms)\nBETA\t\t= "
		  ...
		  "HORIZONTAL (i.e. XY plane) measurements will be inserted in the "
		  "map. "
