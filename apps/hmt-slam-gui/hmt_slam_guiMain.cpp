...
// Load my custom icons:
  ...
  Create(parent, id, _("HTM-SLAM - Part of the MRPT project"),
  ...
  btnReset = new wxCustomButton(
      ...
      wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM | wxCUSTBUT_FLAT, wxDefaultValidator,
      _T("ID_BUTTON1"));
  ...
  StaticLine3 =
      new wxStaticLine(Panel1, ID_STATICLINE3, wxDefaultPosition, wxSize(1, -1),
                       wxLI_VERTICAL, _T("ID_STATICLINE3"));
  FlexGridSizer2->Add(StaticLine3, 1,
  ...
  StaticLine1 =
      new wxStaticLine(Panel1, ID_STATICLINE1, wxDefaultPosition, wxSize(1, -1),
                       wxLI_VERTICAL, _T("ID_STATICLINE1"));
  FlexGridSizer2->Add(StaticLine1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
  ...
  StaticLine2 =
      new wxStaticLine(Panel1, ID_STATICLINE2, wxDefaultPosition, wxSize(1, -1),
                       wxLI_VERTICAL, _T("ID_STATICLINE2"));
  FlexGridSizer2->Add(StaticLine2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
  ...
  FlexGridSizer2->Add(btnShowLogWin, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM,
                      5);
  FlexGridSizer2->Add(-1, -1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
  ...
  Notebook1 = new wxNotebook(Panel2, ID_NOTEBOOK1, wxDefaultPosition,
                             wxDefaultSize, 0, _T("ID_NOTEBOOK1"));
  panConfig = new wxPanel(Notebook1, ID_PANEL3, wxDefaultPosition,
  ...
  StaticText1 = new wxStaticText(panConfig, ID_STATICTEXT1,
                                 _("Input rawlog file:"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT1"));
  FlexGridSizer17->Add(StaticText1, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edInputRawlog = new wxTextCtrl(panConfig, ID_TEXTCTRL1, _("dataset.rawlog"),
                                 wxDefaultPosition, wxDefaultSize, 0,
                                 wxDefaultValidator, _T("ID_TEXTCTRL1"));
  FlexGridSizer17->Add(edInputRawlog, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 5);
  btnPickRawlog =
      new wxButton(panConfig, ID_BUTTON11, _("Pick..."), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON11"));
  FlexGridSizer17->Add(btnPickRawlog, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  StaticText6 = new wxStaticText(panConfig, ID_STATICTEXT6,
                                 _("More parameters:"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT6"));
  FlexGridSizer18->Add(StaticText6, 1,
  ...
  edRestParams = new wxTextCtrl(
      ...
      _("//====================================================\n//            "
        ...
        "app.\n//"
        "====================================================\n[HMT-SLAM]\n\n//"
        " The directory where the log files will be saved (left in blank if no "
        "log is required)\nLOG_OUTPUT_DIR\t= "
        ...
        "(meters)\nMIN_ODOMETRY_STD_PHI\t= 2\t\t\t// Minimum sigma in odometry "
        ...
        "0.20 \t\t// For considering candidate matches\nthreshold_delta\t\t\t= "
        "0.09\n\nransac_prob_good_inliers = 0.9999999999  // Prob. of a good "
        "inliers (for the number of iterations).\n\nmaxKLd_for_merge        = "
        "0.9\t\t// Merge of close SOG modes\n\nmin_ICP_goodness\t= "
        "0.25\nmax_ICP_mahadist\t= 20 //10 // The maximum Mahalanobis distance "
        "between the initial and final poses in the ICP not to discard the "
        "hypothesis (default=10)\n\nransac_minSetSizeRatio\t= 0.15 // "
        "0.20\n\nransac_mahalanobisDistanceThreshold\t= 6\t\t// amRobust "
        "method only\nransac_chi2_quantile\t= 0.5 \t\t\t\t// amModifiedRANSAC "
        "method only\n\nsave_feat_coors\t\t\t= 0\t\t// Dump correspondences to "
        "grid_feats\ndebug_save_map_pairs\t= 1\t\t// Save the pair of maps "
        "with the best correspondences\ndebug_show_corrs\t\t= 0\t\t// Debug "
        "output of graphs\n\n\n// "
        "----------------------------------------------------------\n// All "
        ...
        "\n//  1= SIFT, 2=SURF, 4=Spin images, 8=Polar images, 16=log-polar "
        ...
        "====================================================\n//\n//          "
        "  \tPARTICLE_FILTER\n//\n//  Parameters of the PARTICLE FILTER within "
        ...
        "----------------------------------------------------------------------"
        "------------\nresamplingMethod=0\npfAuxFilterOptimal_"
        "MaximumSearchSamples = 250\t\t// For PF algorithm=3\n\nsampleSize\t= "
        "5\t\t// Number of particles (for fixed number algorithms)\nBETA\t\t= "
        "0.50\t// Resampling ESS threshold\t\npowFactor\t= 0.01\t\t\t// A "
        "\"power factor\" for updating weights\t\t\t\n\n\n// "
        "====================================================\n//"
        ...
        "0.05  // The minimum distance between points (in 3D): If two points "
        "are too close, one of them is not inserted into the "
        "map.\nisPlanarMap=0                   // If set to true, only "
        "HORIZONTAL (i.e. XY plane) measurements will be inserted in the map. "
        "Default value is false, thus 3D maps are generated\n"),
      wxDefaultPosition, wxDefaultSize,
      wxTE_PROCESS_ENTER | wxTE_PROCESS_TAB | wxTE_MULTILINE | wxHSCROLL |
          wxALWAYS_SHOW_SB,
      wxDefaultValidator, _T("ID_TEXTCTRL2"));
  wxFont edRestParamsFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL,
                          wxNORMAL, false, wxEmptyString,
                          wxFONTENCODING_DEFAULT);
  edRestParams->SetFont(edRestParamsFont);
  FlexGridSizer18->Add(edRestParams, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 1);
  ...
  panMapView = new wxPanel(Notebook1, ID_PANEL4, wxDefaultPosition,
  ...
  Panel3 = new wxPanel(SplitterWindow1, ID_PANEL5, wxDefaultPosition,
                       wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL5"));
  FlexGridSizer5 = new wxFlexGridSizer(3, 1, 0, 0);
  FlexGridSizer5->AddGrowableCol(0);
  FlexGridSizer5->AddGrowableRow(1);
  FlexGridSizer7 = new wxFlexGridSizer(0, 2, 0, 0);
  StaticText2 = new wxStaticText(Panel3, ID_STATICTEXT2,
                                 _("Select hypothesis:"), wxDefaultPosition,
                                 wxDefaultSize, 0, _T("ID_STATICTEXT2"));
  FlexGridSizer7->Add(StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      5);
  cbHypos = new wxChoice(Panel3, ID_CHOICE1, wxDefaultPosition, wxDefaultSize,
                         0, 0, 0, wxDefaultValidator, _T("ID_CHOICE1"));
  FlexGridSizer7->Add(cbHypos, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                      wxALIGN_CENTER_VERTICAL,
                      5);
  FlexGridSizer5->Add(FlexGridSizer7, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  Notebook2 = new wxNotebook(Panel3, ID_NOTEBOOK2, wxDefaultPosition,
                             wxDefaultSize, wxNB_MULTILINE, _T("ID_NOTEBOOK2"));
  panTreeView = new wxPanel(Notebook2, ID_PANEL15, wxDefaultPosition,
                            wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL15"));
  FlexGridSizer15 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer15->AddGrowableCol(0);
  FlexGridSizer15->AddGrowableRow(0);
  treeView = new wxTreeCtrl(panTreeView, ID_TREECTRL1, wxDefaultPosition,
                            wxDefaultSize,
                            wxTR_LINES_AT_ROOT | wxTR_MULTIPLE |
                                wxTR_DEFAULT_STYLE | wxVSCROLL | wxHSCROLL,
                            wxDefaultValidator, _T("ID_TREECTRL1"));
  FlexGridSizer15->Add(treeView, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  panTreeView->SetSizer(FlexGridSizer15);
  FlexGridSizer15->Fit(panTreeView);
  FlexGridSizer15->SetSizeHints(panTreeView);
  Panel15 = new wxPanel(Notebook2, ID_PANEL17, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL17"));
  Panel14 = new wxPanel(Notebook2, ID_PANEL16, wxDefaultPosition, wxDefaultSize,
  ...
  FlexGridSizer5->Add(Notebook2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 1);
  Panel8 = new wxPanel(Panel3, ID_PANEL8, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL8"));
  FlexGridSizer8 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer8->AddGrowableCol(0);
  FlexGridSizer8->AddGrowableRow(0);
  BoxSizer3 = new wxBoxSizer(wxHORIZONTAL);
  StaticText5 = new wxStaticText(Panel8, ID_STATICTEXT5, _("Edit the map"),
                                 wxDefaultPosition, wxDefaultSize,
                                 wxALIGN_CENTRE, _T("ID_STATICTEXT5"));
  ...
  BoxSizer3->Add(StaticText5, 1,
                 wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                 5);
  FlexGridSizer8->Add(BoxSizer3, 1,
                      wxALL | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL, 0);
  Panel12 = new wxPanel(Panel8, ID_PANEL14, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL14"));
  FlexGridSizer14 = new wxFlexGridSizer(2, 1, 0, 0);
  FlexGridSizer14->AddGrowableCol(0);
  FlexGridSizer6 = new wxFlexGridSizer(0, 3, 0, 0);
  btnImportArea =
      new wxCustomButton(Panel12, ID_BUTTON7, _("Import area/metric map..."),
  ...
  FlexGridSizer6->Add(btnImportArea, 1, wxALL | wxALIGN_LEFT | wxALIGN_BOTTOM,
                      5);
  FlexGridSizer14->Add(FlexGridSizer6, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  ...
  Panel6 = new wxPanel(SplitterWindow2, ID_PANEL10, wxDefaultPosition,
                       wxSize(100, 100), wxTAB_TRAVERSAL, _T("ID_PANEL10"));
  Panel6->SetMinSize(wxSize(100, 100));
  FlexGridSizer10 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer10->AddGrowableCol(0);
  FlexGridSizer10->AddGrowableRow(1);
  StaticText3 = new wxStaticText(Panel6, ID_STATICTEXT3, _("Global HMT map"),
                                 wxDefaultPosition, wxDefaultSize,
                                 wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
  ...
  FlexGridSizer10->Add(StaticText3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  Panel7 = new wxPanel(Panel6, ID_PANEL11, wxDefaultPosition, wxDefaultSize,
                       wxTAB_TRAVERSAL, _T("ID_PANEL11"));
  FlexGridSizer11 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer11->AddGrowableCol(0);
  FlexGridSizer11->AddGrowableRow(0);
  m_glGlobalHMTMap =
      new CMyGLCanvas(Panel7, ID_XY_GLCANVAS, wxDefaultPosition, wxDefaultSize,
                      wxTAB_TRAVERSAL, _T("ID_XY_GLCANVAS"));
  FlexGridSizer11->Add(m_glGlobalHMTMap, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  Panel7->SetSizer(FlexGridSizer11);
  FlexGridSizer11->Fit(Panel7);
  FlexGridSizer11->SetSizeHints(Panel7);
  FlexGridSizer10->Add(Panel7, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                       0);
  Panel6->SetSizer(FlexGridSizer10);
  FlexGridSizer10->SetSizeHints(Panel6);
  Panel10 = new wxPanel(SplitterWindow2, ID_PANEL12, wxDefaultPosition,
                        wxSize(100, 100), wxTAB_TRAVERSAL, _T("ID_PANEL12"));
  ...
  StaticText4 = new wxStaticText(
      Panel10, ID_STATICTEXT4, _("Selected area local map"), wxDefaultPosition,
  ...
  FlexGridSizer12->Add(StaticText4, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                           wxALIGN_CENTER_VERTICAL,
                       5);
  Panel11 = new wxPanel(Panel10, ID_PANEL13, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL, _T("ID_PANEL13"));
  FlexGridSizer13 = new wxFlexGridSizer(0, 1, 0, 0);
  FlexGridSizer13->AddGrowableCol(0);
  FlexGridSizer13->AddGrowableRow(0);
  m_glLocalArea =
      new CMyGLCanvas(Panel11, ID_CUSTOM1, wxDefaultPosition, wxDefaultSize,
                      wxTAB_TRAVERSAL, _T("ID_CUSTOM1"));
  FlexGridSizer13->Add(m_glLocalArea, 1,
                       wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  Panel11->SetSizer(FlexGridSizer13);
  FlexGridSizer13->Fit(Panel11);
  FlexGridSizer13->SetSizeHints(Panel11);
  FlexGridSizer12->Add(Panel11, 1,
  ...
  FlexGridSizer3->Add(Notebook1, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 1);
  Panel2->SetSizer(FlexGridSizer3);
  FlexGridSizer3->Fit(Panel2);
  FlexGridSizer3->SetSizeHints(Panel2);
  FlexGridSizer1->Add(Panel2, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_BOTTOM, 0);
  SetSizer(FlexGridSizer1);
  MenuBar1 = new wxMenuBar();
  Menu1 = new wxMenu();
  MenuItem3 = new wxMenuItem(Menu1, ID_MENUITEM1, _("Reset HMT map"),
                             wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem3);
  Menu1->AppendSeparator();
  MenuItem4 = new wxMenuItem(Menu1, ID_MENUITEM2, _("Load state..."),
                             wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem4);
  MenuItem5 = new wxMenuItem(Menu1, ID_MENUITEM3, _("Save state..."),
                             wxEmptyString, wxITEM_NORMAL);
  ...
  Menu3 = new wxMenu();
  MenuItem8 = new wxMenuItem(Menu3, ID_MENUITEM6, _("Set parameters"),
                             wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem8);
  Menu3->AppendSeparator();
  MenuItem6 = new wxMenuItem(Menu3, ID_MENUITEM4, _("Start SLAM"),
                             wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem6);
  MenuItem7 = new wxMenuItem(Menu3, ID_MENUITEM5, _("Pause SLAM"),
                             wxEmptyString, wxITEM_NORMAL);
  ...
  Connect(ID_NOTEBOOK2, wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED,
...
void hmt_slam_guiFrame::loadHMTConfigFromSettings() {
  ...
  // From GUI controls:
  cfg.write("HMT-SLAM", "rawlog_file",
...
void hmt_slam_guiFrame::rebuildTreeView() {
  ...
  for (i = 0, it = m_hmtslam->m_map.begin(); it != m_hmtslam->m_map.end();
    ...
    treeView->AppendItem(root, _U(str.c_str()), 0, -1,
...
bool hmt_slam_guiFrame::AskForOpenHMTMap(std::string &fil) {
  ...
  wxString wildcard =
      wxT("HMT-SLAM files (*.hmtslam;*.hmtslam.gz)|*.hmtslam;*.hmtslam.gz|All "
          "files (*.*)|*.*");
