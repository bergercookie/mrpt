...
CDlgCamTracking::CDlgCamTracking(_DSceneViewerFrame *parent, wxWindowID id,
  ...
  Create(parent, id, _("Define camera path"), wxDefaultPosition, wxDefaultSize,
  ...
  btnGrab =
      new wxButton(this, ID_BUTTON4, _("Grab current"), wxDefaultPosition,
  ...
  cbConstVel = new wxCheckBox(this, ID_CHECKBOX1,
                              _("Ignore time, with constant velocity (m/s):"),
  ...
  edVel =
      new wxTextCtrl(this, ID_TEXTCTRL1, _("0.2"), wxDefaultPosition,
  ...
  FlexGridSizer1->Add(FlexGridSizer4, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 0);
  gridPoses = new wxGrid(this, ID_GRID1, wxDefaultPosition, wxDefaultSize, 0,
                         _T("ID_GRID1"));
  gridPoses->CreateGrid(0, 7);
  gridPoses->SetMinSize(wxSize(600, 200));
  FlexGridSizer1->Add(gridPoses, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer3 = new wxFlexGridSizer(0, 3, 0, 0);
  btnClose =
      new wxButton(this, ID_BUTTON1, _("Close"), wxDefaultPosition,
                   wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
  FlexGridSizer3->Add(btnClose, 1, wxALL | wxALIGN_LEFT | wxALIGN_TOP, 5);
  FlexGridSizer1->Add(FlexGridSizer3, 1, wxALL | wxALIGN_RIGHT | wxALIGN_TOP,
                      0);
  SetSizer(FlexGridSizer1);
  MenuItem1 = new wxMenuItem((&menuGrid), ID_MENUITEM1, _("Delete entry"),
...
void CDlgCamTracking::OnbtnGrabClick(wxCommandEvent &event) {
  ...
  CPose3D p;
  m_main_win->m_canvas->m_openGLScene->getViewport("main")
...
void CDlgCamTracking::UpdateTableFromPoses() {
  ...
  for (CPose3DInterpolator::const_iterator it = m_poses.begin();
    ...
    gridPoses->SetCellValue(i, 5,
                            wxString::Format(wxT("%f"), RAD2DEG(p.pitch)));
