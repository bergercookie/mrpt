	...
	wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size)
{
	...
	Create(
		parent, wxID_ANY, _("Options"), wxDefaultPosition, wxDefaultSize,
		wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	FlexGridSizer1 = new wxFlexGridSizer(2, 1, 0, 0);
	FlexGridSizer1->AddGrowableCol(0);
	FlexGridSizer1->AddGrowableRow(0);
	Notebook1 = new wxNotebook(
		this, ID_NOTEBOOK1, wxDefaultPosition, wxSize(415, 251), 0,
		_T("ID_NOTEBOOK1"));
	Panel1 = new wxPanel(
	...
	cbViewFileName = new wxCheckBox(
		Panel1, ID_CHECKBOX1, _("View file name overlapped to viewport"),
	...
	StaticText6 = new wxStaticText(
		Panel3, ID_STATICTEXT6, _("X"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT6"));
	FlexGridSizer6->Add(StaticText6, 1, wxALL | wxEXPAND, 5);
	SpinCtrl1 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL2, _T("0"), wxDefaultPosition, wxSize(94, 21), 0,
		-100, 100, 0, _T("ID_SPINCTRL2"));
	SpinCtrl1->SetValue(_T("0"));
	FlexGridSizer6->Add(SpinCtrl1, 1, wxALL | wxEXPAND, 5);
	StaticText3 = new wxStaticText(
		Panel3, ID_STATICTEXT3, _("Y"), wxDefaultPosition, wxDefaultSize, 0,
		_T("ID_STATICTEXT3"));
	FlexGridSizer6->Add(StaticText3, 1, wxALL | wxEXPAND, 5);
	SpinCtrl2 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL3, _T("0"), wxDefaultPosition, wxSize(93, 21), 0,
		-100, 100, 0, _T("ID_SPINCTRL3"));
	SpinCtrl2->SetValue(_T("0"));
	FlexGridSizer6->Add(SpinCtrl2, 1, wxALL | wxEXPAND, 5);
	StaticText7 = new wxStaticText(
		Panel3, ID_STATICTEXT7, _("Z"), wxDefaultPosition, wxSize(16, 21), 0,
		_T("ID_STATICTEXT7"));
	FlexGridSizer6->Add(StaticText7, 1, wxALL | wxEXPAND, 5);
	SpinCtrl3 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL4, _T("0"), wxDefaultPosition, wxSize(64, 21), 0,
		-100, 100, 0, _T("ID_SPINCTRL4"));
	...
	StaticText2 = new wxStaticText(
		Panel3, ID_STATICTEXT2, _("Zoom distance"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	FlexGridSizer7->Add(StaticText2, 1, wxALL | wxEXPAND, 5);
	SpinCtrl5 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL6, _T("10"), wxDefaultPosition, wxSize(100, 21), 0,
		-100, 100, 10, _T("ID_SPINCTRL6"));
	SpinCtrl5->SetValue(_T("10"));
	FlexGridSizer7->Add(SpinCtrl5, 1, wxALL | wxEXPAND, 5);
	StaticText5 = new wxStaticText(
		Panel3, ID_STATICTEXT5, _("Elevation degrees"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT5"));
	FlexGridSizer7->Add(StaticText5, 1, wxALL | wxEXPAND, 5);
	SpinCtrl7 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL8, _T("35"), wxDefaultPosition, wxSize(47, 21), 0, 0,
		359, 35, _T("ID_SPINCTRL8"));
	SpinCtrl7->SetValue(_T("35"));
	FlexGridSizer7->Add(SpinCtrl7, 1, wxALL | wxEXPAND, 5);
	StaticText4 = new wxStaticText(
		Panel3, ID_STATICTEXT4, _("Azimuth degrees"), wxDefaultPosition,
		wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer7->Add(StaticText4, 1, wxALL | wxEXPAND, 5);
	SpinCtrl4 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL5, _T("45"), wxDefaultPosition, wxSize(47, 21), 0, 0,
		359, 45, _T("ID_SPINCTRL5"));
	...
	StaticBoxSizer2 = new wxStaticBoxSizer(
		wxHORIZONTAL, Panel3, _("Azimuth offset (degrees)"));
	...
	StaticText10 = new wxStaticText(
		Panel3, ID_STATICTEXT10, _("-"), wxDefaultPosition, wxSize(15, 21),
		wxALIGN_RIGHT, _T("ID_STATICTEXT10"));
	FlexGridSizer8->Add(StaticText10, 1, wxALL | wxEXPAND, 5);
	SpinCtrl9 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL10, _T("45"), wxDefaultPosition, wxSize(70, 21), 0,
		0, 180, 45, _T("ID_SPINCTRL10"));
	SpinCtrl9->SetValue(_T("45"));
	FlexGridSizer8->Add(SpinCtrl9, 1, wxALL | wxEXPAND, 5);
	StaticText11 = new wxStaticText(
		Panel3, ID_STATICTEXT11, _("step"), wxDefaultPosition, wxSize(30, 21),
		wxALIGN_RIGHT, _T("ID_STATICTEXT11"));
	FlexGridSizer8->Add(StaticText11, 1, wxALL | wxEXPAND, 5);
	SpinCtrl8 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL9, _T("5"), wxDefaultPosition, wxSize(70, 21), 0, 0,
		10, 5, _T("ID_SPINCTRL9"));
	SpinCtrl8->SetValue(_T("5"));
	FlexGridSizer8->Add(SpinCtrl8, 1, wxALL | wxEXPAND, 5);
	StaticText8 = new wxStaticText(
		Panel3, ID_STATICTEXT8, _("/10"), wxDefaultPosition, wxSize(22, 21),
		wxALIGN_LEFT, _T("ID_STATICTEXT8"));
	FlexGridSizer8->Add(StaticText8, 1, wxALL | wxEXPAND, 5);
	StaticText9 = new wxStaticText(
		Panel3, ID_STATICTEXT9, _("+"), wxDefaultPosition, wxSize(15, 21),
		wxALIGN_RIGHT, _T("ID_STATICTEXT9"));
	FlexGridSizer8->Add(StaticText9, 1, wxALL | wxEXPAND, 5);
	SpinCtrl6 = new wxSpinCtrl(
		Panel3, ID_SPINCTRL7, _T("45"), wxDefaultPosition, wxSize(70, 21), 0, 0,
		180, 45, _T("ID_SPINCTRL7"));
