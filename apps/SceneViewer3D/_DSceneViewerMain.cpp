...
void CMyGLCanvas::OnPostRenderSwapBuffers(double At, wxPaintDC &dc) {
  ...
  if (isCapturing) {
    ...
    string fileName(
        format("%s/screenshot_%07i.png", capturingDir.c_str(), captureCount++));
  ...
  string str =
      format("Center=(%.02f,%.02f,%.02f) Zoom:%.02f AZ=%.02f deg EL:%.02f deg",
             cameraPointingX, cameraPointingY, cameraPointingZ,
             cameraZoomDistance, cameraAzimuthDeg, cameraElevationDeg);
...
// Load my custom icons:
  ...
  Create(parent, id, _("3DSceneViewer - Part of the MRPT project"),
  ...
  FlexGridSizer2->Add(btnNew, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  ...
  FlexGridSizer2->Add(btnToolbarOpen, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  StaticLine1 =
      new wxStaticLine(this, ID_STATICLINE1, wxDefaultPosition, wxSize(50, -1),
                       wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
  FlexGridSizer2->Add(StaticLine1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
  ...
  FlexGridSizer2->Add(btnPrev, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  ...
  FlexGridSizer2->Add(btnNext, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  btnReload = new wxCustomButton(
      this, ID_BUTTON5, _("  Reload  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_REDO")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer2->Add(btnReload, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      wxDLG_UNIT(this, wxSize(1, 0)).GetWidth());
  StaticLine2 =
      new wxStaticLine(this, ID_STATICLINE2, wxDefaultPosition, wxSize(50, -1),
                       wxLI_HORIZONTAL, _T("ID_STATICLINE2"));
  FlexGridSizer2->Add(StaticLine2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      2);
  btnOptions = new wxCustomButton(
      this, ID_BUTTON6, _("  Options  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_FIND")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer2->Add(btnOptions, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  ...
  FlexGridSizer2->Add(btnAutoplay, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  btnCapture = new wxCustomButton(
      this, ID_BUTTON9, _("  Capture  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_HARDDISK")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_TOGGLE | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer2->Add(btnCapture, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  StaticLine3 =
      new wxStaticLine(this, ID_STATICLINE3, wxDefaultPosition, wxSize(50, -1),
                       wxLI_HORIZONTAL, _T("ID_STATICLINE3"));
  FlexGridSizer2->Add(StaticLine3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL |
                                          wxALIGN_CENTER_VERTICAL,
                      2);
  ...
  FlexGridSizer2->Add(btnAbout, 1,
                      wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP, 1);
  btnQuit = new wxCustomButton(
      this, ID_BUTTON11, _("  Quit  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_QUIT")),
                               wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM,
  ...
  FlexGridSizer2->Add(btnQuit, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_TOP,
                      1);
  ...
  Menu1 = new wxMenu();
  MenuItem3 = new wxMenuItem(Menu1, ID_MENUITEM1, _("New scene"), wxEmptyString,
                             wxITEM_NORMAL);
  Menu1->Append(MenuItem3);
  MenuItem4 = new wxMenuItem(Menu1, ID_MENUITEM2, _("Open..."), wxEmptyString,
                             wxITEM_NORMAL);
  Menu1->Append(MenuItem4);
  MenuItem7 = new wxMenuItem(Menu1, ID_MENUITEM5, _("Reload file\tF5"),
                             wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem7);
  MenuItem9 = new wxMenuItem(Menu1, ID_MENUITEM7, _("Save..."), wxEmptyString,
                             wxITEM_NORMAL);
  Menu1->Append(MenuItem9);
  Menu1->AppendSeparator();
  MenuItem18 = new wxMenu();
  MenuItem8 = new wxMenuItem(MenuItem18, ID_MENUITEM6,
                             _("a 3D model (any Assimp format)..."),
                             wxEmptyString, wxITEM_NORMAL);
  MenuItem18->Append(MenuItem8);
  MenuItem19 =
      new wxMenuItem(MenuItem18, ID_MENUITEM20, _("a PLY point cloud..."),
                     wxEmptyString, wxITEM_NORMAL);
  MenuItem18->Append(MenuItem19);
  mnuImportLAS =
      new wxMenuItem(MenuItem18, ID_MENUITEM25, _("a LAS LiDAR file..."),
                     wxEmptyString, wxITEM_NORMAL);
  MenuItem18->Append(mnuImportLAS);
  Menu1->Append(ID_MENUITEM19, _("Import"), MenuItem18, wxEmptyString);
  MenuItem20 = new wxMenu();
  MenuItem21 = new wxMenuItem(MenuItem20, ID_MENUITEM22,
                              _("point clouds to PLY file..."), wxEmptyString,
                              wxITEM_NORMAL);
  MenuItem20->Append(MenuItem21);
  Menu1->Append(ID_MENUITEM21, _("Export"), MenuItem20, wxEmptyString);
  Menu1->AppendSeparator();
  MenuItem23 = new wxMenuItem(Menu1, ID_MENUITEM29, _("Previous file\tF7"),
                              wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem23);
  MenuItem24 = new wxMenuItem(Menu1, ID_MENUITEM30, _("Next file\tF8"),
                              wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem24);
  Menu1->AppendSeparator();
  MenuItem14 = new wxMenuItem(Menu1, ID_MENUITEM12, _("Take snapshot...\tF2"),
                              _("Saves the current window image to a file"),
                              wxITEM_NORMAL);
  Menu1->Append(MenuItem14);
  MenuItem22 = new wxMenuItem(Menu1, ID_MENUITEM23,
                              _("High-resolution render to file..."),
                              wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem22);
  mnuSceneStats = new wxMenuItem(Menu1, ID_MENUITEM18, _("Scene stats"),
                                 wxEmptyString, wxITEM_NORMAL);
  ...
  Menu4 = new wxMenu();
  mnuSelectNone = new wxMenuItem(Menu4, ID_MENUITEM24, _("Select none"),
                                 wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectNone);
  mnuSelectByClass =
      new wxMenuItem(Menu4, ID_MENUITEM26, _("Select by class..."),
                     wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectByClass);
  Menu4->AppendSeparator();
  mnuSelectionScale =
      new wxMenuItem(Menu4, ID_MENUITEM27, _("Re-scale selected..."),
                     wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectionScale);
  mnuSelectionDelete = new wxMenuItem(
      Menu4, ID_MENUITEM28, _("Delete selected"), wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectionDelete);
  MenuBar1->Append(Menu4, _("&Edit"));
  Menu3 = new wxMenu();
  MenuItem6 = new wxMenuItem(Menu3, ID_MENUITEM4, _("Background color..."),
                             wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem6);
  MenuItem5 = new wxMenuItem(Menu3, ID_MENUITEM3, _("Options..."),
                             wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem5);
  Menu3->AppendSeparator();
  MenuItem17 = new wxMenu();
  mnuItemShowCloudOctrees =
      new wxMenuItem(MenuItem17, ID_MENUITEM15, _("Show/hide bounding boxes"),
  ...
  Menu3->Append(ID_MENUITEM16, _("Point clouds octrees..."), MenuItem17,
                wxEmptyString);
  Menu3->AppendSeparator();
  MenuItem13 = new wxMenuItem(Menu3, ID_MENUITEM11, _("Delete all objects"),
                              wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem13);
  MenuItem11 = new wxMenu();
  MenuItem12 = new wxMenuItem(MenuItem11, ID_MENUITEM9, _("Simple robot model"),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem11->Append(MenuItem12);
  Menu3->Append(ID_MENUITEM8, _("Insert stock object"), MenuItem11,
                wxEmptyString);
  Menu3->AppendSeparator();
  MenuItem15 = new wxMenu();
  MenuItem10 = new wxMenuItem(MenuItem15, ID_MENUITEM10, _("Circular"),
                              wxEmptyString, wxITEM_NORMAL);
  MenuItem15->Append(MenuItem10);
  MenuItem16 = new wxMenuItem(MenuItem15, ID_MENUITEM14, _("Arbitrary path..."),
                              wxEmptyString, wxITEM_NORMAL);
  ...
  Connect(ID_BUTTON7, wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
          (wxObjectEventFunction)&_DSceneViewerFrame::OnbtnOrthoClicked);
  Connect(ID_BUTTON8, wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
          (wxObjectEventFunction)&_DSceneViewerFrame::OnbtnAutoplayClicked);
  Connect(ID_BUTTON9, wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
  ...
  Connect(
      ...
      (wxObjectEventFunction)&_DSceneViewerFrame::OnmnuSelectionScaleSelected);
  Connect(
      ID_MENUITEM28, wxEVT_COMMAND_MENU_SELECTED,
      (wxObjectEventFunction)&_DSceneViewerFrame::OnmnuSelectionDeleteSelected);
  ...
  Connect(ID_TIMER_AUTOPLAY, wxEVT_TIMER,
          (wxObjectEventFunction)&_DSceneViewerFrame::OntimAutoplay);
  Connect(ID_TRAVELLING_TIMER, wxEVT_TIMER,
...
void _DSceneViewerFrame::loadFromFile(const std::string &fil,
                                      bool isInASequence) {
  try {
    // Save the path
    ...
    if (m_canvas->m_openGLScene->viewportsCount() == 0 ||
      ...
      wxMessageBox(_("File is empty or format unrecognized."), _("Warning"),
                   wxOK, this);
...
void _DSceneViewerFrame::OnMenuBackColor(wxCommandEvent &event) {
  ...
  wxColour color;
  color.Set((int)(255 * m_canvas->clearColorR),
            (int)(255 * m_canvas->clearColorG),
  ...
  try {
    ...
    wxString wildcard =
        wxT("3D models (All Assimp "
            "formats)|*.dae;*.blend;*.3ds;*.ase;*.obj;*.ifc;*.xgl;.zgl;*.ply;*."
            "dxf;.lwo;*.lws;*.lxo;*.stl;*.x;*.ac;*.ms3d;*.cob;.scn;*.bvh;*.csm;"
            "*.xml;*.irrmesh;*.irr;*.mdl;*.md2;*.md3;*.pk3;*.mdc;*.md5*;*.smd;."
            "vta;*.m3;*.3d;*.b3d;*.q3d;*.q3s;*.nff;*.nff;*.off;*.raw;*.ter;*."
            "mdl;*.hmp;*.ndo;|All files (*.*)|*.*");
    wxString defaultDir(
        _U(iniFile->read_string(iniFileSect, "LastDir", ".").c_str()));
    wxString defaultFilename = wxT("");
    ...
    obj3D->loadScene(fil);
    obj3D->setPose(
        mrpt::math::TPose3D(0, 0, 0, DEG2RAD(.0), DEG2RAD(0.), DEG2RAD(90.0)));
  ...
  try {
    if ((m_canvas->m_openGLScene->viewportsCount() == 0) ||
      ...
      if (m_travelling_is_arbitrary) {
        ...
        // ===============================
        double step = atof(
            iniFile->read_string("Spherical travelling", "Step", "5").c_str());
...
void _DSceneViewerFrame::OnStartCameraTravelling(wxCommandEvent &event) {
  try {
    if ((m_canvas->m_openGLScene->viewportsCount() == 0) ||
      ...
      double target_x =
          atof(iniFile->read_string("Spherical travelling", "X", "0").c_str());
      double target_y =
          atof(iniFile->read_string("Spherical travelling", "Y", "0").c_str());
      double target_z =
          atof(iniFile->read_string("Spherical travelling", "Z", "0").c_str());

      double zoom = atof(
          iniFile->read_string("Spherical travelling", "Zoom distance", "25")
              .c_str());
      double elevation = atof(
          iniFile
              ->read_string("Spherical travelling", "Elevation degrees", "15")
              .c_str());
      double azimuth = atof(
          iniFile->read_string("Spherical travelling", "Azimuth degrees", "90")
              .c_str());

      double min_value =
          atof(iniFile->read_string("Spherical travelling", "Min value", "90")
                   .c_str());
      double max_value =
          atof(iniFile->read_string("Spherical travelling", "Max value", "90")
                   .c_str());
...
void _DSceneViewerFrame::OnmnuSceneStatsSelected(wxCommandEvent &event) {
  try {
    ...
    ss << "Number of objects: " << sceneStats.nObjects << endl
       << format("Overall points (in point clouds): %e",
                 double(sceneStats.nPoints))
       << endl
       << "Total octree nodes   (in point clouds): " << sceneStats.nOctreeTotal
       << endl
...
void _DSceneViewerFrame::OnMenuItemImportPLYPointCloud(wxCommandEvent &event) {
  try {
    ...
    if (!res) {
      wxMessageBox(_("Error loading or parsing the PLY file"), _("Exception"),
                   wxOK, this);
    } else {
      ...
      if (dlgPLY.cbXYGrid->GetValue()) {
        mrpt::opengl::CGridPlaneXY::Ptr obj =
            std::make_shared<mrpt::opengl::CGridPlaneXY>(-50, 50, -50, 50, 0,
                                                         1);
        obj->setColor(0.3, 0.3, 0.3);
        m_canvas->m_openGLScene->insert(obj);
      }
      ...
      if (gl_points_col)
        gl_points_col->setPointSize(ptSize);
      ...
      if (gl_points_col)
        m_canvas->m_openGLScene->insert(gl_points_col);
      ...
      wxMessageBox(_U(format("Comments:\n--------------------\n%s\nObject "
                             "info:\n--------------------\n%s",
...
void _DSceneViewerFrame::OnMenuItemExportPointsPLY(wxCommandEvent &event) {
  try {
    wxMessageBox(_("Each point cloud object in the scene will be exported as a "
                   "separate PLY file."),
                 _("Notice"));
    ...
    wxMessageBox(wxString::Format(_("%u point cloud(s) exported to PLY files."),
                                  counter),
                 _("Result"));
...
void _DSceneViewerFrame::OnMenuItemHighResRender(wxCommandEvent &event) {
  try {
...

    {
      ...
      // It seems wxGetNumberFromUser() leads to a crash with wxGTK (tested with
      // wx2.8.11)
      // So use wxGetTextFromUser() instead
      wxString ssW = wxGetTextFromUser(_("Render image size"),
                                       _("Width in pixels:"), _("1024"), this);
      std::string sW = std::string(ssW.mb_str());
      const long width = atoi(sW.c_str());

      wxString ssH = wxGetTextFromUser(_("Render image size"),
                                       _("Height in pixels:"), _("768"), this);
      ...
      render.setBackgroundColor(mrpt::utils::TColorf(m_canvas->clearColorR,
                                                     m_canvas->clearColorG,
...
void _DSceneViewerFrame::OnmnuSelectByClassSelected(wxCommandEvent &event) {
...
#if wxCHECK_VERSION(2, 9, 0)
  wxGetSelectedChoices(selections, _("Select by class:"), _("Select objects"),
                       glClassNames, this);
#else
  wxGetMultipleChoices(selections, _("Select by class:"), _("Select objects"),
                       glClassNames, this);
#endif
  ...
  theWindow->StatusBar1->SetStatusText(
      _U(mrpt::format("%u objects selected",
...
void _DSceneViewerFrame::OnmnuSelectionScaleSelected(wxCommandEvent &event) {
  wxString ssScale = wxGetTextFromUser(_("Multiply scale of selected objects"),
                                       _("Scale factor:"), _("1.0"), this);
...
void _DSceneViewerFrame::OnmnuImportLASSelected(wxCommandEvent &event) {
  try {
    ...
    wxFileDialog dialog(
        ...
        _U(iniFile->read_string(iniFileSect, "LastDir", ".").c_str()),
        _("*.las"), _("LAS files (*.las, *.laz)|*.las;*.LAS;*.laz;*.LAZ|All "
                      "files (*.*)|*.*"),
        wxFD_OPEN | wxFD_FILE_MUST_EXIST);
    ...
    if (!res) {
      wxMessageBox(_("Error loading or parsing the LAS file"), _("Exception"),
                   wxOK, this);
      return;
    }
    ...
    if (dlgPLY.cbXYGrid->GetValue()) {
      mrpt::opengl::CGridPlaneXY::Ptr obj =
          std::make_shared<mrpt::opengl::CGridPlaneXY>(
              bb_min.x, bb_max.x, bb_min.y, bb_max.y, 0, scene_size * 0.02);
      obj->setColor(0.3, 0.3, 0.3);
      m_canvas->m_openGLScene->insert(obj);
    }
