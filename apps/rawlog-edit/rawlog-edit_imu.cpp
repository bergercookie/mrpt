...
DECLARE_OP_FUNCTION(op_export_imu_txt) {
  ...
  public:
    ...
    CRawlogProcessor_ExportIMU_TXT(CFileGZInputStream &in_rawlog,
    ...
    bool processOneObservation(CObservation::Ptr &o) {
      ...
      if (it == lstFiles.end()) // A new file for this sensorlabel??
      {
        ...
        ::fprintf(f_this,
                  ...
                  "IMU_Z_VEL", "IMU_YAW", "IMU_PITCH", "IMU_ROLL", "IMU_X",
                  "IMU_Y", "IMU_Z", "MAG_X", "MAG_Y", "MAG_Z", "PRESS",
