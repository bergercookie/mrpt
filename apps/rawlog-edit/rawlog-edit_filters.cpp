...
DECLARE_OP_FUNCTION(op_remove_label) {
  ...
  public:
    CRawlogProcessor_RemoveLabel(mrpt::utils::CFileGZInputStream &in_rawlog,
  ...
  CRawlogProcessor_RemoveLabel proc(in_rawlog, cmdline, verbose,
                                    outrawlog.out_rawlog, filter_label);
...
DECLARE_OP_FUNCTION(op_keep_label) {
  ...
  public:
    CRawlogProcessor_KeepLabel(mrpt::utils::CFileGZInputStream &in_rawlog,
                               TCLAP::CmdLine &cmdline, bool verbose,
                               CFileGZOutputStream &out_rawlog,
                               const std::string &filter_label)
        : CRawlogProcessorFilterObservations(in_rawlog, cmdline, verbose,
  ...
  TOutputRawlogCreator outrawlog;
  CRawlogProcessor_KeepLabel proc(in_rawlog, cmdline, verbose,
                                  outrawlog.out_rawlog, filter_label);
  proc.doProcessRawlog();
