...
DECLARE_OP_FUNCTION(op_export_gps_gas_kml) {
  ...
  public:
    CRawlogProcessor_ExportGPSGAS_KML(CFileGZInputStream &in_rawlog,
    ...
    bool processOneObservation(CObservation::Ptr &o) {
      if (IS_CLASS(o, CObservationGPS)) {
        ...
        // obsGas->m_readings[0].readingsVoltage.size() << " elements." << endl;
    ...
    void generate_KML() {
      ...
      for (map<string, TDataPerGPSGAS>::const_iterator it = m_gps_paths.begin();
        ...
        for (map<TTimeStamp, TGPSGASDataPoint>::const_iterator
          ...
          float r, g, b;
          jet2rgb((d.color - minGasValue) / (maxGasValue - minGasValue), r, g,
                  b);
