...
void TestLeastSquares() {
  ...
  /**
   * for convenience, first initialize the data as C arrays and then define
   * std;:vectors from
   * that data
   *
   * loadVector
   ...
   * refer to
   * http://reference.mrpt.org/stable/group__container__ops__grp.html#ga40e8e47dea9f504a28d2a70ea8ddb158
   */
