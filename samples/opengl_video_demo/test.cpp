...
void TestOpenGLVideo() {
  ...
  // Create 3D window:
  CDisplayWindow3D win("Demo of video textures with MRPT's OpenGL objects", 640,
                       480);
  ...
  opengl::CTexturedPlane::Ptr gl_plane1 =
      std::make_shared<opengl::CTexturedPlane>(0, 1, 0,
                                               0.75); // 4/3 aspect ratio
  opengl::CTexturedPlane::Ptr gl_plane2 =
      std::make_shared<opengl::CTexturedPlane>(0, 1, 0, 0.75);
