...
//=================================================================================================
//
// This example illustrates how points closer than a RGBD camera threshold (0.3
// - 0.5 m typically)
// can be detected with these cameras. This method finds pixels with a very high
// value in the
// infrared image and, therefore, it will fail if an external source of infrared
// light (sun) affects
// the camera...
//
// =================================================================================================
...
int main(int argc, char **argv) {
  ...
  //						Uncomment this to see the video modes
  //available
  //========================================================================================
  // Infrared modes
  // openni::VideoMode vm;
  ...
  opengl::CGridPlaneXY::Ptr grid =
      std::make_shared<opengl::CGridPlaneXY>(-4, 4, -4, 4, 0);
  scene->insert(grid);
  ...
  //					Grab frames continuously and show saturated
  //pixels
  //========================================================================================
