...
int main(int argc, char **argv) {
  try {
    ...
    ////  #if MRPT_HAS_CXX11
    ////		typedef std::unique_ptr<COpenNI2_RGBD360> COpenNI2Ptr;  // This
    ///assures automatic destruction
    ////  #else
    ////		typedef std::auto_ptr<COpenNI2_RGBD360> COpenNI2Ptr;  // This assures
    ...
    //    rgbd360.loadConfig_sensorSpecific(const mrpt::utils::CConfigFileBase
    //    &configSource,	const std::string	 &iniSection );
    ...
    //
    //    opengl::COpenGLViewport::Ptr viewInt; // Extra viewports for the RGB
    //    images.
    //    {
    ...
    //          "_fast" since the intensity image may be needed later on.
    //        }
    //        win3D.unlockAccess3DScene();
    //
    //        // -------------------------------------------------------
    ...
    //  #if 1
    //          win3D.get3DSceneAndLock();
    //            newObs->project3DPointsFromDepthImageInto(*gl_points, false /*
    //            without obs.sensorPose */);
    //          win3D.unlockAccess3DScene();
    //  #endif
    //        }
