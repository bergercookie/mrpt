...
const std::string myTestFile(MRPT_EXAMPLES_BASE_DIRECTORY +
                             std::string("imageBasics/frame_color.jpg"));
...
void TextureSizes_test() {
  ...
  if (1) {
    opengl::CTexturedPlane::Ptr obj =
        std::make_shared<opengl::CTexturedPlane>(-3, 3, -3, 3);
  ...
  if (1) {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("B/W texture, random size, w/o transp");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  if (1) {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("Color texture, 2^N size, w/o transp");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  if (1) {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("Color texture, 2^N size, with transp");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  if (1) {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("B/W texture, 2^N size, w/o transp");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  if (1) {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("B/W texture, 2^N size, with transp");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
