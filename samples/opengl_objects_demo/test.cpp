...
void TestOpenGLObjects()
{
	 ...
	 */
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CGridPlaneXY");
	...
	// XZ Grid
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CGridPlaneXZ");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// Cylinder
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CCylinder");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	{
		{
			opengl::CDisk::Ptr obj =
				std::make_shared<opengl::CDisk>(2.0f, 1.8f, 50);
			obj->setLocation(off_x, 0, 0);
		...
		{
			opengl::CDisk::Ptr obj =
				std::make_shared<opengl::CDisk>(2.0f, 0, 50);
	...
	// CEllipsoid
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CEllipsoid");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// CPointCloud
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CPointCloud");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// CPolyhedron
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CPolyhedron");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// CColorMap
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CColorBar");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// CSetOfLines
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CSetOfLines");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// CSimpleLine
	{
		...
		opengl::CText::Ptr gl_txt =
			std::make_shared<opengl::CText>("CSimpleLine");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
	off_x += STEP_X;
	...
	// stock_objects::Househam_Sprayer
	{
		...
		opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>(
			"stock_objects::Househam_Sprayer()");
		gl_txt->setLocation(off_x, off_y_label, 0);
		theScene->insert(gl_txt);
	}
