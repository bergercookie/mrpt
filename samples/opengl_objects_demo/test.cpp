...
void TestOpenGLObjects() {
   ...
   */
  {
    ...
    opengl::CGridPlaneXY::Ptr obj =
        std::make_shared<opengl::CGridPlaneXY>(-7, 7, -7, 7, 0, 1);
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CGridPlaneXY");
  ...
  // XZ Grid
  {
    opengl::CGridPlaneXZ::Ptr obj =
        std::make_shared<opengl::CGridPlaneXZ>(-7, 7, -7, 7, 0, 1);
    obj->setColor(0.7, 0.7, 0.7);
    obj->setLocation(off_x, 0, 0);
    theScene->insert(obj);

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CGridPlaneXZ");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // Arrow
  {
    opengl::CArrow::Ptr obj = std::make_shared<opengl::CArrow>(
        0, 0, 0, 3, 0, 0, 0.2f, 0.1f, 0.2f, 0, 0, 0);
    obj->setLocation(off_x, 0, 0);
    obj->setColor(1, 0, 0);
    theScene->insert(obj);

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CArrow");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // Axis
  {
    opengl::CAxis::Ptr obj =
        std::make_shared<opengl::CAxis>(-6, -6, -6, 6, 6, 6, 2, 2, true);
    obj->setLocation(off_x, 0, 0);
    theScene->insert(obj);

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CAxis");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // Box
  {
    ...
    opengl::CBox::Ptr obj2 = std::make_shared<opengl::CBox>(
        TPoint3D(0, 0, 0), TPoint3D(1, 1, 1), false);
    obj2->setLocation(off_x, 4, 0);
    theScene->insert(obj2);

    opengl::CBox::Ptr obj3 = std::make_shared<opengl::CBox>(
        TPoint3D(0, 0, 0), TPoint3D(1, 1, 1), false);
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CBox");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // Frustum
  {
    opengl::CFrustum::Ptr obj =
        std::make_shared<opengl::CFrustum>(1, 5, 60, 45, 1.5f, true, false);
    obj->setLocation(off_x, 0, 0);
    theScene->insert(obj);

    opengl::CFrustum::Ptr obj2 =
        std::make_shared<opengl::CFrustum>(1, 5, 60, 45, 2.5f, true, true);
    obj2->setLocation(off_x, 6, 0);
    theScene->insert(obj2);

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CFrustum");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // Cylinder
  {
    opengl::CCylinder::Ptr obj =
        std::make_shared<opengl::CCylinder>(2, 2, 4, 20, 10);
    obj->setLocation(off_x, 0, 0);
    obj->setColor(0, 0, 0.8);
    theScene->insert(obj);

    opengl::CCylinder::Ptr obj2 =
        std::make_shared<opengl::CCylinder>(2, 1, 4, 20, 10);
    obj2->setLocation(off_x, 6, 0);
    obj2->setColor(0, 0, 0.8);
    theScene->insert(obj2);

    opengl::CCylinder::Ptr obj3 =
        std::make_shared<opengl::CCylinder>(2, 0, 4, 20, 10);
    obj3->setLocation(off_x, -6, 0);
    obj3->setColor(0, 0, 0.8);
    theScene->insert(obj3);

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CCylinder");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CDisk::Ptr obj = std::make_shared<opengl::CDisk>(2.0f, 1.8f, 50);
      obj->setLocation(off_x, 0, 0);
    ...
    {
      opengl::CDisk::Ptr obj = std::make_shared<opengl::CDisk>(2.0f, 0, 50);
      obj->setLocation(off_x, 5, 0);
      obj->setColor(0.8, 0, 0);
      theScene->insert(obj);
    }

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CDisk");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // CEllipsoid
  {
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CEllipsoid");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  { // (range,bearing) -> (x,y)
...

    {
      opengl::CEllipsoidRangeBearing2D::Ptr obj =
          std::make_shared<opengl::CEllipsoidRangeBearing2D>();
  ...
  { // (range,bearing) -> (x,y)
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("CEllipsoidRangeBearing2D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  { // (inv_range,yaw) -> (x,y)
    ...
    const double cov_params_dat[] = {square(rho_std), 0, 0, square(DEG2RAD(2))};
...

    {
      opengl::CEllipsoidInverseDepth2D::Ptr obj =
          std::make_shared<opengl::CEllipsoidInverseDepth2D>();
      obj->setCovMatrixAndMean(cov_params, mean_params);
      obj->setLocation(off_x, 6, 0);
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("CEllipsoidInverseDepth2D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  { // (inv_range,yaw,pitch) -> (x,y,z)
...

    {
      opengl::CEllipsoidInverseDepth3D::Ptr obj =
          std::make_shared<opengl::CEllipsoidInverseDepth3D>();
      obj->setCovMatrixAndMean(cov_params, mean_params);
      obj->setLocation(off_x, 0, 0);
      obj->setQuantiles(3.f);
      // obj->setNumberOfSegments(50);
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("CEllipsoidInverseDepth3D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // CMesh
  {
    opengl::CMesh::Ptr obj = std::make_shared<opengl::CMesh>();
    obj->setLocation(off_x, 0, 0);
    ...
    for (size_t i = 0; i < size(Zs, 1); i++)
      for (size_t j = 0; j < size(Zs, 2); j++) {
        ...
        double y = j * 0.25;
        Zs(i, j) =
            4 * cos((x + y) * 0.6) + sin((x - 0.5) * (y + 1.2) * 0.3) * 3;
      }
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CMesh");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // CMesh3D
  {
    opengl::CMesh3D::Ptr obj = std::make_shared<opengl::CMesh3D>();
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CMesh3D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // CPointCloud
  {
    ...
    for (int i = 0; i < 100000; i++)
      obj->insertPoint(mrpt::random::randomGenerator.drawUniform(-5, 5),
                       mrpt::random::randomGenerator.drawUniform(-5, 5),
                       mrpt::random::randomGenerator.drawUniform(-5, 5));

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CPointCloud");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // CPointCloudColoured
  {
    ...
    for (int i = 0; i < 200; i++)
      obj->push_back(mrpt::random::randomGenerator.drawUniform(-5, 5),
                     mrpt::random::randomGenerator.drawUniform(-5, 5),
                     mrpt::random::randomGenerator.drawUniform(-5, 5),
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("CPointCloudColoured");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // CPolyhedron
  {
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CPolyhedron");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CSphere::Ptr obj = std::make_shared<opengl::CSphere>(3.0);
      obj->setLocation(off_x, 0, 0);
      theScene->insert(obj);
    }

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CSphere");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CText::Ptr obj = std::make_shared<opengl::CText>(
          "This is a CText example! My size is invariant to eye-distance");
      obj->setLocation(off_x, 0, 0);
      theScene->insert(obj);
    }

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CText");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CText3D::Ptr obj =
          std::make_shared<opengl::CText3D>("I'm a cool CText3D!");
      obj->setLocation(off_x, 0, 0);
      theScene->insert(obj);
    }

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CText3D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CColorBar::Ptr obj = std::make_shared<opengl::CColorBar>(
          mrpt::utils::cmHOT, 0.2, 1.0, 0.0, 1.0, -50.0, 100.0, "%7.02f m/s");
      obj->setLocation(off_x, 0, 0);
      theScene->insert(obj);
    }

    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CColorBar");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CSetOfLines::Ptr obj = std::make_shared<opengl::CSetOfLines>();
      obj->setLocation(off_x, 0, 0);

      for (int i = 0; i < 15; i++)
        obj->appendLine(mrpt::random::randomGenerator.drawUniform(-5, 5),
                        mrpt::random::randomGenerator.drawUniform(-5, 5),
                        mrpt::random::randomGenerator.drawUniform(-5, 5),
                        mrpt::random::randomGenerator.drawUniform(-5, 5),
                        mrpt::random::randomGenerator.drawUniform(-5, 5),
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CSetOfLines");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CSimpleLine::Ptr obj = std::make_shared<opengl::CSimpleLine>();
      obj->setLocation(off_x, 0, 0);

      obj->setLineCoords(mrpt::random::randomGenerator.drawUniform(-5, 5),
                         mrpt::random::randomGenerator.drawUniform(-5, 5),
                         mrpt::random::randomGenerator.drawUniform(-5, 5),
                         mrpt::random::randomGenerator.drawUniform(-5, 5),
                         mrpt::random::randomGenerator.drawUniform(-5, 5),
    ...
    opengl::CText::Ptr gl_txt = std::make_shared<opengl::CText>("CSimpleLine");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      opengl::CVectorField2D::Ptr obj =
          std::make_shared<opengl::CVectorField2D>();
      obj->setLocation(off_x, 0, 0);
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("CVectorField2D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  {
    {
      ...
      opengl::CVectorField3D::Ptr obj =
          std::make_shared<opengl::CVectorField3D>();
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("CVectorField3D");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::BumblebeeCamera
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::BumblebeeCamera()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::CornerXYSimple
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::CornerXYSimple()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::CornerXYZSimple
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::CornerXYZSimple()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::CornerXYZ
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::CornerXYZ()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::RobotPioneer
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::RobotPioneer()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::Hokuyo_URG
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::Hokuyo_URG()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::Hokuyo_UTM
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::Hokuyo_UTM()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::Househam_Sprayer
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::Househam_Sprayer()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
  ...
  // stock_objects::RobotRhodon
  {
    ...
    opengl::CText::Ptr gl_txt =
        std::make_shared<opengl::CText>("stock_objects::RobotRhodon()");
    gl_txt->setLocation(off_x, off_y_label, 0);
    theScene->insert(gl_txt);
  }
  off_x += STEP_X;
